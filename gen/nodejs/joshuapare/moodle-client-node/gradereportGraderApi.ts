...
export enum GradereportGraderApiApiKeys {
    apiKey,
}

export class GradereportGraderApi {
    ...
    public setApiKey(key: GradereportGraderApiApiKeys, value: string) {
        (this.authentications as any)[GradereportGraderApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async gradereportGraderGetUsersInReport (coreCompletionMarkCourseSelfCompletedRequest: CoreCompletionMarkCourseSelfCompletedRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CoreGradesGetGradableUsers200Response;  }> {
        const localVarPath = this.basePath + '/gradereport_grader_get_users_in_report';
