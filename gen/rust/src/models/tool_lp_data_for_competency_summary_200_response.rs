...
pub struct ToolLpDataForCompetencySummary200Response {
    #[serde(rename = "competency")]
    pub competency: Box<models::CoreCompetencyCreateCompetency200Response>,
    #[serde(rename = "comppath")]
    pub comppath: Box<models::ToolLpDataForCompetencySummary200ResponseComppath>,
