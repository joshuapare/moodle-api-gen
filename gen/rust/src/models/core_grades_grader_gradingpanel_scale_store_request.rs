...
pub struct CoreGradesGraderGradingpanelScaleStoreRequest {
...
impl CoreGradesGraderGradingpanelScaleStoreRequest {
    pub fn new(component: String, contextid: i32, formdata: String, gradeduserid: i32, itemname: String) -> CoreGradesGraderGradingpanelScaleStoreRequest {
