...
pub struct CoreCohortUpdateCohortsRequestCohortsInnerCategorytype {
...
impl CoreCohortUpdateCohortsRequestCohortsInnerCategorytype {
    pub fn new(r#type: String, value: String) -> CoreCohortUpdateCohortsRequestCohortsInnerCategorytype {
