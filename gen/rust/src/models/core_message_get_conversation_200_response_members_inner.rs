...
pub struct CoreMessageGetConversation200ResponseMembersInner {
    ...
    pub contactrequests: Option<Vec<models::CoreMessageGetConversation200ResponseMembersInnerContactrequestsInner>>,
    #[serde(rename = "conversations", skip_serializing_if = "Option::is_none")]
    pub conversations: Option<Vec<models::CoreMessageGetConversation200ResponseMembersInnerConversationsInner>>,
    /// The user's name
...
impl CoreMessageGetConversation200ResponseMembersInner {
    pub fn new() -> CoreMessageGetConversation200ResponseMembersInner {
