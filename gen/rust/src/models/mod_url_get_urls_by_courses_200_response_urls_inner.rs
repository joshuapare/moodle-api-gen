...
pub struct ModUrlGetUrlsByCourses200ResponseUrlsInner {
    /// Course id
...
impl ModUrlGetUrlsByCourses200ResponseUrlsInner {
    pub fn new() -> ModUrlGetUrlsByCourses200ResponseUrlsInner {
