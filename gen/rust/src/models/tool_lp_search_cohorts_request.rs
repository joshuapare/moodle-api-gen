...
pub struct ToolLpSearchCohortsRequest {
...
impl ToolLpSearchCohortsRequest {
    pub fn new(context: models::CoreCohortSearchCohortsRequestContext, query: String) -> ToolLpSearchCohortsRequest {
