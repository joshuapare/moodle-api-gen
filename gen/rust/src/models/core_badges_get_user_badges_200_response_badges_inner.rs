...
pub struct CoreBadgesGetUserBadges200ResponseBadgesInner {
    #[serde(rename = "alignment", skip_serializing_if = "Option::is_none")]
    pub alignment: Option<Vec<models::CoreBadgesGetUserBadges200ResponseBadgesInnerAlignmentInner>>,
    /// Attachment
    ...
    pub endorsement: Option<Box<models::CoreBadgesGetUserBadges200ResponseBadgesInnerEndorsement>>,
    /// Expire date
    ...
    pub relatedbadges: Option<Vec<models::CoreBadgesGetUserBadges200ResponseBadgesInnerRelatedbadgesInner>>,
    /// Status
...
impl CoreBadgesGetUserBadges200ResponseBadgesInner {
    pub fn new() -> CoreBadgesGetUserBadges200ResponseBadgesInner {
