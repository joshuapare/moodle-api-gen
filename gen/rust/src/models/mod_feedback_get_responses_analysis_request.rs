...
pub struct ModFeedbackGetResponsesAnalysisRequest {
...
impl ModFeedbackGetResponsesAnalysisRequest {
    pub fn new(feedbackid: i32) -> ModFeedbackGetResponsesAnalysisRequest {
