...
pub struct CoreCompetencyReadUserEvidence200ResponseFilesInner {
    /// author
...
impl CoreCompetencyReadUserEvidence200ResponseFilesInner {
    pub fn new() -> CoreCompetencyReadUserEvidence200ResponseFilesInner {
