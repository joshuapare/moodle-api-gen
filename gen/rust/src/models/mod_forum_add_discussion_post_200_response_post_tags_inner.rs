...
pub struct ModForumAddDiscussionPost200ResponsePostTagsInner {
    ...
    pub urls: Option<Box<models::ModForumAddDiscussionPost200ResponsePostTagsInnerUrls>>,
}

impl ModForumAddDiscussionPost200ResponsePostTagsInner {
    pub fn new() -> ModForumAddDiscussionPost200ResponsePostTagsInner {
