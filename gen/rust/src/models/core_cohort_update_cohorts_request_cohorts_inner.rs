...
pub struct CoreCohortUpdateCohortsRequestCohortsInner {
    #[serde(rename = "categorytype", skip_serializing_if = "Option::is_none")]
    pub categorytype: Option<Box<models::CoreCohortUpdateCohortsRequestCohortsInnerCategorytype>>,
...
impl CoreCohortUpdateCohortsRequestCohortsInner {
    pub fn new() -> CoreCohortUpdateCohortsRequestCohortsInner {
