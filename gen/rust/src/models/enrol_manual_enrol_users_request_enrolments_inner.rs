...
pub struct EnrolManualEnrolUsersRequestEnrolmentsInner {
...
impl EnrolManualEnrolUsersRequestEnrolmentsInner {
    pub fn new() -> EnrolManualEnrolUsersRequestEnrolmentsInner {
