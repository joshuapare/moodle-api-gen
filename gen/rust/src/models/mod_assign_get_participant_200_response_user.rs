...
pub struct ModAssignGetParticipant200ResponseUser {
    /// Postal address
    ...
    pub customfields: Option<Vec<models::CoreGradesGetGradableUsers200ResponseUsersInnerCustomfieldsInner>>,
    /// department
    ...
    pub preferences: Option<Vec<models::CoreGradesGetGradableUsers200ResponseUsersInnerPreferencesInner>>,
...
impl ModAssignGetParticipant200ResponseUser {
    pub fn new(fullname: String, id: i32, profileimageurl: String, profileimageurlsmall: String) -> ModAssignGetParticipant200ResponseUser {
