...
pub struct CoreCalendarCreateCalendarEvents200ResponseEventsInner {
    /// course id
...
impl CoreCalendarCreateCalendarEvents200ResponseEventsInner {
    /// event
    pub fn new() -> CoreCalendarCreateCalendarEvents200ResponseEventsInner {
