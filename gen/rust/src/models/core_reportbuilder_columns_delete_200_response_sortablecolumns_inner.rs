...
pub struct CoreReportbuilderColumnsDelete200ResponseSortablecolumnsInner {
    /// heading
    ...
    pub sorticon: Option<Box<models::CoreReportbuilderColumnsDelete200ResponseSortablecolumnsInnerSorticon>>,
    /// sortorder
...
impl CoreReportbuilderColumnsDelete200ResponseSortablecolumnsInner {
    pub fn new() -> CoreReportbuilderColumnsDelete200ResponseSortablecolumnsInner {
