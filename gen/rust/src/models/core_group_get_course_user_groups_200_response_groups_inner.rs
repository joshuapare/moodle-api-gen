...
pub struct CoreGroupGetCourseUserGroups200ResponseGroupsInner {
    /// course id
...
impl CoreGroupGetCourseUserGroups200ResponseGroupsInner {
    pub fn new() -> CoreGroupGetCourseUserGroups200ResponseGroupsInner {
