...
pub struct ModForumAddDiscussionPost200ResponsePost {
    #[serde(rename = "attachments")]
    pub attachments: Vec<models::ModForumAddDiscussionPost200ResponsePostAttachmentsInner>,
    #[serde(rename = "author")]
    pub author: Box<models::ModForumAddDiscussionPost200ResponsePostAuthor>,
    #[serde(rename = "capabilities")]
    pub capabilities: Box<models::ModForumAddDiscussionPost200ResponsePostCapabilities>,
    /// charcount
    ...
    pub html: Option<Box<models::ModForumAddDiscussionPost200ResponsePostHtml>>,
    /// id
    #[serde(rename = "id")]
    pub id: i32,
    /// isdeleted
    ...
    pub tags: Option<Vec<models::ModForumAddDiscussionPost200ResponsePostTagsInner>>,
    /// timecreated
    ...
    pub urls: Option<Box<models::ModForumAddDiscussionPost200ResponsePostUrls>>,
    /// wordcount
    #[serde(rename = "wordcount", skip_serializing_if = "Option::is_none")]
    pub wordcount: Option<i32>,
}

impl ModForumAddDiscussionPost200ResponsePost {
    pub fn new(attachments: Vec<models::ModForumAddDiscussionPost200ResponsePostAttachmentsInner>, author: models::ModForumAddDiscussionPost200ResponsePostAuthor, capabilities: models::ModForumAddDiscussionPost200ResponsePostCapabilities, discussionid: i32, hasparent: bool, haswordcount: bool, id: i32, isdeleted: bool, isprivatereply: bool, message: String, messageformat: i32, replysubject: String, subject: String, timecreated: i32, timemodified: i32) -> ModForumAddDiscussionPost200ResponsePost {
