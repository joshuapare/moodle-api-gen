...
pub struct CoreMessageMessageSearchUsersRequest {
    /// Limit from
...
impl CoreMessageMessageSearchUsersRequest {
    pub fn new(search: String, userid: i32) -> CoreMessageMessageSearchUsersRequest {
