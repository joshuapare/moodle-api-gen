...
pub struct CoreRoleAssignRolesRequestAssignmentsInner {
...
impl CoreRoleAssignRolesRequestAssignmentsInner {
    pub fn new() -> CoreRoleAssignRolesRequestAssignmentsInner {
