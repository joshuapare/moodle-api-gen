...
pub struct CoreUserCreateUsersRequestUsersInner {
    /// Postal address
    ...
    #[serde(rename = "createpassword", skip_serializing_if = "Option::is_none")]
    ...
    pub preferences: Option<Vec<models::CoreUserCreateUsersRequestUsersInnerPreferencesInner>>,
...
impl CoreUserCreateUsersRequestUsersInner {
    pub fn new() -> CoreUserCreateUsersRequestUsersInner {
