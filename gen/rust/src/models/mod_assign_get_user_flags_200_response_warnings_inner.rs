...
pub struct ModAssignGetUserFlags200ResponseWarningsInner {
...
impl ModAssignGetUserFlags200ResponseWarningsInner {
    /// warning
    pub fn new() -> ModAssignGetUserFlags200ResponseWarningsInner {
