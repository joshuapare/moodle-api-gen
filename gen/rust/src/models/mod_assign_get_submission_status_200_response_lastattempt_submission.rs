...
pub struct ModAssignGetSubmissionStatus200ResponseLastattemptSubmission {
    /// assignment id
...
impl ModAssignGetSubmissionStatus200ResponseLastattemptSubmission {
    pub fn new(attemptnumber: i32, groupid: i32, id: i32, status: String, timecreated: i32, timemodified: i32, userid: i32) -> ModAssignGetSubmissionStatus200ResponseLastattemptSubmission {
