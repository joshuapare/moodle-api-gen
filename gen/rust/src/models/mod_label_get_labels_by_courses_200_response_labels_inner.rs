...
pub struct ModLabelGetLabelsByCourses200ResponseLabelsInner {
    /// Course id
...
impl ModLabelGetLabelsByCourses200ResponseLabelsInner {
    pub fn new() -> ModLabelGetLabelsByCourses200ResponseLabelsInner {
