...
pub struct CoreReportbuilderFiltersAdd200ResponseActivefiltersInner {
    /// entityname
...
impl CoreReportbuilderFiltersAdd200ResponseActivefiltersInner {
    pub fn new() -> CoreReportbuilderFiltersAdd200ResponseActivefiltersInner {
