...
pub struct ModLessonGetLesson200ResponseLesson {
...
impl ModLessonGetLesson200ResponseLesson {
    pub fn new(allowofflineattempts: bool, course: i32, coursemodule: i32, id: i32, lang: String, name: String) -> ModLessonGetLesson200ResponseLesson {
