...
pub struct ModForumAddDiscussionPostRequestOptionsInner {
...
impl ModForumAddDiscussionPostRequestOptionsInner {
    pub fn new() -> ModForumAddDiscussionPostRequestOptionsInner {
