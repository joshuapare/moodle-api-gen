...
pub struct ModForumAddDiscussionPost200ResponsePostAttachmentsInner {
    /// author
    ...
    pub html: Option<Box<models::ModForumAddDiscussionPost200ResponsePostAttachmentsInnerHtml>>,
    /// icon
    ...
    pub urls: Option<Box<models::ModForumAddDiscussionPost200ResponsePostAttachmentsInnerUrls>>,
}

impl ModForumAddDiscussionPost200ResponsePostAttachmentsInner {
    pub fn new() -> ModForumAddDiscussionPost200ResponsePostAttachmentsInner {
