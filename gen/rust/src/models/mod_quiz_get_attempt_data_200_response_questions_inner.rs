...
pub struct ModQuizGetAttemptData200ResponseQuestionsInner {
    ...
    pub responsefileareas: Option<Vec<models::ModQuizGetAttemptData200ResponseQuestionsInnerResponsefileareasInner>>,
...
impl ModQuizGetAttemptData200ResponseQuestionsInner {
    /// The question data. Some fields may not be returned depending on the quiz display settings.
    pub fn new() -> ModQuizGetAttemptData200ResponseQuestionsInner {
