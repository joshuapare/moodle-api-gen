...
pub struct ModDataAddEntry200ResponseFieldnotificationsInner {
    /// The field name.
...
impl ModDataAddEntry200ResponseFieldnotificationsInner {
    pub fn new() -> ModDataAddEntry200ResponseFieldnotificationsInner {
