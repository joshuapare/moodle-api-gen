...
pub struct ModFeedbackGetFinishedResponsesRequest {
...
impl ModFeedbackGetFinishedResponsesRequest {
    pub fn new(feedbackid: i32) -> ModFeedbackGetFinishedResponsesRequest {
