...
pub struct ModAssignGetSubmissionStatus200ResponseFeedbackPluginsInner {
    #[serde(rename = "editorfields", skip_serializing_if = "Option::is_none")]
    pub editorfields: Option<Vec<models::ModAssignGetSubmissionStatus200ResponseFeedbackPluginsInnerEditorfieldsInner>>,
...
impl ModAssignGetSubmissionStatus200ResponseFeedbackPluginsInner {
    pub fn new() -> ModAssignGetSubmissionStatus200ResponseFeedbackPluginsInner {
