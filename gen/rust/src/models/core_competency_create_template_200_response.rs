...
pub struct CoreCompetencyCreateTemplate200Response {
    /// canmanage
...
impl CoreCompetencyCreateTemplate200Response {
    pub fn new(canmanage: bool, canread: bool, cohortscount: i32, contextid: i32, contextname: String, contextnamenoprefix: String, description: String, duedate: i32, duedateformatted: String, id: i32, planscount: i32, shortname: String, timecreated: i32, timemodified: i32, usermodified: i32, visible: bool) -> CoreCompetencyCreateTemplate200Response {
