...
pub struct CoreBlockGetCourseBlocks200ResponseBlocksInner {
    ...
    pub configs: Option<Vec<models::CoreBlockGetCourseBlocks200ResponseBlocksInnerConfigsInner>>,
    #[serde(rename = "contents", skip_serializing_if = "Option::is_none")]
    pub contents: Option<Box<models::CoreBlockGetCourseBlocks200ResponseBlocksInnerContents>>,
...
impl CoreBlockGetCourseBlocks200ResponseBlocksInner {
    /// Block information.
    pub fn new() -> CoreBlockGetCourseBlocks200ResponseBlocksInner {
