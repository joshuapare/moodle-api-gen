...
**display** | Option<**i32**> | How to display the url | [optional][default to null]
**displayoptions** | Option<**String**> | Display options (width, height) | [optional]
**externalurl** | Option<**String**> | External URL | [optional][default to null]
...
**parameters** | Option<**String**> | Parameters to append to the URL | [optional][default to null]
**section** | Option<**i32**> | Course section id | [optional]
**timemodified** | Option<**i32**> | Last time the url was modified | [optional][default to null]
