...
**display** | Option<**i32**> | Display type of folder contents on a separate page or inline | [optional][default to null]
**forcedownload** | Option<**i32**> | Whether file download is forced | [optional][default to null]
...
**revision** | Option<**i32**> | Incremented when after each file changes, to avoid cache | [optional][default to null]
**section** | Option<**i32**> | Course section id | [optional]
**showdownloadfolder** | Option<**i32**> | Whether to show the download folder button | [optional][default to null]
**showexpanded** | Option<**i32**> | 1 = expanded, 0 = collapsed for sub-folders | [optional][default to null]
**timemodified** | Option<**i32**> | Last time the folder was modified | [optional][default to null]
