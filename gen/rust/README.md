...
Rust Client for Moodle, generated from the relevant OpenAPI spec from the [moodle-api-gen](https://www.github.com/joshuapare/moodle-api-gen) project.

## Installation

Put the package under your project folder in a directory named `moodle-client` and add the following to `Cargo.toml` under `[dependencies]`:

```
moodle-client = { path = "./moodle-client" }
```
