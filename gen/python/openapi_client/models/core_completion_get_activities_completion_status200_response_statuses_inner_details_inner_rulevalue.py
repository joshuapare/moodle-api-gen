...
class CoreCompletionGetActivitiesCompletionStatus200ResponseStatusesInnerDetailsInnerRulevalue(BaseModel):
    """
    CoreCompletionGetActivitiesCompletionStatus200ResponseStatusesInnerDetailsInnerRulevalue
    """ # noqa: E501
    description: StrictStr = Field(description="Completion description")
    status: StrictInt = Field(description="Completion status")
