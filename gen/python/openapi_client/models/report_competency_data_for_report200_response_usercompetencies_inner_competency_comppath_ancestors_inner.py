...
class ReportCompetencyDataForReport200ResponseUsercompetenciesInnerCompetencyComppathAncestorsInner(BaseModel):
    """
    ReportCompetencyDataForReport200ResponseUsercompetenciesInnerCompetencyComppathAncestorsInner
    """ # noqa: E501
    first: Optional[StrictBool] = Field(default=False, description="first")
    id: Optional[StrictInt] = Field(default=None, description="id")
    last: Optional[StrictBool] = Field(default=False, description="last")
    name: Optional[StrictStr] = Field(default=None, description="name")
    position: Optional[StrictInt] = Field(default=null, description="position")
