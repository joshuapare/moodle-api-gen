...
class CoreGroupUpdateGroupingsRequestGroupingsInner(BaseModel):
    """
    ...
    description: Optional[StrictStr] = Field(default=None, description="grouping description text")
    ...
    id: Optional[StrictInt] = Field(default=null, description="id of grouping")
