...
class EnrolGuestValidatePasswordRequest(BaseModel):
    """
    EnrolGuestValidatePasswordRequest
    """ # noqa: E501
    instanceid: StrictInt = Field(description="instance id of guest enrolment plugin")
    password: StrictStr = Field(description="the course password")
    __properties: ClassVar[List[str]] = ["instanceid", "password"]
