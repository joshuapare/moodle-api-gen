...
class ModQuizGetReopenAttemptConfirmationRequest(BaseModel):
    """
    ModQuizGetReopenAttemptConfirmationRequest
    """ # noqa: E501
    attemptid: StrictInt = Field(description="The id of the attempt to reopen")
    __properties: ClassVar[List[str]] = ["attemptid"]
