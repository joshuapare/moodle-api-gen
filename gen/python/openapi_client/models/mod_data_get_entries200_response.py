...
class ModDataGetEntries200Response(BaseModel):
    """
    ModDataGetEntries200Response
    """ # noqa: E501
    entries: List[ModDataGetEntries200ResponseEntriesInner]
    listviewcontents: Optional[StrictStr] = Field(default='null', description="The list view contents as is rendered in the site.")
    totalcount: StrictInt = Field(description="Total count of records.")
    totalfilesize: StrictInt = Field(description="Total size (bytes) of the files included in the records.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [ModDataGetEntries200ResponseEntriesInner.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
            "listviewcontents": obj.get("listviewcontents") if obj.get("listviewcontents") is not None else 'null',
