...
class ModLessonGetUserTimers200Response(BaseModel):
    """
    ModLessonGetUserTimers200Response
    """ # noqa: E501
    timers: List[ModLessonGetUserTimers200ResponseTimersInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "timers": [ModLessonGetUserTimers200ResponseTimersInner.from_dict(_item) for _item in obj["timers"]] if obj.get("timers") is not None else None,
