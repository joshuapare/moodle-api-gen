...
class ToolDataprivacyGetDataRequest200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": ToolDataprivacyGetDataRequest200ResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None,
