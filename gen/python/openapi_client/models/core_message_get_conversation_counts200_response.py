...
class CoreMessageGetConversationCounts200Response(BaseModel):
    """
    CoreMessageGetConversationCounts200Response
    """ # noqa: E501
    favourites: StrictInt = Field(description="Total number of favourite conversations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "types": CoreMessageGetConversationCounts200ResponseTypes.from_dict(obj["types"]) if obj.get("types") is not None else None
        })
        return _obj
