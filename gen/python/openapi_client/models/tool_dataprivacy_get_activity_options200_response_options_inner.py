...
class ToolDataprivacyGetActivityOptions200ResponseOptionsInner(BaseModel):
    """
    ToolDataprivacyGetActivityOptions200ResponseOptionsInner
    """ # noqa: E501
    displayname: Optional[StrictStr] = Field(default='null', description="The display name of the activity")
    name: Optional[StrictStr] = Field(default='null', description="The plugin name of the activity")
