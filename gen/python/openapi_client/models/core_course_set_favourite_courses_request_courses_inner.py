...
class CoreCourseSetFavouriteCoursesRequestCoursesInner(BaseModel):
    """
    CoreCourseSetFavouriteCoursesRequestCoursesInner
    """ # noqa: E501
    favourite: Optional[StrictBool] = Field(default=False, description="favourite status")
    id: Optional[StrictInt] = Field(default=null, description="course ID")
