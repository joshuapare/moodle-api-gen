...
class ModBigbluebuttonbnMeetingInfoRequest(BaseModel):
    """
    ...
    updatecache: Optional[StrictBool] = Field(default=False, description="update cache ?")
    __properties: ClassVar[List[str]] = ["bigbluebuttonbnid", "groupid", "updatecache"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "updatecache": obj.get("updatecache") if obj.get("updatecache") is not None else False
        })
        return _obj
