...
class CoreCompetencyUpdateCompetencyRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "competency": CoreCompetencyUpdateCompetencyRequestCompetency.from_dict(obj["competency"]) if obj.get("competency") is not None else None
        })
        return _obj
