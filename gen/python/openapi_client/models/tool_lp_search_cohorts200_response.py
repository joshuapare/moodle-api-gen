...
class ToolLpSearchCohorts200Response(BaseModel):
    """
    ToolLpSearchCohorts200Response
    """ # noqa: E501
    cohorts: List[ToolLpSearchCohorts200ResponseCohortsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cohorts": [ToolLpSearchCohorts200ResponseCohortsInner.from_dict(_item) for _item in obj["cohorts"]] if obj.get("cohorts") is not None else None
        })
        return _obj
