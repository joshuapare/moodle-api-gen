...
class ModChoiceGetChoiceResults200ResponseOptionsInnerUserresponsesInner(BaseModel):
    """
    User responses
    """ # noqa: E501
    answerid: Optional[StrictInt] = Field(default=null, description="answer id")
    fullname: Optional[StrictStr] = Field(default=None, description="user full name")
    profileimageurl: Optional[StrictStr] = Field(default='null', description="profile user image url")
    timemodified: Optional[StrictInt] = Field(default=null, description="time of modification")
