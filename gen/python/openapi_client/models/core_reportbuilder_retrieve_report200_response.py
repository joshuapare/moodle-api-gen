...
class CoreReportbuilderRetrieveReport200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CoreReportbuilderRetrieveReport200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "details": CoreReportbuilderRetrieveReport200ResponseDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,
