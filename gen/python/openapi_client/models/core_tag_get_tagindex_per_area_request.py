...
class CoreTagGetTagindexPerAreaRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tagindex": CoreTagGetTagindexPerAreaRequestTagindex.from_dict(obj["tagindex"]) if obj.get("tagindex") is not None else None
        })
        return _obj
