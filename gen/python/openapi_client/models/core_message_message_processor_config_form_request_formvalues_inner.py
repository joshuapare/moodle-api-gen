...
class CoreMessageMessageProcessorConfigFormRequestFormvaluesInner(BaseModel):
    """
    CoreMessageMessageProcessorConfigFormRequestFormvaluesInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default='null', description="name of the form element")
    value: Optional[StrictStr] = Field(default='null', description="value of the form element")
