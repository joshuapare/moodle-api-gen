...
class ModBigbluebuttonbnGetJoinUrl200Response(BaseModel):
    """
    ModBigbluebuttonbnGetJoinUrl200Response
    """ # noqa: E501
    join_url: Optional[StrictStr] = Field(default='null', description="Can join session")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "join_url": obj.get("join_url") if obj.get("join_url") is not None else 'null',
