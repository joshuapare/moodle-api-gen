...
class CoreCompetencyCountCompetenciesRequest(BaseModel):
    """
    CoreCompetencyCountCompetenciesRequest
    """ # noqa: E501
    filters: List[CoreCompetencyCountCompetenciesRequestFiltersInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filters": [CoreCompetencyCountCompetenciesRequestFiltersInner.from_dict(_item) for _item in obj["filters"]] if obj.get("filters") is not None else None
        })
        return _obj
