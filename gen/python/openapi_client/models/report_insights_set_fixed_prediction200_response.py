...
class ReportInsightsSetFixedPrediction200Response(BaseModel):
    """
    ReportInsightsSetFixedPrediction200Response
    """ # noqa: E501
    success: StrictBool = Field(description="True if the prediction was successfully flagged as fixed.")
