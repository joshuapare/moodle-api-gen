...
class ModAssignSaveGradesRequestGradesInnerPlugindataAssignfeedbackcommentsEditor(BaseModel):
    """
    ModAssignSaveGradesRequestGradesInnerPlugindataAssignfeedbackcommentsEditor
    """ # noqa: E501
    format: StrictInt = Field(description="The format for this feedback")
    text: StrictStr = Field(description="The text for this feedback.")
