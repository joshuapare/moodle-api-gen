...
class ToolLpSearchUsers200Response(BaseModel):
    """
    ToolLpSearchUsers200Response
    """ # noqa: E501
    count: StrictInt = Field(description="Total number of results.")
    users: List[ToolLpSearchUsers200ResponseUsersInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "users": [ToolLpSearchUsers200ResponseUsersInner.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
