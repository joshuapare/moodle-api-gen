...
class ModAssignGetGrades200Response(BaseModel):
    """
    ModAssignGetGrades200Response
    """ # noqa: E501
    assignments: List[ModAssignGetGrades200ResponseAssignmentsInner]
    warnings: Optional[List[ModAssignGetGrades200ResponseWarningsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assignments": [ModAssignGetGrades200ResponseAssignmentsInner.from_dict(_item) for _item in obj["assignments"]] if obj.get("assignments") is not None else None,
            "warnings": [ModAssignGetGrades200ResponseWarningsInner.from_dict(_item) for _item in obj["warnings"]] if obj.get("warnings") is not None else None
        })
        return _obj
