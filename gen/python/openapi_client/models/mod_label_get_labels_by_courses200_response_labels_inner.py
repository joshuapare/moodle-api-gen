...
class ModLabelGetLabelsByCourses200ResponseLabelsInner(BaseModel):
    """
    ...
    timemodified: Optional[StrictInt] = Field(default=null, description="Last time the label was modified")
