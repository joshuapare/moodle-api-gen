...
class ModUrlGetUrlsByCourses200ResponseUrlsInner(BaseModel):
    """
    ...
    display: Optional[StrictInt] = Field(default=null, description="How to display the url")
    displayoptions: Optional[StrictStr] = Field(default=None, description="Display options (width, height)")
    externalurl: Optional[StrictStr] = Field(default='null', description="External URL")
    ...
    parameters: Optional[StrictStr] = Field(default='null', description="Parameters to append to the URL")
    section: Optional[StrictInt] = Field(default=None, description="Course section id")
    timemodified: Optional[StrictInt] = Field(default=null, description="Last time the url was modified")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "externalurl": obj.get("externalurl") if obj.get("externalurl") is not None else 'null',
            ...
            "lang": obj.get("lang"),
            "name": obj.get("name"),
            "parameters": obj.get("parameters") if obj.get("parameters") is not None else 'null',
