...
class CoreCourseAddContentItemToUserFavourites200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "archetype": obj.get("archetype") if obj.get("archetype") is not None else 'null',
            ...
            "help": obj.get("help") if obj.get("help") is not None else 'null',
