...
class CoreReportbuilderConditionsAdd200ResponseAvailableconditionsInnerOptiongroupValuesInner(BaseModel):
    """
    ...
    visiblename: Optional[StrictStr] = Field(default='null', description="visiblename")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "visiblename": obj.get("visiblename") if obj.get("visiblename") is not None else 'null'
        })
        return _obj
