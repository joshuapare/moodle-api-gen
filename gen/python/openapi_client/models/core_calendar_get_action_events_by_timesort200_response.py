...
class CoreCalendarGetActionEventsByTimesort200Response(BaseModel):
    """
    CoreCalendarGetActionEventsByTimesort200Response
    """ # noqa: E501
    events: List[CoreCalendarGetActionEventsByCourses200ResponseGroupedbycourseInnerEventsInner]
