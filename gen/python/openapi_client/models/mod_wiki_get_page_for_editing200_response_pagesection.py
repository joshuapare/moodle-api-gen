...
class ModWikiGetPageForEditing200ResponsePagesection(BaseModel):
    """
    ModWikiGetPageForEditing200ResponsePagesection
    """ # noqa: E501
    content: Optional[StrictStr] = Field(default='null', description="The contents of the page-section to be edited.")
    contentformat: Optional[StrictStr] = Field(default='null', description="Format of the original content of the page.")
    version: StrictInt = Field(description="Latest version of the page.")
