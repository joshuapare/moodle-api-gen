...
class CoreGradesGetGradeitems200Response(BaseModel):
    """
    CoreGradesGetGradeitems200Response
    """ # noqa: E501
    grade_items: List[CoreGradesGetGradeitems200ResponseGradeItemsInner] = Field(alias="gradeItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "gradeItems": [CoreGradesGetGradeitems200ResponseGradeItemsInner.from_dict(_item) for _item in obj["gradeItems"]] if obj.get("gradeItems") is not None else None,
