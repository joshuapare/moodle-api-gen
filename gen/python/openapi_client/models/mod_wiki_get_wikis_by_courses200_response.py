...
class ModWikiGetWikisByCourses200Response(BaseModel):
    """
    ModWikiGetWikisByCourses200Response
    """ # noqa: E501
    warnings: Optional[List[AuthEmailSignupUser200ResponseWarningsInner]] = None
    wikis: List[ModWikiGetWikisByCourses200ResponseWikisInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "wikis": [ModWikiGetWikisByCourses200ResponseWikisInner.from_dict(_item) for _item in obj["wikis"]] if obj.get("wikis") is not None else None
        })
        return _obj
