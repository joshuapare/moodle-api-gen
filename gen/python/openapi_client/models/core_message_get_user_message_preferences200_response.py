...
class CoreMessageGetUserMessagePreferences200Response(BaseModel):
    """
    CoreMessageGetUserMessagePreferences200Response
    """ # noqa: E501
    blocknoncontacts: StrictInt = Field(description="Privacy messaging setting to define who can message you")
    entertosend: StrictBool = Field(description="User preference for using enter to send messages")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "blocknoncontacts": obj.get("blocknoncontacts") if obj.get("blocknoncontacts") is not None else null,
            "entertosend": obj.get("entertosend") if obj.get("entertosend") is not None else False,
            "preferences": CoreMessageGetUserMessagePreferences200ResponsePreferences.from_dict(obj["preferences"]) if obj.get("preferences") is not None else None,
