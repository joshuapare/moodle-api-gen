...
class CoreNotesViewNotesRequest(BaseModel):
    """
    CoreNotesViewNotesRequest
    """ # noqa: E501
    courseid: StrictInt = Field(description="course id, 0 for notes at system level")
    userid: Optional[StrictInt] = Field(default=0, description="user id, 0 means view all the user notes")
