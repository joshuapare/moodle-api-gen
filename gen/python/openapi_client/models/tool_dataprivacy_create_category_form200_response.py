...
class ToolDataprivacyCreateCategoryForm200Response(BaseModel):
    """
    ToolDataprivacyCreateCategoryForm200Response
    """ # noqa: E501
    category: ToolDataprivacyCreateCategoryForm200ResponseCategory
    validationerrors: StrictBool = Field(description="Were there validation errors")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "category": ToolDataprivacyCreateCategoryForm200ResponseCategory.from_dict(obj["category"]) if obj.get("category") is not None else None,
            "validationerrors": obj.get("validationerrors") if obj.get("validationerrors") is not None else False,
