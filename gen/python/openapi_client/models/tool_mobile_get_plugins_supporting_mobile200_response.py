...
class ToolMobileGetPluginsSupportingMobile200Response(BaseModel):
    """
    ToolMobileGetPluginsSupportingMobile200Response
    """ # noqa: E501
    plugins: List[ToolMobileGetPluginsSupportingMobile200ResponsePluginsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "plugins": [ToolMobileGetPluginsSupportingMobile200ResponsePluginsInner.from_dict(_item) for _item in obj["plugins"]] if obj.get("plugins") is not None else None,
