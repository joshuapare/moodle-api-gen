...
class ModScormGetScormScoTracks200ResponseData(BaseModel):
    """
    ModScormGetScormScoTracks200ResponseData
    """ # noqa: E501
    attempt: StrictInt = Field(description="Attempt number")
    tracks: List[ModScormGetScormScoTracks200ResponseDataTracksInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tracks": [ModScormGetScormScoTracks200ResponseDataTracksInner.from_dict(_item) for _item in obj["tracks"]] if obj.get("tracks") is not None else None
        })
        return _obj
