...
class CoreUserUpdateUsersRequestUsersInner(BaseModel):
    """
    ...
    phone1: Optional[StrictStr] = Field(default='null', description="Phone")
    phone2: Optional[StrictStr] = Field(default='null', description="Mobile phone")
    preferences: Optional[List[CoreUserUpdateUsersRequestUsersInnerPreferencesInner]] = None
    ...
    userpicture: Optional[StrictInt] = Field(default=null, description="The itemid where the new user picture has been uploaded to, 0 to delete")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "preferences": [CoreUserUpdateUsersRequestUsersInnerPreferencesInner.from_dict(_item) for _item in obj["preferences"]] if obj.get("preferences") is not None else None,
            "suspended": obj.get("suspended"),
            "theme": obj.get("theme"),
            "timezone": obj.get("timezone"),
            "username": obj.get("username") if obj.get("username") is not None else '',
            "userpicture": obj.get("userpicture") if obj.get("userpicture") is not None else null
        })
        return _obj
