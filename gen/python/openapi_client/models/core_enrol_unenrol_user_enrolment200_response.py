...
class CoreEnrolUnenrolUserEnrolment200Response(BaseModel):
    """
    CoreEnrolUnenrolUserEnrolment200Response
    """ # noqa: E501
    errors: List[CoreEnrolUnenrolUserEnrolment200ResponseErrorsInner]
    result: StrictBool = Field(description="True if the user's enrolment was successfully updated")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": [CoreEnrolUnenrolUserEnrolment200ResponseErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None,
