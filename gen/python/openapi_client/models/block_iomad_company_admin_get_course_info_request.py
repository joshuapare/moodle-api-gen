...
class BlockIomadCompanyAdminGetCourseInfoRequest(BaseModel):
    """
    BlockIomadCompanyAdminGetCourseInfoRequest
    """ # noqa: E501
    courrseids: Optional[List[Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["courrseids"]
