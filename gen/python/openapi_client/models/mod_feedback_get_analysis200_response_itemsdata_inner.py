...
class ModFeedbackGetAnalysis200ResponseItemsdataInner(BaseModel):
    """
    ModFeedbackGetAnalysis200ResponseItemsdataInner
    """ # noqa: E501
    data: Optional[List[Dict[str, Any]]] = None
    item: Optional[ModFeedbackGetAnalysis200ResponseItemsdataInnerItem] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": obj.get("data"),
            "item": ModFeedbackGetAnalysis200ResponseItemsdataInnerItem.from_dict(obj["item"]) if obj.get("item") is not None else None
        })
        return _obj
