...
class CoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner(BaseModel):
    """
    ...
    maxdayerror: Optional[StrictStr] = Field(default=None, description="maxdayerror")
    maxdaytimestamp: Optional[StrictInt] = Field(default=None, description="maxdaytimestamp")
    mindayerror: Optional[StrictStr] = Field(default=None, description="mindayerror")
    mindaytimestamp: Optional[StrictInt] = Field(default=None, description="mindaytimestamp")
    ...
    popupname: Optional[StrictStr] = Field(default=None, description="popupname")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "maxdayerror": obj.get("maxdayerror"),
            "maxdaytimestamp": obj.get("maxdaytimestamp"),
            "mindayerror": obj.get("mindayerror"),
            "mindaytimestamp": obj.get("mindaytimestamp"),
