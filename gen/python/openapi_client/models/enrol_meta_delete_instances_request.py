...
class EnrolMetaDeleteInstancesRequest(BaseModel):
    """
    EnrolMetaDeleteInstancesRequest
    """ # noqa: E501
    instances: Optional[List[EnrolMetaDeleteInstancesRequestInstancesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "instances": [EnrolMetaDeleteInstancesRequestInstancesInner.from_dict(_item) for _item in obj["instances"]] if obj.get("instances") is not None else None
        })
        return _obj
