...
class ModWorkshopUpdateAssessment200Response(BaseModel):
    """
    ModWorkshopUpdateAssessment200Response
    """ # noqa: E501
    rawgrade: Optional[Union[StrictFloat, StrictInt]] = Field(default=null, description="Raw percentual grade (0.00000 to 100.00000) for submission.")
    status: StrictBool = Field(description="status: true if the assessment was added or updated false otherwise.")
