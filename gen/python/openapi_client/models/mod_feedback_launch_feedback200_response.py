...
class ModFeedbackLaunchFeedback200Response(BaseModel):
    """
    ModFeedbackLaunchFeedback200Response
    """ # noqa: E501
    gopage: StrictInt = Field(description="The next page to go (-1 if we were already in the last page). 0 for first page.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "gopage": obj.get("gopage") if obj.get("gopage") is not None else null,
