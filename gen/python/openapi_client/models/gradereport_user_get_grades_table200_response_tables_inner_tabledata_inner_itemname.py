...
class GradereportUserGetGradesTable200ResponseTablesInnerTabledataInnerItemname(BaseModel):
    """
    ...
    colspan: StrictInt = Field(description="col span")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "class": obj.get("class"),
            "colspan": obj.get("colspan") if obj.get("colspan") is not None else null,
