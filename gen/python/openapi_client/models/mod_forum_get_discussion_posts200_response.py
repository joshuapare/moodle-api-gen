...
class ModForumGetDiscussionPosts200Response(BaseModel):
    """
    ModForumGetDiscussionPosts200Response
    """ # noqa: E501
    courseid: StrictInt = Field(description="The forum course id")
    forumid: StrictInt = Field(description="The forum id")
    posts: List[ModForumGetDiscussionPosts200ResponsePostsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "posts": [ModForumGetDiscussionPosts200ResponsePostsInner.from_dict(_item) for _item in obj["posts"]] if obj.get("posts") is not None else None,
