...
class ModImscpGetImscpsByCourses200ResponseImscpsInner(BaseModel):
    """
    ...
    keepold: Optional[StrictInt] = Field(default=null, description="Number of old IMSCP to keep")
    ...
    revision: Optional[StrictInt] = Field(default=null, description="Revision")
    section: Optional[StrictInt] = Field(default=None, description="Course section id")
    structure: Optional[StrictStr] = Field(default='null', description="IMSCP structure")
    timemodified: Optional[StrictStr] = Field(default='null', description="Time of last modification")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "keepold": obj.get("keepold") if obj.get("keepold") is not None else null,
            "lang": obj.get("lang"),
            "name": obj.get("name"),
            "revision": obj.get("revision") if obj.get("revision") is not None else null,
            "section": obj.get("section"),
            "structure": obj.get("structure") if obj.get("structure") is not None else 'null',
