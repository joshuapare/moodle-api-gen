...
class ModFeedbackProcessPageRequestResponsesInner(BaseModel):
    """
    ModFeedbackProcessPageRequestResponsesInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default='null', description="The response name (usually type[index]_id).")
