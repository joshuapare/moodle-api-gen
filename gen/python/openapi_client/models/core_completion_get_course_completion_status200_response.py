...
class CoreCompletionGetCourseCompletionStatus200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "completionstatus": CoreCompletionGetCourseCompletionStatus200ResponseCompletionstatus.from_dict(obj["completionstatus"]) if obj.get("completionstatus") is not None else None,
