...
class ToolMobileGetConfig200Response(BaseModel):
    """
    ToolMobileGetConfig200Response
    """ # noqa: E501
    settings: List[ToolMobileGetConfig200ResponseSettingsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "settings": [ToolMobileGetConfig200ResponseSettingsInner.from_dict(_item) for _item in obj["settings"]] if obj.get("settings") is not None else None,
