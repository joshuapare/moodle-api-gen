...
class CoreBadgesGetUserBadgeByHash200Response(BaseModel):
    """
    CoreBadgesGetUserBadgeByHash200Response
    """ # noqa: E501
    badge: List[CoreBadgesGetUserBadgeByHash200ResponseBadgeInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "badge": [CoreBadgesGetUserBadgeByHash200ResponseBadgeInner.from_dict(_item) for _item in obj["badge"]] if obj.get("badge") is not None else None,
