...
class BlockIomadCompanyAdminAssignUsers200ResponseUsersInner(BaseModel):
    """
    ...
    message: Optional[StrictStr] = Field(default='null', description="Failure message")
    result: Optional[StrictBool] = Field(default=False, description="Success or failure")
    userid: Optional[StrictInt] = Field(default=null, description="Department ID")
    __properties: ClassVar[List[str]] = ["companyid", "message", "result", "userid"]
