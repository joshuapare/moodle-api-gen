...
class CoreMessageGetBlockedUsers200Response(BaseModel):
    """
    CoreMessageGetBlockedUsers200Response
    """ # noqa: E501
    users: List[CoreMessageGetBlockedUsers200ResponseUsersInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "users": [CoreMessageGetBlockedUsers200ResponseUsersInner.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None,
