...
class CoreUserUpdatePicture200Response(BaseModel):
    """
    CoreUserUpdatePicture200Response
    """ # noqa: E501
    profileimageurl: Optional[StrictStr] = Field(default='null', description="New profile user image url")
    success: StrictBool = Field(description="True if the image was updated, false otherwise.")
