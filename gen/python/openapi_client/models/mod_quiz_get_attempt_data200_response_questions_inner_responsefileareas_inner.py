...
class ModQuizGetAttemptData200ResponseQuestionsInnerResponsefileareasInner(BaseModel):
    """
    ModQuizGetAttemptData200ResponseQuestionsInnerResponsefileareasInner
    """ # noqa: E501
    area: Optional[StrictStr] = Field(default='null', description="File area name")
