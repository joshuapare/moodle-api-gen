...
class ModAssignSaveGradeRequestAdvancedgradingdataGuide(BaseModel):
    """
    ModAssignSaveGradeRequestAdvancedgradingdataGuide
    """ # noqa: E501
    criteria: List[ModAssignSaveGradeRequestAdvancedgradingdataGuideCriteriaInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "criteria": [ModAssignSaveGradeRequestAdvancedgradingdataGuideCriteriaInner.from_dict(_item) for _item in obj["criteria"]] if obj.get("criteria") is not None else None
        })
        return _obj
