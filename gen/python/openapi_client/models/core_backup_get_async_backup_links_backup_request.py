...
class CoreBackupGetAsyncBackupLinksBackupRequest(BaseModel):
    """
    CoreBackupGetAsyncBackupLinksBackupRequest
    """ # noqa: E501
    backupid: StrictStr = Field(description="Backup id")
    contextid: StrictInt = Field(description="Context id")
    filename: StrictStr = Field(description="Backup filename")
    __properties: ClassVar[List[str]] = ["backupid", "contextid", "filename"]
