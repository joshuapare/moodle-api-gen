...
class CoreGradingGetDefinitions200ResponseAreasInnerDefinitionsInnerGuideGuideCommentsInner(BaseModel):
    """
    ...
    id: Optional[StrictInt] = Field(default=null, description="criterion id")
