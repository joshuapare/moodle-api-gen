...
class CoreCompetencyUpdateCourseCompetencySettingsRequestSettings(BaseModel):
    """
    CoreCompetencyUpdateCourseCompetencySettingsRequestSettings
    """ # noqa: E501
    pushratingstouserplans: StrictBool = Field(description="New value of the setting")
