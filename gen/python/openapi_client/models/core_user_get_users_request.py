...
class CoreUserGetUsersRequest(BaseModel):
    """
    CoreUserGetUsersRequest
    """ # noqa: E501
    criteria: List[CoreUserGetUsersRequestCriteriaInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "criteria": [CoreUserGetUsersRequestCriteriaInner.from_dict(_item) for _item in obj["criteria"]] if obj.get("criteria") is not None else None
        })
        return _obj
