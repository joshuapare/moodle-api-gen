...
class ModGlossaryPrepareEntryForEdition200ResponseAreasInnerOptionsInner(BaseModel):
    """
    ModGlossaryPrepareEntryForEdition200ResponseAreasInnerOptionsInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of option.")
    value: Optional[StrictStr] = Field(default=None, description="Value of option.")
