...
class CoreCourseUpdateCategoriesRequestCategoriesInner(BaseModel):
    """
    CoreCourseUpdateCategoriesRequestCategoriesInner
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default='null', description="category description")
    ...
    idnumber: Optional[StrictStr] = Field(default='null', description="category id number")
    name: Optional[StrictStr] = Field(default=None, description="category name")
    parent: Optional[StrictInt] = Field(default=null, description="parent category id")
    theme: Optional[StrictStr] = Field(default='null', description="the category theme. This option must be enabled on moodle")
