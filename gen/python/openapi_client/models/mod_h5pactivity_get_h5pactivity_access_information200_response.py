...
class ModH5pactivityGetH5pactivityAccessInformation200Response(BaseModel):
    """
    ModH5pactivityGetH5pactivityAccessInformation200Response
    """ # noqa: E501
    canaddinstance: Optional[StrictBool] = Field(default=False, description="Whether the user has the capability mod/h5pactivity:addinstance allowed.")
    canreviewattempts: Optional[StrictBool] = Field(default=False, description="Whether the user has the capability mod/h5pactivity:reviewattempts allowed.")
    cansubmit: Optional[StrictBool] = Field(default=False, description="Whether the user has the capability mod/h5pactivity:submit allowed.")
    canview: Optional[StrictBool] = Field(default=False, description="Whether the user has the capability mod/h5pactivity:view allowed.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "canreviewattempts": obj.get("canreviewattempts") if obj.get("canreviewattempts") is not None else False,
