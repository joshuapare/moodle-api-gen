...
class CoreMessageGetUserMessagePreferences200ResponsePreferencesComponentsInner(BaseModel):
    """
    CoreMessageGetUserMessagePreferences200ResponsePreferencesComponentsInner
    """ # noqa: E501
    displayname: Optional[StrictStr] = Field(default='null', description="Display name")
    notifications: Optional[List[CoreMessageGetUserMessagePreferences200ResponsePreferencesComponentsInnerNotificationsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "notifications": [CoreMessageGetUserMessagePreferences200ResponsePreferencesComponentsInnerNotificationsInner.from_dict(_item) for _item in obj["notifications"]] if obj.get("notifications") is not None else None
        })
        return _obj
