...
class EnrolLicenseEnrolUserRequest(BaseModel):
    """
    EnrolLicenseEnrolUserRequest
    """ # noqa: E501
    courseid: StrictInt = Field(description="Id of the course")
    instanceid: Optional[StrictInt] = Field(default=0, description="Instance id oflicenseenrolment plugin.")
    password: Optional[StrictStr] = Field(default='', description="Enrolment key")
    __properties: ClassVar[List[str]] = ["courseid", "instanceid", "password"]
