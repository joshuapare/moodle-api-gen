...
class MessagePopupGetPopupNotifications200Response(BaseModel):
    """
    MessagePopupGetPopupNotifications200Response
    """ # noqa: E501
    notifications: List[MessagePopupGetPopupNotifications200ResponseNotificationsInner]
    unreadcount: StrictInt = Field(description="the number of unread message for the given user")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "notifications": [MessagePopupGetPopupNotifications200ResponseNotificationsInner.from_dict(_item) for _item in obj["notifications"]] if obj.get("notifications") is not None else None,
