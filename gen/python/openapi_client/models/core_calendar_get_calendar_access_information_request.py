...
class CoreCalendarGetCalendarAccessInformationRequest(BaseModel):
    """
    CoreCalendarGetCalendarAccessInformationRequest
    """ # noqa: E501
    courseid: Optional[StrictInt] = Field(default=0, description="Course to check, empty for site calendar events.")
