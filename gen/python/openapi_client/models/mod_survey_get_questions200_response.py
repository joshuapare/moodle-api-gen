...
class ModSurveyGetQuestions200Response(BaseModel):
    """
    ModSurveyGetQuestions200Response
    """ # noqa: E501
    questions: List[ModSurveyGetQuestions200ResponseQuestionsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "questions": [ModSurveyGetQuestions200ResponseQuestionsInner.from_dict(_item) for _item in obj["questions"]] if obj.get("questions") is not None else None,
