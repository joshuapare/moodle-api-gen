...
class CoreCourseSearchCourses200Response(BaseModel):
    """
    CoreCourseSearchCourses200Response
    """ # noqa: E501
    courses: List[CoreCourseSearchCourses200ResponseCoursesInner]
    total: StrictInt = Field(description="total course count")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "courses": [CoreCourseSearchCourses200ResponseCoursesInner.from_dict(_item) for _item in obj["courses"]] if obj.get("courses") is not None else None,
