...
class ModWorkshopGetWorkshopsByCourses200ResponseWorkshopsInner(BaseModel):
    """
    ...
    conclusion: Optional[StrictStr] = Field(default='null', description="A text to be displayed at the end of the workshop.")
    conclusionfiles: Optional[List[CoreBlogGetEntries200ResponseEntriesInnerSummaryfilesInner]] = None
    conclusionformat: Optional[StrictInt] = Field(default=0, description="conclusion format (1 = HTML, 0 = MOODLE, 2 = PLAIN, or 4 = MARKDOWN)")
    course: Optional[StrictInt] = Field(default=null, description="Course id this workshop is part of.")
    coursemodule: Optional[StrictInt] = Field(default=None, description="coursemodule")
    evaluation: Optional[StrictStr] = Field(default='null', description="The recently used grading evaluation method.")
    ...
    instructauthors: Optional[StrictStr] = Field(default='null', description="Instructions for the submission phase.")
    instructauthorsfiles: Optional[List[CoreBlogGetEntries200ResponseEntriesInnerSummaryfilesInner]] = None
    ...
    instructreviewers: Optional[StrictStr] = Field(default='null', description="Instructions for the assessment phase.")
    instructreviewersfiles: Optional[List[CoreBlogGetEntries200ResponseEntriesInnerSummaryfilesInner]] = None
    ...
    intro: Optional[StrictStr] = Field(default='', description="Workshop introduction text.")
    ...
    maxbytes: Optional[StrictInt] = Field(default=100000, description="Maximum size of the one attached file.")
    name: Optional[StrictStr] = Field(default='null', description="Workshop name.")
    nattachments: Optional[StrictInt] = Field(default=1, description="Maximum number of submission attachments.")
    ...
    overallfeedbackfiletypes: Optional[StrictStr] = Field(default='null', description="Comma separated list of file extensions.")
    overallfeedbackmaxbytes: Optional[StrictInt] = Field(default=100000, description="Maximum size of one file attached to the overall feedback.")
    overallfeedbackmode: Optional[StrictInt] = Field(default=1, description="Mode of the overall feedback support.")
    ...
    strategy: Optional[StrictStr] = Field(default='null', description="The type of the current grading strategy used in this workshop.")
    ...
    submissiontypefile: Optional[StrictInt] = Field(default=1, description="Indicates whether a file upload is required as part of each submission. 0 for no, 1 for optional, 2 for required.")
    submissiontypetext: Optional[StrictInt] = Field(default=1, description="Indicates whether text is required as part of each submission. 0 for no, 1 for optional, 2 for required.")
    timemodified: Optional[StrictInt] = Field(default=null, description="The timestamp when the module was modified.")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.conclusionfiles:
            for _item in self.conclusionfiles:
                if _item:
        ...
        if self.instructauthorsfiles:
            for _item in self.instructauthorsfiles:
                if _item:
                    _items.append(_item.to_dict())
        ...
        if self.instructreviewersfiles:
            for _item in self.instructreviewersfiles:
                if _item:
                    _items.append(_item.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "conclusion": obj.get("conclusion") if obj.get("conclusion") is not None else 'null',
            "conclusionfiles": [CoreBlogGetEntries200ResponseEntriesInnerSummaryfilesInner.from_dict(_item) for _item in obj["conclusionfiles"]] if obj.get("conclusionfiles") is not None else None,
            ...
            "evaluation": obj.get("evaluation") if obj.get("evaluation") is not None else 'null',
            ...
            "id": obj.get("id"),
            "instructauthors": obj.get("instructauthors") if obj.get("instructauthors") is not None else 'null',
            "instructauthorsfiles": [CoreBlogGetEntries200ResponseEntriesInnerSummaryfilesInner.from_dict(_item) for _item in obj["instructauthorsfiles"]] if obj.get("instructauthorsfiles") is not None else None,
            "instructauthorsformat": obj.get("instructauthorsformat") if obj.get("instructauthorsformat") is not None else 0,
            "instructreviewers": obj.get("instructreviewers") if obj.get("instructreviewers") is not None else 'null',
            "instructreviewersfiles": [CoreBlogGetEntries200ResponseEntriesInnerSummaryfilesInner.from_dict(_item) for _item in obj["instructreviewersfiles"]] if obj.get("instructreviewersfiles") is not None else None,
            ...
            "maxbytes": obj.get("maxbytes") if obj.get("maxbytes") is not None else 100000,
            "name": obj.get("name") if obj.get("name") is not None else 'null',
            "nattachments": obj.get("nattachments") if obj.get("nattachments") is not None else 1,
            "overallfeedbackfiles": obj.get("overallfeedbackfiles") if obj.get("overallfeedbackfiles") is not None else 0,
            "overallfeedbackfiletypes": obj.get("overallfeedbackfiletypes") if obj.get("overallfeedbackfiletypes") is not None else 'null',
            "overallfeedbackmaxbytes": obj.get("overallfeedbackmaxbytes") if obj.get("overallfeedbackmaxbytes") is not None else 100000,
            "overallfeedbackmode": obj.get("overallfeedbackmode") if obj.get("overallfeedbackmode") is not None else 1,
            ...
            "strategy": obj.get("strategy") if obj.get("strategy") is not None else 'null',
            ...
            "submissiontypefile": obj.get("submissiontypefile") if obj.get("submissiontypefile") is not None else 1,
            "submissiontypetext": obj.get("submissiontypetext") if obj.get("submissiontypetext") is not None else 1,
