...
class ModBigbluebuttonbnGetRecordings200ResponseTabledataColumnsInner(BaseModel):
    """
    ...
    formatter: Optional[StrictStr] = Field(default='null', description="Formatter name")
    key: Optional[StrictStr] = None
    label: Optional[StrictStr] = None
    sortable: Optional[StrictBool] = Field(default=False, description="Whether this column is sortable")
    type: Optional[StrictStr] = Field(default='null', description="Column type")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "formatter": obj.get("formatter") if obj.get("formatter") is not None else 'null',
            "key": obj.get("key"),
            "label": obj.get("label"),
