...
class CoreGroupUpdateGroupingsRequest(BaseModel):
    """
    CoreGroupUpdateGroupingsRequest
    """ # noqa: E501
    groupings: List[CoreGroupUpdateGroupingsRequestGroupingsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groupings": [CoreGroupUpdateGroupingsRequestGroupingsInner.from_dict(_item) for _item in obj["groupings"]] if obj.get("groupings") is not None else None
        })
        return _obj
