...
class ModAssignGetAssignments200ResponseCoursesInner(BaseModel):
    """
    course information object
    """ # noqa: E501
    assignments: Optional[List[ModAssignGetAssignments200ResponseCoursesInnerAssignmentsInner]] = None
    ...
    timemodified: Optional[StrictInt] = Field(default=null, description="last time modified")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assignments": [ModAssignGetAssignments200ResponseCoursesInnerAssignmentsInner.from_dict(_item) for _item in obj["assignments"]] if obj.get("assignments") is not None else None,
