...
class ToolMobileGetContentRequestArgsInner(BaseModel):
    """
    ToolMobileGetContentRequestArgsInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default='null', description="Param name.")
    value: Optional[StrictStr] = Field(default='null', description="Param value.")
