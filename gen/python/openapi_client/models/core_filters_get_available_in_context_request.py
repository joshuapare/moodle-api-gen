...
class CoreFiltersGetAvailableInContextRequest(BaseModel):
    """
    CoreFiltersGetAvailableInContextRequest
    """ # noqa: E501
    contexts: List[CoreFiltersGetAvailableInContextRequestContextsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contexts": [CoreFiltersGetAvailableInContextRequestContextsInner.from_dict(_item) for _item in obj["contexts"]] if obj.get("contexts") is not None else None
        })
        return _obj
