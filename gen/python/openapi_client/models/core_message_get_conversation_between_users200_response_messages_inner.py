...
class CoreMessageGetConversationBetweenUsers200ResponseMessagesInner(BaseModel):
    """
    ...
    useridfrom: Optional[StrictInt] = Field(default=None, description="The id of the user who sent the message")
