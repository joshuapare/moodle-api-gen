...
class ModLessonGetPageDataRequest(BaseModel):
    """
    ...
    returncontents: Optional[StrictBool] = Field(default=False, description="if we must return the complete page contents once rendered")
    review: Optional[StrictBool] = Field(default=False, description="if we want to review just after finishing (1 hour margin)")
    __properties: ClassVar[List[str]] = ["lessonid", "pageid", "password", "returncontents", "review"]
