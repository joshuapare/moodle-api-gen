...
class CoreCalendarGetActionEventsByCourse200ResponseEventsInnerIcon(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "alttext": obj.get("alttext") if obj.get("alttext") is not None else 'null',
            "component": obj.get("component") if obj.get("component") is not None else 'null',
            "iconclass": obj.get("iconclass") if obj.get("iconclass") is not None else 'null',
