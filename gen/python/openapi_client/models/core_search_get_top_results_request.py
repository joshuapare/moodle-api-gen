...
class CoreSearchGetTopResultsRequest(BaseModel):
    """
    CoreSearchGetTopResultsRequest
    """ # noqa: E501
    filters: Optional[CoreSearchGetTopResultsRequestFilters] = None
    query: StrictStr = Field(description="the search query")
    __properties: ClassVar[List[str]] = ["filters", "query"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filters": CoreSearchGetTopResultsRequestFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None,
            "query": obj.get("query")
        })
        return _obj
