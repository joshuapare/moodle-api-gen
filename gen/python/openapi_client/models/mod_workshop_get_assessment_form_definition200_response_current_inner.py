...
class ModWorkshopGetAssessmentFormDefinition200ResponseCurrentInner(BaseModel):
    """
    ...
    value: Optional[StrictStr] = Field(default='null', description="Current field value.")
