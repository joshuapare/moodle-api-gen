...
class ModFeedbackGetNonRespondents200ResponseUsersInner(BaseModel):
    """
    ...
    started: Optional[StrictBool] = Field(default=False, description="If the user has started the attempt")
