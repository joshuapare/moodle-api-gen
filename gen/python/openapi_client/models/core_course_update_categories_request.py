...
class CoreCourseUpdateCategoriesRequest(BaseModel):
    """
    CoreCourseUpdateCategoriesRequest
    """ # noqa: E501
    categories: List[CoreCourseUpdateCategoriesRequestCategoriesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "categories": [CoreCourseUpdateCategoriesRequestCategoriesInner.from_dict(_item) for _item in obj["categories"]] if obj.get("categories") is not None else None
        })
        return _obj
