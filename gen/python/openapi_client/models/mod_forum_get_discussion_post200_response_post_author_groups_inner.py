...
class ModForumGetDiscussionPost200ResponsePostAuthorGroupsInner(BaseModel):
    """
    ModForumGetDiscussionPost200ResponsePostAuthorGroupsInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="id")
    name: Optional[StrictStr] = Field(default=None, description="name")
    urls: Optional[ModForumGetDiscussionPost200ResponsePostAuthorGroupsInnerUrls] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "urls": ModForumGetDiscussionPost200ResponsePostAuthorGroupsInnerUrls.from_dict(obj["urls"]) if obj.get("urls") is not None else None
        })
        return _obj
