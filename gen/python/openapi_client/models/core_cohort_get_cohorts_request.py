...
class CoreCohortGetCohortsRequest(BaseModel):
    """
    CoreCohortGetCohortsRequest
    """ # noqa: E501
    cohortids: Optional[List[Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["cohortids"]
