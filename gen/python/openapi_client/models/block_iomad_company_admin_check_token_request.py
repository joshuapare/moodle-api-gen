...
class BlockIomadCompanyAdminCheckTokenRequest(BaseModel):
    """
    BlockIomadCompanyAdminCheckTokenRequest
    """ # noqa: E501
    key0: BlockIomadCompanyAdminCheckTokenRequestKey0
    __properties: ClassVar[List[str]] = ["key0"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of key0
        if self.key0:
            _dict['key0'] = self.key0.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "key0": BlockIomadCompanyAdminCheckTokenRequestKey0.from_dict(obj["key0"]) if obj.get("key0") is not None else None
        })
        return _obj
