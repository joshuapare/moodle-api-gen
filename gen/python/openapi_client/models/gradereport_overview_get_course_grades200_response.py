...
class GradereportOverviewGetCourseGrades200Response(BaseModel):
    """
    GradereportOverviewGetCourseGrades200Response
    """ # noqa: E501
    grades: List[GradereportOverviewGetCourseGrades200ResponseGradesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "grades": [GradereportOverviewGetCourseGrades200ResponseGradesInner.from_dict(_item) for _item in obj["grades"]] if obj.get("grades") is not None else None,
