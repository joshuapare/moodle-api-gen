...
class ModForumGetForumDiscussions200Response(BaseModel):
    """
    ModForumGetForumDiscussions200Response
    """ # noqa: E501
    discussions: List[ModForumGetForumDiscussions200ResponseDiscussionsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "discussions": [ModForumGetForumDiscussions200ResponseDiscussionsInner.from_dict(_item) for _item in obj["discussions"]] if obj.get("discussions") is not None else None,
