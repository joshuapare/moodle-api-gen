...
class ModFeedbackGetResponsesAnalysis200ResponseAnonattemptsInner(BaseModel):
    """
    ...
    id: Optional[StrictInt] = Field(default=null, description="Completed id")
    number: Optional[StrictInt] = Field(default=null, description="Response number")
    responses: Optional[List[ModFeedbackGetResponsesAnalysis200ResponseAnonattemptsInnerResponsesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "responses": [ModFeedbackGetResponsesAnalysis200ResponseAnonattemptsInnerResponsesInner.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
