...
class CoreSearchGetSearchAreasList200Response(BaseModel):
    """
    CoreSearchGetSearchAreasList200Response
    """ # noqa: E501
    areas: List[CoreSearchGetSearchAreasList200ResponseAreasInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "areas": [CoreSearchGetSearchAreasList200ResponseAreasInner.from_dict(_item) for _item in obj["areas"]] if obj.get("areas") is not None else None,
