...
class BlockIomadCompanyAdminGetDepartments200Response(BaseModel):
    """
    BlockIomadCompanyAdminGetDepartments200Response
    """ # noqa: E501
    departments: List[BlockIomadCompanyAdminGetDepartments200ResponseDepartmentsInner]
    warnings: Optional[List[BlockIomadCompanyAdminGetCompanies200ResponseWarningsInner]] = None
    __properties: ClassVar[List[str]] = ["departments", "warnings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "departments": [BlockIomadCompanyAdminGetDepartments200ResponseDepartmentsInner.from_dict(_item) for _item in obj["departments"]] if obj.get("departments") is not None else None,
            "warnings": [BlockIomadCompanyAdminGetCompanies200ResponseWarningsInner.from_dict(_item) for _item in obj["warnings"]] if obj.get("warnings") is not None else None
        })
        return _obj
