...
class CoreCourseGetCourseModule200ResponseCmOutcomesInner(BaseModel):
    """
    CoreCourseGetCourseModule200ResponseCmOutcomesInner
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default='null', description="Outcome id")
    name: Optional[StrictStr] = Field(default='null', description="Outcome full name")
    scale: Optional[StrictStr] = Field(default='null', description="Scale items")
