...
class ModAssignSaveSubmissionRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["assignmentid", "plugindata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "plugindata": ModAssignSaveSubmissionRequestPlugindata.from_dict(obj["plugindata"]) if obj.get("plugindata") is not None else None
        })
        return _obj
