...
class ModWorkshopGetReviewerAssessments200Response(BaseModel):
    """
    ModWorkshopGetReviewerAssessments200Response
    """ # noqa: E501
    assessments: List[ModWorkshopGetReviewerAssessments200ResponseAssessmentsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assessments": [ModWorkshopGetReviewerAssessments200ResponseAssessmentsInner.from_dict(_item) for _item in obj["assessments"]] if obj.get("assessments") is not None else None,
