...
class CoreMessageMarkAllConversationMessagesAsReadRequest(BaseModel):
    """
    CoreMessageMarkAllConversationMessagesAsReadRequest
    """ # noqa: E501
    conversationid: StrictInt = Field(description="The conversation id who who we are marking the messages as read for")
    userid: StrictInt = Field(description="The user id who who we are marking the messages as read for")
    __properties: ClassVar[List[str]] = ["conversationid", "userid"]
