...
class CoreQuestionGetRandomQuestionSummaries200Response(BaseModel):
    """
    CoreQuestionGetRandomQuestionSummaries200Response
    """ # noqa: E501
    questions: List[CoreQuestionGetRandomQuestionSummaries200ResponseQuestionsInner]
    totalcount: StrictInt = Field(description="total number of questions in result set")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "questions": [CoreQuestionGetRandomQuestionSummaries200ResponseQuestionsInner.from_dict(_item) for _item in obj["questions"]] if obj.get("questions") is not None else None,
