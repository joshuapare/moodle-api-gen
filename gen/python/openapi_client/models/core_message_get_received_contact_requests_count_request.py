...
class CoreMessageGetReceivedContactRequestsCountRequest(BaseModel):
    """
    CoreMessageGetReceivedContactRequestsCountRequest
    """ # noqa: E501
    userid: StrictInt = Field(description="The id of the user we want to return the number of received contact requests for")
