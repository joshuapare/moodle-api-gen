...
class ModForumGetDiscussionPosts200ResponseRatinginfoScalesInner(BaseModel):
    """
    Scale information
    """ # noqa: E501
    ...
    isnumeric: Optional[StrictBool] = Field(default=None, description="Whether is a numeric scale.")
    items: Optional[List[ModForumGetDiscussionPosts200ResponseRatinginfoScalesInnerItemsInner]] = None
    max: Optional[StrictInt] = Field(default=None, description="Max value for the scale.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [ModForumGetDiscussionPosts200ResponseRatinginfoScalesInnerItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "max": obj.get("max"),
            "name": obj.get("name")
        })
        return _obj
