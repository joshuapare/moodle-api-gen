...
class BlockIomadCompanyAdminUpdateCoursesRequest(BaseModel):
    """
    BlockIomadCompanyAdminUpdateCoursesRequest
    """ # noqa: E501
    courses: List[BlockIomadCompanyAdminUpdateCoursesRequestCoursesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "courses": [BlockIomadCompanyAdminUpdateCoursesRequestCoursesInner.from_dict(_item) for _item in obj["courses"]] if obj.get("courses") is not None else None
        })
        return _obj
