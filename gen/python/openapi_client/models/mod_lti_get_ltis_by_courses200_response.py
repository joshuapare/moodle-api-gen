...
class ModLtiGetLtisByCourses200Response(BaseModel):
    """
    ModLtiGetLtisByCourses200Response
    """ # noqa: E501
    ltis: List[ModLtiGetLtisByCourses200ResponseLtisInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ltis": [ModLtiGetLtisByCourses200ResponseLtisInner.from_dict(_item) for _item in obj["ltis"]] if obj.get("ltis") is not None else None,
