...
class CoreMessageGetUnreadConversationCounts200Response(BaseModel):
    """
    CoreMessageGetUnreadConversationCounts200Response
    """ # noqa: E501
    favourites: StrictInt = Field(description="Total number of unread favourite conversations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "favourites": obj.get("favourites") if obj.get("favourites") is not None else null,
            "types": CoreMessageGetUnreadConversationCounts200ResponseTypes.from_dict(obj["types"]) if obj.get("types") is not None else None
        })
        return _obj
