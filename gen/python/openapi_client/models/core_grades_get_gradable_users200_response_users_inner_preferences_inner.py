...
class CoreGradesGetGradableUsers200ResponseUsersInnerPreferencesInner(BaseModel):
    """
    CoreGradesGetGradableUsers200ResponseUsersInnerPreferencesInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the preferences")
    value: Optional[StrictStr] = Field(default=None, description="The value of the preference")
