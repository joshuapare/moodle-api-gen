...
class CoreCohortDeleteCohortMembersRequestMembersInner(BaseModel):
    """
    CoreCohortDeleteCohortMembersRequestMembersInner
    """ # noqa: E501
    cohortid: Optional[StrictInt] = Field(default=null, description="cohort record id")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cohortid": obj.get("cohortid") if obj.get("cohortid") is not None else null,
