...
class CoreGradesGraderGradingpanelScaleFetch200ResponseGradeOptionsInner(BaseModel):
    """
    CoreGradesGraderGradingpanelScaleFetch200ResponseGradeOptionsInner
    """ # noqa: E501
    selected: Optional[StrictBool] = Field(default=False, description="Whether this item is currently selected")
    title: Optional[StrictStr] = Field(default='null', description="The description fo the option")
    value: Optional[Union[StrictFloat, StrictInt]] = Field(default=null, description="The grade value")
