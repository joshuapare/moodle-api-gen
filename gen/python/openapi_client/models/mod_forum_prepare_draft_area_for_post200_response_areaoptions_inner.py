...
class ModForumPrepareDraftAreaForPost200ResponseAreaoptionsInner(BaseModel):
    """
    ModForumPrepareDraftAreaForPost200ResponseAreaoptionsInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default='null', description="Name of option.")
    value: Optional[StrictStr] = Field(default='null', description="Value of option.")
