...
class ToolDataprivacyGetCategoryOptions200ResponseOptionsInner(BaseModel):
    """
    ToolDataprivacyGetCategoryOptions200ResponseOptionsInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="The category ID")
    name: Optional[StrictStr] = Field(default='null', description="The category name")
