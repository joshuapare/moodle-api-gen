...
class CoreCalendarGetCalendarMonthlyView200ResponseWeeksInner(BaseModel):
    """
    CoreCalendarGetCalendarMonthlyView200ResponseWeeksInner
    """ # noqa: E501
    days: Optional[List[CoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInner]] = None
    postpadding: Optional[List[Dict[str, Any]]] = None
    prepadding: Optional[List[Dict[str, Any]]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "days": [CoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInner.from_dict(_item) for _item in obj["days"]] if obj.get("days") is not None else None,
