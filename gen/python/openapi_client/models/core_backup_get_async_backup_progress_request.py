...
class CoreBackupGetAsyncBackupProgressRequest(BaseModel):
    """
    CoreBackupGetAsyncBackupProgressRequest
    """ # noqa: E501
    backupids: List[Dict[str, Any]]
    contextid: StrictInt = Field(description="Context id")
    __properties: ClassVar[List[str]] = ["backupids", "contextid"]
