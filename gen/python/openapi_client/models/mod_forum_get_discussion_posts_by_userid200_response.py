...
class ModForumGetDiscussionPostsByUserid200Response(BaseModel):
    """
    ModForumGetDiscussionPostsByUserid200Response
    """ # noqa: E501
    discussions: List[ModForumGetDiscussionPostsByUserid200ResponseDiscussionsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "discussions": [ModForumGetDiscussionPostsByUserid200ResponseDiscussionsInner.from_dict(_item) for _item in obj["discussions"]] if obj.get("discussions") is not None else None,
