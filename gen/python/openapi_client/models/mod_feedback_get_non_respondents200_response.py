...
class ModFeedbackGetNonRespondents200Response(BaseModel):
    """
    ModFeedbackGetNonRespondents200Response
    """ # noqa: E501
    total: StrictInt = Field(description="Total number of non respondents")
    users: List[ModFeedbackGetNonRespondents200ResponseUsersInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "users": [ModFeedbackGetNonRespondents200ResponseUsersInner.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None,
