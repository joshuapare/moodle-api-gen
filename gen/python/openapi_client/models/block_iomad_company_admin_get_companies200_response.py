...
class BlockIomadCompanyAdminGetCompanies200Response(BaseModel):
    """
    BlockIomadCompanyAdminGetCompanies200Response
    """ # noqa: E501
    companies: List[BlockIomadCompanyAdminGetCompanies200ResponseCompaniesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "companies": [BlockIomadCompanyAdminGetCompanies200ResponseCompaniesInner.from_dict(_item) for _item in obj["companies"]] if obj.get("companies") is not None else None,
