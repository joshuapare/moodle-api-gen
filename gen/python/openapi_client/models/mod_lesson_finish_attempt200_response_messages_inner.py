...
class ModLessonFinishAttempt200ResponseMessagesInner(BaseModel):
    """
    The lesson generated messages
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default='null', description="Message.")
    type: Optional[StrictStr] = Field(default='null', description="Message type: usually a CSS identifier like:                                 success, info, warning, error, notifyproblem, notifyerror, notifytiny, notifysuccess")
