...
class CoreGroupCreateGroupsRequestGroupsInner(BaseModel):
    """
    ...
    description: Optional[StrictStr] = Field(default='null', description="group description text")
    ...
    enrolmentkey: Optional[StrictStr] = Field(default='null', description="group enrol secret phrase")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "enrolmentkey": obj.get("enrolmentkey") if obj.get("enrolmentkey") is not None else 'null',
