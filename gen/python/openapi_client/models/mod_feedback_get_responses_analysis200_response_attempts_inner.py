...
class ModFeedbackGetResponsesAnalysis200ResponseAttemptsInner(BaseModel):
    """
    ...
    fullname: Optional[StrictStr] = Field(default=None, description="User full name")
    id: Optional[StrictInt] = Field(default=None, description="Completed id")
    responses: Optional[List[ModFeedbackGetResponsesAnalysis200ResponseAttemptsInnerResponsesInner]] = None
    timemodified: Optional[StrictInt] = Field(default=null, description="Time modified for the response")
    userid: Optional[StrictInt] = Field(default=null, description="User who responded")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "responses": [ModFeedbackGetResponsesAnalysis200ResponseAttemptsInnerResponsesInner.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None,
