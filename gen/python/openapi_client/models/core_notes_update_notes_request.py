...
class CoreNotesUpdateNotesRequest(BaseModel):
    """
    CoreNotesUpdateNotesRequest
    """ # noqa: E501
    notes: Optional[List[CoreNotesUpdateNotesRequestNotesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "notes": [CoreNotesUpdateNotesRequestNotesInner.from_dict(_item) for _item in obj["notes"]] if obj.get("notes") is not None else None
        })
        return _obj
