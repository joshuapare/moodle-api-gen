...
class ToolMobileCallExternalFunctions200Response(BaseModel):
    """
    ToolMobileCallExternalFunctions200Response
    """ # noqa: E501
    responses: List[ToolMobileCallExternalFunctions200ResponseResponsesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responses": [ToolMobileCallExternalFunctions200ResponseResponsesInner.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
