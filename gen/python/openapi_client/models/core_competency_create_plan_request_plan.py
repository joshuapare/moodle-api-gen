...
class CoreCompetencyCreatePlanRequestPlan(BaseModel):
    """
    ...
    origtemplateid: Optional[StrictInt] = Field(default=null, description="origtemplateid")
    reviewerid: Optional[StrictInt] = Field(default=null, description="reviewerid")
    status: Optional[StrictInt] = Field(default=0, description="status")
    templateid: Optional[StrictInt] = Field(default=null, description="templateid")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "origtemplateid": obj.get("origtemplateid") if obj.get("origtemplateid") is not None else null,
            ...
            "templateid": obj.get("templateid") if obj.get("templateid") is not None else null,
