...
class ModBigbluebuttonbnGetBigbluebuttonbnsByCourses200Response(BaseModel):
    """
    ModBigbluebuttonbnGetBigbluebuttonbnsByCourses200Response
    """ # noqa: E501
    bigbluebuttonbns: List[ModBigbluebuttonbnGetBigbluebuttonbnsByCourses200ResponseBigbluebuttonbnsInner]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.bigbluebuttonbns:
            for _item in self.bigbluebuttonbns:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bigbluebuttonbns": [ModBigbluebuttonbnGetBigbluebuttonbnsByCourses200ResponseBigbluebuttonbnsInner.from_dict(_item) for _item in obj["bigbluebuttonbns"]] if obj.get("bigbluebuttonbns") is not None else None,
