...
class CoreCompetencyUpdateCompetencyFrameworkRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "competencyframework": CoreCompetencyUpdateCompetencyFrameworkRequestCompetencyframework.from_dict(obj["competencyframework"]) if obj.get("competencyframework") is not None else None
        })
        return _obj
