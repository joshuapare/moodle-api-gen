...
class ModGlossaryGetCategories200Response(BaseModel):
    """
    ModGlossaryGetCategories200Response
    """ # noqa: E501
    categories: List[ModGlossaryGetCategories200ResponseCategoriesInner]
    count: StrictInt = Field(description="The total number of records.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "categories": [ModGlossaryGetCategories200ResponseCategoriesInner.from_dict(_item) for _item in obj["categories"]] if obj.get("categories") is not None else None,
            "count": obj.get("count"),
