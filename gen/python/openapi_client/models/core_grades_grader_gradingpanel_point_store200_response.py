...
class CoreGradesGraderGradingpanelPointStore200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "grade": CoreGradesGraderGradingpanelPointStore200ResponseGrade.from_dict(obj["grade"]) if obj.get("grade") is not None else None,
