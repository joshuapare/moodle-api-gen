...
class CoreRatingAddRating200Response(BaseModel):
    """
    CoreRatingAddRating200Response
    """ # noqa: E501
    aggregate: Optional[StrictStr] = Field(default='null', description="New aggregate")
    count: Optional[StrictInt] = Field(default=null, description="Ratings count")
    itemid: Optional[StrictInt] = Field(default=null, description="Rating item id")
    success: StrictBool = Field(description="Whether the rate was successfully created")
