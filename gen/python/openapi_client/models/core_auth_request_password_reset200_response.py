...
class CoreAuthRequestPasswordReset200Response(BaseModel):
    """
    CoreAuthRequestPasswordReset200Response
    """ # noqa: E501
    notice: StrictStr = Field(description="Important information for the user about the process.")
    status: StrictStr = Field(description="The returned status of the process:                     dataerror: Error in the sent data (username or email). More information in warnings field.                     emailpasswordconfirmmaybesent: Email sent or not (depends on user found in database).                     emailpasswordconfirmnotsent: Failure, user not found.                     emailpasswordconfirmnoemail: Failure, email not found.                     emailalreadysent: Email already sent.                     emailpasswordconfirmsent: User pending confirmation.                     emailresetconfirmsent: Email sent.                 ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "notice": obj.get("notice") if obj.get("notice") is not None else 'null',
