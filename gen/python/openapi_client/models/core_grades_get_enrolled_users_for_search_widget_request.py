...
class CoreGradesGetEnrolledUsersForSearchWidgetRequest(BaseModel):
    """
    CoreGradesGetEnrolledUsersForSearchWidgetRequest
    """ # noqa: E501
    actionbaseurl: StrictStr = Field(description="The base URL for the user option")
    courseid: StrictInt = Field(description="Course Id")
    groupid: Optional[StrictInt] = Field(default=0, description="Group Id")
    __properties: ClassVar[List[str]] = ["actionbaseurl", "courseid", "groupid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actionbaseurl": obj.get("actionbaseurl") if obj.get("actionbaseurl") is not None else 'null',
