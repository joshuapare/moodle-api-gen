...
class CoreCohortUpdateCohortsRequestCohortsInner(BaseModel):
    """
    CoreCohortUpdateCohortsRequestCohortsInner
    """ # noqa: E501
    categorytype: Optional[CoreCohortUpdateCohortsRequestCohortsInnerCategorytype] = None
    ...
    id: Optional[StrictInt] = Field(default=None, description="ID of the cohort")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "categorytype": CoreCohortUpdateCohortsRequestCohortsInnerCategorytype.from_dict(obj["categorytype"]) if obj.get("categorytype") is not None else None,
