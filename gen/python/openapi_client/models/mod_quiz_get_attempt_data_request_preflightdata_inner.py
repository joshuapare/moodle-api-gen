...
class ModQuizGetAttemptDataRequestPreflightdataInner(BaseModel):
    """
    ModQuizGetAttemptDataRequestPreflightdataInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="data name")
    value: Optional[StrictStr] = Field(default=None, description="data value")
