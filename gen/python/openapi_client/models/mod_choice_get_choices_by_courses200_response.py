...
class ModChoiceGetChoicesByCourses200Response(BaseModel):
    """
    ModChoiceGetChoicesByCourses200Response
    """ # noqa: E501
    choices: List[ModChoiceGetChoicesByCourses200ResponseChoicesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "choices": [ModChoiceGetChoicesByCourses200ResponseChoicesInner.from_dict(_item) for _item in obj["choices"]] if obj.get("choices") is not None else None,
