...
class CoreUpdateInplaceEditableRequest(BaseModel):
    """
    CoreUpdateInplaceEditableRequest
    """ # noqa: E501
    component: StrictStr = Field(description="component responsible for the update")
    itemid: StrictStr = Field(description="identifier of the updated item")
    itemtype: StrictStr = Field(description="type of the updated item inside the component")
    value: StrictStr = Field(description="new value")
    __properties: ClassVar[List[str]] = ["component", "itemid", "itemtype", "value"]
