...
class CoreUserSetUserPreferences200Response(BaseModel):
    """
    CoreUserSetUserPreferences200Response
    """ # noqa: E501
    saved: List[CoreUserSetUserPreferences200ResponseSavedInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "saved": [CoreUserSetUserPreferences200ResponseSavedInner.from_dict(_item) for _item in obj["saved"]] if obj.get("saved") is not None else None,
