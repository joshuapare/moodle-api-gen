...
class CoreMessageGetUserMessagePreferences200ResponsePreferencesComponentsInnerNotificationsInner(BaseModel):
    """
    ...
    preferencekey: Optional[StrictStr] = Field(default='null', description="Preference key")
    processors: Optional[List[CoreMessageGetUserMessagePreferences200ResponsePreferencesComponentsInnerNotificationsInnerProcessorsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "preferencekey": obj.get("preferencekey") if obj.get("preferencekey") is not None else 'null',
            "processors": [CoreMessageGetUserMessagePreferences200ResponsePreferencesComponentsInnerNotificationsInnerProcessorsInner.from_dict(_item) for _item in obj["processors"]] if obj.get("processors") is not None else None
        })
        return _obj
