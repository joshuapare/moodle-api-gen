...
class CoreSearchViewResultsRequest(BaseModel):
    """
    CoreSearchViewResultsRequest
    """ # noqa: E501
    filters: Optional[CoreSearchViewResultsRequestFilters] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filters": CoreSearchViewResultsRequestFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None,
