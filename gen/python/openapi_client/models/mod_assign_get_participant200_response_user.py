...
class ModAssignGetParticipant200ResponseUser(BaseModel):
    """
    ...
    profileimageurl: StrictStr = Field(description="User image profile URL - big version")
    profileimageurlsmall: StrictStr = Field(description="User image profile URL - small version")
