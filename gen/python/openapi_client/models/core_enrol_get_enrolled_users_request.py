...
class CoreEnrolGetEnrolledUsersRequest(BaseModel):
    """
    CoreEnrolGetEnrolledUsersRequest
    """ # noqa: E501
    courseid: StrictInt = Field(description="course id")
    options: Optional[List[CoreEnrolGetEnrolledUsersRequestOptionsInner]] = None
    __properties: ClassVar[List[str]] = ["courseid", "options"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "options": [CoreEnrolGetEnrolledUsersRequestOptionsInner.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None
        })
        return _obj
