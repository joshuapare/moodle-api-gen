...
class ModScormGetScormScoes200Response(BaseModel):
    """
    ModScormGetScormScoes200Response
    """ # noqa: E501
    scoes: List[ModScormGetScormScoes200ResponseScoesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "scoes": [ModScormGetScormScoes200ResponseScoesInner.from_dict(_item) for _item in obj["scoes"]] if obj.get("scoes") is not None else None,
