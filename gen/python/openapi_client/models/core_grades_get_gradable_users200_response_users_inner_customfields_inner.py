...
class CoreGradesGetGradableUsers200ResponseUsersInnerCustomfieldsInner(BaseModel):
    """
    ...
    value: Optional[StrictStr] = Field(default=None, description="The value of the custom field (as stored in the database)")
