...
class CoreCourseGetCoursesByField200Response(BaseModel):
    """
    CoreCourseGetCoursesByField200Response
    """ # noqa: E501
    courses: List[CoreCourseGetCoursesByField200ResponseCoursesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "courses": [CoreCourseGetCoursesByField200ResponseCoursesInner.from_dict(_item) for _item in obj["courses"]] if obj.get("courses") is not None else None,
