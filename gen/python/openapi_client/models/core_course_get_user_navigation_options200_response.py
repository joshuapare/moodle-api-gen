...
class CoreCourseGetUserNavigationOptions200Response(BaseModel):
    """
    CoreCourseGetUserNavigationOptions200Response
    """ # noqa: E501
    courses: List[CoreCourseGetUserNavigationOptions200ResponseCoursesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "courses": [CoreCourseGetUserNavigationOptions200ResponseCoursesInner.from_dict(_item) for _item in obj["courses"]] if obj.get("courses") is not None else None,
