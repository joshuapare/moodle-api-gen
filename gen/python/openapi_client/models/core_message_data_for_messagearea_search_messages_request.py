...
class CoreMessageDataForMessageareaSearchMessagesRequest(BaseModel):
    """
    ...
    search: StrictStr = Field(description="The string being searched")
    userid: StrictInt = Field(description="The id of the user who is performing the search")
    __properties: ClassVar[List[str]] = ["limitfrom", "limitnum", "search", "userid"]
