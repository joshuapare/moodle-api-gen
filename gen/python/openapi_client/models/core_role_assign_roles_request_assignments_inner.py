...
class CoreRoleAssignRolesRequestAssignmentsInner(BaseModel):
    """
    CoreRoleAssignRolesRequestAssignmentsInner
    """ # noqa: E501
    contextid: Optional[StrictInt] = Field(default=null, description="The context to assign the user role in")
    contextlevel: Optional[StrictStr] = Field(default='null', description="The context level to assign the user role in                                     (block, course, coursecat, system, user, module)")
    instanceid: Optional[StrictInt] = Field(default=null, description="The Instance id of item where the role needs to be assigned")
    roleid: Optional[StrictInt] = Field(default=None, description="Role to assign to the user")
    userid: Optional[StrictInt] = Field(default=null, description="The user that is going to be assigned")
