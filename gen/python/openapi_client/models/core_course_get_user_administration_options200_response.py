...
class CoreCourseGetUserAdministrationOptions200Response(BaseModel):
    """
    CoreCourseGetUserAdministrationOptions200Response
    """ # noqa: E501
    courses: List[CoreCourseGetUserAdministrationOptions200ResponseCoursesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "courses": [CoreCourseGetUserAdministrationOptions200ResponseCoursesInner.from_dict(_item) for _item in obj["courses"]] if obj.get("courses") is not None else None,
