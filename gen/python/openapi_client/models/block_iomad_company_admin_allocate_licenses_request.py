...
class BlockIomadCompanyAdminAllocateLicensesRequest(BaseModel):
    """
    BlockIomadCompanyAdminAllocateLicensesRequest
    """ # noqa: E501
    licenses: List[BlockIomadCompanyAdminAllocateLicensesRequestLicensesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "licenses": [BlockIomadCompanyAdminAllocateLicensesRequestLicensesInner.from_dict(_item) for _item in obj["licenses"]] if obj.get("licenses") is not None else None
        })
        return _obj
