...
class CoreSearchGetResults200Response(BaseModel):
    """
    CoreSearchGetResults200Response
    """ # noqa: E501
    results: List[CoreSearchGetResults200ResponseResultsInner]
    totalcount: StrictInt = Field(description="Total number of results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [CoreSearchGetResults200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
