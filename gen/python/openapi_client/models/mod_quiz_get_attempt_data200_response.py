...
class ModQuizGetAttemptData200Response(BaseModel):
    """
    ModQuizGetAttemptData200Response
    """ # noqa: E501
    attempt: ModQuizGetAttemptData200ResponseAttempt
    messages: List[Dict[str, Any]]
    nextpage: StrictInt = Field(description="next page number")
    questions: List[ModQuizGetAttemptData200ResponseQuestionsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attempt": ModQuizGetAttemptData200ResponseAttempt.from_dict(obj["attempt"]) if obj.get("attempt") is not None else None,
            "messages": obj.get("messages"),
            "nextpage": obj.get("nextpage") if obj.get("nextpage") is not None else null,
            "questions": [ModQuizGetAttemptData200ResponseQuestionsInner.from_dict(_item) for _item in obj["questions"]] if obj.get("questions") is not None else None,
