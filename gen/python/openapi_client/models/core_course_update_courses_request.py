...
class CoreCourseUpdateCoursesRequest(BaseModel):
    """
    CoreCourseUpdateCoursesRequest
    """ # noqa: E501
    courses: List[CoreCourseUpdateCoursesRequestCoursesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "courses": [CoreCourseUpdateCoursesRequestCoursesInner.from_dict(_item) for _item in obj["courses"]] if obj.get("courses") is not None else None
        })
        return _obj
