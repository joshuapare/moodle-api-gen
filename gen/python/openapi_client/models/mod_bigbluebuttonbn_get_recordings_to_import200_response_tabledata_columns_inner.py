...
class ModBigbluebuttonbnGetRecordingsToImport200ResponseTabledataColumnsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["allowHTML", "key", "label", "sortable", "type", "width"]
