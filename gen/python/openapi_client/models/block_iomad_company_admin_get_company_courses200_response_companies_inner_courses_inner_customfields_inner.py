...
class BlockIomadCompanyAdminGetCompanyCourses200ResponseCompaniesInnerCoursesInnerCustomfieldsInner(BaseModel):
    """
    BlockIomadCompanyAdminGetCompanyCourses200ResponseCompaniesInnerCoursesInnerCustomfieldsInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=null, description="Custom field id")
    name: Optional[StrictStr] = Field(default='null', description="Custom field name")
    value: Optional[StrictStr] = Field(default='null', description="Custom field data value")
