...
class ModBookGetBooksByCourses200ResponseBooksInner(BaseModel):
    """
    Books
    """ # noqa: E501
    ...
    customtitles: Optional[StrictInt] = Field(default=null, description="Book custom titles type")
    ...
    navstyle: Optional[StrictInt] = Field(default=null, description="Book navigation style configuration")
    numbering: Optional[StrictInt] = Field(default=null, description="Book numbering configuration")
    revision: Optional[StrictInt] = Field(default=null, description="Book revision")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customtitles": obj.get("customtitles") if obj.get("customtitles") is not None else null,
            ...
            "lang": obj.get("lang"),
            "name": obj.get("name"),
            "navstyle": obj.get("navstyle") if obj.get("navstyle") is not None else null,
            "numbering": obj.get("numbering") if obj.get("numbering") is not None else null,
