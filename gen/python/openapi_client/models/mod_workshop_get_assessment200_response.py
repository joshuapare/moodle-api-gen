...
class ModWorkshopGetAssessment200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assessment": ModWorkshopGetAssessment200ResponseAssessment.from_dict(obj["assessment"]) if obj.get("assessment") is not None else None,
