...
class ModQuizGetQuizzesByCourses200Response(BaseModel):
    """
    ModQuizGetQuizzesByCourses200Response
    """ # noqa: E501
    quizzes: List[ModQuizGetQuizzesByCourses200ResponseQuizzesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "quizzes": [ModQuizGetQuizzesByCourses200ResponseQuizzesInner.from_dict(_item) for _item in obj["quizzes"]] if obj.get("quizzes") is not None else None,
