...
class GradingformRubricGraderGradingpanelFetch200ResponseGradeCriteriaInner(BaseModel):
    """
    GradingformRubricGraderGradingpanelFetch200ResponseGradeCriteriaInner
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default='null', description="Description of the Criteria")
    id: Optional[StrictInt] = Field(default=null, description="ID of the Criteria")
    levels: Optional[List[GradingformRubricGraderGradingpanelFetch200ResponseGradeCriteriaInnerLevelsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "levels": [GradingformRubricGraderGradingpanelFetch200ResponseGradeCriteriaInnerLevelsInner.from_dict(_item) for _item in obj["levels"]] if obj.get("levels") is not None else None,
