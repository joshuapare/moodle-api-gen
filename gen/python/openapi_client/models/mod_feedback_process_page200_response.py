...
class ModFeedbackProcessPage200Response(BaseModel):
    """
    ModFeedbackProcessPage200Response
    """ # noqa: E501
    completed: StrictBool = Field(description="If the user completed the feedback.")
    completionpagecontents: StrictStr = Field(description="The completion page contents.")
    jumpto: StrictInt = Field(description="The page to jump to.")
    siteaftersubmit: StrictStr = Field(description="The link (could be relative) to show after submit.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "completionpagecontents": obj.get("completionpagecontents") if obj.get("completionpagecontents") is not None else 'null',
            "jumpto": obj.get("jumpto") if obj.get("jumpto") is not None else null,
            "siteaftersubmit": obj.get("siteaftersubmit") if obj.get("siteaftersubmit") is not None else 'null',
