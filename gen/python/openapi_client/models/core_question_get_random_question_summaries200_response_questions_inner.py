...
class CoreQuestionGetRandomQuestionSummaries200ResponseQuestionsInner(BaseModel):
    """
    CoreQuestionGetRandomQuestionSummaries200ResponseQuestionsInner
    """ # noqa: E501
    category: Optional[StrictInt] = Field(default=null, description="category")
    icon: Optional[CoreQuestionGetRandomQuestionSummaries200ResponseQuestionsInnerIcon] = None
    id: Optional[StrictInt] = Field(default=None, description="id")
    name: Optional[StrictStr] = Field(default=None, description="name")
    parent: Optional[StrictInt] = Field(default=None, description="parent")
    qtype: Optional[StrictStr] = Field(default='null', description="qtype")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "icon": CoreQuestionGetRandomQuestionSummaries200ResponseQuestionsInnerIcon.from_dict(obj["icon"]) if obj.get("icon") is not None else None,
            "id": obj.get("id"),
            "name": obj.get("name"),
