...
class ModLessonFinishAttempt200ResponseDataInner(BaseModel):
    """
    ModLessonFinishAttempt200ResponseDataInner
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default='null', description="Data message (translated string).")
    name: Optional[StrictStr] = Field(default='null', description="Data name.")
    value: Optional[StrictStr] = Field(default='null', description="Data value.")
