...
class ModFeedbackGetCurrentCompletedTmp200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "feedback": ModFeedbackGetCurrentCompletedTmp200ResponseFeedback.from_dict(obj["feedback"]) if obj.get("feedback") is not None else None,
