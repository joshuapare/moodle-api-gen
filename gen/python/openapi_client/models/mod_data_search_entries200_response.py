...
class ModDataSearchEntries200Response(BaseModel):
    """
    ModDataSearchEntries200Response
    """ # noqa: E501
    entries: List[ModDataSearchEntries200ResponseEntriesInner]
    listviewcontents: Optional[StrictStr] = Field(default=None, description="The list view contents as is rendered in the site.")
    maxcount: Optional[StrictInt] = Field(default=null, description="Total count of records that the user could see in the database                     (if all the search criterias were removed).")
    totalcount: StrictInt = Field(description="Total count of records returned by the search.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [ModDataSearchEntries200ResponseEntriesInner.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
            "listviewcontents": obj.get("listviewcontents"),
            "maxcount": obj.get("maxcount") if obj.get("maxcount") is not None else null,
