...
class CoreCompletionOverrideActivityCompletionStatusRequest(BaseModel):
    """
    CoreCompletionOverrideActivityCompletionStatusRequest
    """ # noqa: E501
    cmid: StrictInt = Field(description="course module id")
    newstate: StrictInt = Field(description="the new activity completion state")
    userid: StrictInt = Field(description="user id")
    __properties: ClassVar[List[str]] = ["cmid", "newstate", "userid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "newstate": obj.get("newstate") if obj.get("newstate") is not None else null,
