...
class CoreCustomfieldReloadTemplate200ResponseCategoriesInnerFieldsInner(BaseModel):
    """
    CoreCustomfieldReloadTemplate200ResponseCategoriesInnerFieldsInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=null, description="id")
    name: Optional[StrictStr] = Field(default='null', description="name")
    shortname: Optional[StrictStr] = Field(default='null', description="shortname")
    type: Optional[StrictStr] = Field(default='null', description="type")
