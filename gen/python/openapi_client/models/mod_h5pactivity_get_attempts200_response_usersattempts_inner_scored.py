...
class ModH5pactivityGetAttempts200ResponseUsersattemptsInnerScored(BaseModel):
    """
    ModH5pactivityGetAttempts200ResponseUsersattemptsInnerScored
    """ # noqa: E501
    attempts: List[ModH5pactivityGetAttempts200ResponseUsersattemptsInnerScoredAttemptsInner]
    grademethod: StrictStr = Field(description="Scored attempts title")
    title: StrictStr = Field(description="Scored attempts title")
