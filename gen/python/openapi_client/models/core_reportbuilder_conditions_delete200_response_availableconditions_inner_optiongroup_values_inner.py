...
class CoreReportbuilderConditionsDelete200ResponseAvailableconditionsInnerOptiongroupValuesInner(BaseModel):
    """
    ...
    visiblename: Optional[StrictStr] = Field(default=None, description="visiblename")
