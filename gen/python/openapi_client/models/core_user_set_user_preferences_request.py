...
class CoreUserSetUserPreferencesRequest(BaseModel):
    """
    CoreUserSetUserPreferencesRequest
    """ # noqa: E501
    preferences: List[CoreUserSetUserPreferencesRequestPreferencesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "preferences": [CoreUserSetUserPreferencesRequestPreferencesInner.from_dict(_item) for _item in obj["preferences"]] if obj.get("preferences") is not None else None
        })
        return _obj
