...
class ModForumAddDiscussionPost200ResponsePostAttachmentsInnerUrls(BaseModel):
    """
    ModForumAddDiscussionPost200ResponsePostAttachmentsInnerUrls
    """ # noqa: E501
    export: Optional[StrictStr] = Field(default='null', description="The URL used to export the attachment")
