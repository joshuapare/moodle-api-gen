...
class CoreGradingSaveDefinitionsRequestAreasInnerDefinitionsInner(BaseModel):
    """
    ...
    guide: Optional[CoreGradingSaveDefinitionsRequestAreasInnerDefinitionsInnerGuide] = None
    ...
    rubric: Optional[CoreGradingSaveDefinitionsRequestAreasInnerDefinitionsInnerRubric] = None
    ...
    timecreated: Optional[StrictInt] = Field(default=None, description="creation time")
    timemodified: Optional[StrictInt] = Field(default=None, description="last modified time")
    usercreated: Optional[StrictInt] = Field(default=None, description="user who created definition")
    usermodified: Optional[StrictInt] = Field(default=None, description="user who modified definition")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "guide": CoreGradingSaveDefinitionsRequestAreasInnerDefinitionsInnerGuide.from_dict(obj["guide"]) if obj.get("guide") is not None else None,
            "id": obj.get("id"),
            "method": obj.get("method"),
            "name": obj.get("name"),
            "rubric": CoreGradingSaveDefinitionsRequestAreasInnerDefinitionsInnerRubric.from_dict(obj["rubric"]) if obj.get("rubric") is not None else None,
