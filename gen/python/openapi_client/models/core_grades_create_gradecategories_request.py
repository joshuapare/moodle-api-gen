...
class CoreGradesCreateGradecategoriesRequest(BaseModel):
    """
    CoreGradesCreateGradecategoriesRequest
    """ # noqa: E501
    categories: List[CoreGradesCreateGradecategoriesRequestCategoriesInner]
    courseid: StrictInt = Field(description="id of course")
    __properties: ClassVar[List[str]] = ["categories", "courseid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "categories": [CoreGradesCreateGradecategoriesRequestCategoriesInner.from_dict(_item) for _item in obj["categories"]] if obj.get("categories") is not None else None,
