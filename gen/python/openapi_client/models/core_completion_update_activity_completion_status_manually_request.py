...
class CoreCompletionUpdateActivityCompletionStatusManuallyRequest(BaseModel):
    """
    CoreCompletionUpdateActivityCompletionStatusManuallyRequest
    """ # noqa: E501
    cmid: StrictInt = Field(description="course module id")
    completed: StrictBool = Field(description="activity completed or not")
    __properties: ClassVar[List[str]] = ["cmid", "completed"]
