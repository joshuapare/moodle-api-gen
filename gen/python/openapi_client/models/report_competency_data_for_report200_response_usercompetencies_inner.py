...
class ReportCompetencyDataForReport200ResponseUsercompetenciesInner(BaseModel):
    """
    ReportCompetencyDataForReport200ResponseUsercompetenciesInner
    """ # noqa: E501
    competency: Optional[ReportCompetencyDataForReport200ResponseUsercompetenciesInnerCompetency] = None
    usercompetencycourse: Optional[ReportCompetencyDataForReport200ResponseUsercompetenciesInnerUsercompetencycourse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "competency": ReportCompetencyDataForReport200ResponseUsercompetenciesInnerCompetency.from_dict(obj["competency"]) if obj.get("competency") is not None else None,
            "usercompetencycourse": ReportCompetencyDataForReport200ResponseUsercompetenciesInnerUsercompetencycourse.from_dict(obj["usercompetencycourse"]) if obj.get("usercompetencycourse") is not None else None
        })
        return _obj
