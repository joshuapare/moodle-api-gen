...
class CoreGradesGetGradeitems200ResponseGradeItemsInner(BaseModel):
    """
    CoreGradesGetGradeitems200ResponseGradeItemsInner
    """ # noqa: E501
    category: Optional[StrictStr] = Field(default='null', description="The grade category of the grade item")
    id: Optional[StrictStr] = Field(default='null', description="An ID for the grade item")
    itemname: Optional[StrictStr] = Field(default='null', description="The full name of the grade item")
