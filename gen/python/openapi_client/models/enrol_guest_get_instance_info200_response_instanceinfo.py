...
class EnrolGuestGetInstanceInfo200ResponseInstanceinfo(BaseModel):
    """
    ...
    passwordrequired: StrictBool = Field(description="Is a password required?")
    status: StrictBool = Field(description="Is the enrolment enabled?")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "passwordrequired": obj.get("passwordrequired") if obj.get("passwordrequired") is not None else False,
