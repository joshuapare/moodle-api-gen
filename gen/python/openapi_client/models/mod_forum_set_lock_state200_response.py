...
class ModForumSetLockState200Response(BaseModel):
    """
    ModForumSetLockState200Response
    """ # noqa: E501
    id: StrictInt = Field(description="The discussion we are locking.")
    locked: StrictBool = Field(description="The locked state of the discussion.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "times": ModForumSetLockState200ResponseTimes.from_dict(obj["times"]) if obj.get("times") is not None else None
        })
        return _obj
