...
class ModH5pactivityGetAttempts200ResponseUsersattemptsInner(BaseModel):
    """
    ModH5pactivityGetAttempts200ResponseUsersattemptsInner
    """ # noqa: E501
    attempts: Optional[List[ModH5pactivityGetAttempts200ResponseUsersattemptsInnerAttemptsInner]] = None
    scored: Optional[ModH5pactivityGetAttempts200ResponseUsersattemptsInnerScored] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attempts": [ModH5pactivityGetAttempts200ResponseUsersattemptsInnerAttemptsInner.from_dict(_item) for _item in obj["attempts"]] if obj.get("attempts") is not None else None,
            "scored": ModH5pactivityGetAttempts200ResponseUsersattemptsInnerScored.from_dict(obj["scored"]) if obj.get("scored") is not None else None,
