...
class ModAssignSaveGradeRequestAdvancedgradingdata(BaseModel):
    """
    ModAssignSaveGradeRequestAdvancedgradingdata
    """ # noqa: E501
    guide: Optional[ModAssignSaveGradeRequestAdvancedgradingdataGuide] = None
    rubric: Optional[ModAssignSaveGradeRequestAdvancedgradingdataRubric] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "guide": ModAssignSaveGradeRequestAdvancedgradingdataGuide.from_dict(obj["guide"]) if obj.get("guide") is not None else None,
            "rubric": ModAssignSaveGradeRequestAdvancedgradingdataRubric.from_dict(obj["rubric"]) if obj.get("rubric") is not None else None
        })
        return _obj
