...
class ModGlossaryPrepareEntryForEdition200ResponseAreasInner(BaseModel):
    """
    ModGlossaryPrepareEntryForEdition200ResponseAreasInner
    """ # noqa: E501
    area: Optional[StrictStr] = Field(default=None, description="File area name.")
    options: Optional[List[ModGlossaryPrepareEntryForEdition200ResponseAreasInnerOptionsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "area": obj.get("area"),
            "options": [ModGlossaryPrepareEntryForEdition200ResponseAreasInnerOptionsInner.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None
        })
        return _obj
