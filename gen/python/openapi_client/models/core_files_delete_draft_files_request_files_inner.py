...
class CoreFilesDeleteDraftFilesRequestFilesInner(BaseModel):
    """
    CoreFilesDeleteDraftFilesRequestFilesInner
    """ # noqa: E501
    filename: Optional[StrictStr] = Field(default='null', description="Name of the file to delete.")
    filepath: Optional[StrictStr] = Field(default='null', description="Path to the file or directory to delete.")
