...
class BlockStarredcoursesGetStarredCoursesRequest(BaseModel):
    """
    BlockStarredcoursesGetStarredCoursesRequest
    """ # noqa: E501
    limit: Optional[StrictInt] = Field(default=0, description="Limit")
    offset: Optional[StrictInt] = Field(default=0, description="Offset")
