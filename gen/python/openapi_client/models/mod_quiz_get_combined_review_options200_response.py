...
class ModQuizGetCombinedReviewOptions200Response(BaseModel):
    """
    ModQuizGetCombinedReviewOptions200Response
    """ # noqa: E501
    alloptions: List[ModQuizGetCombinedReviewOptions200ResponseAlloptionsInner]
    someoptions: List[ModQuizGetCombinedReviewOptions200ResponseSomeoptionsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "alloptions": [ModQuizGetCombinedReviewOptions200ResponseAlloptionsInner.from_dict(_item) for _item in obj["alloptions"]] if obj.get("alloptions") is not None else None,
            "someoptions": [ModQuizGetCombinedReviewOptions200ResponseSomeoptionsInner.from_dict(_item) for _item in obj["someoptions"]] if obj.get("someoptions") is not None else None,
