...
class CoreOutputLoadTemplateWithDependencies200ResponseTemplatesInner(BaseModel):
    """
    CoreOutputLoadTemplateWithDependencies200ResponseTemplatesInner
    """ # noqa: E501
    component: Optional[StrictStr] = Field(default=None, description="component containing the resource")
    name: Optional[StrictStr] = Field(default=None, description="name of the resource")
    value: Optional[StrictStr] = Field(default=None, description="resource value")
