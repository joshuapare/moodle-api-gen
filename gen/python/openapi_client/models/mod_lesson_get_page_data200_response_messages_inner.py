...
class ModLessonGetPageData200ResponseMessagesInner(BaseModel):
    """
    The lesson generated messages
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Message.")
    type: Optional[StrictStr] = Field(default=None, description="Message type: usually a CSS identifier like:                                 success, info, warning, error, notifyproblem, notifyerror, notifytiny, notifysuccess")
