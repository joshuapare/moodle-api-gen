...
class CoreGradingGetGradingformInstances200ResponseInstancesInnerRubric(BaseModel):
    """
    CoreGradingGetGradingformInstances200ResponseInstancesInnerRubric
    """ # noqa: E501
    criteria: Optional[List[CoreGradingGetGradingformInstances200ResponseInstancesInnerRubricCriteriaInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "criteria": [CoreGradingGetGradingformInstances200ResponseInstancesInnerRubricCriteriaInner.from_dict(_item) for _item in obj["criteria"]] if obj.get("criteria") is not None else None
        })
        return _obj
