...
class ModForumGetDiscussionPosts200ResponseRatinginfo(BaseModel):
    """
    ...
    ratings: Optional[List[ModForumGetDiscussionPosts200ResponseRatinginfoRatingsInner]] = None
    scales: Optional[List[ModForumGetDiscussionPosts200ResponseRatinginfoScalesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ratings": [ModForumGetDiscussionPosts200ResponseRatinginfoRatingsInner.from_dict(_item) for _item in obj["ratings"]] if obj.get("ratings") is not None else None,
            "scales": [ModForumGetDiscussionPosts200ResponseRatinginfoScalesInner.from_dict(_item) for _item in obj["scales"]] if obj.get("scales") is not None else None
        })
        return _obj
