...
class CoreMessageMarkAllNotificationsAsReadRequest(BaseModel):
    """
    CoreMessageMarkAllNotificationsAsReadRequest
    """ # noqa: E501
    timecreatedto: Optional[StrictInt] = Field(default=0, description="mark messages created before this time as read, 0 for all messages")
    ...
    __properties: ClassVar[List[str]] = ["timecreatedto", "useridfrom", "useridto"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "timecreatedto": obj.get("timecreatedto") if obj.get("timecreatedto") is not None else 0,
