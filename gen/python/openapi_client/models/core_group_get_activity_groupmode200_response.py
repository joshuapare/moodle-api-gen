...
class CoreGroupGetActivityGroupmode200Response(BaseModel):
    """
    CoreGroupGetActivityGroupmode200Response
    """ # noqa: E501
    groupmode: StrictInt = Field(description="group mode:                                                     0 for no groups, 1 for separate groups, 2 for visible groups")
