...
class ToolLpDataForUserEvidenceListPage200Response(BaseModel):
    """
    ToolLpDataForUserEvidenceListPage200Response
    """ # noqa: E501
    canmanage: StrictBool = Field(description="Can the current user manage the user's evidence")
    evidence: List[ToolLpDataForUserEvidenceListPage200ResponseEvidenceInner]
    navigation: List[Dict[str, Any]]
    pluginbaseurl: StrictStr = Field(description="Url to the tool_lp plugin folder on this Moodle site")
    userid: StrictInt = Field(description="The user ID")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "evidence": [ToolLpDataForUserEvidenceListPage200ResponseEvidenceInner.from_dict(_item) for _item in obj["evidence"]] if obj.get("evidence") is not None else None,
