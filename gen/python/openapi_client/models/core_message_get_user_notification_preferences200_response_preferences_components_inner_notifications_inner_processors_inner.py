...
class CoreMessageGetUserNotificationPreferences200ResponsePreferencesComponentsInnerNotificationsInnerProcessorsInner(BaseModel):
    """
    ...
    locked: Optional[StrictBool] = Field(default=None, description="Is locked by admin?")
    lockedmessage: Optional[StrictStr] = Field(default=None, description="Text to display if locked")
    loggedin: Optional[CoreMessageGetUserMessagePreferences200ResponsePreferencesComponentsInnerNotificationsInnerProcessorsInnerLoggedoff] = None
    ...
    userconfigured: Optional[StrictInt] = Field(default=None, description="Is configured?")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "loggedin": CoreMessageGetUserMessagePreferences200ResponsePreferencesComponentsInnerNotificationsInnerProcessorsInnerLoggedoff.from_dict(obj["loggedin"]) if obj.get("loggedin") is not None else None,
