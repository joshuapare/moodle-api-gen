...
class CoreGradesGraderGradingpanelPointFetch200Response(BaseModel):
    """
    CoreGradesGraderGradingpanelPointFetch200Response
    """ # noqa: E501
    grade: CoreGradesGraderGradingpanelPointFetch200ResponseGrade
    hasgrade: StrictBool = Field(description="Does the user have a grade?")
    templatename: StrictStr = Field(description="The template to use when rendering this data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "grade": CoreGradesGraderGradingpanelPointFetch200ResponseGrade.from_dict(obj["grade"]) if obj.get("grade") is not None else None,
            "hasgrade": obj.get("hasgrade") if obj.get("hasgrade") is not None else False,
            "templatename": obj.get("templatename") if obj.get("templatename") is not None else 'null',
