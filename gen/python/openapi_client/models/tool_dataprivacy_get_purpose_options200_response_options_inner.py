...
class ToolDataprivacyGetPurposeOptions200ResponseOptionsInner(BaseModel):
    """
    ToolDataprivacyGetPurposeOptions200ResponseOptionsInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="The purpose ID")
    name: Optional[StrictStr] = Field(default='null', description="The purpose name")
