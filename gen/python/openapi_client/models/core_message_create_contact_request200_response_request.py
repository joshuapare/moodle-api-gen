...
class CoreMessageCreateContactRequest200ResponseRequest(BaseModel):
    """
    CoreMessageCreateContactRequest200ResponseRequest
    """ # noqa: E501
    id: StrictInt = Field(description="Message id")
    requesteduserid: StrictInt = Field(description="User to id")
    timecreated: StrictInt = Field(description="Time created")
    userid: StrictInt = Field(description="User from id")
