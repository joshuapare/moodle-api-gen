...
class ModH5pactivityGetResults200Response(BaseModel):
    """
    ModH5pactivityGetResults200Response
    """ # noqa: E501
    activityid: StrictInt = Field(description="Activity course module ID")
    attempts: List[ModH5pactivityGetResults200ResponseAttemptsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attempts": [ModH5pactivityGetResults200ResponseAttemptsInner.from_dict(_item) for _item in obj["attempts"]] if obj.get("attempts") is not None else None,
