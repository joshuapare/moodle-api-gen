...
class ModResourceGetResourcesByCourses200Response(BaseModel):
    """
    ModResourceGetResourcesByCourses200Response
    """ # noqa: E501
    resources: List[ModResourceGetResourcesByCourses200ResponseResourcesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resources": [ModResourceGetResourcesByCourses200ResponseResourcesInner.from_dict(_item) for _item in obj["resources"]] if obj.get("resources") is not None else None,
