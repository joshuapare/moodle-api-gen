...
class ToolMobileGetTokensForQrLogin200Response(BaseModel):
    """
    ToolMobileGetTokensForQrLogin200Response
    """ # noqa: E501
    privatetoken: StrictStr = Field(description="Private token used for auto-login processes.")
    token: StrictStr = Field(description="A valid WebService token for the official mobile app service.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "token": obj.get("token") if obj.get("token") is not None else 'null',
