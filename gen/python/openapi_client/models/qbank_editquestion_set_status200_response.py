...
class QbankEditquestionSetStatus200Response(BaseModel):
    """
    QbankEditquestionSetStatus200Response
    """ # noqa: E501
    error: StrictStr = Field(description="Error message if error exists")
    status: StrictBool = Field(description="status: true if success")
    statusname: StrictStr = Field(description="statusname: name of the status")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": obj.get("error") if obj.get("error") is not None else 'null',
