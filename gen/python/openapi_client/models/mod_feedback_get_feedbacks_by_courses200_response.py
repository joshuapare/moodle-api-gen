...
class ModFeedbackGetFeedbacksByCourses200Response(BaseModel):
    """
    ModFeedbackGetFeedbacksByCourses200Response
    """ # noqa: E501
    feedbacks: List[ModFeedbackGetFeedbacksByCourses200ResponseFeedbacksInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "feedbacks": [ModFeedbackGetFeedbacksByCourses200ResponseFeedbacksInner.from_dict(_item) for _item in obj["feedbacks"]] if obj.get("feedbacks") is not None else None,
