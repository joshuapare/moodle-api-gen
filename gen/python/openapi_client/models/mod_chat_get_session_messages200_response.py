...
class ModChatGetSessionMessages200Response(BaseModel):
    """
    ModChatGetSessionMessages200Response
    """ # noqa: E501
    messages: List[ModChatGetSessionMessages200ResponseMessagesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "messages": [ModChatGetSessionMessages200ResponseMessagesInner.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None,
