...
class CoreCalendarGetCalendarMonthlyView200ResponseDaynamesInner(BaseModel):
    """
    CoreCalendarGetCalendarMonthlyView200ResponseDaynamesInner
    """ # noqa: E501
    dayno: Optional[StrictInt] = Field(default=null, description="dayno")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dayno": obj.get("dayno") if obj.get("dayno") is not None else null,
