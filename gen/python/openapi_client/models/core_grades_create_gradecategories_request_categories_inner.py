...
class CoreGradesCreateGradecategoriesRequestCategoriesInner(BaseModel):
    """
    Category to create
    """ # noqa: E501
    fullname: Optional[StrictStr] = Field(default='null', description="fullname of category")
    options: Optional[CoreGradesCreateGradecategoriesRequestCategoriesInnerOptions] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "options": CoreGradesCreateGradecategoriesRequestCategoriesInnerOptions.from_dict(obj["options"]) if obj.get("options") is not None else None
        })
        return _obj
