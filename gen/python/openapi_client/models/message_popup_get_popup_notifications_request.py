...
class MessagePopupGetPopupNotificationsRequest(BaseModel):
    """
    MessagePopupGetPopupNotificationsRequest
    """ # noqa: E501
    limit: Optional[StrictInt] = Field(default=0, description="the number of results to return")
    newestfirst: Optional[StrictBool] = Field(default=True, description="true for ordering by newest first, false for oldest first")
    offset: Optional[StrictInt] = Field(default=0, description="offset the result set by a given amount")
    useridto: StrictInt = Field(description="the user id who received the message, 0 for current user")
    __properties: ClassVar[List[str]] = ["limit", "newestfirst", "offset", "useridto"]
