...
class BlockIomadCompanyAdminGetLicenseInfo200Response(BaseModel):
    """
    BlockIomadCompanyAdminGetLicenseInfo200Response
    """ # noqa: E501
    licenses: List[BlockIomadCompanyAdminGetLicenseInfo200ResponseLicensesInner]
    warnings: Optional[List[BlockIomadCompanyAdminGetCompanies200ResponseWarningsInner]] = None
    __properties: ClassVar[List[str]] = ["licenses", "warnings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "licenses": [BlockIomadCompanyAdminGetLicenseInfo200ResponseLicensesInner.from_dict(_item) for _item in obj["licenses"]] if obj.get("licenses") is not None else None,
