...
class ModBigbluebuttonbnMeetingInfo200ResponseFeaturesInner(BaseModel):
    """
    ModBigbluebuttonbnMeetingInfo200ResponseFeaturesInner
    """ # noqa: E501
    isenabled: Optional[StrictBool] = Field(default=False, description="Whether the feature is enabled.")
