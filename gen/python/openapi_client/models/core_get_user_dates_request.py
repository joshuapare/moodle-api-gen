...
class CoreGetUserDatesRequest(BaseModel):
    """
    ...
    timestamps: List[CoreGetUserDatesRequestTimestampsInner]
    __properties: ClassVar[List[str]] = ["contextid", "contextlevel", "instanceid", "timestamps"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "timestamps": [CoreGetUserDatesRequestTimestampsInner.from_dict(_item) for _item in obj["timestamps"]] if obj.get("timestamps") is not None else None
        })
        return _obj
