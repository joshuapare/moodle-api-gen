...
class ModQuizGetUserBestGrade200Response(BaseModel):
    """
    ModQuizGetUserBestGrade200Response
    """ # noqa: E501
    grade: Optional[Union[StrictFloat, StrictInt]] = Field(default=null, description="The grade (only if the user has a grade).")
    gradetopass: Optional[Union[StrictFloat, StrictInt]] = Field(default=null, description="The grade to pass the quiz (only if set).")
    hasgrade: StrictBool = Field(description="Whether the user has a grade on the given quiz.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gradetopass": obj.get("gradetopass") if obj.get("gradetopass") is not None else null,
