...
class ModBigbluebuttonbnGetRecordings200Response(BaseModel):
    """
    ModBigbluebuttonbnGetRecordings200Response
    """ # noqa: E501
    status: StrictBool = Field(description="Whether the fetch was successful")
    tabledata: Optional[ModBigbluebuttonbnGetRecordings200ResponseTabledata] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tabledata": ModBigbluebuttonbnGetRecordings200ResponseTabledata.from_dict(obj["tabledata"]) if obj.get("tabledata") is not None else None,
