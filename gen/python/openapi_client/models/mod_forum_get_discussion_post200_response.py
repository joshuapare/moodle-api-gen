...
class ModForumGetDiscussionPost200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "post": ModForumGetDiscussionPost200ResponsePost.from_dict(obj["post"]) if obj.get("post") is not None else None,
