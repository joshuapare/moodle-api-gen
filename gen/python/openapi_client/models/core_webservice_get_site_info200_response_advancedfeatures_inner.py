...
class CoreWebserviceGetSiteInfo200ResponseAdvancedfeaturesInner(BaseModel):
    """
    Advanced features availability
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default='null', description="feature name")
    value: Optional[StrictInt] = Field(default=null, description="feature value. Usually 1 means enabled.")
