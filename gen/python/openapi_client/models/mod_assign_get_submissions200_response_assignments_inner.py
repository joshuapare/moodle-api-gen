...
class ModAssignGetSubmissions200ResponseAssignmentsInner(BaseModel):
    """
    ...
    submissions: Optional[List[ModAssignGetSubmissions200ResponseAssignmentsInnerSubmissionsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "submissions": [ModAssignGetSubmissions200ResponseAssignmentsInnerSubmissionsInner.from_dict(_item) for _item in obj["submissions"]] if obj.get("submissions") is not None else None
        })
        return _obj
