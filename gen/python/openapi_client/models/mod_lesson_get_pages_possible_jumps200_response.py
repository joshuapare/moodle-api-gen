...
class ModLessonGetPagesPossibleJumps200Response(BaseModel):
    """
    ModLessonGetPagesPossibleJumps200Response
    """ # noqa: E501
    jumps: List[ModLessonGetPagesPossibleJumps200ResponseJumpsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jumps": [ModLessonGetPagesPossibleJumps200ResponseJumpsInner.from_dict(_item) for _item in obj["jumps"]] if obj.get("jumps") is not None else None,
