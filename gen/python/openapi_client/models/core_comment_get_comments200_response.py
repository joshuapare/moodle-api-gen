...
class CoreCommentGetComments200Response(BaseModel):
    """
    CoreCommentGetComments200Response
    """ # noqa: E501
    canpost: Optional[StrictBool] = Field(default=False, description="Whether the user can post in this comment area.")
    comments: List[CoreCommentGetComments200ResponseCommentsInner]
    count: Optional[StrictInt] = Field(default=null, description="Total number of comments.")
    perpage: Optional[StrictInt] = Field(default=null, description="Number of comments per page.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "comments": [CoreCommentGetComments200ResponseCommentsInner.from_dict(_item) for _item in obj["comments"]] if obj.get("comments") is not None else None,
