...
class ModAssignSaveSubmissionRequestPlugindataOnlinetextEditor(BaseModel):
    """
    ModAssignSaveSubmissionRequestPlugindataOnlinetextEditor
    """ # noqa: E501
    format: StrictInt = Field(description="The format for this submission")
    itemid: StrictInt = Field(description="The draft area id for files attached to the submission")
    text: StrictStr = Field(description="The text for this submission.")
