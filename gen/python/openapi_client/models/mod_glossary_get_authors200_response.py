...
class ModGlossaryGetAuthors200Response(BaseModel):
    """
    ModGlossaryGetAuthors200Response
    """ # noqa: E501
    authors: List[ModGlossaryGetAuthors200ResponseAuthorsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "authors": [ModGlossaryGetAuthors200ResponseAuthorsInner.from_dict(_item) for _item in obj["authors"]] if obj.get("authors") is not None else None,
