...
class EnrolGuestValidatePassword200Response(BaseModel):
    """
    EnrolGuestValidatePassword200Response
    """ # noqa: E501
    hint: Optional[StrictStr] = Field(default='null', description="Password hint (if enabled)")
    validated: StrictBool = Field(description="Whether the password was successfully validated")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hint": obj.get("hint") if obj.get("hint") is not None else 'null',
