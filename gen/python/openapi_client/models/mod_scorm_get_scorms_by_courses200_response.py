...
class ModScormGetScormsByCourses200Response(BaseModel):
    """
    ModScormGetScormsByCourses200Response
    """ # noqa: E501
    options: Optional[List[ModScormGetScormsByCourses200ResponseOptionsInner]] = None
    scorms: List[ModScormGetScormsByCourses200ResponseScormsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "options": [ModScormGetScormsByCourses200ResponseOptionsInner.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None,
            "scorms": [ModScormGetScormsByCourses200ResponseScormsInner.from_dict(_item) for _item in obj["scorms"]] if obj.get("scorms") is not None else None,
