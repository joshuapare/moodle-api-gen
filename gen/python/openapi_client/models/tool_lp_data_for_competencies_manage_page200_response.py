...
class ToolLpDataForCompetenciesManagePage200Response(BaseModel):
    """
    ToolLpDataForCompetenciesManagePage200Response
    """ # noqa: E501
    canmanage: StrictBool = Field(description="True if this user has permission to manage competency frameworks")
    framework: CoreCompetencyDuplicateCompetencyFramework200Response
    pagecontextid: StrictInt = Field(description="Context id for the framework")
    pluginbaseurl: StrictStr = Field(description="Plugin base url")
    rulesmodules: StrictStr = Field(description="JSON encoded data for rules")
    search: StrictStr = Field(description="Current search string")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rulesmodules": obj.get("rulesmodules") if obj.get("rulesmodules") is not None else 'null',
