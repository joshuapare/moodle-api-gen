...
class CoreTagGetTagCollections200Response(BaseModel):
    """
    CoreTagGetTagCollections200Response
    """ # noqa: E501
    collections: List[CoreTagGetTagCollections200ResponseCollectionsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "collections": [CoreTagGetTagCollections200ResponseCollectionsInner.from_dict(_item) for _item in obj["collections"]] if obj.get("collections") is not None else None,
