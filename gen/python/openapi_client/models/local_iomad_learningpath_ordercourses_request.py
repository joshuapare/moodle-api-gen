...
class LocalIomadLearningpathOrdercoursesRequest(BaseModel):
    """
    LocalIomadLearningpathOrdercoursesRequest
    """ # noqa: E501
    courses: List[LocalIomadLearningpathOrdercoursesRequestCoursesInner]
    pathid: StrictInt = Field(description="ID of Iomad Learning Path")
    __properties: ClassVar[List[str]] = ["courses", "pathid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "courses": [LocalIomadLearningpathOrdercoursesRequestCoursesInner.from_dict(_item) for _item in obj["courses"]] if obj.get("courses") is not None else None,
