...
class CoreUserCreateUsersRequest(BaseModel):
    """
    CoreUserCreateUsersRequest
    """ # noqa: E501
    users: List[CoreUserCreateUsersRequestUsersInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "users": [CoreUserCreateUsersRequestUsersInner.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
