...
class CoreGroupGetCourseUserGroups200Response(BaseModel):
    """
    CoreGroupGetCourseUserGroups200Response
    """ # noqa: E501
    groups: List[CoreGroupGetCourseUserGroups200ResponseGroupsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [CoreGroupGetCourseUserGroups200ResponseGroupsInner.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,
