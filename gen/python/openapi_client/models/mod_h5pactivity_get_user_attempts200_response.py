...
class ModH5pactivityGetUserAttempts200Response(BaseModel):
    """
    ModH5pactivityGetUserAttempts200Response
    """ # noqa: E501
    activityid: StrictInt = Field(description="Activity course module ID")
    usersattempts: List[ModH5pactivityGetUserAttempts200ResponseUsersattemptsInner]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.usersattempts:
            for _item in self.usersattempts:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "usersattempts": [ModH5pactivityGetUserAttempts200ResponseUsersattemptsInner.from_dict(_item) for _item in obj["usersattempts"]] if obj.get("usersattempts") is not None else None,
