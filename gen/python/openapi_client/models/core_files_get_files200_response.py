...
class CoreFilesGetFiles200Response(BaseModel):
    """
    CoreFilesGetFiles200Response
    """ # noqa: E501
    files: List[CoreFilesGetFiles200ResponseFilesInner]
    parents: List[CoreFilesGetFiles200ResponseParentsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "files": [CoreFilesGetFiles200ResponseFilesInner.from_dict(_item) for _item in obj["files"]] if obj.get("files") is not None else None,
            "parents": [CoreFilesGetFiles200ResponseParentsInner.from_dict(_item) for _item in obj["parents"]] if obj.get("parents") is not None else None
        })
        return _obj
