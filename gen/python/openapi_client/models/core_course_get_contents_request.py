...
class CoreCourseGetContentsRequest(BaseModel):
    """
    CoreCourseGetContentsRequest
    """ # noqa: E501
    courseid: StrictInt = Field(description="course id")
    options: Optional[List[CoreCourseGetContentsRequestOptionsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "options": [CoreCourseGetContentsRequestOptionsInner.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None
        })
        return _obj
