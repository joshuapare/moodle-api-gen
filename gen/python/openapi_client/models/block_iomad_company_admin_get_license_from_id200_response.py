...
class BlockIomadCompanyAdminGetLicenseFromId200Response(BaseModel):
    """
    BlockIomadCompanyAdminGetLicenseFromId200Response
    """ # noqa: E501
    courses: List[BlockIomadCompanyAdminGetLicenseFromId200ResponseCoursesInner]
    license: BlockIomadCompanyAdminGetLicenseFromId200ResponseLicense
    __properties: ClassVar[List[str]] = ["courses", "license"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "courses": [BlockIomadCompanyAdminGetLicenseFromId200ResponseCoursesInner.from_dict(_item) for _item in obj["courses"]] if obj.get("courses") is not None else None,
            "license": BlockIomadCompanyAdminGetLicenseFromId200ResponseLicense.from_dict(obj["license"]) if obj.get("license") is not None else None
        })
        return _obj
