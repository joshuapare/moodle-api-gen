...
class CoreCourseGetCoursesRequest(BaseModel):
    """
    CoreCourseGetCoursesRequest
    """ # noqa: E501
    options: Optional[CoreCourseGetCoursesRequestOptions] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "options": CoreCourseGetCoursesRequestOptions.from_dict(obj["options"]) if obj.get("options") is not None else None
        })
        return _obj
