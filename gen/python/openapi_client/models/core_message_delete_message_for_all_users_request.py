...
class CoreMessageDeleteMessageForAllUsersRequest(BaseModel):
    """
    CoreMessageDeleteMessageForAllUsersRequest
    """ # noqa: E501
    messageid: StrictInt = Field(description="The message id")
    userid: StrictInt = Field(description="The user id of who we want to delete the message for all users")
    __properties: ClassVar[List[str]] = ["messageid", "userid"]
