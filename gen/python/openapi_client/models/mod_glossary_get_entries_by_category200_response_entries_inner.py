...
class ModGlossaryGetEntriesByCategory200ResponseEntriesInner(BaseModel):
    """
    ModGlossaryGetEntriesByCategory200ResponseEntriesInner
    """ # noqa: E501
    approved: Optional[StrictBool] = Field(default=None, description="Whether the entry was approved")
    attachment: Optional[StrictBool] = Field(default=None, description="Whether or not the entry has attachments")
    attachments: Optional[List[CoreBlockGetDashboardBlocks200ResponseBlocksInnerContentsFilesInner]] = None
    casesensitive: Optional[StrictBool] = Field(default=None, description="When true, the matching is case sensitive")
    categoryid: Optional[StrictInt] = Field(default=-1, description="The category ID. This may be '-1' when the entry is not categorised")
    ...
    concept: Optional[StrictStr] = Field(default=None, description="The concept")
    definition: Optional[StrictStr] = Field(default=None, description="The definition")
    ...
    definitiontrust: Optional[StrictBool] = Field(default=None, description="The definition trust flag")
    fullmatch: Optional[StrictBool] = Field(default=None, description="When true, the matching is done on full words only")
    glossaryid: Optional[StrictInt] = Field(default=None, description="The glossary ID")
    id: Optional[StrictInt] = Field(default=None, description="The entry ID")
    sourceglossaryid: Optional[StrictInt] = Field(default=None, description="The source glossary ID")
    tags: Optional[List[ModDataGetEntries200ResponseEntriesInnerTagsInner]] = None
    teacherentry: Optional[StrictBool] = Field(default=None, description="The entry was created by a teacher, or equivalent.")
    ...
    usedynalink: Optional[StrictBool] = Field(default=None, description="Whether the concept should be automatically linked")
    userfullname: Optional[StrictStr] = Field(default=None, description="Author full name")
    userid: Optional[StrictInt] = Field(default=None, description="Author ID")
    userpictureurl: Optional[StrictStr] = Field(default=None, description="Author picture")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "categoryid": obj.get("categoryid") if obj.get("categoryid") is not None else -1,
