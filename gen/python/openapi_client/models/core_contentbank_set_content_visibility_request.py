...
class CoreContentbankSetContentVisibilityRequest(BaseModel):
    """
    CoreContentbankSetContentVisibilityRequest
    """ # noqa: E501
    contentid: StrictInt = Field(description="The content id to rename")
    visibility: StrictInt = Field(description="The new visibility for the content")
    __properties: ClassVar[List[str]] = ["contentid", "visibility"]
