...
class ModChoiceGetChoiceOptions200Response(BaseModel):
    """
    ModChoiceGetChoiceOptions200Response
    """ # noqa: E501
    options: List[ModChoiceGetChoiceOptions200ResponseOptionsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "options": [ModChoiceGetChoiceOptions200ResponseOptionsInner.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None,
