...
class ToolMoodlenetVerifyWebfingerRequest(BaseModel):
    """
    ToolMoodlenetVerifyWebfingerRequest
    """ # noqa: E501
    course: StrictInt = Field(description="The course we are adding to")
    profileurl: StrictStr = Field(description="The profile url that the user has given us")
    section: StrictInt = Field(description="The section within the course we are adding to")
    __properties: ClassVar[List[str]] = ["course", "profileurl", "section"]
