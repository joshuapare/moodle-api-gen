...
class ModForumSetPinState200ResponseGroup(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "urls": ModForumSetPinState200ResponseGroupUrls.from_dict(obj["urls"]) if obj.get("urls") is not None else None
        })
        return _obj
