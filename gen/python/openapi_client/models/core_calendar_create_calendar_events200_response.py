...
class CoreCalendarCreateCalendarEvents200Response(BaseModel):
    """
    CoreCalendarCreateCalendarEvents200Response
    """ # noqa: E501
    events: List[CoreCalendarCreateCalendarEvents200ResponseEventsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [CoreCalendarCreateCalendarEvents200ResponseEventsInner.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None,
