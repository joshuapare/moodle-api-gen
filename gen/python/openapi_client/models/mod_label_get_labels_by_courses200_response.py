...
class ModLabelGetLabelsByCourses200Response(BaseModel):
    """
    ModLabelGetLabelsByCourses200Response
    """ # noqa: E501
    labels: List[ModLabelGetLabelsByCourses200ResponseLabelsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "labels": [ModLabelGetLabelsByCourses200ResponseLabelsInner.from_dict(_item) for _item in obj["labels"]] if obj.get("labels") is not None else None,
