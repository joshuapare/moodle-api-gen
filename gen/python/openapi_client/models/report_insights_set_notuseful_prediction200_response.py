...
class ReportInsightsSetNotusefulPrediction200Response(BaseModel):
    """
    ReportInsightsSetNotusefulPrediction200Response
    """ # noqa: E501
    success: StrictBool = Field(description="True if the prediction was successfully flagged as not useful.")
