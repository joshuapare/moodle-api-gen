...
class ModAssignGetSubmissions200Response(BaseModel):
    """
    ModAssignGetSubmissions200Response
    """ # noqa: E501
    assignments: List[ModAssignGetSubmissions200ResponseAssignmentsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assignments": [ModAssignGetSubmissions200ResponseAssignmentsInner.from_dict(_item) for _item in obj["assignments"]] if obj.get("assignments") is not None else None,
