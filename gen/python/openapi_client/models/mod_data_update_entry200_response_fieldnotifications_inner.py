...
class ModDataUpdateEntry200ResponseFieldnotificationsInner(BaseModel):
    """
    ModDataUpdateEntry200ResponseFieldnotificationsInner
    """ # noqa: E501
    fieldname: Optional[StrictStr] = Field(default=None, description="The field name.")
    notification: Optional[StrictStr] = Field(default=None, description="The notification for the field.")
