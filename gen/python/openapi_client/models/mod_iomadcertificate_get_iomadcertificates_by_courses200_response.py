...
class ModIomadcertificateGetIomadcertificatesByCourses200Response(BaseModel):
    """
    ModIomadcertificateGetIomadcertificatesByCourses200Response
    """ # noqa: E501
    iomadcertificates: List[ModIomadcertificateGetIomadcertificatesByCourses200ResponseIomadcertificatesInner]
    warnings: Optional[List[AuthEmailSignupUser200ResponseWarningsInner]] = None
    __properties: ClassVar[List[str]] = ["iomadcertificates", "warnings"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in iomadcertificates (list)
        _items = []
        if self.iomadcertificates:
            for _item in self.iomadcertificates:
                if _item:
                    _items.append(_item.to_dict())
            _dict['iomadcertificates'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "iomadcertificates": [ModIomadcertificateGetIomadcertificatesByCourses200ResponseIomadcertificatesInner.from_dict(_item) for _item in obj["iomadcertificates"]] if obj.get("iomadcertificates") is not None else None,
