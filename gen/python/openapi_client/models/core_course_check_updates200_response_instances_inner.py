...
class CoreCourseCheckUpdates200ResponseInstancesInner(BaseModel):
    """
    ...
    id: Optional[StrictInt] = Field(default=null, description="Instance id")
    updates: Optional[List[CoreCourseCheckUpdates200ResponseInstancesInnerUpdatesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "updates": [CoreCourseCheckUpdates200ResponseInstancesInnerUpdatesInner.from_dict(_item) for _item in obj["updates"]] if obj.get("updates") is not None else None
        })
        return _obj
