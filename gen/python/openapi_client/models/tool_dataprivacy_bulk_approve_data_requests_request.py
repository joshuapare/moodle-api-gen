...
class ToolDataprivacyBulkApproveDataRequestsRequest(BaseModel):
    """
    ToolDataprivacyBulkApproveDataRequestsRequest
    """ # noqa: E501
    requestids: List[Dict[str, Any]]
    __properties: ClassVar[List[str]] = ["requestids"]
