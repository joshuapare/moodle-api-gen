...
class CoreCourseGetEnrolledCoursesByTimelineClassification200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nextoffset": obj.get("nextoffset") if obj.get("nextoffset") is not None else null
        })
        return _obj
