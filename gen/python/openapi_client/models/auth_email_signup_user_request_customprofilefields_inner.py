...
class AuthEmailSignupUserRequestCustomprofilefieldsInner(BaseModel):
    """
    AuthEmailSignupUserRequestCustomprofilefieldsInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default='null', description="The name of the custom field")
    type: Optional[StrictStr] = Field(default='null', description="The type of the custom field")
    value: Optional[StrictStr] = Field(default='null', description="Custom field value, can be an encoded json if required")
