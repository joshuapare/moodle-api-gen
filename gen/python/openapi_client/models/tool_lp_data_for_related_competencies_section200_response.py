...
class ToolLpDataForRelatedCompetenciesSection200Response(BaseModel):
    """
    ...
    showdeleterelatedaction: StrictBool = Field(description="Whether to show the delete relation link or not")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "showdeleterelatedaction": obj.get("showdeleterelatedaction") if obj.get("showdeleterelatedaction") is not None else False
        })
        return _obj
