...
class ModQuizGetQuizFeedbackForGradeRequest(BaseModel):
    """
    ModQuizGetQuizFeedbackForGradeRequest
    """ # noqa: E501
    grade: Union[StrictFloat, StrictInt] = Field(description="the grade to check")
    quizid: StrictInt = Field(description="quiz instance id")
    __properties: ClassVar[List[str]] = ["grade", "quizid"]
