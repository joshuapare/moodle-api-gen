...
class BlockIomadCompanyAdminGetDepartmentUsersRequest(BaseModel):
    """
    BlockIomadCompanyAdminGetDepartmentUsersRequest
    """ # noqa: E501
    departmentids: Optional[List[Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["departmentids"]
