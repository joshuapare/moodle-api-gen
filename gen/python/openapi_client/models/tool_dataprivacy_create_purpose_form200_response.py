...
class ToolDataprivacyCreatePurposeForm200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "purpose": ToolDataprivacyCreatePurposeForm200ResponsePurpose.from_dict(obj["purpose"]) if obj.get("purpose") is not None else None,
