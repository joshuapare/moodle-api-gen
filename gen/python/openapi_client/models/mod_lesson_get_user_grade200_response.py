...
class ModLessonGetUserGrade200Response(BaseModel):
    """
    ModLessonGetUserGrade200Response
    """ # noqa: E501
    formattedgrade: StrictStr = Field(description="The lesson final grade formatted")
    grade: Union[StrictFloat, StrictInt] = Field(description="The lesson final raw grade")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "formattedgrade": obj.get("formattedgrade") if obj.get("formattedgrade") is not None else 'null',
