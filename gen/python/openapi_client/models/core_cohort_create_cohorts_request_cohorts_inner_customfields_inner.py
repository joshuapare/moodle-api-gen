...
class CoreCohortCreateCohortsRequestCohortsInnerCustomfieldsInner(BaseModel):
    """
    CoreCohortCreateCohortsRequestCohortsInnerCustomfieldsInner
    """ # noqa: E501
    shortname: Optional[StrictStr] = Field(default='null', description="The shortname of the custom field")
    value: Optional[StrictStr] = Field(default='null', description="The value of the custom field")
