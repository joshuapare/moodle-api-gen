...
class ModGlossaryGetEntriesByAuthor200Response(BaseModel):
    """
    ...
    entries: List[ModGlossaryGetEntriesByAuthor200ResponseEntriesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entries": [ModGlossaryGetEntriesByAuthor200ResponseEntriesInner.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
