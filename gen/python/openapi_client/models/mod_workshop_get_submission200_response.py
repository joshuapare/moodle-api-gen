...
class ModWorkshopGetSubmission200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "submission": ModWorkshopGetSubmission200ResponseSubmission.from_dict(obj["submission"]) if obj.get("submission") is not None else None,
