...
class CoreOutputLoadTemplateWithDependencies200Response(BaseModel):
    """
    CoreOutputLoadTemplateWithDependencies200Response
    """ # noqa: E501
    strings: List[CoreOutputLoadTemplateWithDependencies200ResponseStringsInner]
    templates: List[CoreOutputLoadTemplateWithDependencies200ResponseTemplatesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "strings": [CoreOutputLoadTemplateWithDependencies200ResponseStringsInner.from_dict(_item) for _item in obj["strings"]] if obj.get("strings") is not None else None,
            "templates": [CoreOutputLoadTemplateWithDependencies200ResponseTemplatesInner.from_dict(_item) for _item in obj["templates"]] if obj.get("templates") is not None else None
        })
        return _obj
