...
class ModWorkshopEvaluateAssessment200Response(BaseModel):
    """
    ModWorkshopEvaluateAssessment200Response
    """ # noqa: E501
    status: StrictBool = Field(description="status: true if the assessment was evaluated, false otherwise.")
