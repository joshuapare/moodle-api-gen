...
class CoreCalendarGetCalendarEventsRequest(BaseModel):
    """
    CoreCalendarGetCalendarEventsRequest
    """ # noqa: E501
    events: Optional[CoreCalendarGetCalendarEventsRequestEvents] = None
    options: Optional[CoreCalendarGetCalendarEventsRequestOptions] = None
    __properties: ClassVar[List[str]] = ["events", "options"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": CoreCalendarGetCalendarEventsRequestEvents.from_dict(obj["events"]) if obj.get("events") is not None else None,
            "options": CoreCalendarGetCalendarEventsRequestOptions.from_dict(obj["options"]) if obj.get("options") is not None else None
        })
        return _obj
