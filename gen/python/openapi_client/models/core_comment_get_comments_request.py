...
class CoreCommentGetCommentsRequest(BaseModel):
    """
    ...
    contextlevel: StrictStr = Field(description="contextlevel system, course, user...")
    ...
    __properties: ClassVar[List[str]] = ["area", "component", "contextlevel", "instanceid", "itemid", "page", "sortdirection"]
