...
class ModChatGetSessions200Response(BaseModel):
    """
    ModChatGetSessions200Response
    """ # noqa: E501
    sessions: List[ModChatGetSessions200ResponseSessionsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sessions": [ModChatGetSessions200ResponseSessionsInner.from_dict(_item) for _item in obj["sessions"]] if obj.get("sessions") is not None else None,
