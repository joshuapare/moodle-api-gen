...
class MessageAirnotifierAreNotificationPreferencesConfigured200Response(BaseModel):
    """
    MessageAirnotifierAreNotificationPreferencesConfigured200Response
    """ # noqa: E501
    users: List[MessageAirnotifierAreNotificationPreferencesConfigured200ResponseUsersInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "users": [MessageAirnotifierAreNotificationPreferencesConfigured200ResponseUsersInner.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None,
