...
class CoreReportbuilderReportsGet200ResponseSidebarmenucardsMenucardsInner(BaseModel):
    """
    CoreReportbuilderReportsGet200ResponseSidebarmenucardsMenucardsInner
    """ # noqa: E501
    items: Optional[List[CoreReportbuilderReportsGet200ResponseSidebarmenucardsMenucardsInnerItemsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [CoreReportbuilderReportsGet200ResponseSidebarmenucardsMenucardsInnerItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "key": obj.get("key"),
            "name": obj.get("name")
        })
        return _obj
