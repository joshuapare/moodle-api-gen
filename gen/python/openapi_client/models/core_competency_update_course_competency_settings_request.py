...
class CoreCompetencyUpdateCourseCompetencySettingsRequest(BaseModel):
    """
    CoreCompetencyUpdateCourseCompetencySettingsRequest
    """ # noqa: E501
    courseid: StrictInt = Field(description="Course id for the course to update")
    settings: CoreCompetencyUpdateCourseCompetencySettingsRequestSettings
    __properties: ClassVar[List[str]] = ["courseid", "settings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "settings": CoreCompetencyUpdateCourseCompetencySettingsRequestSettings.from_dict(obj["settings"]) if obj.get("settings") is not None else None
        })
        return _obj
