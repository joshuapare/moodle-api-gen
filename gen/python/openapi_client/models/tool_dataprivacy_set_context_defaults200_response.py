...
class ToolDataprivacySetContextDefaults200Response(BaseModel):
    """
    ToolDataprivacySetContextDefaults200Response
    """ # noqa: E501
    result: StrictBool = Field(description="Whether the context defaults were successfully set or not")
