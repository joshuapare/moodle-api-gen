...
class CoreCourseCheckUpdates200Response(BaseModel):
    """
    CoreCourseCheckUpdates200Response
    """ # noqa: E501
    instances: List[CoreCourseCheckUpdates200ResponseInstancesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "instances": [CoreCourseCheckUpdates200ResponseInstancesInner.from_dict(_item) for _item in obj["instances"]] if obj.get("instances") is not None else None,
