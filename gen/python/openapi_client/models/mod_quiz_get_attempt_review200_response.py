...
class ModQuizGetAttemptReview200Response(BaseModel):
    """
    ModQuizGetAttemptReview200Response
    """ # noqa: E501
    additionaldata: List[ModQuizGetAttemptReview200ResponseAdditionaldataInner]
    attempt: ModQuizGetAttemptReview200ResponseAttempt
    grade: StrictStr = Field(description="grade for the quiz (or empty or \"notyetgraded\")")
    questions: List[ModQuizGetAttemptReview200ResponseQuestionsInner]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.additionaldata:
            for _item in self.additionaldata:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "additionaldata": [ModQuizGetAttemptReview200ResponseAdditionaldataInner.from_dict(_item) for _item in obj["additionaldata"]] if obj.get("additionaldata") is not None else None,
            "attempt": ModQuizGetAttemptReview200ResponseAttempt.from_dict(obj["attempt"]) if obj.get("attempt") is not None else None,
            "grade": obj.get("grade") if obj.get("grade") is not None else 'null',
            "questions": [ModQuizGetAttemptReview200ResponseQuestionsInner.from_dict(_item) for _item in obj["questions"]] if obj.get("questions") is not None else None,
