...
class ModForumGetDiscussionPosts200ResponseRatinginfoScalesInnerItemsInner(BaseModel):
    """
    ModForumGetDiscussionPosts200ResponseRatinginfoScalesInnerItemsInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Scale name.")
    value: Optional[StrictInt] = Field(default=None, description="Scale value/option id.")
