...
class CoreTagGetTagsRequest(BaseModel):
    """
    CoreTagGetTagsRequest
    """ # noqa: E501
    tags: List[CoreTagGetTagsRequestTagsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tags": [CoreTagGetTagsRequestTagsInner.from_dict(_item) for _item in obj["tags"]] if obj.get("tags") is not None else None
        })
        return _obj
