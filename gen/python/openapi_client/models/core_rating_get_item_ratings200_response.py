...
class CoreRatingGetItemRatings200Response(BaseModel):
    """
    CoreRatingGetItemRatings200Response
    """ # noqa: E501
    ratings: List[CoreRatingGetItemRatings200ResponseRatingsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ratings": [CoreRatingGetItemRatings200ResponseRatingsInner.from_dict(_item) for _item in obj["ratings"]] if obj.get("ratings") is not None else None,
