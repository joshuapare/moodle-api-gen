...
class CoreMessageCreateContactRequest200Response(BaseModel):
    """
    CoreMessageCreateContactRequest200Response
    """ # noqa: E501
    request: Optional[CoreMessageCreateContactRequest200ResponseRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": CoreMessageCreateContactRequest200ResponseRequest.from_dict(obj["request"]) if obj.get("request") is not None else None,
