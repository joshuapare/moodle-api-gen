...
class ModQuizGetAttemptReview200ResponseAdditionaldataInner(BaseModel):
    """
    ModQuizGetAttemptReview200ResponseAdditionaldataInner
    """ # noqa: E501
    content: Optional[StrictStr] = Field(default='null', description="data content")
    id: Optional[StrictStr] = Field(default='null', description="id of the data")
    title: Optional[StrictStr] = Field(default='null', description="data title")
