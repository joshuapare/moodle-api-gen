...
class ModLessonGetLessonRequest(BaseModel):
    """
    ModLessonGetLessonRequest
    """ # noqa: E501
    lessonid: StrictInt = Field(description="lesson instance id")
    password: Optional[StrictStr] = Field(default='', description="lesson password")
    __properties: ClassVar[List[str]] = ["lessonid", "password"]
