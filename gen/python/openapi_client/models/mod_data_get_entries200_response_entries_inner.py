...
class ModDataGetEntries200ResponseEntriesInner(BaseModel):
    """
    ...
    canmanageentry: Optional[StrictBool] = Field(default=False, description="Whether the current user can manage this entry")
    contents: Optional[List[ModDataGetEntries200ResponseEntriesInnerContentsInner]] = None
    dataid: Optional[StrictInt] = Field(default=0, description="The database id this record belongs to.")
    fullname: Optional[StrictStr] = Field(default='null', description="The user who created the entry fullname.")
    groupid: Optional[StrictInt] = Field(default=0, description="The group id this record belongs to (0 for no groups).")
    id: Optional[StrictInt] = Field(default=null, description="Record id.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contents": [ModDataGetEntries200ResponseEntriesInnerContentsInner.from_dict(_item) for _item in obj["contents"]] if obj.get("contents") is not None else None,
