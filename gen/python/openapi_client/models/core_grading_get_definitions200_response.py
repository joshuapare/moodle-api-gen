...
class CoreGradingGetDefinitions200Response(BaseModel):
    """
    CoreGradingGetDefinitions200Response
    """ # noqa: E501
    areas: List[CoreGradingGetDefinitions200ResponseAreasInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "areas": [CoreGradingGetDefinitions200ResponseAreasInner.from_dict(_item) for _item in obj["areas"]] if obj.get("areas") is not None else None,
