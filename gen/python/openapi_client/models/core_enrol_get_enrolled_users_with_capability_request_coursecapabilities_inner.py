...
class CoreEnrolGetEnrolledUsersWithCapabilityRequestCoursecapabilitiesInner(BaseModel):
    """
    CoreEnrolGetEnrolledUsersWithCapabilityRequestCoursecapabilitiesInner
    """ # noqa: E501
    capabilities: Optional[List[Dict[str, Any]]] = None
    courseid: Optional[StrictInt] = Field(default=null, description="Course ID number in the Moodle course table")
