...
class CoreCompetencySetParentCompetencyRequest(BaseModel):
    """
    CoreCompetencySetParentCompetencyRequest
    """ # noqa: E501
    competencyid: StrictInt = Field(description="The competency id")
    parentid: StrictInt = Field(description="The new competency parent id")
    __properties: ClassVar[List[str]] = ["competencyid", "parentid"]
