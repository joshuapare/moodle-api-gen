...
class CoreCompetencyCreateTemplateRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "template": CoreCompetencyCreateTemplateRequestTemplate.from_dict(obj["template"]) if obj.get("template") is not None else None
        })
        return _obj
