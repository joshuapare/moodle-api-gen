...
class ModGlossaryViewGlossaryRequest(BaseModel):
    """
    ModGlossaryViewGlossaryRequest
    """ # noqa: E501
    id: StrictInt = Field(description="Glossary instance ID")
    mode: StrictStr = Field(description="The mode in which the glossary is viewed")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mode": obj.get("mode") if obj.get("mode") is not None else 'null'
        })
        return _obj
