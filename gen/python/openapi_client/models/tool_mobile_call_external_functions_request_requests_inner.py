...
class ToolMobileCallExternalFunctionsRequestRequestsInner(BaseModel):
    """
    ...
    function: Optional[StrictStr] = Field(default='null', description="Function name")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "function": obj.get("function") if obj.get("function") is not None else 'null',
