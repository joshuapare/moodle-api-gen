...
class ToolLpDataForCourseCompetenciesPageRequest(BaseModel):
    """
    ToolLpDataForCourseCompetenciesPageRequest
    """ # noqa: E501
    courseid: StrictInt = Field(description="The course id")
    moduleid: Optional[StrictInt] = Field(default=0, description="The module id")
    __properties: ClassVar[List[str]] = ["courseid", "moduleid"]
