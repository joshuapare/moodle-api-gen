...
class ModForumAddDiscussionPostRequest(BaseModel):
    """
    ModForumAddDiscussionPostRequest
    """ # noqa: E501
    message: StrictStr = Field(description="new post message (html assumed if messageformat is not provided)")
    messageformat: Optional[StrictInt] = Field(default=1, description="message format (1 = HTML, 0 = MOODLE, 2 = PLAIN, or 4 = MARKDOWN)")
    options: Optional[List[ModForumAddDiscussionPostRequestOptionsInner]] = None
    postid: StrictInt = Field(description="the post id we are going to reply to                                                 (can be the initial discussion post")
    subject: StrictStr = Field(description="new post subject")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "options": [ModForumAddDiscussionPostRequestOptionsInner.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None,
