...
class GradereportOverviewGetCourseGradesRequest(BaseModel):
    """
    GradereportOverviewGetCourseGradesRequest
    """ # noqa: E501
    userid: Optional[StrictInt] = Field(default=0, description="Get grades for this user (optional, default current)")
