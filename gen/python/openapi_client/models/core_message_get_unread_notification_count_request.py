...
class CoreMessageGetUnreadNotificationCountRequest(BaseModel):
    """
    CoreMessageGetUnreadNotificationCountRequest
    """ # noqa: E501
    useridto: StrictInt = Field(description="user id who received the notification, 0 for any user")
    __properties: ClassVar[List[str]] = ["useridto"]
