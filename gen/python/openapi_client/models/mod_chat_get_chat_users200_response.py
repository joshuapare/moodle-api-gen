...
class ModChatGetChatUsers200Response(BaseModel):
    """
    ModChatGetChatUsers200Response
    """ # noqa: E501
    users: List[ModChatGetChatUsers200ResponseUsersInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "users": [ModChatGetChatUsers200ResponseUsersInner.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None,
