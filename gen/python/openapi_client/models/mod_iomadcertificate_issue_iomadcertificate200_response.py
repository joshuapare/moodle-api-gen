...
class ModIomadcertificateIssueIomadcertificate200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["issue", "warnings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "issue": ModIomadcertificateIssueIomadcertificate200ResponseIssue.from_dict(obj["issue"]) if obj.get("issue") is not None else None,
