...
class ModBookGetBooksByCourses200Response(BaseModel):
    """
    ModBookGetBooksByCourses200Response
    """ # noqa: E501
    books: List[ModBookGetBooksByCourses200ResponseBooksInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "books": [ModBookGetBooksByCourses200ResponseBooksInner.from_dict(_item) for _item in obj["books"]] if obj.get("books") is not None else None,
