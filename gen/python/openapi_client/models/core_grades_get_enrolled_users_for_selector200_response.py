...
class CoreGradesGetEnrolledUsersForSelector200Response(BaseModel):
    """
    CoreGradesGetEnrolledUsersForSelector200Response
    """ # noqa: E501
    users: List[CoreGradesGetEnrolledUsersForSelector200ResponseUsersInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "users": [CoreGradesGetEnrolledUsersForSelector200ResponseUsersInner.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None,
