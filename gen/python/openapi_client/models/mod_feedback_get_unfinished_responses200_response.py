...
class ModFeedbackGetUnfinishedResponses200Response(BaseModel):
    """
    ModFeedbackGetUnfinishedResponses200Response
    """ # noqa: E501
    responses: List[ModFeedbackGetUnfinishedResponses200ResponseResponsesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responses": [ModFeedbackGetUnfinishedResponses200ResponseResponsesInner.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None,
