...
class ToolPolicyGetPolicyVersion200ResponseResult(BaseModel):
    """
    ToolPolicyGetPolicyVersion200ResponseResult
    """ # noqa: E501
    policy: Optional[ToolPolicyGetPolicyVersion200ResponseResultPolicy] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policy": ToolPolicyGetPolicyVersion200ResponseResultPolicy.from_dict(obj["policy"]) if obj.get("policy") is not None else None
        })
        return _obj
