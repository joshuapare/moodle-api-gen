...
class ModWikiEditPageRequest(BaseModel):
    """
    ModWikiEditPageRequest
    """ # noqa: E501
    content: StrictStr = Field(description="Page contents.")
    pageid: StrictInt = Field(description="Page ID.")
    section: Optional[StrictStr] = Field(default='null', description="Section page title.")
    __properties: ClassVar[List[str]] = ["content", "pageid", "section"]
