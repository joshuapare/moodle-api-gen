...
class ModForumPrepareDraftAreaForPost200Response(BaseModel):
    """
    ModForumPrepareDraftAreaForPost200Response
    """ # noqa: E501
    areaoptions: List[ModForumPrepareDraftAreaForPost200ResponseAreaoptionsInner]
    draftitemid: StrictInt = Field(description="Draft item id for the file area.")
    files: Optional[List[CoreBlockGetDashboardBlocks200ResponseBlocksInnerContentsFilesInner]] = None
    messagetext: StrictStr = Field(description="Message text with URLs rewritten.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "areaoptions": [ModForumPrepareDraftAreaForPost200ResponseAreaoptionsInner.from_dict(_item) for _item in obj["areaoptions"]] if obj.get("areaoptions") is not None else None,
            "draftitemid": obj.get("draftitemid") if obj.get("draftitemid") is not None else null,
            ...
            "messagetext": obj.get("messagetext") if obj.get("messagetext") is not None else 'null',
