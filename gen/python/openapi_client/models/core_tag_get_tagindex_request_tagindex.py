...
class CoreTagGetTagindexRequestTagindex(BaseModel):
    """
    ...
    rec: Optional[StrictInt] = Field(default=1, description="search in the context recursive")
    ta: StrictInt = Field(description="tag area id")
    tag: StrictStr = Field(description="tag name")
    tc: StrictInt = Field(description="tag collection id")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ta": obj.get("ta") if obj.get("ta") is not None else null,
            "tag": obj.get("tag") if obj.get("tag") is not None else 'null',
            "tc": obj.get("tc") if obj.get("tc") is not None else null
        })
        return _obj
