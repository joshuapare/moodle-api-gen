...
class ToolDataprivacyTreeExtraBranches200Response(BaseModel):
    """
    ToolDataprivacyTreeExtraBranches200Response
    """ # noqa: E501
    branches: List[ToolDataprivacyTreeExtraBranches200ResponseBranchesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "branches": [ToolDataprivacyTreeExtraBranches200ResponseBranchesInner.from_dict(_item) for _item in obj["branches"]] if obj.get("branches") is not None else None,
