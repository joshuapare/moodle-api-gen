...
class ReportCompetencyDataForReport200ResponseUsercompetenciesInnerUsercompetencycourse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "proficiency": obj.get("proficiency") if obj.get("proficiency") is not None else False,
            "proficiencyname": obj.get("proficiencyname") if obj.get("proficiencyname") is not None else 'null',
