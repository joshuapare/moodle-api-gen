...
class ModH5pactivityGetAttempts200Response(BaseModel):
    """
    ModH5pactivityGetAttempts200Response
    """ # noqa: E501
    activityid: StrictInt = Field(description="Activity course module ID")
    usersattempts: List[ModH5pactivityGetAttempts200ResponseUsersattemptsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "usersattempts": [ModH5pactivityGetAttempts200ResponseUsersattemptsInner.from_dict(_item) for _item in obj["usersattempts"]] if obj.get("usersattempts") is not None else None,
