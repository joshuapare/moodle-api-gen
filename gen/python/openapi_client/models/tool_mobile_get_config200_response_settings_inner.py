...
class ToolMobileGetConfig200ResponseSettingsInner(BaseModel):
    """
    ToolMobileGetConfig200ResponseSettingsInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default='null', description="The name of the setting")
    value: Optional[StrictStr] = Field(default='null', description="The value of the setting")
