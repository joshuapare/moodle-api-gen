...
class CoreReportbuilderRetrieveSystemReport200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CoreReportbuilderRetrieveSystemReport200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
