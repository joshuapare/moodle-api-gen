...
class CoreMessageSendMessagesToConversationRequest(BaseModel):
    """
    CoreMessageSendMessagesToConversationRequest
    """ # noqa: E501
    conversationid: StrictInt = Field(description="id of the conversation")
    messages: List[CoreMessageSendMessagesToConversationRequestMessagesInner]
    __properties: ClassVar[List[str]] = ["conversationid", "messages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "messages": [CoreMessageSendMessagesToConversationRequestMessagesInner.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None
        })
        return _obj
