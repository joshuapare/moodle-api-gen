...
class ModLessonGetContentPagesViewed200Response(BaseModel):
    """
    ModLessonGetContentPagesViewed200Response
    """ # noqa: E501
    pages: List[ModLessonGetContentPagesViewed200ResponsePagesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pages": [ModLessonGetContentPagesViewed200ResponsePagesInner.from_dict(_item) for _item in obj["pages"]] if obj.get("pages") is not None else None,
