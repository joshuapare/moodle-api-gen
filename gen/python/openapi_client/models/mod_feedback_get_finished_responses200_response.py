...
class ModFeedbackGetFinishedResponses200Response(BaseModel):
    """
    ModFeedbackGetFinishedResponses200Response
    """ # noqa: E501
    responses: List[ModFeedbackGetFinishedResponses200ResponseResponsesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responses": [ModFeedbackGetFinishedResponses200ResponseResponsesInner.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None,
