...
class BlockIomadCompanyAdminCreateLicensesRequest(BaseModel):
    """
    BlockIomadCompanyAdminCreateLicensesRequest
    """ # noqa: E501
    licenses: List[BlockIomadCompanyAdminCreateLicensesRequestLicensesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "licenses": [BlockIomadCompanyAdminCreateLicensesRequestLicensesInner.from_dict(_item) for _item in obj["licenses"]] if obj.get("licenses") is not None else None
        })
        return _obj
