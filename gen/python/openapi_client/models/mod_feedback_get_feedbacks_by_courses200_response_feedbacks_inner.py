...
class ModFeedbackGetFeedbacksByCourses200ResponseFeedbacksInner(BaseModel):
    """
    ModFeedbackGetFeedbacksByCourses200ResponseFeedbacksInner
    """ # noqa: E501
    anonymous: Optional[StrictInt] = Field(default=null, description="Whether the feedback is anonymous.")
    autonumbering: Optional[StrictBool] = Field(default=False, description="Whether questions should be auto-numbered.")
    completionsubmit: Optional[StrictBool] = Field(default=False, description="If this field is set to 1, then the activity will be automatically marked as complete on submission.")
    course: Optional[StrictInt] = Field(default=null, description="Course id this feedback is part of.")
    ...
    id: Optional[StrictInt] = Field(default=null, description="The primary key of the record.")
    intro: Optional[StrictStr] = Field(default='', description="Feedback introduction text.")
    ...
    multiple_submit: Optional[StrictBool] = Field(default=False, description="Whether multiple submissions are allowed.")
    name: Optional[StrictStr] = Field(default='null', description="Feedback name.")
    page_after_submit: Optional[StrictStr] = Field(default='null', description="Text to display after submission.")
    ...
    pageaftersubmitfiles: Optional[List[CoreBlogGetEntries200ResponseEntriesInnerSummaryfilesInner]] = None
    publish_stats: Optional[StrictBool] = Field(default=False, description="Whether stats should be published.")
    site_after_submit: Optional[StrictStr] = Field(default='null', description="Link to next page after submission.")
    timeclose: Optional[StrictInt] = Field(default=null, description="Allow answers until this time.")
    timemodified: Optional[StrictInt] = Field(default=null, description="The time this record was modified.")
    timeopen: Optional[StrictInt] = Field(default=null, description="Allow answers from this time.")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.pageaftersubmitfiles:
            for _item in self.pageaftersubmitfiles:
                if _item:
                    _items.append(_item.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "anonymous": obj.get("anonymous") if obj.get("anonymous") is not None else null,
            "autonumbering": obj.get("autonumbering") if obj.get("autonumbering") is not None else False,
            ...
            "lang": obj.get("lang"),
            "multiple_submit": obj.get("multiple_submit") if obj.get("multiple_submit") is not None else False,
            "name": obj.get("name") if obj.get("name") is not None else 'null',
            "page_after_submit": obj.get("page_after_submit") if obj.get("page_after_submit") is not None else 'null',
            "page_after_submitformat": obj.get("page_after_submitformat") if obj.get("page_after_submitformat") is not None else 0,
            "pageaftersubmitfiles": [CoreBlogGetEntries200ResponseEntriesInnerSummaryfilesInner.from_dict(_item) for _item in obj["pageaftersubmitfiles"]] if obj.get("pageaftersubmitfiles") is not None else None,
            "publish_stats": obj.get("publish_stats") if obj.get("publish_stats") is not None else False,
            "site_after_submit": obj.get("site_after_submit") if obj.get("site_after_submit") is not None else 'null',
