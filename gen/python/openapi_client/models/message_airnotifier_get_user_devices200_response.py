...
class MessageAirnotifierGetUserDevices200Response(BaseModel):
    """
    MessageAirnotifierGetUserDevices200Response
    """ # noqa: E501
    devices: List[MessageAirnotifierGetUserDevices200ResponseDevicesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "devices": [MessageAirnotifierGetUserDevices200ResponseDevicesInner.from_dict(_item) for _item in obj["devices"]] if obj.get("devices") is not None else None,
