...
class CoreUserGetUserPreferences200Response(BaseModel):
    """
    CoreUserGetUserPreferences200Response
    """ # noqa: E501
    preferences: List[CoreUserGetUserPreferences200ResponsePreferencesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "preferences": [CoreUserGetUserPreferences200ResponsePreferencesInner.from_dict(_item) for _item in obj["preferences"]] if obj.get("preferences") is not None else None,
