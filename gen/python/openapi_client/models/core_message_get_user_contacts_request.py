...
class CoreMessageGetUserContactsRequest(BaseModel):
    """
    ...
    userid: StrictInt = Field(description="The id of the user who we retrieving the contacts for")
    __properties: ClassVar[List[str]] = ["limitfrom", "limitnum", "userid"]
