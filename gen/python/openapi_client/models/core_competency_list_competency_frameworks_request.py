...
class CoreCompetencyListCompetencyFrameworksRequest(BaseModel):
    """
    ...
    onlyvisible: Optional[StrictBool] = Field(default=False, description="Only visible frameworks will be returned if visible true")
    order: Optional[StrictStr] = Field(default='', description="Sort direction. Should be either ASC or DESC")
    query: Optional[StrictStr] = Field(default='', description="A query string to filter the results")
    skip: Optional[StrictInt] = Field(default=0, description="Skip this number of records before returning results")
    sort: Optional[StrictStr] = Field(default='shortname', description="Column to sort by.")
    __properties: ClassVar[List[str]] = ["context", "includes", "limit", "onlyvisible", "order", "query", "skip", "sort"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sort": obj.get("sort") if obj.get("sort") is not None else 'shortname'
        })
        return _obj
