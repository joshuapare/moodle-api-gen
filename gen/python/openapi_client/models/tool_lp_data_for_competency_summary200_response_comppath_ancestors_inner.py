...
class ToolLpDataForCompetencySummary200ResponseComppathAncestorsInner(BaseModel):
    """
    ToolLpDataForCompetencySummary200ResponseComppathAncestorsInner
    """ # noqa: E501
    first: Optional[StrictBool] = Field(default=None, description="first")
    id: Optional[StrictInt] = Field(default=None, description="id")
    last: Optional[StrictBool] = Field(default=None, description="last")
