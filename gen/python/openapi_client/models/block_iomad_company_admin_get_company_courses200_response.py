...
class BlockIomadCompanyAdminGetCompanyCourses200Response(BaseModel):
    """
    BlockIomadCompanyAdminGetCompanyCourses200Response
    """ # noqa: E501
    companies: List[BlockIomadCompanyAdminGetCompanyCourses200ResponseCompaniesInner]
    warnings: Optional[List[BlockIomadCompanyAdminGetCompanies200ResponseWarningsInner]] = None
    __properties: ClassVar[List[str]] = ["companies", "warnings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "companies": [BlockIomadCompanyAdminGetCompanyCourses200ResponseCompaniesInner.from_dict(_item) for _item in obj["companies"]] if obj.get("companies") is not None else None,
