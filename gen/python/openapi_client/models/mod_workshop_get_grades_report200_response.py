...
class ModWorkshopGetGradesReport200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "report": ModWorkshopGetGradesReport200ResponseReport.from_dict(obj["report"]) if obj.get("report") is not None else None,
