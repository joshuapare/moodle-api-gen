...
class ModUrlGetUrlsByCourses200Response(BaseModel):
    """
    ModUrlGetUrlsByCourses200Response
    """ # noqa: E501
    urls: List[ModUrlGetUrlsByCourses200ResponseUrlsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "urls": [ModUrlGetUrlsByCourses200ResponseUrlsInner.from_dict(_item) for _item in obj["urls"]] if obj.get("urls") is not None else None,
