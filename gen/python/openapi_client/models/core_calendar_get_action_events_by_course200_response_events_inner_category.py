...
class CoreCalendarGetActionEventsByCourse200ResponseEventsInnerCategory(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nestedname": obj.get("nestedname") if obj.get("nestedname") is not None else 'null',
