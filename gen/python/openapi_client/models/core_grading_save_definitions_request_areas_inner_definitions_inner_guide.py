...
class CoreGradingSaveDefinitionsRequestAreasInnerDefinitionsInnerGuide(BaseModel):
    """
    CoreGradingSaveDefinitionsRequestAreasInnerDefinitionsInnerGuide
    """ # noqa: E501
    guide_comments: Optional[List[CoreGradingSaveDefinitionsRequestAreasInnerDefinitionsInnerGuideGuideCommentsInner]] = None
    guide_criteria: Optional[List[CoreGradingSaveDefinitionsRequestAreasInnerDefinitionsInnerGuideGuideCriteriaInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "guide_comments": [CoreGradingSaveDefinitionsRequestAreasInnerDefinitionsInnerGuideGuideCommentsInner.from_dict(_item) for _item in obj["guide_comments"]] if obj.get("guide_comments") is not None else None,
            "guide_criteria": [CoreGradingSaveDefinitionsRequestAreasInnerDefinitionsInnerGuideGuideCriteriaInner.from_dict(_item) for _item in obj["guide_criteria"]] if obj.get("guide_criteria") is not None else None
        })
        return _obj
