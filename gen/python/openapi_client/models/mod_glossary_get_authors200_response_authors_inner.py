...
class ModGlossaryGetAuthors200ResponseAuthorsInner(BaseModel):
    """
    ModGlossaryGetAuthors200ResponseAuthorsInner
    """ # noqa: E501
    fullname: Optional[StrictStr] = Field(default='null', description="The fullname")
    id: Optional[StrictInt] = Field(default=None, description="The user ID")
    pictureurl: Optional[StrictStr] = Field(default='null', description="The picture URL")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "pictureurl": obj.get("pictureurl") if obj.get("pictureurl") is not None else 'null'
        })
        return _obj
