...
class ModLessonFinishAttempt200Response(BaseModel):
    """
    ModLessonFinishAttempt200Response
    """ # noqa: E501
    data: List[ModLessonFinishAttempt200ResponseDataInner]
    messages: List[ModLessonFinishAttempt200ResponseMessagesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ModLessonFinishAttempt200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "messages": [ModLessonFinishAttempt200ResponseMessagesInner.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None,
