...
class ModResourceViewResourceRequest(BaseModel):
    """
    ModResourceViewResourceRequest
    """ # noqa: E501
    resourceid: StrictInt = Field(description="resource instance id")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resourceid": obj.get("resourceid") if obj.get("resourceid") is not None else null
        })
        return _obj
