...
class CoreCourseCreateCoursesRequest(BaseModel):
    """
    CoreCourseCreateCoursesRequest
    """ # noqa: E501
    courses: List[CoreCourseCreateCoursesRequestCoursesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "courses": [CoreCourseCreateCoursesRequestCoursesInner.from_dict(_item) for _item in obj["courses"]] if obj.get("courses") is not None else None
        })
        return _obj
