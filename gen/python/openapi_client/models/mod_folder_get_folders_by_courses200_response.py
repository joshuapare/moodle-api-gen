...
class ModFolderGetFoldersByCourses200Response(BaseModel):
    """
    ModFolderGetFoldersByCourses200Response
    """ # noqa: E501
    folders: List[ModFolderGetFoldersByCourses200ResponseFoldersInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "folders": [ModFolderGetFoldersByCourses200ResponseFoldersInner.from_dict(_item) for _item in obj["folders"]] if obj.get("folders") is not None else None,
