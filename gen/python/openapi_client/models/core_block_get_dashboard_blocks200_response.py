...
class CoreBlockGetDashboardBlocks200Response(BaseModel):
    """
    CoreBlockGetDashboardBlocks200Response
    """ # noqa: E501
    blocks: List[CoreBlockGetDashboardBlocks200ResponseBlocksInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "blocks": [CoreBlockGetDashboardBlocks200ResponseBlocksInner.from_dict(_item) for _item in obj["blocks"]] if obj.get("blocks") is not None else None,
