...
class GradingformRubricGraderGradingpanelFetch200ResponseGrade(BaseModel):
    """
    GradingformRubricGraderGradingpanelFetch200ResponseGrade
    """ # noqa: E501
    canedit: StrictBool = Field(description="Can the user edit this")
    criteria: List[GradingformRubricGraderGradingpanelFetch200ResponseGradeCriteriaInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "criteria": [GradingformRubricGraderGradingpanelFetch200ResponseGradeCriteriaInner.from_dict(_item) for _item in obj["criteria"]] if obj.get("criteria") is not None else None,
            "gradedby": obj.get("gradedby"),
            "instanceid": obj.get("instanceid"),
            "maxgrade": obj.get("maxgrade"),
            "rubricmode": obj.get("rubricmode") if obj.get("rubricmode") is not None else 'null',
