...
class ModAssignGetGrades200ResponseAssignmentsInner(BaseModel):
    """
    ...
    grades: Optional[List[ModAssignGetGrades200ResponseAssignmentsInnerGradesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "grades": [ModAssignGetGrades200ResponseAssignmentsInnerGradesInner.from_dict(_item) for _item in obj["grades"]] if obj.get("grades") is not None else None
        })
        return _obj
