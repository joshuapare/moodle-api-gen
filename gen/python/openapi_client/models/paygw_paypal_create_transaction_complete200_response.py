...
class PaygwPaypalCreateTransactionComplete200Response(BaseModel):
    """
    PaygwPaypalCreateTransactionComplete200Response
    """ # noqa: E501
    message: StrictStr = Field(description="Message (usually the error message).")
    success: StrictBool = Field(description="Whether everything was successful or not.")
