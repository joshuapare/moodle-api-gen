...
class CoreCourseGetCoursesByField200ResponseCoursesInnerContactsInner(BaseModel):
    """
    CoreCourseGetCoursesByField200ResponseCoursesInnerContactsInner
    """ # noqa: E501
    fullname: Optional[StrictStr] = Field(default='null', description="contact user fullname")
    id: Optional[StrictInt] = Field(default=null, description="contact user id")
