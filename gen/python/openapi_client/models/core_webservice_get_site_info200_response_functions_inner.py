...
class CoreWebserviceGetSiteInfo200ResponseFunctionsInner(BaseModel):
    """
    functions that are available
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default='null', description="function name")
    version: Optional[StrictStr] = Field(default='null', description="The version number of the component to which the function belongs")
