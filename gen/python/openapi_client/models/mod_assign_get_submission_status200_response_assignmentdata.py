...
class ModAssignGetSubmissionStatus200ResponseAssignmentdata(BaseModel):
    """
    ModAssignGetSubmissionStatus200ResponseAssignmentdata
    """ # noqa: E501
    activity: Optional[StrictStr] = Field(default='null', description="Text of activity")
    activityformat: Optional[StrictInt] = Field(default=None, description="activity format (1 = HTML, 0 = MOODLE, 2 = PLAIN, or 4 = MARKDOWN)")
    attachments: Optional[ModAssignGetSubmissionStatus200ResponseAssignmentdataAttachments] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attachments": ModAssignGetSubmissionStatus200ResponseAssignmentdataAttachments.from_dict(obj["attachments"]) if obj.get("attachments") is not None else None
        })
        return _obj
