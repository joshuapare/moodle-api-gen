...
class ModForumSetPinState200ResponseTimed(BaseModel):
    """
    ModForumSetPinState200ResponseTimed
    """ # noqa: E501
    istimed: Optional[StrictBool] = Field(default=False, description="istimed")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "istimed": obj.get("istimed") if obj.get("istimed") is not None else False,
