...
class ModForumSetSubscriptionState200ResponseGroupUrls(BaseModel):
    """
    ModForumSetSubscriptionState200ResponseGroupUrls
    """ # noqa: E501
    picture: Optional[StrictStr] = Field(default=None, description="picture")
    userlist: Optional[StrictStr] = Field(default=None, description="userlist")
