...
class ModLessonLaunchAttemptRequest(BaseModel):
    """
    ModLessonLaunchAttemptRequest
    """ # noqa: E501
    lessonid: StrictInt = Field(description="lesson instance id")
    pageid: Optional[StrictInt] = Field(default=0, description="page id to continue from (only when continuing an attempt)")
    password: Optional[StrictStr] = Field(default='', description="optional password (the lesson may be protected)")
    review: Optional[StrictBool] = Field(default=False, description="if we want to review just after finishing")
    __properties: ClassVar[List[str]] = ["lessonid", "pageid", "password", "review"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pageid": obj.get("pageid") if obj.get("pageid") is not None else 0,
