...
class CoreCompletionGetActivitiesCompletionStatus200Response(BaseModel):
    """
    CoreCompletionGetActivitiesCompletionStatus200Response
    """ # noqa: E501
    statuses: List[CoreCompletionGetActivitiesCompletionStatus200ResponseStatusesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "statuses": [CoreCompletionGetActivitiesCompletionStatus200ResponseStatusesInner.from_dict(_item) for _item in obj["statuses"]] if obj.get("statuses") is not None else None,
