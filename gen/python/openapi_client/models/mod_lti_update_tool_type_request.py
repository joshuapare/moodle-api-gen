...
class ModLtiUpdateToolTypeRequest(BaseModel):
    """
    ...
    state: Optional[StrictInt] = Field(default=null, description="Tool type state")
    __properties: ClassVar[List[str]] = ["description", "id", "name", "state"]
