...
class ModGlossaryGetGlossariesByCourses200Response(BaseModel):
    """
    ModGlossaryGetGlossariesByCourses200Response
    """ # noqa: E501
    glossaries: List[ModGlossaryGetGlossariesByCourses200ResponseGlossariesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "glossaries": [ModGlossaryGetGlossariesByCourses200ResponseGlossariesInner.from_dict(_item) for _item in obj["glossaries"]] if obj.get("glossaries") is not None else None,
