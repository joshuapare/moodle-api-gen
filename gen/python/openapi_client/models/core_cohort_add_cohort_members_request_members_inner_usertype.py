...
class CoreCohortAddCohortMembersRequestMembersInnerUsertype(BaseModel):
    """
    CoreCohortAddCohortMembersRequestMembersInnerUsertype
    """ # noqa: E501
    type: StrictStr = Field(description="The name of the field: id                                         (numeric value of id) or username (alphanumeric value of username) ")
