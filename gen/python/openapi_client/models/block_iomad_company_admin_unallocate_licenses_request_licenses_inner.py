...
class BlockIomadCompanyAdminUnallocateLicensesRequestLicensesInner(BaseModel):
    """
    BlockIomadCompanyAdminUnallocateLicensesRequestLicensesInner
    """ # noqa: E501
    licensecourseid: Optional[StrictInt] = Field(default=None, description="Course ID")
    licenseid: Optional[StrictInt] = Field(default=None, description="License ID")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "licensecourseid": obj.get("licensecourseid"),
