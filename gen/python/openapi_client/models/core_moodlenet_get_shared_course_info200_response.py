...
class CoreMoodlenetGetSharedCourseInfo200Response(BaseModel):
    """
    CoreMoodlenetGetSharedCourseInfo200Response
    """ # noqa: E501
    issuerid: StrictInt = Field(description="MoodleNet issuer id")
    name: StrictStr = Field(description="Course short name")
    ...
    type: StrictStr = Field(description="Course type")
