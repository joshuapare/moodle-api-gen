...
class ModLtiGetToolLaunchData200ResponseParametersInner(BaseModel):
    """
    ModLtiGetToolLaunchData200ResponseParametersInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default='null', description="Parameter name")
    value: Optional[StrictStr] = Field(default='null', description="Parameter value")
