...
class ModForumSetSubscriptionState200Response(BaseModel):
    """
    ...
    group: Optional[ModForumSetSubscriptionState200ResponseGroup] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "capabilities": ModForumSetSubscriptionState200ResponseCapabilities.from_dict(obj["capabilities"]) if obj.get("capabilities") is not None else None,
            "firstpostid": obj.get("firstpostid"),
            "forumid": obj.get("forumid"),
            "group": ModForumSetSubscriptionState200ResponseGroup.from_dict(obj["group"]) if obj.get("group") is not None else None,
            "id": obj.get("id"),
            "istimelocked": obj.get("istimelocked"),
            "locked": obj.get("locked"),
            "name": obj.get("name"),
            "pinned": obj.get("pinned"),
            "timed": ModForumSetSubscriptionState200ResponseTimed.from_dict(obj["timed"]) if obj.get("timed") is not None else None,
            "times": ModForumSetSubscriptionState200ResponseTimes.from_dict(obj["times"]) if obj.get("times") is not None else None,
            "urls": ModForumSetSubscriptionState200ResponseUrls.from_dict(obj["urls"]) if obj.get("urls") is not None else None,
            "userstate": ModForumSetSubscriptionState200ResponseUserstate.from_dict(obj["userstate"]) if obj.get("userstate") is not None else None
        })
        return _obj
