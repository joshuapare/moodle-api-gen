...
class TinyPremiumGetApiKey200Response(BaseModel):
    """
    TinyPremiumGetApiKey200Response
    """ # noqa: E501
    apikey: StrictStr = Field(description="The API key for Tiny Premium")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apikey": obj.get("apikey") if obj.get("apikey") is not None else 'null'
        })
        return _obj
