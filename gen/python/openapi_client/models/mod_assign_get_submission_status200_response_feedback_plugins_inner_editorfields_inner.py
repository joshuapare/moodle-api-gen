...
class ModAssignGetSubmissionStatus200ResponseFeedbackPluginsInnerEditorfieldsInner(BaseModel):
    """
    ModAssignGetSubmissionStatus200ResponseFeedbackPluginsInnerEditorfieldsInner
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default='null', description="field description")
    format: Optional[StrictInt] = Field(default=None, description="text format (1 = HTML, 0 = MOODLE, 2 = PLAIN, or 4 = MARKDOWN)")
    name: Optional[StrictStr] = Field(default='null', description="field name")
    text: Optional[StrictStr] = Field(default='null', description="field value")
