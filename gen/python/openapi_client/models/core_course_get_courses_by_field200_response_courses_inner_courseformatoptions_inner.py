...
class CoreCourseGetCoursesByField200ResponseCoursesInnerCourseformatoptionsInner(BaseModel):
    """
    CoreCourseGetCoursesByField200ResponseCoursesInnerCourseformatoptionsInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default='null', description="Course format option name.")
    value: Optional[StrictStr] = Field(default='null', description="Course format option value.")
