...
class ModWorkshopGetUserPlan200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "userplan": ModWorkshopGetUserPlan200ResponseUserplan.from_dict(obj["userplan"]) if obj.get("userplan") is not None else None,
