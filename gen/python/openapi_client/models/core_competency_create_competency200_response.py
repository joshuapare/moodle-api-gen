...
class CoreCompetencyCreateCompetency200Response(BaseModel):
    """
    ...
    ruleconfig: StrictStr = Field(description="ruleconfig")
    ruleoutcome: StrictInt = Field(description="ruleoutcome")
    ruletype: StrictStr = Field(description="ruletype")
