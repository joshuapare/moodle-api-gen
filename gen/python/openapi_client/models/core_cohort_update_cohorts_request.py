...
class CoreCohortUpdateCohortsRequest(BaseModel):
    """
    CoreCohortUpdateCohortsRequest
    """ # noqa: E501
    cohorts: List[CoreCohortUpdateCohortsRequestCohortsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cohorts": [CoreCohortUpdateCohortsRequestCohortsInner.from_dict(_item) for _item in obj["cohorts"]] if obj.get("cohorts") is not None else None
        })
        return _obj
