...
class TinyEquationFilterRequest(BaseModel):
    """
    TinyEquationFilterRequest
    """ # noqa: E501
    content: StrictStr = Field(description="The equation content")
    contextid: StrictInt = Field(description="The context ID")
    __properties: ClassVar[List[str]] = ["content", "contextid"]
