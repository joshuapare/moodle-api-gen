...
class GradereportSingleviewGetGradeItemsForSearchWidget200ResponseGradeitemsInner(BaseModel):
    """
    GradereportSingleviewGetGradeItemsForSearchWidget200ResponseGradeitemsInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=null, description="ID of the grade item")
