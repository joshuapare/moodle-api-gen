...
class ModImscpGetImscpsByCourses200Response(BaseModel):
    """
    ModImscpGetImscpsByCourses200Response
    """ # noqa: E501
    imscps: List[ModImscpGetImscpsByCourses200ResponseImscpsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "imscps": [ModImscpGetImscpsByCourses200ResponseImscpsInner.from_dict(_item) for _item in obj["imscps"]] if obj.get("imscps") is not None else None,
