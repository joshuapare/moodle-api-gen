...
class CoreCohortAddCohortMembersRequestMembersInnerCohorttype(BaseModel):
    """
    CoreCohortAddCohortMembersRequestMembersInnerCohorttype
    """ # noqa: E501
    type: StrictStr = Field(description="The name of the field: id                                         (numeric value of cohortid) or idnumber (alphanumeric value of idnumber) ")
    value: StrictStr = Field(description="The value of the cohort")
