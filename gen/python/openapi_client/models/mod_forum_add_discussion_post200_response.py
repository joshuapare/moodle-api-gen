...
class ModForumAddDiscussionPost200Response(BaseModel):
    """
    ModForumAddDiscussionPost200Response
    """ # noqa: E501
    messages: Optional[List[ModForumAddDiscussionPost200ResponseMessagesInner]] = None
    post: ModForumAddDiscussionPost200ResponsePost
    postid: StrictInt = Field(description="new post id")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "messages": [ModForumAddDiscussionPost200ResponseMessagesInner.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None,
            "post": ModForumAddDiscussionPost200ResponsePost.from_dict(obj["post"]) if obj.get("post") is not None else None,
