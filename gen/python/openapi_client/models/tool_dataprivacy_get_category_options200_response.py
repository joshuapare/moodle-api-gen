...
class ToolDataprivacyGetCategoryOptions200Response(BaseModel):
    """
    ToolDataprivacyGetCategoryOptions200Response
    """ # noqa: E501
    options: List[ToolDataprivacyGetCategoryOptions200ResponseOptionsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "options": [ToolDataprivacyGetCategoryOptions200ResponseOptionsInner.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None,
