...
class GradereportUserGetGradesTable200Response(BaseModel):
    """
    GradereportUserGetGradesTable200Response
    """ # noqa: E501
    tables: List[GradereportUserGetGradesTable200ResponseTablesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tables": [GradereportUserGetGradesTable200ResponseTablesInner.from_dict(_item) for _item in obj["tables"]] if obj.get("tables") is not None else None,
