...
class ModChatGetChatLatestMessages200Response(BaseModel):
    """
    ModChatGetChatLatestMessages200Response
    """ # noqa: E501
    chatnewlasttime: StrictInt = Field(description="new last time")
    messages: List[ModChatGetChatLatestMessages200ResponseMessagesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chatnewlasttime": obj.get("chatnewlasttime") if obj.get("chatnewlasttime") is not None else null,
            "messages": [ModChatGetChatLatestMessages200ResponseMessagesInner.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None,
