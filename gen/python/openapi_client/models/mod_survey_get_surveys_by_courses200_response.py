...
class ModSurveyGetSurveysByCourses200Response(BaseModel):
    """
    ModSurveyGetSurveysByCourses200Response
    """ # noqa: E501
    surveys: List[ModSurveyGetSurveysByCourses200ResponseSurveysInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "surveys": [ModSurveyGetSurveysByCourses200ResponseSurveysInner.from_dict(_item) for _item in obj["surveys"]] if obj.get("surveys") is not None else None,
