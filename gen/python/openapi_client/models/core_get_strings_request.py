...
class CoreGetStringsRequest(BaseModel):
    """
    CoreGetStringsRequest
    """ # noqa: E501
    strings: List[CoreGetStringsRequestStringsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "strings": [CoreGetStringsRequestStringsInner.from_dict(_item) for _item in obj["strings"]] if obj.get("strings") is not None else None
        })
        return _obj
