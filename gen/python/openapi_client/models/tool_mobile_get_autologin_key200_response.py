...
class ToolMobileGetAutologinKey200Response(BaseModel):
    """
    ToolMobileGetAutologinKey200Response
    """ # noqa: E501
    autologinurl: StrictStr = Field(description="Auto-login URL.")
    key: StrictStr = Field(description="Auto-login key for a single usage with time expiration.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "autologinurl": obj.get("autologinurl") if obj.get("autologinurl") is not None else 'null',
