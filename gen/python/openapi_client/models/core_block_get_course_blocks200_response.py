...
class CoreBlockGetCourseBlocks200Response(BaseModel):
    """
    CoreBlockGetCourseBlocks200Response
    """ # noqa: E501
    blocks: List[CoreBlockGetCourseBlocks200ResponseBlocksInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "blocks": [CoreBlockGetCourseBlocks200ResponseBlocksInner.from_dict(_item) for _item in obj["blocks"]] if obj.get("blocks") is not None else None,
