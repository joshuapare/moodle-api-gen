...
class ToolLpDataForCourseCompetenciesPage200ResponseCompetenciesInnerCoursemodulesInner(BaseModel):
    """
    ToolLpDataForCourseCompetenciesPage200ResponseCompetenciesInnerCoursemodulesInner
    """ # noqa: E501
    iconurl: Optional[StrictStr] = Field(default=None, description="iconurl")
