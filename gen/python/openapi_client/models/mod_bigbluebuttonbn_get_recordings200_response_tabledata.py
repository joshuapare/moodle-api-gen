...
class ModBigbluebuttonbnGetRecordings200ResponseTabledata(BaseModel):
    """
    ModBigbluebuttonbnGetRecordings200ResponseTabledata
    """ # noqa: E501
    activity: StrictStr
    columns: List[ModBigbluebuttonbnGetRecordings200ResponseTabledataColumnsInner]
    data: StrictStr
    locale: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "columns": [ModBigbluebuttonbnGetRecordings200ResponseTabledataColumnsInner.from_dict(_item) for _item in obj["columns"]] if obj.get("columns") is not None else None,
            "data": obj.get("data"),
