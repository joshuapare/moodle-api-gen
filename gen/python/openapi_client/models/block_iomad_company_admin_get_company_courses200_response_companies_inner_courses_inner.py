...
class BlockIomadCompanyAdminGetCompanyCourses200ResponseCompaniesInnerCoursesInner(BaseModel):
    """
    BlockIomadCompanyAdminGetCompanyCourses200ResponseCompaniesInnerCoursesInner
    """ # noqa: E501
    customfields: Optional[List[BlockIomadCompanyAdminGetCompanyCourses200ResponseCompaniesInnerCoursesInnerCustomfieldsInner]] = None
    ...
    __properties: ClassVar[List[str]] = ["customfields", "fullname", "id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customfields": [BlockIomadCompanyAdminGetCompanyCourses200ResponseCompaniesInnerCoursesInnerCustomfieldsInner.from_dict(_item) for _item in obj["customfields"]] if obj.get("customfields") is not None else None,
