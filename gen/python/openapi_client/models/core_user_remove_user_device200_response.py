...
class CoreUserRemoveUserDevice200Response(BaseModel):
    """
    CoreUserRemoveUserDevice200Response
    """ # noqa: E501
    removed: StrictBool = Field(description="True if removed, false if not removed because it doesn't exists")
