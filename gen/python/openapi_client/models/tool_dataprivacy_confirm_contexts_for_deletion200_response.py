...
class ToolDataprivacyConfirmContextsForDeletion200Response(BaseModel):
    """
    ToolDataprivacyConfirmContextsForDeletion200Response
    """ # noqa: E501
    result: StrictBool = Field(description="Whether the record was properly marked for deletion or not")
