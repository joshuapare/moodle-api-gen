...
class ModGlossaryGetEntriesByAuthorId200Response(BaseModel):
    """
    ModGlossaryGetEntriesByAuthorId200Response
    """ # noqa: E501
    count: StrictInt = Field(description="The total number of records matching the request.")
    entries: List[ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "entries": [ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
