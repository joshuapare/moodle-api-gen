...
class ToolLpDataForCourseCompetenciesPage200ResponseCompetenciesInnerRuleoutcomeoptionsInner(BaseModel):
    """
    ToolLpDataForCourseCompetenciesPage200ResponseCompetenciesInnerRuleoutcomeoptionsInner
    """ # noqa: E501
    selected: Optional[StrictBool] = Field(default=False, description="If this is the currently selected option")
    text: Optional[StrictStr] = Field(default='null', description="The name of the option")
    value: Optional[StrictInt] = Field(default=null, description="The option value")
