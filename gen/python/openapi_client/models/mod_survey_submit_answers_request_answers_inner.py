...
class ModSurveySubmitAnswersRequestAnswersInner(BaseModel):
    """
    ModSurveySubmitAnswersRequestAnswersInner
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default='null', description="Answer key")
    value: Optional[StrictStr] = Field(default='null', description="Answer value")
