...
class ModFeedbackGetLastCompleted200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "completed": ModFeedbackGetLastCompleted200ResponseCompleted.from_dict(obj["completed"]) if obj.get("completed") is not None else None,
