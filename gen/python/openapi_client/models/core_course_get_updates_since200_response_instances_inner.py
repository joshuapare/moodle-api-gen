...
class CoreCourseGetUpdatesSince200ResponseInstancesInner(BaseModel):
    """
    ...
    updates: Optional[List[CoreCourseGetUpdatesSince200ResponseInstancesInnerUpdatesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "updates": [CoreCourseGetUpdatesSince200ResponseInstancesInnerUpdatesInner.from_dict(_item) for _item in obj["updates"]] if obj.get("updates") is not None else None
        })
        return _obj
