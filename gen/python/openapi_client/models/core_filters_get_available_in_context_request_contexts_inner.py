...
class CoreFiltersGetAvailableInContextRequestContextsInner(BaseModel):
    """
    ...
    instanceid: Optional[StrictInt] = Field(default=null, description="The instance id of item associated with the context.")
