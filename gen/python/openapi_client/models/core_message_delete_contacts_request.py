...
class CoreMessageDeleteContactsRequest(BaseModel):
    """
    CoreMessageDeleteContactsRequest
    """ # noqa: E501
    userid: Optional[StrictInt] = Field(default=0, description="The id of the user we are deleting the contacts for, 0 for the                     current user")
    userids: List[Dict[str, Any]]
    __properties: ClassVar[List[str]] = ["userid", "userids"]
