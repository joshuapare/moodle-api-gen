...
class ModDataGetMappingInformation200Response(BaseModel):
    """
    ModDataGetMappingInformation200Response
    """ # noqa: E501
    data: Optional[ModDataGetMappingInformation200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ModDataGetMappingInformation200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
