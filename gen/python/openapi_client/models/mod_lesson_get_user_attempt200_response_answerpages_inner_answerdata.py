...
class ModLessonGetUserAttempt200ResponseAnswerpagesInnerAnswerdata(BaseModel):
    """
    ModLessonGetUserAttempt200ResponseAnswerpagesInnerAnswerdata
    """ # noqa: E501
    answers: Optional[List[Dict[str, Any]]] = None
    response: StrictStr = Field(description="The response text.")
    responseformat: StrictInt = Field(description="response. format (1 = HTML, 0 = MOODLE, 2 = PLAIN, or 4 = MARKDOWN)")
    score: StrictStr = Field(description="The score (text version).")
