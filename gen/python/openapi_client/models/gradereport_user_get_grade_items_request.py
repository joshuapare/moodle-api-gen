...
class GradereportUserGetGradeItemsRequest(BaseModel):
    """
    GradereportUserGetGradeItemsRequest
    """ # noqa: E501
    courseid: StrictInt = Field(description="Course Id")
    groupid: Optional[StrictInt] = Field(default=0, description="Get users from this group only")
    userid: Optional[StrictInt] = Field(default=0, description="Return grades only for this user (optional)")
    __properties: ClassVar[List[str]] = ["courseid", "groupid", "userid"]
