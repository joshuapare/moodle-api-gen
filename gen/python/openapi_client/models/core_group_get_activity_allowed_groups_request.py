...
class CoreGroupGetActivityAllowedGroupsRequest(BaseModel):
    """
    CoreGroupGetActivityAllowedGroupsRequest
    """ # noqa: E501
    cmid: StrictInt = Field(description="course module id")
    userid: Optional[StrictInt] = Field(default=0, description="id of user, empty for current user")
    __properties: ClassVar[List[str]] = ["cmid", "userid"]
