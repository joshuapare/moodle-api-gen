...
class CoreBlogGetEntries200Response(BaseModel):
    """
    CoreBlogGetEntries200Response
    """ # noqa: E501
    entries: List[CoreBlogGetEntries200ResponseEntriesInner]
    totalentries: StrictInt = Field(description="The total number of entries found.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [CoreBlogGetEntries200ResponseEntriesInner.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
            "totalentries": obj.get("totalentries") if obj.get("totalentries") is not None else null,
