...
class LocalIomadLearningpathGetcoursesRequest(BaseModel):
    """
    LocalIomadLearningpathGetcoursesRequest
    """ # noqa: E501
    groupid: Optional[StrictInt] = Field(default=0, description="ID of Iomad Learning Path group (0 = return all)")
    pathid: StrictInt = Field(description="ID of Iomad Learning Path")
    __properties: ClassVar[List[str]] = ["groupid", "pathid"]
