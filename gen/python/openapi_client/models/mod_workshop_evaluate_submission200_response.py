...
class ModWorkshopEvaluateSubmission200Response(BaseModel):
    """
    ModWorkshopEvaluateSubmission200Response
    """ # noqa: E501
    status: StrictBool = Field(description="status: true if the submission was evaluated, false otherwise.")
