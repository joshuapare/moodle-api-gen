...
class CoreCalendarGetTimestamps200Response(BaseModel):
    """
    CoreCalendarGetTimestamps200Response
    """ # noqa: E501
    timestamps: List[CoreCalendarGetTimestamps200ResponseTimestampsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "timestamps": [CoreCalendarGetTimestamps200ResponseTimestampsInner.from_dict(_item) for _item in obj["timestamps"]] if obj.get("timestamps") is not None else None
        })
        return _obj
