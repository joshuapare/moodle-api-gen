...
class ModAssignGetUserMappings200ResponseAssignmentsInner(BaseModel):
    """
    ...
    mappings: Optional[List[ModAssignGetUserMappings200ResponseAssignmentsInnerMappingsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mappings": [ModAssignGetUserMappings200ResponseAssignmentsInnerMappingsInner.from_dict(_item) for _item in obj["mappings"]] if obj.get("mappings") is not None else None
        })
        return _obj
