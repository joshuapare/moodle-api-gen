...
class GradingformGuideGraderGradingpanelFetch200ResponseGrade(BaseModel):
    """
    GradingformGuideGraderGradingpanelFetch200ResponseGrade
    """ # noqa: E501
    comments: List[GradingformGuideGraderGradingpanelFetch200ResponseGradeCommentsInner]
    criterion: List[GradingformGuideGraderGradingpanelFetch200ResponseGradeCriterionInner]
    gradedby: StrictStr = Field(description="The assumed grader of this grading instance")
    hascomments: StrictBool = Field(description="Whether there are any frequently-used comments")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "comments": [GradingformGuideGraderGradingpanelFetch200ResponseGradeCommentsInner.from_dict(_item) for _item in obj["comments"]] if obj.get("comments") is not None else None,
            "criterion": [GradingformGuideGraderGradingpanelFetch200ResponseGradeCriterionInner.from_dict(_item) for _item in obj["criterion"]] if obj.get("criterion") is not None else None,
            "gradedby": obj.get("gradedby"),
            "hascomments": obj.get("hascomments") if obj.get("hascomments") is not None else False,
