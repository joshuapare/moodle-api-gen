...
class ModAssignGetSubmissionStatus200Response(BaseModel):
    """
    ModAssignGetSubmissionStatus200Response
    """ # noqa: E501
    assignmentdata: Optional[ModAssignGetSubmissionStatus200ResponseAssignmentdata] = None
    feedback: Optional[ModAssignGetSubmissionStatus200ResponseFeedback] = None
    gradingsummary: Optional[ModAssignGetSubmissionStatus200ResponseGradingsummary] = None
    lastattempt: Optional[ModAssignGetSubmissionStatus200ResponseLastattempt] = None
    previousattempts: Optional[List[ModAssignGetSubmissionStatus200ResponsePreviousattemptsInner]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.previousattempts:
            for _item in self.previousattempts:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assignmentdata": ModAssignGetSubmissionStatus200ResponseAssignmentdata.from_dict(obj["assignmentdata"]) if obj.get("assignmentdata") is not None else None,
            "feedback": ModAssignGetSubmissionStatus200ResponseFeedback.from_dict(obj["feedback"]) if obj.get("feedback") is not None else None,
            "gradingsummary": ModAssignGetSubmissionStatus200ResponseGradingsummary.from_dict(obj["gradingsummary"]) if obj.get("gradingsummary") is not None else None,
            "lastattempt": ModAssignGetSubmissionStatus200ResponseLastattempt.from_dict(obj["lastattempt"]) if obj.get("lastattempt") is not None else None,
            "previousattempts": [ModAssignGetSubmissionStatus200ResponsePreviousattemptsInner.from_dict(_item) for _item in obj["previousattempts"]] if obj.get("previousattempts") is not None else None,
