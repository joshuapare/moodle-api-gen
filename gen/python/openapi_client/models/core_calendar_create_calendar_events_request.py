...
class CoreCalendarCreateCalendarEventsRequest(BaseModel):
    """
    CoreCalendarCreateCalendarEventsRequest
    """ # noqa: E501
    events: List[CoreCalendarCreateCalendarEventsRequestEventsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [CoreCalendarCreateCalendarEventsRequestEventsInner.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
        return _obj
