...
class CoreMoodlenetSendActivity200Response(BaseModel):
    """
    CoreMoodlenetSendActivity200Response
    """ # noqa: E501
    resourceurl: StrictStr = Field(description="Resource URL from MoodleNet")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resourceurl": obj.get("resourceurl") if obj.get("resourceurl") is not None else 'null',
