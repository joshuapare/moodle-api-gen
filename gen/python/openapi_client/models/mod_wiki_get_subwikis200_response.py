...
class ModWikiGetSubwikis200Response(BaseModel):
    """
    ModWikiGetSubwikis200Response
    """ # noqa: E501
    subwikis: List[ModWikiGetSubwikis200ResponseSubwikisInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subwikis": [ModWikiGetSubwikis200ResponseSubwikisInner.from_dict(_item) for _item in obj["subwikis"]] if obj.get("subwikis") is not None else None,
