...
class CoreEnrolUnenrolUserEnrolment200ResponseErrorsInner(BaseModel):
    """
    CoreEnrolUnenrolUserEnrolment200ResponseErrorsInner
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default='null', description="The data that failed the validation")
    message: Optional[StrictStr] = Field(default='null', description="The error message")
