...
class CoreCourseGetUserNavigationOptions200ResponseCoursesInner(BaseModel):
    """
    CoreCourseGetUserNavigationOptions200ResponseCoursesInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Course id")
    options: Optional[List[CoreCourseGetUserNavigationOptions200ResponseCoursesInnerOptionsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "options": [CoreCourseGetUserNavigationOptions200ResponseCoursesInnerOptionsInner.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None
        })
        return _obj
