...
class CoreTableGetDynamicTableContentRequestFiltersInnerFilteroptionsInner(BaseModel):
    """
    CoreTableGetDynamicTableContentRequestFiltersInnerFilteroptionsInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default='null', description="Name of the filter option")
    value: Optional[StrictStr] = Field(default='null', description="Value of the filter option")
