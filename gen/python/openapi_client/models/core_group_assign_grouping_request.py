...
class CoreGroupAssignGroupingRequest(BaseModel):
    """
    CoreGroupAssignGroupingRequest
    """ # noqa: E501
    assignments: List[CoreGroupAssignGroupingRequestAssignmentsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assignments": [CoreGroupAssignGroupingRequestAssignmentsInner.from_dict(_item) for _item in obj["assignments"]] if obj.get("assignments") is not None else None
        })
        return _obj
