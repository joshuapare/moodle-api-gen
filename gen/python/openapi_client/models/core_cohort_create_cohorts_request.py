...
class CoreCohortCreateCohortsRequest(BaseModel):
    """
    CoreCohortCreateCohortsRequest
    """ # noqa: E501
    cohorts: List[CoreCohortCreateCohortsRequestCohortsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cohorts": [CoreCohortCreateCohortsRequestCohortsInner.from_dict(_item) for _item in obj["cohorts"]] if obj.get("cohorts") is not None else None
        })
        return _obj
