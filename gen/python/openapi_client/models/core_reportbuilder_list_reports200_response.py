...
class CoreReportbuilderListReports200Response(BaseModel):
    """
    CoreReportbuilderListReports200Response
    """ # noqa: E501
    reports: List[CoreReportbuilderListReports200ResponseReportsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reports": [CoreReportbuilderListReports200ResponseReportsInner.from_dict(_item) for _item in obj["reports"]] if obj.get("reports") is not None else None,
