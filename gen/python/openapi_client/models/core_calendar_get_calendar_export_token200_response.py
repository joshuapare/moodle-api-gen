...
class CoreCalendarGetCalendarExportToken200Response(BaseModel):
    """
    CoreCalendarGetCalendarExportToken200Response
    """ # noqa: E501
    token: StrictStr = Field(description="The calendar permanent access token for calendar export.")
