...
class CoreCourseDeleteCategoriesRequest(BaseModel):
    """
    CoreCourseDeleteCategoriesRequest
    """ # noqa: E501
    categories: List[CoreCourseDeleteCategoriesRequestCategoriesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "categories": [CoreCourseDeleteCategoriesRequestCategoriesInner.from_dict(_item) for _item in obj["categories"]] if obj.get("categories") is not None else None
        })
        return _obj
