...
class CoreTagGetTagCloud200Response(BaseModel):
    """
    CoreTagGetTagCloud200Response
    """ # noqa: E501
    tags: List[CoreTagGetTagCloud200ResponseTagsInner]
    tagscount: StrictInt = Field(description="Number of tags returned.")
    totalcount: StrictInt = Field(description="Total count of tags.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tags": [CoreTagGetTagCloud200ResponseTagsInner.from_dict(_item) for _item in obj["tags"]] if obj.get("tags") is not None else None,
            "tagscount": obj.get("tagscount") if obj.get("tagscount") is not None else null,
