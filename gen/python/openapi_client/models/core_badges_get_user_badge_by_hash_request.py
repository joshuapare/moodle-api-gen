...
class CoreBadgesGetUserBadgeByHashRequest(BaseModel):
    """
    CoreBadgesGetUserBadgeByHashRequest
    """ # noqa: E501
    hash: StrictStr = Field(description="Badge issued hash")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hash": obj.get("hash") if obj.get("hash") is not None else 'null'
        })
        return _obj
