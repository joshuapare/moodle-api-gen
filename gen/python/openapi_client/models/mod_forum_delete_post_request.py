...
class ModForumDeletePostRequest(BaseModel):
    """
    ModForumDeletePostRequest
    """ # noqa: E501
    postid: StrictInt = Field(description="Post to be deleted. It can be a discussion topic post.")
    __properties: ClassVar[List[str]] = ["postid"]
