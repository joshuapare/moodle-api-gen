...
class ModLessonFinishAttemptRequest(BaseModel):
    """
    ModLessonFinishAttemptRequest
    """ # noqa: E501
    lessonid: StrictInt = Field(description="Lesson instance id.")
    outoftime: Optional[StrictBool] = Field(default=False, description="If the user run out of time.")
    ...
    __properties: ClassVar[List[str]] = ["lessonid", "outoftime", "password", "review"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "outoftime": obj.get("outoftime") if obj.get("outoftime") is not None else False,
