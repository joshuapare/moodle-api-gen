...
class BlockIomadCompanyAdminDeleteLicensesRequest(BaseModel):
    """
    BlockIomadCompanyAdminDeleteLicensesRequest
    """ # noqa: E501
    licenses: List[BlockIomadCompanyAdminDeleteLicensesRequestLicensesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "licenses": [BlockIomadCompanyAdminDeleteLicensesRequestLicensesInner.from_dict(_item) for _item in obj["licenses"]] if obj.get("licenses") is not None else None
        })
        return _obj
