...
class ModIomadcertificateGetIssuedIomadcertificates200Response(BaseModel):
    """
    ModIomadcertificateGetIssuedIomadcertificates200Response
    """ # noqa: E501
    issues: List[ModIomadcertificateGetIssuedIomadcertificates200ResponseIssuesInner]
    warnings: Optional[List[AuthEmailSignupUser200ResponseWarningsInner]] = None
    __properties: ClassVar[List[str]] = ["issues", "warnings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "issues": [ModIomadcertificateGetIssuedIomadcertificates200ResponseIssuesInner.from_dict(_item) for _item in obj["issues"]] if obj.get("issues") is not None else None,
