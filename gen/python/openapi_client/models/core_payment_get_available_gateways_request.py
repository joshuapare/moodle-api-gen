...
class CorePaymentGetAvailableGatewaysRequest(BaseModel):
    """
    CorePaymentGetAvailableGatewaysRequest
    """ # noqa: E501
    component: StrictStr = Field(description="Component")
    itemid: StrictInt = Field(description="An identifier for payment area in the component")
    paymentarea: StrictStr = Field(description="Payment area in the component")
    __properties: ClassVar[List[str]] = ["component", "itemid", "paymentarea"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "paymentarea": obj.get("paymentarea") if obj.get("paymentarea") is not None else 'null'
        })
        return _obj
