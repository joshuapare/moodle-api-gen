...
class ToolMoodlenetSearchCourses200ResponseCoursesInner(BaseModel):
    """
    ToolMoodlenetSearchCourses200ResponseCoursesInner
    """ # noqa: E501
    coursecategory: Optional[StrictStr] = Field(default='null', description="Category name")
    ...
    hidden: Optional[StrictInt] = Field(default=null, description="is the course visible")
    id: Optional[StrictInt] = Field(default=None, description="course id")
    viewurl: Optional[StrictStr] = Field(default='null', description="Next step of import")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hidden": obj.get("hidden") if obj.get("hidden") is not None else null,
            "id": obj.get("id"),
