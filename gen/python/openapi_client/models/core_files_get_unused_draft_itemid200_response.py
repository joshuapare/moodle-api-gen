...
class CoreFilesGetUnusedDraftItemid200Response(BaseModel):
    """
    CoreFilesGetUnusedDraftItemid200Response
    """ # noqa: E501
    component: StrictStr = Field(description="File area component.")
    contextid: StrictInt = Field(description="File area context.")
    filearea: StrictStr = Field(description="File area name.")
    itemid: StrictInt = Field(description="File are item id.")
    userid: StrictInt = Field(description="File area user id.")
