...
class ModAssignGetSubmissionStatus200ResponseLastattemptSubmissionPluginsInnerEditorfieldsInner(BaseModel):
    """
    ...
    text: Optional[StrictStr] = Field(default=None, description="field value")
