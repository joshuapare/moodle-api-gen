...
class GradereportSingleviewGetGradeItemsForSearchWidget200Response(BaseModel):
    """
    GradereportSingleviewGetGradeItemsForSearchWidget200Response
    """ # noqa: E501
    gradeitems: List[GradereportSingleviewGetGradeItemsForSearchWidget200ResponseGradeitemsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "gradeitems": [GradereportSingleviewGetGradeItemsForSearchWidget200ResponseGradeitemsInner.from_dict(_item) for _item in obj["gradeitems"]] if obj.get("gradeitems") is not None else None,
