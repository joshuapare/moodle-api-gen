...
class ToolMobileGetPublicConfig200ResponseIdentityprovidersInner(BaseModel):
    """
    ToolMobileGetPublicConfig200ResponseIdentityprovidersInner
    """ # noqa: E501
    iconurl: Optional[StrictStr] = Field(default='null', description="The icon URL for the provider.")
    name: Optional[StrictStr] = Field(default='null', description="The identity provider name.")
    url: Optional[StrictStr] = Field(default='null', description="The URL of the provider.")
