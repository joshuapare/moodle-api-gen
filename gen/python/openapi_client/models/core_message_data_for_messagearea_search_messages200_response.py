...
class CoreMessageDataForMessageareaSearchMessages200Response(BaseModel):
    """
    CoreMessageDataForMessageareaSearchMessages200Response
    """ # noqa: E501
    contacts: List[CoreMessageDataForMessageareaSearchMessages200ResponseContactsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contacts": [CoreMessageDataForMessageareaSearchMessages200ResponseContactsInner.from_dict(_item) for _item in obj["contacts"]] if obj.get("contacts") is not None else None
        })
        return _obj
