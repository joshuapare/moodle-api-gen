...
class ModWorkshopAddSubmission200Response(BaseModel):
    """
    ModWorkshopAddSubmission200Response
    """ # noqa: E501
    status: StrictBool = Field(description="True if the submission was created false otherwise.")
    submissionid: Optional[StrictInt] = Field(default=null, description="New workshop submission id.")
