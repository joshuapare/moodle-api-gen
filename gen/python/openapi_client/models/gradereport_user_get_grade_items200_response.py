...
class GradereportUserGetGradeItems200Response(BaseModel):
    """
    GradereportUserGetGradeItems200Response
    """ # noqa: E501
    usergrades: List[GradereportUserGetGradeItems200ResponseUsergradesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "usergrades": [GradereportUserGetGradeItems200ResponseUsergradesInner.from_dict(_item) for _item in obj["usergrades"]] if obj.get("usergrades") is not None else None,
