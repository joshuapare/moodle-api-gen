...
class ModGlossaryGetCategories200ResponseCategoriesInner(BaseModel):
    """
    ...
    id: Optional[StrictInt] = Field(default=null, description="The category ID")
    name: Optional[StrictStr] = Field(default='null', description="The name of the category")
    usedynalink: Optional[StrictBool] = Field(default=False, description="Whether the category is automatically linked")
