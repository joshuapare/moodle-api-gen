...
class CoreGroupGetActivityAllowedGroups200ResponseGroupsInner(BaseModel):
    """
    ...
    id: Optional[StrictInt] = Field(default=None, description="group record id")
    idnumber: Optional[StrictStr] = Field(default=None, description="id number")
    name: Optional[StrictStr] = Field(default='null', description="group name")
