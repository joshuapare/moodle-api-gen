...
class CoreBlockGetDashboardBlocks200ResponseBlocksInnerConfigsInner(BaseModel):
    """
    CoreBlockGetDashboardBlocks200ResponseBlocksInnerConfigsInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name.")
    type: Optional[StrictStr] = Field(default=None, description="Type (instance or plugin).")
    value: Optional[StrictStr] = Field(default=None, description="JSON encoded representation of the config value.")
