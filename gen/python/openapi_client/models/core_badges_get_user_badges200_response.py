...
class CoreBadgesGetUserBadges200Response(BaseModel):
    """
    CoreBadgesGetUserBadges200Response
    """ # noqa: E501
    badges: List[CoreBadgesGetUserBadges200ResponseBadgesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "badges": [CoreBadgesGetUserBadges200ResponseBadgesInner.from_dict(_item) for _item in obj["badges"]] if obj.get("badges") is not None else None,
