...
class ModLessonGetQuestionsAttempts200Response(BaseModel):
    """
    ModLessonGetQuestionsAttempts200Response
    """ # noqa: E501
    attempts: List[ModLessonGetQuestionsAttempts200ResponseAttemptsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attempts": [ModLessonGetQuestionsAttempts200ResponseAttemptsInner.from_dict(_item) for _item in obj["attempts"]] if obj.get("attempts") is not None else None,
