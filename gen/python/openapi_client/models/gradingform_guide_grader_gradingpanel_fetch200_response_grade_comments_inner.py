...
class GradingformGuideGraderGradingpanelFetch200ResponseGradeCommentsInner(BaseModel):
    """
    GradingformGuideGraderGradingpanelFetch200ResponseGradeCommentsInner
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default='null', description="The comment value")
    id: Optional[StrictInt] = Field(default=null, description="Comment id")
    sortorder: Optional[StrictInt] = Field(default=null, description="The sortorder of this comment")
