...
class ModLessonGetUserAttempt200Response(BaseModel):
    """
    ModLessonGetUserAttempt200Response
    """ # noqa: E501
    answerpages: List[ModLessonGetUserAttempt200ResponseAnswerpagesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "answerpages": [ModLessonGetUserAttempt200ResponseAnswerpagesInner.from_dict(_item) for _item in obj["answerpages"]] if obj.get("answerpages") is not None else None,
            "userstats": ModLessonGetUserAttempt200ResponseUserstats.from_dict(obj["userstats"]) if obj.get("userstats") is not None else None,
