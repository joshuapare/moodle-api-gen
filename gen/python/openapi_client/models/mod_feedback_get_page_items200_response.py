...
class ModFeedbackGetPageItems200Response(BaseModel):
    """
    ModFeedbackGetPageItems200Response
    """ # noqa: E501
    hasnextpage: StrictBool = Field(description="Whether there are more pages.")
    hasprevpage: StrictBool = Field(description="Whether is a previous page.")
    items: List[ModFeedbackGetItems200ResponseItemsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hasnextpage": obj.get("hasnextpage") if obj.get("hasnextpage") is not None else False,
            "hasprevpage": obj.get("hasprevpage") if obj.get("hasprevpage") is not None else False,
            "items": [ModFeedbackGetItems200ResponseItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
