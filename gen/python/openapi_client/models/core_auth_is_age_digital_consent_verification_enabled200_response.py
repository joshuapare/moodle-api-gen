...
class CoreAuthIsAgeDigitalConsentVerificationEnabled200Response(BaseModel):
    """
    CoreAuthIsAgeDigitalConsentVerificationEnabled200Response
    """ # noqa: E501
    status: StrictBool = Field(description="True if digital consent verification is enabled,                     false otherwise.")
