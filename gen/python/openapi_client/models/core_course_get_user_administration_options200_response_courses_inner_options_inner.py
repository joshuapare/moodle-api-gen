...
class CoreCourseGetUserAdministrationOptions200ResponseCoursesInnerOptionsInner(BaseModel):
    """
    CoreCourseGetUserAdministrationOptions200ResponseCoursesInnerOptionsInner
    """ # noqa: E501
    available: Optional[StrictBool] = Field(default=False, description="Whether the option is available or not")
    name: Optional[StrictStr] = Field(default='null', description="Option name")
