...
class CoreGroupUpdateGroupsRequest(BaseModel):
    """
    CoreGroupUpdateGroupsRequest
    """ # noqa: E501
    groups: List[CoreGroupUpdateGroupsRequestGroupsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [CoreGroupUpdateGroupsRequestGroupsInner.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None
        })
        return _obj
