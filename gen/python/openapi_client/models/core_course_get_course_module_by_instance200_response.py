...
class CoreCourseGetCourseModuleByInstance200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cm": CoreCourseGetCourseModuleByInstance200ResponseCm.from_dict(obj["cm"]) if obj.get("cm") is not None else None,
