...
class CoreCommentAddCommentsRequest(BaseModel):
    """
    CoreCommentAddCommentsRequest
    """ # noqa: E501
    comments: List[CoreCommentAddCommentsRequestCommentsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "comments": [CoreCommentAddCommentsRequestCommentsInner.from_dict(_item) for _item in obj["comments"]] if obj.get("comments") is not None else None
        })
        return _obj
