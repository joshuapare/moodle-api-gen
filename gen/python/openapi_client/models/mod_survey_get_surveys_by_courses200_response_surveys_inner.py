...
class ModSurveyGetSurveysByCourses200ResponseSurveysInner(BaseModel):
    """
    Surveys
    """ # noqa: E501
    ...
    days: Optional[StrictInt] = Field(default=null, description="Days")
    ...
    questions: Optional[StrictStr] = Field(default='null', description="Question ids")
    section: Optional[StrictInt] = Field(default=None, description="Course section id")
    surveydone: Optional[StrictInt] = Field(default=null, description="Did I finish the survey?")
    template: Optional[StrictInt] = Field(default=null, description="Survey type")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "days": obj.get("days") if obj.get("days") is not None else null,
            ...
            "lang": obj.get("lang"),
            "name": obj.get("name"),
            "questions": obj.get("questions") if obj.get("questions") is not None else 'null',
            "section": obj.get("section"),
            "surveydone": obj.get("surveydone") if obj.get("surveydone") is not None else null,
