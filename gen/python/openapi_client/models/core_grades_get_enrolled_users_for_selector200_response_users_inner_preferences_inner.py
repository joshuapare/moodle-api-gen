...
class CoreGradesGetEnrolledUsersForSelector200ResponseUsersInnerPreferencesInner(BaseModel):
    """
    CoreGradesGetEnrolledUsersForSelector200ResponseUsersInnerPreferencesInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default='null', description="The name of the preferences")
    value: Optional[StrictStr] = Field(default='null', description="The value of the preference")
