...
class ModScormGetScormUserData200ResponseDataInnerDefaultdataInner(BaseModel):
    """
    ModScormGetScormUserData200ResponseDataInnerDefaultdataInner
    """ # noqa: E501
    element: Optional[StrictStr] = Field(default=None, description="element name")
    value: Optional[StrictStr] = Field(default=None, description="element value")
