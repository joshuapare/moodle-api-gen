...
class CoreReportbuilderRetrieveSystemReport200ResponseData(BaseModel):
    """
    CoreReportbuilderRetrieveSystemReport200ResponseData
    """ # noqa: E501
    headers: List[Dict[str, Any]]
    rows: List[CoreReportbuilderRetrieveSystemReport200ResponseDataRowsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rows": [CoreReportbuilderRetrieveSystemReport200ResponseDataRowsInner.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None,
