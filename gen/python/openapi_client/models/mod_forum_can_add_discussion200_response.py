...
class ModForumCanAddDiscussion200Response(BaseModel):
    """
    ModForumCanAddDiscussion200Response
    """ # noqa: E501
    cancreateattachment: Optional[StrictBool] = Field(default=False, description="True if the user can add attachments, false otherwise.")
    canpindiscussions: Optional[StrictBool] = Field(default=False, description="True if the user can pin discussions, false otherwise.")
    status: StrictBool = Field(description="True if the user can add discussions, false otherwise.")
