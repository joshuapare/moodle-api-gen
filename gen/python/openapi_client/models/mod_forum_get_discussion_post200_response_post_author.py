...
class ModForumGetDiscussionPost200ResponsePostAuthor(BaseModel):
    """
    ModForumGetDiscussionPost200ResponsePostAuthor
    """ # noqa: E501
    fullname: Optional[StrictStr] = Field(default=None, description="fullname")
    groups: Optional[List[ModForumGetDiscussionPost200ResponsePostAuthorGroupsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "groups": [ModForumGetDiscussionPost200ResponsePostAuthorGroupsInner.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,
            "id": obj.get("id"),
            "isdeleted": obj.get("isdeleted"),
            "urls": ModForumGetDiscussionPost200ResponsePostAuthorUrls.from_dict(obj["urls"]) if obj.get("urls") is not None else None
        })
        return _obj
