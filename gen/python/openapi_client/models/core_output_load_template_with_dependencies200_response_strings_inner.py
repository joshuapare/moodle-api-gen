...
class CoreOutputLoadTemplateWithDependencies200ResponseStringsInner(BaseModel):
    """
    CoreOutputLoadTemplateWithDependencies200ResponseStringsInner
    """ # noqa: E501
    component: Optional[StrictStr] = Field(default='null', description="component containing the resource")
    name: Optional[StrictStr] = Field(default='null', description="name of the resource")
    value: Optional[StrictStr] = Field(default='null', description="resource value")
