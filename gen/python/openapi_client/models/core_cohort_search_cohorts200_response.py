...
class CoreCohortSearchCohorts200Response(BaseModel):
    """
    CoreCohortSearchCohorts200Response
    """ # noqa: E501
    cohorts: List[CoreCohortSearchCohorts200ResponseCohortsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cohorts": [CoreCohortSearchCohorts200ResponseCohortsInner.from_dict(_item) for _item in obj["cohorts"]] if obj.get("cohorts") is not None else None
        })
        return _obj
