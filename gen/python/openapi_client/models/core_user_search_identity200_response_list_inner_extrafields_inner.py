...
class CoreUserSearchIdentity200ResponseListInnerExtrafieldsInner(BaseModel):
    """
    CoreUserSearchIdentity200ResponseListInnerExtrafieldsInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default='null', description="Name of the extrafield.")
    value: Optional[StrictStr] = Field(default='null', description="Value of the extrafield.")
