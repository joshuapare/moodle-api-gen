...
class ModForumGetForumDiscussionsPaginated200Response(BaseModel):
    """
    ModForumGetForumDiscussionsPaginated200Response
    """ # noqa: E501
    discussions: List[ModForumGetForumDiscussionsPaginated200ResponseDiscussionsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "discussions": [ModForumGetForumDiscussionsPaginated200ResponseDiscussionsInner.from_dict(_item) for _item in obj["discussions"]] if obj.get("discussions") is not None else None,
