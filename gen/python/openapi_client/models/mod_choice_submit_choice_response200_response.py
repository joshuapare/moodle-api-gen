...
class ModChoiceSubmitChoiceResponse200Response(BaseModel):
    """
    ModChoiceSubmitChoiceResponse200Response
    """ # noqa: E501
    answers: List[ModChoiceSubmitChoiceResponse200ResponseAnswersInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "answers": [ModChoiceSubmitChoiceResponse200ResponseAnswersInner.from_dict(_item) for _item in obj["answers"]] if obj.get("answers") is not None else None,
