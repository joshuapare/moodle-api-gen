...
class GradereportOverviewGetCourseGrades200ResponseGradesInner(BaseModel):
    """
    ...
    grade: Optional[StrictStr] = Field(default='null', description="Grade formatted")
    rank: Optional[StrictInt] = Field(default=null, description="Your rank in the course")
    rawgrade: Optional[StrictStr] = Field(default='null', description="Raw grade, not formatted")
