...
class CoreGradingGetGradingformInstances200ResponseInstancesInnerGuide(BaseModel):
    """
    CoreGradingGetGradingformInstances200ResponseInstancesInnerGuide
    """ # noqa: E501
    criteria: Optional[List[CoreGradingGetGradingformInstances200ResponseInstancesInnerGuideCriteriaInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "criteria": [CoreGradingGetGradingformInstances200ResponseInstancesInnerGuideCriteriaInner.from_dict(_item) for _item in obj["criteria"]] if obj.get("criteria") is not None else None
        })
        return _obj
