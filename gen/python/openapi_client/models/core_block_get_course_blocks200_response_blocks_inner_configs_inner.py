...
class CoreBlockGetCourseBlocks200ResponseBlocksInnerConfigsInner(BaseModel):
    """
    CoreBlockGetCourseBlocks200ResponseBlocksInnerConfigsInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default='null', description="Name.")
    type: Optional[StrictStr] = Field(default='null', description="Type (instance or plugin).")
    value: Optional[StrictStr] = Field(default='null', description="JSON encoded representation of the config value.")
