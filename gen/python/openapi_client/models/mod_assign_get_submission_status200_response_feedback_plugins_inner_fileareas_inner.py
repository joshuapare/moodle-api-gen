...
class ModAssignGetSubmissionStatus200ResponseFeedbackPluginsInnerFileareasInner(BaseModel):
    """
    ModAssignGetSubmissionStatus200ResponseFeedbackPluginsInnerFileareasInner
    """ # noqa: E501
    area: Optional[StrictStr] = Field(default=None, description="file area")
