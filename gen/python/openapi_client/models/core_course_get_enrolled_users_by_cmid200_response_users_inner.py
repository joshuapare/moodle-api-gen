...
class CoreCourseGetEnrolledUsersByCmid200ResponseUsersInner(BaseModel):
    """
    ...
    fullname: Optional[StrictStr] = Field(default='null', description="The full name of the user")
    id: Optional[StrictInt] = Field(default=null, description="ID of the user")
    lastname: Optional[StrictStr] = Field(default=None, description="The family name of the user")
    profileimage: Optional[StrictStr] = Field(default='null', description="The location of the users larger image")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "profileimage": obj.get("profileimage") if obj.get("profileimage") is not None else 'null'
        })
        return _obj
