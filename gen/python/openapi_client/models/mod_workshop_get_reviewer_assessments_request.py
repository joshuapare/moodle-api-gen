...
class ModWorkshopGetReviewerAssessmentsRequest(BaseModel):
    """
    ModWorkshopGetReviewerAssessmentsRequest
    """ # noqa: E501
    userid: Optional[StrictInt] = Field(default=0, description="User id who did the assessment review (empty or 0 for current user).")
