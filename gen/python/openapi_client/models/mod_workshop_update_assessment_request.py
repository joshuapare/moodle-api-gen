...
class ModWorkshopUpdateAssessmentRequest(BaseModel):
    """
    ModWorkshopUpdateAssessmentRequest
    """ # noqa: E501
    assessmentid: StrictInt = Field(description="Assessment id.")
    data: List[ModWorkshopUpdateAssessmentRequestDataInner]
    __properties: ClassVar[List[str]] = ["assessmentid", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [ModWorkshopUpdateAssessmentRequestDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
