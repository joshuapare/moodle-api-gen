...
class CoreCourseUpdateCoursesRequestCoursesInnerCourseformatoptionsInner(BaseModel):
    """
    CoreCourseUpdateCoursesRequestCoursesInnerCourseformatoptionsInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="course format option name")
    value: Optional[StrictStr] = Field(default=None, description="course format option value")
