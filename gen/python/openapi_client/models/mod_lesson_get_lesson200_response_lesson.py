...
class ModLessonGetLesson200ResponseLesson(BaseModel):
    """
    ModLessonGetLesson200ResponseLesson
    """ # noqa: E501
    activitylink: Optional[StrictInt] = Field(default=null, description="Id of the next activity to be linked once the lesson is completed")
    allowofflineattempts: StrictBool = Field(description="Whether to allow the lesson to be attempted offline in the mobile app")
    available: Optional[StrictInt] = Field(default=null, description="Available from")
    bgcolor: Optional[StrictStr] = Field(default='null', description="Slideshow bgcolor")
    completionendreached: Optional[StrictInt] = Field(default=null, description="Require end reached for completion?")
    completiontimespent: Optional[StrictInt] = Field(default=null, description="Student must do this activity at least for")
    conditions: Optional[StrictStr] = Field(default='null', description="Conditions to enable the lesson")
    ...
    deadline: Optional[StrictInt] = Field(default=null, description="Available until")
    dependency: Optional[StrictInt] = Field(default=null, description="Dependent on (another lesson id)")
    displayleft: Optional[StrictBool] = Field(default=False, description="Display left pages menu?")
    displayleftif: Optional[StrictInt] = Field(default=null, description="Minimum grade to display menu")
    feedback: Optional[StrictBool] = Field(default=False, description="Display default feedback")
    grade: Optional[StrictInt] = Field(default=null, description="The total that the grade is scaled to be out of")
    height: Optional[StrictInt] = Field(default=null, description="Slideshow height")
    id: StrictInt = Field(description="Standard Moodle primary key.")
    intro: Optional[StrictStr] = Field(default='null', description="Lesson introduction text.")
    ...
    lang: StrictStr = Field(description="Forced activity language")
    maxanswers: Optional[StrictInt] = Field(default=null, description="Maximum answers per page")
    maxattempts: Optional[StrictInt] = Field(default=null, description="Maximum attempts")
    maxpages: Optional[StrictInt] = Field(default=null, description="Number of pages to show")
    mediaclose: Optional[StrictInt] = Field(default=null, description="Display a close button in the popup?")
    mediafile: Optional[StrictStr] = Field(default='null', description="Local file path or full external URL")
    mediafiles: Optional[List[CoreBlogGetEntries200ResponseEntriesInnerSummaryfilesInner]] = None
    mediaheight: Optional[StrictInt] = Field(default=null, description="Popup for media file height")
    mediawidth: Optional[StrictInt] = Field(default=null, description="Popup for media with")
    minquestions: Optional[StrictInt] = Field(default=null, description="Minimum number of questions")
    ...
    nextpagedefault: Optional[StrictInt] = Field(default=null, description="Action for a correct answer")
    ongoing: Optional[StrictBool] = Field(default=False, description="Display ongoing score?")
    password: Optional[StrictStr] = Field(default='null', description="Password")
    ...
    timelimit: Optional[StrictInt] = Field(default=null, description="Time limit")
    timemodified: Optional[StrictInt] = Field(default=null, description="Last time settings were updated")
    usemaxgrade: Optional[StrictInt] = Field(default=null, description="How to calculate the final grade")
    usepassword: Optional[StrictBool] = Field(default=False, description="Password protected lesson?")
    width: Optional[StrictInt] = Field(default=null, description="Slideshow width")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activitylink": obj.get("activitylink") if obj.get("activitylink") is not None else null,
            "allowofflineattempts": obj.get("allowofflineattempts") if obj.get("allowofflineattempts") is not None else False,
            "available": obj.get("available") if obj.get("available") is not None else null,
            "bgcolor": obj.get("bgcolor") if obj.get("bgcolor") is not None else 'null',
            "completionendreached": obj.get("completionendreached") if obj.get("completionendreached") is not None else null,
            "completiontimespent": obj.get("completiontimespent") if obj.get("completiontimespent") is not None else null,
            "conditions": obj.get("conditions") if obj.get("conditions") is not None else 'null',
            ...
            "deadline": obj.get("deadline") if obj.get("deadline") is not None else null,
            "dependency": obj.get("dependency") if obj.get("dependency") is not None else null,
            "displayleft": obj.get("displayleft") if obj.get("displayleft") is not None else False,
            "displayleftif": obj.get("displayleftif") if obj.get("displayleftif") is not None else null,
            ...
            "lang": obj.get("lang"),
            "maxanswers": obj.get("maxanswers") if obj.get("maxanswers") is not None else null,
            "maxattempts": obj.get("maxattempts") if obj.get("maxattempts") is not None else null,
            "maxpages": obj.get("maxpages") if obj.get("maxpages") is not None else null,
            "mediaclose": obj.get("mediaclose") if obj.get("mediaclose") is not None else null,
            "mediafile": obj.get("mediafile") if obj.get("mediafile") is not None else 'null',
            ...
            "mediaheight": obj.get("mediaheight") if obj.get("mediaheight") is not None else null,
            "mediawidth": obj.get("mediawidth") if obj.get("mediawidth") is not None else null,
            "minquestions": obj.get("minquestions") if obj.get("minquestions") is not None else null,
            ...
            "nextpagedefault": obj.get("nextpagedefault") if obj.get("nextpagedefault") is not None else null,
            ...
            "usemaxgrade": obj.get("usemaxgrade") if obj.get("usemaxgrade") is not None else null,
