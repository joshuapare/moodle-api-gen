...
class ModAssignGetAssignments200Response(BaseModel):
    """
    ModAssignGetAssignments200Response
    """ # noqa: E501
    courses: List[ModAssignGetAssignments200ResponseCoursesInner]
    warnings: Optional[List[ModAssignGetAssignments200ResponseWarningsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "courses": [ModAssignGetAssignments200ResponseCoursesInner.from_dict(_item) for _item in obj["courses"]] if obj.get("courses") is not None else None,
            "warnings": [ModAssignGetAssignments200ResponseWarningsInner.from_dict(_item) for _item in obj["warnings"]] if obj.get("warnings") is not None else None
        })
        return _obj
