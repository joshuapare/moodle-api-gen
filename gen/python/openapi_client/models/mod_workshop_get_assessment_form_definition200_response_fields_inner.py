...
class ModWorkshopGetAssessmentFormDefinition200ResponseFieldsInner(BaseModel):
    """
    ...
    value: Optional[StrictStr] = Field(default='null', description="Field default value.")
