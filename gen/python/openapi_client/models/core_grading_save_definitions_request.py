...
class CoreGradingSaveDefinitionsRequest(BaseModel):
    """
    CoreGradingSaveDefinitionsRequest
    """ # noqa: E501
    areas: List[CoreGradingSaveDefinitionsRequestAreasInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "areas": [CoreGradingSaveDefinitionsRequestAreasInner.from_dict(_item) for _item in obj["areas"]] if obj.get("areas") is not None else None
        })
        return _obj
