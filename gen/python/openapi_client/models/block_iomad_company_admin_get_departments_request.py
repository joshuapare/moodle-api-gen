...
class BlockIomadCompanyAdminGetDepartmentsRequest(BaseModel):
    """
    BlockIomadCompanyAdminGetDepartmentsRequest
    """ # noqa: E501
    criteria: List[BlockIomadCompanyAdminGetDepartmentsRequestCriteriaInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "criteria": [BlockIomadCompanyAdminGetDepartmentsRequestCriteriaInner.from_dict(_item) for _item in obj["criteria"]] if obj.get("criteria") is not None else None
        })
        return _obj
