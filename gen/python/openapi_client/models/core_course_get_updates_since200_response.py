...
class CoreCourseGetUpdatesSince200Response(BaseModel):
    """
    CoreCourseGetUpdatesSince200Response
    """ # noqa: E501
    instances: List[CoreCourseGetUpdatesSince200ResponseInstancesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "instances": [CoreCourseGetUpdatesSince200ResponseInstancesInner.from_dict(_item) for _item in obj["instances"]] if obj.get("instances") is not None else None,
