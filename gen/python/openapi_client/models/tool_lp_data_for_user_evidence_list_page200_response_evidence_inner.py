...
class ToolLpDataForUserEvidenceListPage200ResponseEvidenceInner(BaseModel):
    """
    ...
    competencycount: Optional[StrictInt] = Field(default=None, description="competencycount")
    ...
    filecount: Optional[StrictInt] = Field(default=None, description="filecount")
    files: Optional[List[ModFeedbackGetAnalysis200ResponseItemsdataInnerItemItemfilesInner]] = None
    hasurlorfiles: Optional[StrictBool] = Field(default=None, description="hasurlorfiles")
    ...
    urlshort: Optional[StrictStr] = Field(default=None, description="urlshort")
    usercompetencies: Optional[List[ToolLpDataForUserEvidenceListPage200ResponseEvidenceInnerUsercompetenciesInner]] = None
    userhasplan: Optional[StrictBool] = Field(default=False, description="userhasplan")
