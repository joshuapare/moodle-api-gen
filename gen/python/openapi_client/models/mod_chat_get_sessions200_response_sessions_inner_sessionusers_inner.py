...
class ModChatGetSessions200ResponseSessionsInnerSessionusersInner(BaseModel):
    """
    ModChatGetSessions200ResponseSessionsInnerSessionusersInner
    """ # noqa: E501
    messagecount: Optional[StrictInt] = Field(default=null, description="Number of messages in the session.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "messagecount": obj.get("messagecount") if obj.get("messagecount") is not None else null,
