...
class CoreCourseGetCourseModuleByInstance200ResponseCmAdvancedgradingInner(BaseModel):
    """
    CoreCourseGetCourseModuleByInstance200ResponseCmAdvancedgradingInner
    """ # noqa: E501
    area: Optional[StrictStr] = Field(default=None, description="Gradable area name")
    method: Optional[StrictStr] = Field(default=None, description="Grading method")
