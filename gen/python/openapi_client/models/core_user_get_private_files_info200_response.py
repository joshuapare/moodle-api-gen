...
class CoreUserGetPrivateFilesInfo200Response(BaseModel):
    """
    CoreUserGetPrivateFilesInfo200Response
    """ # noqa: E501
    filecount: StrictInt = Field(description="Number of files in the area.")
    filesize: StrictInt = Field(description="Total size of the files in the area.")
    filesizewithoutreferences: StrictInt = Field(description="Total size of the area excluding file references")
    foldercount: StrictInt = Field(description="Number of folders in the area.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filesizewithoutreferences": obj.get("filesizewithoutreferences") if obj.get("filesizewithoutreferences") is not None else null,
            "foldercount": obj.get("foldercount") if obj.get("foldercount") is not None else null,
