...
class ModDataGetEntry200ResponseRatinginfoScalesInnerItemsInner(BaseModel):
    """
    ModDataGetEntry200ResponseRatinginfoScalesInnerItemsInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default='null', description="Scale name.")
    value: Optional[StrictInt] = Field(default=null, description="Scale value/option id.")
