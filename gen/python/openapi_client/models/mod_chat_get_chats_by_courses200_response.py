...
class ModChatGetChatsByCourses200Response(BaseModel):
    """
    ModChatGetChatsByCourses200Response
    """ # noqa: E501
    chats: List[ModChatGetChatsByCourses200ResponseChatsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chats": [ModChatGetChatsByCourses200ResponseChatsInner.from_dict(_item) for _item in obj["chats"]] if obj.get("chats") is not None else None,
