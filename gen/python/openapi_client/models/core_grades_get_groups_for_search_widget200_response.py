...
class CoreGradesGetGroupsForSearchWidget200Response(BaseModel):
    """
    CoreGradesGetGroupsForSearchWidget200Response
    """ # noqa: E501
    groups: List[CoreGradesGetGroupsForSearchWidget200ResponseGroupsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [CoreGradesGetGroupsForSearchWidget200ResponseGroupsInner.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,
