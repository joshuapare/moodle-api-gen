...
class ModGlossaryPrepareEntryForEdition200Response(BaseModel):
    """
    ModGlossaryPrepareEntryForEdition200Response
    """ # noqa: E501
    aliases: List[Dict[str, Any]]
    areas: List[ModGlossaryPrepareEntryForEdition200ResponseAreasInner]
    attachmentsid: StrictInt = Field(description="Draft item id for the file manager.")
    categories: List[Dict[str, Any]]
    inlineattachmentsid: StrictInt = Field(description="Draft item id for the text editor.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "areas": [ModGlossaryPrepareEntryForEdition200ResponseAreasInner.from_dict(_item) for _item in obj["areas"]] if obj.get("areas") is not None else None,
            "attachmentsid": obj.get("attachmentsid") if obj.get("attachmentsid") is not None else null,
            "categories": obj.get("categories"),
            "inlineattachmentsid": obj.get("inlineattachmentsid") if obj.get("inlineattachmentsid") is not None else null,
