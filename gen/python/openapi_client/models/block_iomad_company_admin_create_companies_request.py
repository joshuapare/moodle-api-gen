...
class BlockIomadCompanyAdminCreateCompaniesRequest(BaseModel):
    """
    BlockIomadCompanyAdminCreateCompaniesRequest
    """ # noqa: E501
    companies: List[BlockIomadCompanyAdminCreateCompaniesRequestCompaniesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "companies": [BlockIomadCompanyAdminCreateCompaniesRequestCompaniesInner.from_dict(_item) for _item in obj["companies"]] if obj.get("companies") is not None else None
        })
        return _obj
