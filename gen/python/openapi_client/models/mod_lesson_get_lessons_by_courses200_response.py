...
class ModLessonGetLessonsByCourses200Response(BaseModel):
    """
    ModLessonGetLessonsByCourses200Response
    """ # noqa: E501
    lessons: List[ModLessonGetLessonsByCourses200ResponseLessonsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lessons": [ModLessonGetLessonsByCourses200ResponseLessonsInner.from_dict(_item) for _item in obj["lessons"]] if obj.get("lessons") is not None else None,
