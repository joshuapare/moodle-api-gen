...
class ModLtiGetToolLaunchData200Response(BaseModel):
    """
    ModLtiGetToolLaunchData200Response
    """ # noqa: E501
    endpoint: StrictStr = Field(description="Endpoint URL")
    parameters: List[ModLtiGetToolLaunchData200ResponseParametersInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "endpoint": obj.get("endpoint") if obj.get("endpoint") is not None else 'null',
            "parameters": [ModLtiGetToolLaunchData200ResponseParametersInner.from_dict(_item) for _item in obj["parameters"]] if obj.get("parameters") is not None else None,
