...
class ModDataSearchEntriesRequestAdvsearchInner(BaseModel):
    """
    ModDataSearchEntriesRequestAdvsearchInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default='null', description="Field key for search.                                                             Use fn or ln for first or last name")
    value: Optional[StrictStr] = Field(default='null', description="JSON encoded value for search")
