...
class CoreMessageGetUserMessagePreferences200ResponsePreferencesComponentsInnerNotificationsInnerProcessorsInnerLoggedin(BaseModel):
    """
    CoreMessageGetUserMessagePreferences200ResponsePreferencesComponentsInnerNotificationsInnerProcessorsInnerLoggedin
    """ # noqa: E501
    checked: StrictBool = Field(description="Is checked?")
    displayname: StrictStr = Field(description="Display name")
    name: StrictStr = Field(description="Name")
    __properties: ClassVar[List[str]] = ["checked", "displayname", "name"]
