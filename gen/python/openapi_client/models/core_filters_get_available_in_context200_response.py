...
class CoreFiltersGetAvailableInContext200Response(BaseModel):
    """
    CoreFiltersGetAvailableInContext200Response
    """ # noqa: E501
    filters: List[CoreFiltersGetAvailableInContext200ResponseFiltersInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filters": [CoreFiltersGetAvailableInContext200ResponseFiltersInner.from_dict(_item) for _item in obj["filters"]] if obj.get("filters") is not None else None,
