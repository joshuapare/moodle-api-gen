...
class TestModForumGetDiscussionPosts200ResponsePostsInner(unittest.TestCase):
    """ModForumGetDiscussionPosts200ResponsePostsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModForumGetDiscussionPosts200ResponsePostsInner:
        """Test ModForumGetDiscussionPosts200ResponsePostsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModForumGetDiscussionPosts200ResponsePostsInner`
        """
        model = ModForumGetDiscussionPosts200ResponsePostsInner()
        if include_optional:
            return ModForumGetDiscussionPosts200ResponsePostsInner(
                attachments = [
    ...
    def testModForumGetDiscussionPosts200ResponsePostsInner(self):
        """Test ModForumGetDiscussionPosts200ResponsePostsInner"""
