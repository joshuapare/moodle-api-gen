...
class TestCoreCalendarGetActionEventsByCourses200ResponseGroupedbycourseInner(unittest.TestCase):
    """CoreCalendarGetActionEventsByCourses200ResponseGroupedbycourseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoreCalendarGetActionEventsByCourses200ResponseGroupedbycourseInner:
        """Test CoreCalendarGetActionEventsByCourses200ResponseGroupedbycourseInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CoreCalendarGetActionEventsByCourses200ResponseGroupedbycourseInner`
        """
        model = CoreCalendarGetActionEventsByCourses200ResponseGroupedbycourseInner()
        if include_optional:
            return CoreCalendarGetActionEventsByCourses200ResponseGroupedbycourseInner(
                courseid = 56,
                events = [
                    openapi_client.models.core_calendar_get_action_events_by_courses_200_response_groupedbycourse_inner_events_inner.core_calendar_get_action_events_by_courses_200_response_groupedbycourse_inner_events_inner(
    ...
    def testCoreCalendarGetActionEventsByCourses200ResponseGroupedbycourseInner(self):
        """Test CoreCalendarGetActionEventsByCourses200ResponseGroupedbycourseInner"""
