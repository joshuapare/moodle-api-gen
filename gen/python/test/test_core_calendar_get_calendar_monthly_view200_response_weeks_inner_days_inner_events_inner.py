...
class TestCoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner(unittest.TestCase):
    """CoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner:
        """Test CoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner`
        """
        model = CoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner()
        if include_optional:
            return CoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner(
    ...
    def testCoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner(self):
        """Test CoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner"""
