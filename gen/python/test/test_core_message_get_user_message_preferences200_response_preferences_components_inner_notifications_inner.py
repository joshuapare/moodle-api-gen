...
class TestCoreMessageGetUserMessagePreferences200ResponsePreferencesComponentsInnerNotificationsInner(unittest.TestCase):
    """CoreMessageGetUserMessagePreferences200ResponsePreferencesComponentsInnerNotificationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoreMessageGetUserMessagePreferences200ResponsePreferencesComponentsInnerNotificationsInner:
        """Test CoreMessageGetUserMessagePreferences200ResponsePreferencesComponentsInnerNotificationsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CoreMessageGetUserMessagePreferences200ResponsePreferencesComponentsInnerNotificationsInner`
        """
        model = CoreMessageGetUserMessagePreferences200ResponsePreferencesComponentsInnerNotificationsInner()
        if include_optional:
            return CoreMessageGetUserMessagePreferences200ResponsePreferencesComponentsInnerNotificationsInner(
                displayname = '',
                preferencekey = 'null',
                processors = [
    ...
    def testCoreMessageGetUserMessagePreferences200ResponsePreferencesComponentsInnerNotificationsInner(self):
        """Test CoreMessageGetUserMessagePreferences200ResponsePreferencesComponentsInnerNotificationsInner"""
