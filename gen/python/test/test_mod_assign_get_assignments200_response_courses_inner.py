...
class TestModAssignGetAssignments200ResponseCoursesInner(unittest.TestCase):
    """ModAssignGetAssignments200ResponseCoursesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModAssignGetAssignments200ResponseCoursesInner:
        """Test ModAssignGetAssignments200ResponseCoursesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModAssignGetAssignments200ResponseCoursesInner`
        """
        model = ModAssignGetAssignments200ResponseCoursesInner()
        if include_optional:
            return ModAssignGetAssignments200ResponseCoursesInner(
                assignments = [
    ...
    def testModAssignGetAssignments200ResponseCoursesInner(self):
        """Test ModAssignGetAssignments200ResponseCoursesInner"""
