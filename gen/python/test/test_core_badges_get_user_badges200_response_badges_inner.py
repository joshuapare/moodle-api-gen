...
class TestCoreBadgesGetUserBadges200ResponseBadgesInner(unittest.TestCase):
    """CoreBadgesGetUserBadges200ResponseBadgesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoreBadgesGetUserBadges200ResponseBadgesInner:
        """Test CoreBadgesGetUserBadges200ResponseBadgesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CoreBadgesGetUserBadges200ResponseBadgesInner`
        """
        model = CoreBadgesGetUserBadges200ResponseBadgesInner()
        if include_optional:
            return CoreBadgesGetUserBadges200ResponseBadgesInner(
                alignment = [
    ...
    def testCoreBadgesGetUserBadges200ResponseBadgesInner(self):
        """Test CoreBadgesGetUserBadges200ResponseBadgesInner"""
