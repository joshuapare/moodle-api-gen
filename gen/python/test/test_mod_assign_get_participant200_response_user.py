...
class TestModAssignGetParticipant200ResponseUser(unittest.TestCase):
    """ModAssignGetParticipant200ResponseUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModAssignGetParticipant200ResponseUser:
        """Test ModAssignGetParticipant200ResponseUser
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModAssignGetParticipant200ResponseUser`
        """
        model = ModAssignGetParticipant200ResponseUser()
        if include_optional:
            return ModAssignGetParticipant200ResponseUser(
                address = '',
                auth = '',
                calendartype = '',
                city = '',
    ...
    def testModAssignGetParticipant200ResponseUser(self):
        """Test ModAssignGetParticipant200ResponseUser"""
