...
class TestModAssignSaveGradesRequest(unittest.TestCase):
    """ModAssignSaveGradesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModAssignSaveGradesRequest:
        """Test ModAssignSaveGradesRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModAssignSaveGradesRequest`
        """
        model = ModAssignSaveGradesRequest()
        if include_optional:
            return ModAssignSaveGradesRequest(
                applytoall = True,
                assignmentid = 56,
                grades = [
                    openapi_client.models.mod_assign_save_grades_request_grades_inner.mod_assign_save_grades_request_grades_inner(
                        addattempt = True, 
                        ...
                        attemptnumber = 56, 
                        grade = 1.337, 
                        plugindata = openapi_client.models.mod_assign_save_grades_request_grades_inner_plugindata.mod_assign_save_grades_request_grades_inner_plugindata(
    ...
    def testModAssignSaveGradesRequest(self):
        """Test ModAssignSaveGradesRequest"""
