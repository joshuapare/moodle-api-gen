...
class TestCoreGradingSaveDefinitionsRequestAreasInner(unittest.TestCase):
    """CoreGradingSaveDefinitionsRequestAreasInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoreGradingSaveDefinitionsRequestAreasInner:
        """Test CoreGradingSaveDefinitionsRequestAreasInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CoreGradingSaveDefinitionsRequestAreasInner`
        """
        model = CoreGradingSaveDefinitionsRequestAreasInner()
        if include_optional:
            return CoreGradingSaveDefinitionsRequestAreasInner(
                activemethod = '',
                areaname = '',
                cmid = 56,
                component = '',
    ...
    def testCoreGradingSaveDefinitionsRequestAreasInner(self):
        """Test CoreGradingSaveDefinitionsRequestAreasInner"""
