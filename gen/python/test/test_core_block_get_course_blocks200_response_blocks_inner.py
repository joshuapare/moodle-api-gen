...
class TestCoreBlockGetCourseBlocks200ResponseBlocksInner(unittest.TestCase):
    """CoreBlockGetCourseBlocks200ResponseBlocksInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoreBlockGetCourseBlocks200ResponseBlocksInner:
        """Test CoreBlockGetCourseBlocks200ResponseBlocksInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CoreBlockGetCourseBlocks200ResponseBlocksInner`
        """
        model = CoreBlockGetCourseBlocks200ResponseBlocksInner()
        if include_optional:
            return CoreBlockGetCourseBlocks200ResponseBlocksInner(
                collapsible = True,
                configs = [
    ...
    def testCoreBlockGetCourseBlocks200ResponseBlocksInner(self):
        """Test CoreBlockGetCourseBlocks200ResponseBlocksInner"""
