...
class TestModForumGetDiscussionPostsByUserid200ResponseDiscussionsInner(unittest.TestCase):
    """ModForumGetDiscussionPostsByUserid200ResponseDiscussionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModForumGetDiscussionPostsByUserid200ResponseDiscussionsInner:
        """Test ModForumGetDiscussionPostsByUserid200ResponseDiscussionsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModForumGetDiscussionPostsByUserid200ResponseDiscussionsInner`
        """
        model = ModForumGetDiscussionPostsByUserid200ResponseDiscussionsInner()
        if include_optional:
            return ModForumGetDiscussionPostsByUserid200ResponseDiscussionsInner(
                authorfullname = 'null',
                id = 56,
                name = 'null',
    ...
    def testModForumGetDiscussionPostsByUserid200ResponseDiscussionsInner(self):
        """Test ModForumGetDiscussionPostsByUserid200ResponseDiscussionsInner"""
