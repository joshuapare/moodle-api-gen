...
class TestModAssignSaveGradesRequestGradesInner(unittest.TestCase):
    """ModAssignSaveGradesRequestGradesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModAssignSaveGradesRequestGradesInner:
        """Test ModAssignSaveGradesRequestGradesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModAssignSaveGradesRequestGradesInner`
        """
        model = ModAssignSaveGradesRequestGradesInner()
        if include_optional:
            return ModAssignSaveGradesRequestGradesInner(
                addattempt = True,
    ...
    def testModAssignSaveGradesRequestGradesInner(self):
        """Test ModAssignSaveGradesRequestGradesInner"""
