...
class TestModAssignGetSubmissionStatus200ResponseLastattemptTeamsubmission(unittest.TestCase):
    """ModAssignGetSubmissionStatus200ResponseLastattemptTeamsubmission unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModAssignGetSubmissionStatus200ResponseLastattemptTeamsubmission:
        """Test ModAssignGetSubmissionStatus200ResponseLastattemptTeamsubmission
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModAssignGetSubmissionStatus200ResponseLastattemptTeamsubmission`
        """
        model = ModAssignGetSubmissionStatus200ResponseLastattemptTeamsubmission()
        if include_optional:
            return ModAssignGetSubmissionStatus200ResponseLastattemptTeamsubmission(
                assignment = 56,
                attemptnumber = 56,
                gradingstatus = '',
                groupid = 56,
    ...
    def testModAssignGetSubmissionStatus200ResponseLastattemptTeamsubmission(self):
        """Test ModAssignGetSubmissionStatus200ResponseLastattemptTeamsubmission"""
