...
> ModUrlGetUrlsByCourses200Response mod_url_get_urls_by_courses(mod_bigbluebuttonbn_get_bigbluebuttonbns_by_courses_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ModUrlApi(api_client)
    ...
    try:
        # Returns a list of urls in a provided list of courses, if no list is provided all urls that the user                             can view will be returned.
        api_response = api_instance.mod_url_get_urls_by_courses(mod_bigbluebuttonbn_get_bigbluebuttonbns_by_courses_request)
        print("The response of ModUrlApi->mod_url_get_urls_by_courses:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ModUrlApi->mod_url_get_urls_by_courses: %s\n" % e)
```
...
# **mod_url_view_url**
> CoreCalendarDeleteSubscription200Response mod_url_view_url(mod_url_view_url_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ModUrlApi(api_client)
    mod_url_view_url_request = openapi_client.ModUrlViewUrlRequest() # ModUrlViewUrlRequest | 

    try:
        # Trigger the course module viewed event and update the module completion status.
        api_response = api_instance.mod_url_view_url(mod_url_view_url_request)
        print("The response of ModUrlApi->mod_url_view_url:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ModUrlApi->mod_url_view_url: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **mod_url_view_url_request** | [**ModUrlViewUrlRequest**](ModUrlViewUrlRequest.md)|  | 
