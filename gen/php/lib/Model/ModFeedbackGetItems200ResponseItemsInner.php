...
/**
 * ModFeedbackGetItems200ResponseItemsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModFeedbackGetItems200ResponseItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_feedback_get_items_200_response_items_inner';
    ...
    */
     ...
     * Sets dependitem
     *
     * @param int|null $dependitem The item id this item depend on.
     *
     * @return self
     */
     ...
     * Sets dependvalue
     *
     * @param string|null $dependvalue The depend value.
     *
     * @return self
     */
     ...
     * Sets feedback
     *
     * @param int|null $feedback The feedback instance id this records belongs to.
     *
     * @return self
     */
     ...
     * Sets hasvalue
     *
     * @param int|null $hasvalue Whether it has a value or not.
     *
     * @return self
     */
     ...
     * Sets itemfiles
     *
     * @param \OpenAPI\Client\Model\ModFeedbackGetAnalysis200ResponseItemsdataInnerItemItemfilesInner[]|null $itemfiles itemfiles
     *
     * @return self
     */
     ...
     * Sets itemnumber
     *
     * @param int|null $itemnumber The item position number
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The item label.
     *
     * @return self
     */
     ...
     * Sets options
     *
     * @param string|null $options Different additional settings for the item (question).
     *
     * @return self
     */
     ...
     * Sets otherdata
     *
     * @param string|null $otherdata Additional data that may be required by external functions
     *
     * @return self
     */
     ...
     * Sets position
     *
     * @param int|null $position The position in the list of questions.
     *
     * @return self
     */
     ...
     * Sets presentation
     *
     * @param string|null $presentation The text describing the item or the available possible answers.
     *
     * @return self
     */
     ...
     * Sets required
     *
     * @param bool|null $required Whether is a item (question) required or not.
     *
     * @return self
     */
     ...
     * Sets template
     *
     * @param int|null $template If it belogns to a template, the template id.
     *
     * @return self
     */
     ...
     * Sets typ
     *
     * @param string|null $typ The type of the item.
     *
     * @return self
     */
