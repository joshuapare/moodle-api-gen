...
/**
 * ModLtiGetToolTypesAndProxies200ResponseTypesInnerState Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModLtiGetToolTypesAndProxies200ResponseTypesInnerState implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_lti_get_tool_types_and_proxies_200_response_types_inner_state';
    ...
    */
     ...
     * Sets configured
     *
     * @param bool $configured Is the state configured
     *
     * @return self
     */
     ...
     * Sets pending
     *
     * @param bool $pending Is the state pending
     *
     * @return self
     */
     ...
     * Sets rejected
     *
     * @param bool $rejected Is the state rejected
     *
     * @return self
     */
     ...
     * Sets text
     *
     * @param string $text Tool type state name string
     *
     * @return self
     */
     ...
     * Sets unknown
     *
     * @param bool $unknown Is the state unknown
     *
     * @return self
     */
