...
/**
 * ModWorkshopGetSubmission200ResponseSubmission Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModWorkshopGetSubmission200ResponseSubmission implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_workshop_get_submission_200_response_submission';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['contenttrust'] === null) {
            $invalidProperties[] = "'contenttrust' can't be null";
        }
        ...
        if ($this->container['late'] === null) {
            $invalidProperties[] = "'late' can't be null";
        }
     ...
     * Sets attachment
     *
     * @param int $attachment Used by File API file_postupdate_standard_filemanager.
     *
     * @return self
     */
     ...
     * Sets authorid
     *
     * @param int $authorid The author of the submission.
     *
     * @return self
     */
     ...
     * Sets content
     *
     * @param string $content Submission text.
     *
     * @return self
     */
     ...
     * Sets contenttrust
     *
     * @param int $contenttrust The trust mode of the data.
     *
     * @return self
     */
     ...
     * Sets example
     *
     * @param bool $example Is this submission an example from teacher.
     *
     * @return self
     */
     ...
     * Sets late
     *
     * @param int $late Has this submission been submitted after the deadline or during the assessment phase?
     *
     * @return self
     */
     ...
     * Sets published
     *
     * @param bool $published Shall the submission be available to other when the workshop is closed.
     *
     * @return self
     */
     ...
     * Sets timecreated
     *
     * @param int $timecreated Timestamp when the work was submitted for the first time.
     *
     * @return self
     */
     ...
     * Sets timemodified
     *
     * @param int $timemodified Timestamp when the submission has been updated.
     *
     * @return self
     */
     ...
     * Sets workshopid
     *
     * @param int $workshopid The id of the workshop instance.
     *
     * @return self
     */
