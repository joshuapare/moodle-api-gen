...
/**
 * CoreReportbuilderReportsGetRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreReportbuilderReportsGetRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_reportbuilder_reports_get_request';
    ...
    {
        $this->setIfExists('editmode', $data ?? [], 0);
        $this->setIfExists('pagesize', $data ?? [], 0);
    ...
    */
     ...
     * Sets editmode
     *
     * @param bool|null $editmode Whether editing mode is enabled
     *
     * @return self
     */
