...
/**
 * ModSurveyGetSurveysByCourses200ResponseSurveysInner Class Doc Comment
 *
 * @category Class
 * @description Surveys
 * @package  OpenAPI\Client
 ...
 */
class ModSurveyGetSurveysByCourses200ResponseSurveysInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_survey_get_surveys_by_courses_200_response_surveys_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('surveydone', $data ?? [], null);
    ...
    */
     ...
     * Sets questions
     *
     * @param string|null $questions Question ids
     *
     * @return self
     */
    ...
    {
        return $this->container['surveydone'];
    }

    /**
     * Sets surveydone
     *
     * @param int|null $surveydone Did I finish the survey?
     *
     * @return self
     */
    public function setSurveydone($surveydone)
    {
        if (is_null($surveydone)) {
            throw new \InvalidArgumentException('non-nullable surveydone cannot be null');
        }
        $this->container['surveydone'] = $surveydone;
     ...
     * Sets template
     *
     * @param int|null $template Survey type
     *
     * @return self
     */
