...
/**
 * CoreCourseUpdateCategoriesRequestCategoriesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreCourseUpdateCategoriesRequestCategoriesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_course_update_categories_request_categories_inner';
    ...
    */
     ...
     * Sets idnumber
     *
     * @param string|null $idnumber category id number
     *
     * @return self
     */
     ...
     * Sets parent
     *
     * @param int|null $parent parent category id
     *
     * @return self
     */
     ...
     * Sets theme
     *
     * @param string|null $theme the category theme. This option must be enabled on moodle
     *
     * @return self
     */
