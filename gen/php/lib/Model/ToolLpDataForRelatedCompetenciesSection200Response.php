...
/**
 * ToolLpDataForRelatedCompetenciesSection200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ToolLpDataForRelatedCompetenciesSection200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tool_lp_data_for_related_competencies_section_200_response';
    ...
    protected static $setters = [
        ...
        'showdeleterelatedaction' => 'setShowdeleterelatedaction'
    ];
    ...
    protected static $getters = [
        ...
        'showdeleterelatedaction' => 'getShowdeleterelatedaction'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('showdeleterelatedaction', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['showdeleterelatedaction'] === null) {
            $invalidProperties[] = "'showdeleterelatedaction' can't be null";
        }
    ...
    /**
     * Gets showdeleterelatedaction
     *
     * @return bool
     */
    public function getShowdeleterelatedaction()
    {
        return $this->container['showdeleterelatedaction'];
    }

    /**
     * Sets showdeleterelatedaction
     *
     * @param bool $showdeleterelatedaction Whether to show the delete relation link or not
     *
     * @return self
     */
    public function setShowdeleterelatedaction($showdeleterelatedaction)
    {
        if (is_null($showdeleterelatedaction)) {
            throw new \InvalidArgumentException('non-nullable showdeleterelatedaction cannot be null');
        }
        $this->container['showdeleterelatedaction'] = $showdeleterelatedaction;
