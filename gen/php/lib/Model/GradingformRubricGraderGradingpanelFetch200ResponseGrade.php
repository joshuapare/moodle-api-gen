...
/**
 * GradingformRubricGraderGradingpanelFetch200ResponseGrade Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GradingformRubricGraderGradingpanelFetch200ResponseGrade implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'gradingform_rubric_grader_gradingpanel_fetch_200_response_grade';
    ...
    protected static $openAPITypes = [
        'canedit' => 'bool',
        'criteria' => '\OpenAPI\Client\Model\GradingformRubricGraderGradingpanelFetch200ResponseGradeCriteriaInner[]',
        'gradedby' => 'string',
        'instanceid' => 'int',
        'maxgrade' => 'string',
        'rubricmode' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('rubricmode', $data ?? [], 'null');
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['rubricmode'] === null) {
            $invalidProperties[] = "'rubricmode' can't be null";
        }
     ...
     * Sets canedit
     *
     * @param bool $canedit Can the user edit this
     *
     * @return self
     */
     ...
     * Gets criteria
     *
     * @return \OpenAPI\Client\Model\GradingformRubricGraderGradingpanelFetch200ResponseGradeCriteriaInner[]
     */
     ...
     * Sets criteria
     *
     * @param \OpenAPI\Client\Model\GradingformRubricGraderGradingpanelFetch200ResponseGradeCriteriaInner[] $criteria criteria
     *
     * @return self
     */
     ...
     * @return string
     */
    public function getRubricmode()
    {
        return $this->container['rubricmode'];
    }

    /**
     * Sets rubricmode
     *
     * @param string $rubricmode The mode i.e. evaluate editable
     *
     * @return self
     */
    public function setRubricmode($rubricmode)
    {
        if (is_null($rubricmode)) {
            throw new \InvalidArgumentException('non-nullable rubricmode cannot be null');
        }
        $this->container['rubricmode'] = $rubricmode;
