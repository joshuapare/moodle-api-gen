...
/**
 * ModDataGetEntry200ResponseEntry Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModDataGetEntry200ResponseEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_data_get_entry_200_response_entry';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['canmanageentry'] === null) {
            $invalidProperties[] = "'canmanageentry' can't be null";
        }
     ...
     * Sets approved
     *
     * @param bool $approved Whether the entry has been approved (if the database is configured in that way).
     *
     * @return self
     */
     ...
     * Sets canmanageentry
     *
     * @param bool $canmanageentry Whether the current user can manage this entry
     *
     * @return self
     */
     ...
     * Sets dataid
     *
     * @param int $dataid The database id this record belongs to.
     *
     * @return self
     */
     ...
     * Sets groupid
     *
     * @param int $groupid The group id this record belongs to (0 for no groups).
     *
     * @return self
     */
     ...
     * Sets timecreated
     *
     * @param int $timecreated Time the record was created.
     *
     * @return self
     */
     ...
     * Sets timemodified
     *
     * @param int $timemodified Last time the record was modified.
     *
     * @return self
     */
     ...
     * Sets userid
     *
     * @param int $userid The id of the user who created the record.
     *
     * @return self
     */
