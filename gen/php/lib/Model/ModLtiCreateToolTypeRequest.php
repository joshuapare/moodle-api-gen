...
/**
 * ModLtiCreateToolTypeRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModLtiCreateToolTypeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_lti_create_tool_type_request';
    ...
    {
        $this->setIfExists('cartridgeurl', $data ?? [], '');
        $this->setIfExists('key', $data ?? [], '');
        $this->setIfExists('secret', $data ?? [], '');
    }
    ...
    */
     ...
     * Sets cartridgeurl
     *
     * @param string|null $cartridgeurl URL to cardridge to load tool information
     *
     * @return self
     */
     ...
     * Sets secret
     *
     * @param string|null $secret Shared secret
     *
     * @return self
     */
