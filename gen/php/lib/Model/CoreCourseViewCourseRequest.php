...
/**
 * CoreCourseViewCourseRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreCourseViewCourseRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_course_view_course_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('sectionnumber', $data ?? [], 0);
    }
    ...
    */
    ...
    public function setSectionnumber($sectionnumber)
    {
        if (is_null($sectionnumber)) {
            throw new \InvalidArgumentException('non-nullable sectionnumber cannot be null');
        }
