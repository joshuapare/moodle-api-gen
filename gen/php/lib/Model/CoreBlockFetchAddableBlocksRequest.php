...
/**
 * CoreBlockFetchAddableBlocksRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreBlockFetchAddableBlocksRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_block_fetch_addable_blocks_request';
    ...
    */
     ...
     * Sets pagehash
     *
     * @param string|null $pagehash Page hash
     *
     * @return self
     */
    ...
    {
        return $this->container['subpage'];
    }

    /**
     * Sets subpage
     *
     * @param string|null $subpage The subpage identifier
     *
     * @return self
     */
    ...
    {
        if (is_null($subpage)) {
            throw new \InvalidArgumentException('non-nullable subpage cannot be null');
        }
        $this->container['subpage'] = $subpage;
