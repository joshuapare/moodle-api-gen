...
/**
 * ModChatGetChatsByCourses200ResponseChatsInner Class Doc Comment
 *
 * @category Class
 * @description Chats
 * @package  OpenAPI\Client
 ...
 */
class ModChatGetChatsByCourses200ResponseChatsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_chat_get_chats_by_courses_200_response_chats_inner';
    ...
    protected static $setters = [
        'chatmethod' => 'setChatmethod',
        'chattime' => 'setChattime',
        'course' => 'setCourse',
    ...
    {
        $this->setIfExists('chatmethod', $data ?? [], 'null');
        $this->setIfExists('chattime', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getChatmethod()
    {
        return $this->container['chatmethod'];
    }

    /**
     * Sets chatmethod
     *
     * @param string|null $chatmethod chat method (sockets, ajax, header_js)
     *
     * @return self
     */
    public function setChatmethod($chatmethod)
    {
        if (is_null($chatmethod)) {
            throw new \InvalidArgumentException('non-nullable chatmethod cannot be null');
        }
        $this->container['chatmethod'] = $chatmethod;
    ...
    {
        return $this->container['chattime'];
    }

    /**
     * Sets chattime
     *
     * @param int|null $chattime chat time
     *
     * @return self
     */
    ...
    {
        if (is_null($chattime)) {
            throw new \InvalidArgumentException('non-nullable chattime cannot be null');
        }
        $this->container['chattime'] = $chattime;
     ...
     * Sets keepdays
     *
     * @param int|null $keepdays keep days
     *
     * @return self
     */
    ...
    {
        if (is_null($keepdays)) {
            throw new \InvalidArgumentException('non-nullable keepdays cannot be null');
        }
     ...
     * Sets schedule
     *
     * @param int|null $schedule schedule type
     *
     * @return self
     */
    ...
    {
        return $this->container['studentlogs'];
    }

    /**
     * Sets studentlogs
     *
     * @param int|null $studentlogs student logs visible to everyone
     *
     * @return self
     */
    public function setStudentlogs($studentlogs)
    {
        if (is_null($studentlogs)) {
            throw new \InvalidArgumentException('non-nullable studentlogs cannot be null');
        }
        $this->container['studentlogs'] = $studentlogs;
