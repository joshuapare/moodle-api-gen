...
/**
 * ModGlossaryGetEntriesByCategory200ResponseEntriesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModGlossaryGetEntriesByCategory200ResponseEntriesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_glossary_get_entries_by_category_200_response_entries_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('categoryid', $data ?? [], -1);
        $this->setIfExists('categoryname', $data ?? [], '');
    ...
    */
     ...
     * Sets categoryid
     *
     * @param int|null $categoryid The category ID. This may be '-1' when the entry is not categorised
     *
     * @return self
     */
     ...
     * Sets categoryname
     *
     * @param string|null $categoryname The category name. May be empty when the entry is not categorised, or the request was limited to one category.
     *
     * @return self
     */
