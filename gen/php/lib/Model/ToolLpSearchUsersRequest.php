...
/**
 * ToolLpSearchUsersRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ToolLpSearchUsersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tool_lp_search_users_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('limitnum', $data ?? [], '100');
    ...
    */
     ...
     * Sets limitfrom
     *
     * @param int|null $limitfrom Number of records to skip
     *
     * @return self
     */
     ...
     * Sets limitnum
     *
     * @param string|null $limitnum Number of records to fetch
     *
     * @return self
     */
