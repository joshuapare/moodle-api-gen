...
/**
 * CoreXapiGetStatesRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreXapiGetStatesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_xapi_get_states_request';
    ...
    */
     ...
     * Sets since
     *
     * @param string|null $since Filter ids stored since the timestamp (exclusive)
     *
     * @return self
     */
