...
/**
 * ModBookGetBooksByCourses200ResponseBooksInner Class Doc Comment
 *
 * @category Class
 * @description Books
 * @package  OpenAPI\Client
 ...
 */
class ModBookGetBooksByCourses200ResponseBooksInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_book_get_books_by_courses_200_response_books_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('customtitles', $data ?? [], null);
        ...
        $this->setIfExists('navstyle', $data ?? [], null);
        $this->setIfExists('numbering', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['customtitles'];
    }

    /**
     * Sets customtitles
     *
     * @param int|null $customtitles Book custom titles type
     *
     * @return self
     */
    public function setCustomtitles($customtitles)
    {
        if (is_null($customtitles)) {
            throw new \InvalidArgumentException('non-nullable customtitles cannot be null');
        }
        $this->container['customtitles'] = $customtitles;
    ...
    {
        return $this->container['navstyle'];
    }

    /**
     * Sets navstyle
     *
     * @param int|null $navstyle Book navigation style configuration
     *
     * @return self
     */
    ...
    {
        if (is_null($navstyle)) {
            throw new \InvalidArgumentException('non-nullable navstyle cannot be null');
        }
        $this->container['navstyle'] = $navstyle;
    ...
    {
        return $this->container['numbering'];
    }

    /**
     * Sets numbering
     *
     * @param int|null $numbering Book numbering configuration
     *
     * @return self
     */
    public function setNumbering($numbering)
    {
        if (is_null($numbering)) {
            throw new \InvalidArgumentException('non-nullable numbering cannot be null');
        }
        $this->container['numbering'] = $numbering;
     ...
     * Sets revision
     *
     * @param int|null $revision Book revision
     *
     * @return self
     */
