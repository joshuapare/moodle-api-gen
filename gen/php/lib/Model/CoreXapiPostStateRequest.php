...
/**
 * CoreXapiPostStateRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreXapiPostStateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_xapi_post_state_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('state_data', $data ?? [], 'null');
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['state_data'] === null) {
            $invalidProperties[] = "'state_data' can't be null";
        }
     ...
     * Sets state_data
     *
     * @param string $state_data JSON object with the state data
     *
     * @return self
     */
    public function setStateData($state_data)
    {
        if (is_null($state_data)) {
            throw new \InvalidArgumentException('non-nullable state_data cannot be null');
        }
