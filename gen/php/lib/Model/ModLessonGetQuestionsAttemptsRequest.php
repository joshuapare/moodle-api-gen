...
/**
 * ModLessonGetQuestionsAttemptsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModLessonGetQuestionsAttemptsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_lesson_get_questions_attempts_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('correct', $data ?? [], false);
    ...
    */
     ...
     * Sets attempt
     *
     * @param int $attempt lesson attempt number
     *
     * @return self
     */
     ...
     * Sets correct
     *
     * @param bool|null $correct only fetch correct attempts
     *
     * @return self
     */
     ...
     * Sets pageid
     *
     * @param int|null $pageid only fetch attempts at the given page
     *
     * @return self
     */
     ...
     * Sets userid
     *
     * @param int|null $userid only fetch attempts of the given user
     *
     * @return self
     */
