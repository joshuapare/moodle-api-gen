...
/**
 * ToolLpDataForCompetenciesManagePageRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ToolLpDataForCompetenciesManagePageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tool_lp_data_for_competencies_manage_page_request';
    ...
    {
        $this->setIfExists('competencyframeworkid', $data ?? [], null);
    ...
    */
     ...
     * Sets search
     *
     * @param string|null $search A search string
     *
     * @return self
     */
