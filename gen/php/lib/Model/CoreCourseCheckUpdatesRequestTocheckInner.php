...
/**
 * CoreCourseCheckUpdatesRequestTocheckInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreCourseCheckUpdatesRequestTocheckInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_course_check_updates_request_tocheck_inner';
    ...
    */
     ...
     * Sets contextlevel
     *
     * @param string|null $contextlevel The context level for the file location.                                                                                 Only module supported right now.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param int|null $id Context instance id
     *
     * @return self
     */
     ...
     * Sets since
     *
     * @param int|null $since Check updates since this time stamp
     *
     * @return self
     */
