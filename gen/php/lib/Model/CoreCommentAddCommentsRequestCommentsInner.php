...
/**
 * CoreCommentAddCommentsRequestCommentsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreCommentAddCommentsRequestCommentsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_comment_add_comments_request_comments_inner';
    ...
    */
     ...
     * Sets area
     *
     * @param string|null $area string comment area
     *
     * @return self
     */
     ...
     * Sets content
     *
     * @param string|null $content component
     *
     * @return self
     */
     ...
     * Sets contextlevel
     *
     * @param string|null $contextlevel contextlevel system, course, user...
     *
     * @return self
     */
     ...
     * Sets instanceid
     *
     * @param int|null $instanceid the id of item associated with the contextlevel
     *
     * @return self
     */
     ...
     * Sets itemid
     *
     * @param int|null $itemid associated id
     *
     * @return self
     */
