...
/**
 * CoreCalendarGetCalendarUpcomingView200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreCalendarGetCalendarUpcomingView200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_calendar_get_calendar_upcoming_view_200_response';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('isloggedin', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['isloggedin'] === null) {
            $invalidProperties[] = "'isloggedin' can't be null";
        }
     ...
     * Gets events
     *
     * @return \OpenAPI\Client\Model\CoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner[]
     */
     ...
     * Sets events
     *
     * @param \OpenAPI\Client\Model\CoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner[] $events events
     *
     * @return self
     */
    ...
    {
        return $this->container['isloggedin'];
    }

    /**
     * Sets isloggedin
     *
     * @param bool $isloggedin isloggedin
     *
     * @return self
     */
    public function setIsloggedin($isloggedin)
    {
        if (is_null($isloggedin)) {
            throw new \InvalidArgumentException('non-nullable isloggedin cannot be null');
        }
        $this->container['isloggedin'] = $isloggedin;
