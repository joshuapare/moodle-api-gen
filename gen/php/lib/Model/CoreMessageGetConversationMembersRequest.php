...
/**
 * CoreMessageGetConversationMembersRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreMessageGetConversationMembersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_message_get_conversation_members_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('includecontactrequests', $data ?? [], false);
        $this->setIfExists('includeprivacyinfo', $data ?? [], false);
    ...
    */
     ...
     *
     * @param bool|null $includecontactrequests Do we want to include contact requests?
     *
     * @return self
     */
     ...
     *
     * @param bool|null $includeprivacyinfo Do we want to include privacy info?
     *
     * @return self
     */
     ...
     * Sets userid
     *
     * @param int $userid The id of the user we are performing this action on behalf of
     *
     * @return self
     */
