...
/**
 * CoreGetFragmentRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreGetFragmentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_get_fragment_request';
    ...
    protected static $openAPITypes = [
        'args' => '\OpenAPI\Client\Model\CoreGetFragmentRequestArgsInner[]',
        'callback' => 'string',
        'component' => 'string',
        'contextid' => 'int'
    ];
    ...
    */
     ...
     * Gets args
     *
     * @return \OpenAPI\Client\Model\CoreGetFragmentRequestArgsInner[]|null
     */
     ...
     * Sets args
     *
     * @param \OpenAPI\Client\Model\CoreGetFragmentRequestArgsInner[]|null $args args
     *
     * @return self
     */
     ...
     * Sets callback
     *
     * @param string $callback Name of the callback to execute
     *
     * @return self
     */
     ...
     * Sets component
     *
     * @param string $component Component for the callback e.g. mod_assign
     *
     * @return self
     */
     ...
     * Sets contextid
     *
     * @param int $contextid Context ID that the fragment is from
     *
     * @return self
     */
