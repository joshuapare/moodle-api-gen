...
/**
 * CoreUserUpdateUsersRequestUsersInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreUserUpdateUsersRequestUsersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_user_update_users_request_users_inner';
    ...
    protected static $openAPITypes = [
        ...
        'phone1' => 'string',
        'phone2' => 'string',
        'preferences' => '\OpenAPI\Client\Model\CoreUserUpdateUsersRequestUsersInnerPreferencesInner[]',
        'suspended' => 'bool',
        'theme' => 'string',
        'timezone' => 'string',
        'username' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('auth', $data ?? [], '');
        $this->setIfExists('calendartype', $data ?? [], '');
        ...
        $this->setIfExists('userpicture', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets phone1
     *
     * @param string|null $phone1 Phone
     *
     * @return self
     */
     ...
     * Sets phone2
     *
     * @param string|null $phone2 Mobile phone
     *
     * @return self
     */
     ...
     * Gets preferences
     *
     * @return \OpenAPI\Client\Model\CoreUserUpdateUsersRequestUsersInnerPreferencesInner[]|null
     */
     ...
     * Sets preferences
     *
     * @param \OpenAPI\Client\Model\CoreUserUpdateUsersRequestUsersInnerPreferencesInner[]|null $preferences preferences
     *
     * @return self
     */
    ...
    {
        return $this->container['userpicture'];
    }

    /**
     * Sets userpicture
     *
     * @param int|null $userpicture The itemid where the new user picture has been uploaded to, 0 to delete
     *
     * @return self
     */
    public function setUserpicture($userpicture)
    {
        if (is_null($userpicture)) {
            throw new \InvalidArgumentException('non-nullable userpicture cannot be null');
        }
        $this->container['userpicture'] = $userpicture;
