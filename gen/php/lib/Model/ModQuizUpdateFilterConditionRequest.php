...
/**
 * ModQuizUpdateFilterConditionRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModQuizUpdateFilterConditionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_quiz_update_filter_condition_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('filtercondition', $data ?? [], 'null');
        $this->setIfExists('slotid', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['filtercondition'] === null) {
            $invalidProperties[] = "'filtercondition' can't be null";
        }
     ...
     * Sets slotid
     *
     * @param int $slotid The quiz slot ID for the random question.
     *
     * @return self
     */
    ...
    {
        if (is_null($slotid)) {
            throw new \InvalidArgumentException('non-nullable slotid cannot be null');
        }
