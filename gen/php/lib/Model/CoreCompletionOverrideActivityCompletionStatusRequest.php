...
/**
 * CoreCompletionOverrideActivityCompletionStatusRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreCompletionOverrideActivityCompletionStatusRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_completion_override_activity_completion_status_request';
    ...
    */
     ...
     * Sets newstate
     *
     * @param int $newstate the new activity completion state
     *
     * @return self
     */
