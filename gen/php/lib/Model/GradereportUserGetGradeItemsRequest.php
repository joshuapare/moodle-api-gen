...
/**
 * GradereportUserGetGradeItemsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GradereportUserGetGradeItemsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'gradereport_user_get_grade_items_request';
    ...
    */
     ...
     * Sets groupid
     *
     * @param int|null $groupid Get users from this group only
     *
     * @return self
     */
     ...
     * Sets userid
     *
     * @param int|null $userid Return grades only for this user (optional)
     *
     * @return self
     */
