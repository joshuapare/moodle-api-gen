...
/**
 * CoreGradesGraderGradingpanelScaleStore200ResponseGrade Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreGradesGraderGradingpanelScaleStore200ResponseGrade implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_grades_grader_gradingpanel_scale_store_200_response_grade';
    ...
    protected static $openAPITypes = [
        'gradedby' => 'string',
        'maxgrade' => 'string',
        'options' => '\OpenAPI\Client\Model\CoreGradesGraderGradingpanelScaleStore200ResponseGradeOptionsInner[]',
        'timecreated' => 'int',
        'timemodified' => 'int',
        'usergrade' => 'string'
    ];
    ...
    */
     ...
     * Gets options
     *
     * @return \OpenAPI\Client\Model\CoreGradesGraderGradingpanelScaleStore200ResponseGradeOptionsInner[]
     */
     ...
     * Sets options
     *
     * @param \OpenAPI\Client\Model\CoreGradesGraderGradingpanelScaleStore200ResponseGradeOptionsInner[] $options options
     *
     * @return self
     */
