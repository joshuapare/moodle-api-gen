...
/**
 * ModWorkshopAddSubmissionRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModWorkshopAddSubmissionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_workshop_add_submission_request';
    ...
    {
        $this->setIfExists('attachmentsid', $data ?? [], 0);
        $this->setIfExists('content', $data ?? [], '');
        $this->setIfExists('contentformat', $data ?? [], 0);
        $this->setIfExists('inlineattachmentsid', $data ?? [], 0);
    ...
    */
     ...
     * Sets attachmentsid
     *
     * @param int|null $attachmentsid The draft file area id for attachments
     *
     * @return self
     */
     ...
     * Sets content
     *
     * @param string|null $content Submission text content
     *
     * @return self
     */
     ...
     * Sets contentformat
     *
     * @param int|null $contentformat The format used for the content
     *
     * @return self
     */
     ...
     *
     * @param int|null $inlineattachmentsid The draft file area id for inline attachments in the content
     *
     * @return self
     */
