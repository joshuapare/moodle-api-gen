...
/**
 * ModGlossaryGetEntryById200ResponsePermissions Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModGlossaryGetEntryById200ResponsePermissions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_glossary_get_entry_by_id_200_response_permissions';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('canupdate', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets candelete
     *
     * @param bool $candelete Whether the user can delete the entry.
     *
     * @return self
     */
     ...
     * Sets canupdate
     *
     * @param bool $canupdate Whether the user can update the entry.
     *
     * @return self
     */
    public function setCanupdate($canupdate)
    {
        if (is_null($canupdate)) {
            throw new \InvalidArgumentException('non-nullable canupdate cannot be null');
        }
