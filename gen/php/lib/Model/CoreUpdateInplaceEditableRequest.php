...
/**
 * CoreUpdateInplaceEditableRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreUpdateInplaceEditableRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_update_inplace_editable_request';
    ...
    */
     ...
     * Sets component
     *
     * @param string $component component responsible for the update
     *
     * @return self
     */
     ...
     * Sets itemid
     *
     * @param string $itemid identifier of the updated item
     *
     * @return self
     */
     ...
     * Sets itemtype
     *
     * @param string $itemtype type of the updated item inside the component
     *
     * @return self
     */
