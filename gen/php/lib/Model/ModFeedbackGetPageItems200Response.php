...
/**
 * ModFeedbackGetPageItems200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModFeedbackGetPageItems200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_feedback_get_page_items_200_response';
    ...
    protected static $openAPITypes = [
        'hasnextpage' => 'bool',
        'hasprevpage' => 'bool',
        'items' => '\OpenAPI\Client\Model\ModFeedbackGetItems200ResponseItemsInner[]',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('hasprevpage', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['hasprevpage'] === null) {
            $invalidProperties[] = "'hasprevpage' can't be null";
        }
     ...
     * Sets hasprevpage
     *
     * @param bool $hasprevpage Whether is a previous page.
     *
     * @return self
     */
    public function setHasprevpage($hasprevpage)
    {
        if (is_null($hasprevpage)) {
            throw new \InvalidArgumentException('non-nullable hasprevpage cannot be null');
        }
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\ModFeedbackGetItems200ResponseItemsInner[]
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\ModFeedbackGetItems200ResponseItemsInner[] $items items
     *
     * @return self
     */
