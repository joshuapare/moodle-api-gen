...
/**
 * ModWorkshopGetAssessment200ResponseAssessment Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModWorkshopGetAssessment200ResponseAssessment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_workshop_get_assessment_200_response_assessment';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['feedbackattachmentfiles'] === null) {
            $invalidProperties[] = "'feedbackattachmentfiles' can't be null";
        }
        if ($this->container['feedbackauthor'] === null) {
            $invalidProperties[] = "'feedbackauthor' can't be null";
        }
        if ($this->container['feedbackauthorattachment'] === null) {
            $invalidProperties[] = "'feedbackauthorattachment' can't be null";
        }
        if ($this->container['feedbackcontentfiles'] === null) {
            $invalidProperties[] = "'feedbackcontentfiles' can't be null";
        }
        if ($this->container['grade'] === null) {
            $invalidProperties[] = "'grade' can't be null";
        }
        if ($this->container['gradinggrade'] === null) {
            $invalidProperties[] = "'gradinggrade' can't be null";
        }
        if ($this->container['gradinggradeover'] === null) {
            $invalidProperties[] = "'gradinggradeover' can't be null";
        }
        if ($this->container['gradinggradeoverby'] === null) {
            $invalidProperties[] = "'gradinggradeoverby' can't be null";
        }
     ...
     *
     * @return \OpenAPI\Client\Model\CoreBlogGetEntries200ResponseEntriesInnerSummaryfilesInner[]
     */
     ...
     *
     * @param \OpenAPI\Client\Model\CoreBlogGetEntries200ResponseEntriesInnerSummaryfilesInner[] $feedbackattachmentfiles feedbackattachmentfiles
     *
     * @return self
     */
     ...
     * Sets feedbackauthor
     *
     * @param string $feedbackauthor The comment/feedback from the reviewer for the author.
     *
     * @return self
     */
     ...
     *
     * @param int $feedbackauthorattachment Are there some files attached to the feedbackauthor field?                     Sets to 1 by file_postupdate_standard_filemanager().
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\CoreBlogGetEntries200ResponseEntriesInnerSummaryfilesInner[] $feedbackcontentfiles feedbackcontentfiles
     *
     * @return self
     */
     ...
     * Sets grade
     *
     * @param float $grade The aggregated grade for submission suggested by the reviewer.                     The grade 0..100 is computed from the values assigned to the assessment dimensions fields. If NULL then it has not been aggregated yet.
     *
     * @return self
     */
     ...
     * Sets gradinggrade
     *
     * @param float $gradinggrade The computed grade 0..100 for this assessment. If NULL then it has not been computed yet.
     *
     * @return self
     */
     ...
     *
     * @param float $gradinggradeover Grade for the assessment manually overridden by a teacher.                     Grade is always from interval 0..100. If NULL then the grade is not overriden.
     *
     * @return self
     */
     ...
     *
     * @param int $gradinggradeoverby The id of the user who has overridden the grade for submission.
     *
     * @return self
     */
     ...
     * Sets reviewerid
     *
     * @param int $reviewerid The id of the reviewer who makes this assessment
     *
     * @return self
     */
     ...
     * Sets submissionid
     *
     * @param int $submissionid The id of the assessed submission
     *
     * @return self
     */
     ...
     * Sets timecreated
     *
     * @param int $timecreated If 0 then the assessment was allocated but the reviewer has not assessed yet.                     If greater than 0 then the timestamp of when the reviewer assessed for the first time
     *
     * @return self
     */
     ...
     * Sets timemodified
     *
     * @param int $timemodified If 0 then the assessment was allocated but the reviewer has not assessed yet.                     If greater than 0 then the timestamp of when the reviewer assessed for the last time
     *
     * @return self
     */
     ...
     * Sets weight
     *
     * @param int $weight The weight of the assessment for the purposes of aggregation
     *
     * @return self
     */
