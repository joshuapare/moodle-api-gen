...
/**
 * LocalIomadLearningpathAddcoursesRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LocalIomadLearningpathAddcoursesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'local_iomad_learningpath_addcourses_request';
    ...
    */
     ...
     * Sets groupid
     *
     * @param int|null $groupid ID of group. If 0 just add to lowest numbered group
     *
     * @return self
     */
