...
/**
 * CoreCourseGetActivityChooserFooterRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreCourseGetActivityChooserFooterRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_course_get_activity_chooser_footer_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sectionid'] === null) {
            $invalidProperties[] = "'sectionid' can't be null";
        }
