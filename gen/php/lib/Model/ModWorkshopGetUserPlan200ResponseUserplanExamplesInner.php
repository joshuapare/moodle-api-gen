...
/**
 * ModWorkshopGetUserPlan200ResponseUserplanExamplesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModWorkshopGetUserPlan200ResponseUserplanExamplesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_workshop_get_user_plan_200_response_userplan_examples_inner';
    ...
    */
     ...
     * Sets assessmentid
     *
     * @param int|null $assessmentid Example submission assessment id.
     *
     * @return self
     */
     ...
     * Sets grade
     *
     * @param float|null $grade The submission grade.
     *
     * @return self
     */
     ...
     * Sets gradinggrade
     *
     * @param float|null $gradinggrade The assessment grade.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param int|null $id Example submission id.
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string|null $title Example submission title.
     *
     * @return self
     */
