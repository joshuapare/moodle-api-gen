...
/**
 * ModLessonLaunchAttemptRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModLessonLaunchAttemptRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_lesson_launch_attempt_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('pageid', $data ?? [], 0);
    ...
    */
     ...
     * Sets pageid
     *
     * @param int|null $pageid page id to continue from (only when continuing an attempt)
     *
     * @return self
     */
     ...
     * Sets review
     *
     * @param bool|null $review if we want to review just after finishing
     *
     * @return self
     */
