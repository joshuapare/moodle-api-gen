...
/**
 * CoreH5pGetTrustedH5pFileRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreH5pGetTrustedH5pFileRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_h5p_get_trusted_h5p_file_request';
    ...
    {
        $this->setIfExists('copyright', $data ?? [], 0);
        $this->setIfExists('embed', $data ?? [], 0);
        $this->setIfExists('export', $data ?? [], 0);
        $this->setIfExists('frame', $data ?? [], 0);
    ...
    */
     ...
     * Sets copyright
     *
     * @param int|null $copyright The copyright option
     *
     * @return self
     */
     ...
     * Sets embed
     *
     * @param int|null $embed The embed allow to copy the code to your site
     *
     * @return self
     */
     ...
     * Sets export
     *
     * @param int|null $export The export allow to download the package
     *
     * @return self
     */
     ...
     * Sets frame
     *
     * @param int|null $frame The frame allow to show the bar options below the content
     *
     * @return self
     */
