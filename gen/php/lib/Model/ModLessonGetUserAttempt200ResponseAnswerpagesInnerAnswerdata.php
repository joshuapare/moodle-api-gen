...
/**
 * ModLessonGetUserAttempt200ResponseAnswerpagesInnerAnswerdata Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModLessonGetUserAttempt200ResponseAnswerpagesInnerAnswerdata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_lesson_get_user_attempt_200_response_answerpages_inner_answerdata';
    ...
    */
     ...
     * Sets answers
     *
     * @param object[]|null $answers answers
     *
     * @return self
     */
     ...
     * Sets responseformat
     *
     * @param int $responseformat response. format (1 = HTML, 0 = MOODLE, 2 = PLAIN, or 4 = MARKDOWN)
     *
     * @return self
     */
     ...
     * Sets score
     *
     * @param string $score The score (text version).
     *
     * @return self
     */
