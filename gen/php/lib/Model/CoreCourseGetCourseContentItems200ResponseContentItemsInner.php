...
/**
 * CoreCourseGetCourseContentItems200ResponseContentItemsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreCourseGetCourseContentItems200ResponseContentItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_course_get_course_content_items_200_response_content_items_inner';
    ...
    */
     ...
     * Sets archetype
     *
     * @param string|null $archetype The archetype of the module exposing the content item
     *
     * @return self
     */
     ...
     * Sets componentname
     *
     * @param string|null $componentname The name of the component exposing the content item
     *
     * @return self
     */
     ...
     * Sets favourite
     *
     * @param bool|null $favourite Has the user favourited the content item
     *
     * @return self
     */
     ...
     * Sets help
     *
     * @param string|null $help Html description / help for the content item
     *
     * @return self
     */
     ...
     * Sets icon
     *
     * @param string|null $icon Html containing the icon for the content item
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param int|null $id The id of the content item
     *
     * @return self
     */
     ...
     * Sets legacyitem
     *
     * @param bool|null $legacyitem If this item was pulled from the old callback and has no item id.
     *
     * @return self
     */
     ...
     * Sets link
     *
     * @param string|null $link The link to the content item creation page
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name of the content item
     *
     * @return self
     */
     ...
     * Sets purpose
     *
     * @param string|null $purpose The purpose of the component exposing the content item
     *
     * @return self
     */
     ...
     * Sets recommended
     *
     * @param bool|null $recommended Has this item been recommended
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string|null $title The string title of the content item, human readable
     *
     * @return self
     */
