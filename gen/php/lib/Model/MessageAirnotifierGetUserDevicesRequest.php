...
/**
 * MessageAirnotifierGetUserDevicesRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MessageAirnotifierGetUserDevicesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'message_airnotifier_get_user_devices_request';
    ...
    */
     ...
     * Sets userid
     *
     * @param int|null $userid User id, 0 for current user
     *
     * @return self
     */
