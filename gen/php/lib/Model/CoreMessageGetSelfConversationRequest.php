...
/**
 * CoreMessageGetSelfConversationRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreMessageGetSelfConversationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_message_get_self_conversation_request';
    ...
    */
     ...
     * Sets userid
     *
     * @param int $userid The id of the user who we are viewing self-conversations for
     *
     * @return self
     */
