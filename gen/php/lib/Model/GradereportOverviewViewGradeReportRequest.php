...
/**
 * GradereportOverviewViewGradeReportRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GradereportOverviewViewGradeReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'gradereport_overview_view_grade_report_request';
    ...
    */
     ...
     * Sets userid
     *
     * @param int|null $userid id of the user, 0 means current user
     *
     * @return self
     */
