...
/**
 * CoreCompetencyGradeCompetencyInCourse200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreCompetencyGradeCompetencyInCourse200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_competency_grade_competency_in_course_200_response';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['actionuserid'] === null) {
            $invalidProperties[] = "'actionuserid' can't be null";
        }
        ...
        if ($this->container['desca'] === null) {
            $invalidProperties[] = "'desca' can't be null";
        }
        if ($this->container['desccomponent'] === null) {
            $invalidProperties[] = "'desccomponent' can't be null";
        }
        if ($this->container['descidentifier'] === null) {
            $invalidProperties[] = "'descidentifier' can't be null";
        }
        ...
        if ($this->container['usercompetencyid'] === null) {
            $invalidProperties[] = "'usercompetencyid' can't be null";
        }
        if ($this->container['userdate'] === null) {
            $invalidProperties[] = "'userdate' can't be null";
        }
     ...
     * Sets actionuserid
     *
     * @param int $actionuserid actionuserid
     *
     * @return self
     */
     ...
     * Sets desccomponent
     *
     * @param string $desccomponent desccomponent
     *
     * @return self
     */
     ...
     * Sets descidentifier
     *
     * @param string $descidentifier descidentifier
     *
     * @return self
     */
     ...
     *
     * @param int $usercompetencyid usercompetencyid
     *
     * @return self
     */
     ...
     * Sets userdate
     *
     * @param string $userdate userdate
     *
     * @return self
     */
