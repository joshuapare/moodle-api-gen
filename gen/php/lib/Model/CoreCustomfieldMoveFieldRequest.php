...
/**
 * CoreCustomfieldMoveFieldRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreCustomfieldMoveFieldRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_customfield_move_field_request';
    ...
    */
     ...
     * Sets beforeid
     *
     * @param int|null $beforeid Id of the field before which it needs to be moved
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param int $id Id of the field to move
     *
     * @return self
     */
