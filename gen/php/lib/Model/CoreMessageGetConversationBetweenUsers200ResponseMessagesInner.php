...
/**
 * CoreMessageGetConversationBetweenUsers200ResponseMessagesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreMessageGetConversationBetweenUsers200ResponseMessagesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_message_get_conversation_between_users_200_response_messages_inner';
    ...
    */
     ...
     * Sets timecreated
     *
     * @param int|null $timecreated The timecreated timestamp for the message
     *
     * @return self
     */
     ...
     * Sets useridfrom
     *
     * @param int|null $useridfrom The id of the user who sent the message
     *
     * @return self
     */
