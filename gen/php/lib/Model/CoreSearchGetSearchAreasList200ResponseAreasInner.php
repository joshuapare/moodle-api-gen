...
/**
 * CoreSearchGetSearchAreasList200ResponseAreasInner Class Doc Comment
 *
 * @category Class
 ...
 */
class CoreSearchGetSearchAreasList200ResponseAreasInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_search_get_search_areas_list_200_response_areas_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id search area id
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name search area name
     *
     * @return self
     */
