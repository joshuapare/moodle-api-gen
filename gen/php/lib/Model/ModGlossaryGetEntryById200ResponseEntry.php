...
/**
 * ModGlossaryGetEntryById200ResponseEntry Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModGlossaryGetEntryById200ResponseEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_glossary_get_entry_by_id_200_response_entry';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['definitiontrust'] === null) {
            $invalidProperties[] = "'definitiontrust' can't be null";
        }
        if ($this->container['fullmatch'] === null) {
            $invalidProperties[] = "'fullmatch' can't be null";
        }
        if ($this->container['glossaryid'] === null) {
            $invalidProperties[] = "'glossaryid' can't be null";
        }
        if ($this->container['id'] === null) {
            $invalidProperties[] = "'id' can't be null";
        }
        if ($this->container['sourceglossaryid'] === null) {
            $invalidProperties[] = "'sourceglossaryid' can't be null";
        }
        if ($this->container['teacherentry'] === null) {
            $invalidProperties[] = "'teacherentry' can't be null";
        }
        ...
        if ($this->container['usedynalink'] === null) {
            $invalidProperties[] = "'usedynalink' can't be null";
        }
        if ($this->container['userfullname'] === null) {
            $invalidProperties[] = "'userfullname' can't be null";
        }
     ...
     * Sets approved
     *
     * @param bool $approved Whether the entry was approved
     *
     * @return self
     */
     ...
     * Sets attachment
     *
     * @param bool $attachment Whether or not the entry has attachments
     *
     * @return self
     */
     ...
     * Sets casesensitive
     *
     * @param bool $casesensitive When true, the matching is case sensitive
     *
     * @return self
     */
     ...
     *
     * @param bool $definitiontrust The definition trust flag
     *
     * @return self
     */
     ...
     * Sets fullmatch
     *
     * @param bool $fullmatch When true, the matching is done on full words only
     *
     * @return self
     */
     ...
     *
     * @param int $sourceglossaryid The source glossary ID
     *
     * @return self
     */
     ...
     * Sets teacherentry
     *
     * @param bool $teacherentry The entry was created by a teacher, or equivalent.
     *
     * @return self
     */
     ...
     * Sets usedynalink
     *
     * @param bool $usedynalink Whether the concept should be automatically linked
     *
     * @return self
     */
     ...
     * Sets userfullname
     *
     * @param string $userfullname Author full name
     *
     * @return self
     */
     ...
     * Sets userpictureurl
     *
     * @param string $userpictureurl Author picture
     *
     * @return self
     */
