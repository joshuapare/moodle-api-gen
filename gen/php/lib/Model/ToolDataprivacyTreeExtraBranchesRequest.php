...
/**
 * ToolDataprivacyTreeExtraBranchesRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ToolDataprivacyTreeExtraBranchesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tool_dataprivacy_tree_extra_branches_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['element'] === null) {
            $invalidProperties[] = "'element' can't be null";
        }
     ...
     * Sets contextid
     *
     * @param int $contextid The context id to expand
     *
     * @return self
     */
     ...
     * Sets element
     *
     * @param string $element The element we are interested on
     *
     * @return self
     */
