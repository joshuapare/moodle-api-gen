...
/**
 * CoreMessageMarkNotificationReadRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreMessageMarkNotificationReadRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_message_mark_notification_read_request';
    ...
    */
     ...
     * Sets timeread
     *
     * @param int|null $timeread timestamp for when the notification should be marked read
     *
     * @return self
     */
