...
/**
 * CoreMessageMarkMessageReadRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreMessageMarkMessageReadRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_message_mark_message_read_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('timeread', $data ?? [], 0);
    }
    ...
    */
     ...
     * Sets messageid
     *
     * @param int $messageid id of the message in the messages table
     *
     * @return self
     */
     ...
     * Sets timeread
     *
     * @param int|null $timeread timestamp for when the message should be marked read
     *
     * @return self
     */
