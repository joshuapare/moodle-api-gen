...
/**
 * CoreCalendarGetCalendarMonthlyViewRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreCalendarGetCalendarMonthlyViewRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_calendar_get_calendar_monthly_view_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('courseid', $data ?? [], 1);
        $this->setIfExists('day', $data ?? [], 1);
        $this->setIfExists('includenavigation', $data ?? [], true);
        $this->setIfExists('mini', $data ?? [], false);
        $this->setIfExists('month', $data ?? [], null);
        $this->setIfExists('view', $data ?? [], 'month');
    ...
    */
     ...
     * Sets categoryid
     *
     * @param int|null $categoryid Category being viewed
     *
     * @return self
     */
     ...
     * Sets courseid
     *
     * @param int|null $courseid Course being viewed
     *
     * @return self
     */
     ...
     * Sets day
     *
     * @param int|null $day Day to be viewed
     *
     * @return self
     */
     ...
     *
     * @param bool|null $includenavigation Whether to show course navigation
     *
     * @return self
     */
    ...
    {
        return $this->container['mini'];
    }

    /**
     * Sets mini
     *
     * @param bool|null $mini Whether to return the mini month view or not
     *
     * @return self
     */
    ...
    {
        if (is_null($mini)) {
            throw new \InvalidArgumentException('non-nullable mini cannot be null');
        }
        $this->container['mini'] = $mini;
     ...
     * Sets month
     *
     * @param int $month Month to be viewed
     *
     * @return self
     */
     ...
     * Sets view
     *
     * @param string|null $view The view mode of the calendar
     *
     * @return self
     */
     ...
     * Sets year
     *
     * @param int $year Year to be viewed
     *
     * @return self
     */
