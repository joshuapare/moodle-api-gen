...
/**
 * ModChatViewSessionsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModChatViewSessionsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_chat_view_sessions_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('end', $data ?? [], 0);
        $this->setIfExists('start', $data ?? [], 0);
    }
    ...
    */
     ...
     * Sets end
     *
     * @param int|null $end Session end time
     *
     * @return self
     */
     ...
     * Sets start
     *
     * @param int|null $start Session start time
     *
     * @return self
     */
