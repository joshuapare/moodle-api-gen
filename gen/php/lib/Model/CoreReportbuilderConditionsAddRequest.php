...
/**
 * CoreReportbuilderConditionsAddRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreReportbuilderConditionsAddRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_reportbuilder_conditions_add_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['uniqueidentifier'] === null) {
            $invalidProperties[] = "'uniqueidentifier' can't be null";
        }
     ...
     *
     * @param string $uniqueidentifier Unique identifier of the condition
     *
     * @return self
     */
