...
/**
 * ModWorkshopGetSubmissionsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModWorkshopGetSubmissionsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_workshop_get_submissions_request';
    ...
    */
     ...
     * Sets groupid
     *
     * @param int|null $groupid Group id, 0 means that the function will determine the user group.                                                    It will return submissions done by users in the given group.
     *
     * @return self
     */
     ...
     * Sets userid
     *
     * @param int|null $userid Get submissions done by this user. Use 0 or empty for the current user
     *
     * @return self
     */
