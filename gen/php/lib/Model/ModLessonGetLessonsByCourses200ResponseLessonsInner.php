...
/**
 * ModLessonGetLessonsByCourses200ResponseLessonsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModLessonGetLessonsByCourses200ResponseLessonsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_lesson_get_lessons_by_courses_200_response_lessons_inner';
    ...
    */
     ...
     *
     * @param bool|null $allowofflineattempts Whether to allow the lesson to be attempted offline in the mobile app
     *
     * @return self
     */
     ...
     * Sets course
     *
     * @param int|null $course Foreign key reference to the course this lesson is part of.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param int|null $id Standard Moodle primary key.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Lesson name.
     *
     * @return self
     */
