...
/**
 * ToolMoodlenetVerifyWebfingerRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ToolMoodlenetVerifyWebfingerRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tool_moodlenet_verify_webfinger_request';
    ...
    */
     ...
     * Sets profileurl
     *
     * @param string $profileurl The profile url that the user has given us
     *
     * @return self
     */
