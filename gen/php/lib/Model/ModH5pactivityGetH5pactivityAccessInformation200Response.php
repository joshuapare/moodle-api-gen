...
/**
 * ModH5pactivityGetH5pactivityAccessInformation200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModH5pactivityGetH5pactivityAccessInformation200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_h5pactivity_get_h5pactivity_access_information_200_response';
    ...
    protected static $attributeMap = [
        ...
        'canreviewattempts' => 'canreviewattempts',
        'cansubmit' => 'cansubmit',
        'canview' => 'canview',
        'warnings' => 'warnings'
    ];
    ...
    protected static $setters = [
        ...
        'canreviewattempts' => 'setCanreviewattempts',
    ...
    protected static $getters = [
        ...
        'canreviewattempts' => 'getCanreviewattempts',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('canreviewattempts', $data ?? [], null);
    ...
    */
     ...
     * Sets canaddinstance
     *
     * @param bool|null $canaddinstance Whether the user has the capability mod/h5pactivity:addinstance allowed.
     *
     * @return self
     */
    ...
    /**
     * Gets canreviewattempts
     *
     * @return bool|null
     */
    public function getCanreviewattempts()
    {
        return $this->container['canreviewattempts'];
    }

    /**
     * Sets canreviewattempts
     *
     * @param bool|null $canreviewattempts Whether the user has the capability mod/h5pactivity:reviewattempts allowed.
     *
     * @return self
     */
    public function setCanreviewattempts($canreviewattempts)
    {
        if (is_null($canreviewattempts)) {
            throw new \InvalidArgumentException('non-nullable canreviewattempts cannot be null');
        }
        $this->container['canreviewattempts'] = $canreviewattempts;
     ...
     * Sets cansubmit
     *
     * @param bool|null $cansubmit Whether the user has the capability mod/h5pactivity:submit allowed.
     *
     * @return self
     */
     ...
     * Sets canview
     *
     * @param bool|null $canview Whether the user has the capability mod/h5pactivity:view allowed.
     *
     * @return self
     */
