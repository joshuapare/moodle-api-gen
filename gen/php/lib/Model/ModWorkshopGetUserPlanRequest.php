...
/**
 * ModWorkshopGetUserPlanRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModWorkshopGetUserPlanRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_workshop_get_user_plan_request';
    ...
    */
     ...
     * Sets userid
     *
     * @param int|null $userid User id (empty or 0 for current user).
     *
     * @return self
     */
