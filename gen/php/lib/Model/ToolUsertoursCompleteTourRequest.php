...
/**
 * ToolUsertoursCompleteTourRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ToolUsertoursCompleteTourRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tool_usertours_complete_tour_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('stepindex', $data ?? [], null);
        $this->setIfExists('tourid', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['stepid'] === null) {
            $invalidProperties[] = "'stepid' can't be null";
        }
        if ($this->container['stepindex'] === null) {
            $invalidProperties[] = "'stepindex' can't be null";
        }
        if ($this->container['tourid'] === null) {
            $invalidProperties[] = "'tourid' can't be null";
        }
     ...
     * Sets stepindex
     *
     * @param int $stepindex Step Number
     *
     * @return self
     */
    public function setStepindex($stepindex)
    {
        if (is_null($stepindex)) {
            throw new \InvalidArgumentException('non-nullable stepindex cannot be null');
        }
    ...
    {
        if (is_null($tourid)) {
            throw new \InvalidArgumentException('non-nullable tourid cannot be null');
        }
        $this->container['tourid'] = $tourid;
