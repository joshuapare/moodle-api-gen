...
/**
 * CoreCompetencyGradeCompetencyInCourseRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreCompetencyGradeCompetencyInCourseRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_competency_grade_competency_in_course_request';
    ...
    */
     ...
     * Sets note
     *
     * @param string|null $note A note to attach to the evidence
     *
     * @return self
     */
