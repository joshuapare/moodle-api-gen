...
/**
 * CoreRoleUnassignRolesRequestUnassignmentsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreRoleUnassignRolesRequestUnassignmentsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_role_unassign_roles_request_unassignments_inner';
    ...
    */
     ...
     * Sets contextid
     *
     * @param int|null $contextid The context to unassign the user role from
     *
     * @return self
     */
     ...
     * Sets contextlevel
     *
     * @param string|null $contextlevel The context level to unassign the user role in +                                    (block, course, coursecat, system, user, module)
     *
     * @return self
     */
     ...
     * Sets instanceid
     *
     * @param int|null $instanceid The Instance id of item where the role needs to be unassigned
     *
     * @return self
     */
     ...
     * Sets userid
     *
     * @param int|null $userid The user that is going to be assigned
     *
     * @return self
     */
