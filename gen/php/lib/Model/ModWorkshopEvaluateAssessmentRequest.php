...
/**
 * ModWorkshopEvaluateAssessmentRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModWorkshopEvaluateAssessmentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_workshop_evaluate_assessment_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('feedbackformat', $data ?? [], 0);
        $this->setIfExists('feedbacktext', $data ?? [], '');
        $this->setIfExists('gradinggradeover', $data ?? [], '');
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['assessmentid'] === null) {
            $invalidProperties[] = "'assessmentid' can't be null";
        }
     ...
     * Sets feedbackformat
     *
     * @param int|null $feedbackformat The feedback format for text.
     *
     * @return self
     */
     ...
     * Sets feedbacktext
     *
     * @param string|null $feedbacktext The feedback for the reviewer.
     *
     * @return self
     */
     ...
     *
     * @param string|null $gradinggradeover The new grading grade.
     *
     * @return self
     */
     ...
     * Sets weight
     *
     * @param int|null $weight The new weight for the assessment.
     *
     * @return self
     */
