...
/**
 * ModAssignGetSubmissionStatusRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModAssignGetSubmissionStatusRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_assign_get_submission_status_request';
    ...
    */
     ...
     * Sets groupid
     *
     * @param int|null $groupid filter by users in group (used for generating the grading summary).                     0 for all groups information, any other empty value will calculate currrent group.
     *
     * @return self
     */
