...
/**
 * ModBigbluebuttonbnMeetingInfoRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModBigbluebuttonbnMeetingInfoRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_bigbluebuttonbn_meeting_info_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('updatecache', $data ?? [], false);
    }
    ...
    */
     ...
     *
     * @param int $bigbluebuttonbnid bigbluebuttonbn instance id
     *
     * @return self
     */
     ...
     * Sets updatecache
     *
     * @param bool|null $updatecache update cache ?
     *
     * @return self
     */
    public function setUpdatecache($updatecache)
    {
        if (is_null($updatecache)) {
            throw new \InvalidArgumentException('non-nullable updatecache cannot be null');
        }
        $this->container['updatecache'] = $updatecache;
