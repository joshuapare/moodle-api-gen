...
/**
 * EnrolSelfEnrolUserRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EnrolSelfEnrolUserRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'enrol_self_enrol_user_request';
    ...
    */
     ...
     * Sets instanceid
     *
     * @param int|null $instanceid Instance id of self enrolment plugin.
     *
     * @return self
     */
