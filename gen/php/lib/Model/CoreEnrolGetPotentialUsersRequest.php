...
/**
 * CoreEnrolGetPotentialUsersRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreEnrolGetPotentialUsersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_enrol_get_potential_users_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('enrolid', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['enrolid'] === null) {
            $invalidProperties[] = "'enrolid' can't be null";
        }
    ...
    {
        if (is_null($enrolid)) {
            throw new \InvalidArgumentException('non-nullable enrolid cannot be null');
        }
        $this->container['enrolid'] = $enrolid;
