...
/**
 * ModForumCanAddDiscussion200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModForumCanAddDiscussion200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_forum_can_add_discussion_200_response';
    ...
    */
     ...
     *
     * @param bool|null $cancreateattachment True if the user can add attachments, false otherwise.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $canpindiscussions True if the user can pin discussions, false otherwise.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param bool $status True if the user can add discussions, false otherwise.
     *
     * @return self
     */
