...
/**
 * QbankTagquestionSubmitTagsFormRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class QbankTagquestionSubmitTagsFormRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'qbank_tagquestion_submit_tags_form_request';
    ...
    */
     ...
     * Sets formdata
     *
     * @param string $formdata The data from the tag form
     *
     * @return self
     */
