...
/**
 * ModLtiDeleteToolProxy200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModLtiDeleteToolProxy200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_lti_delete_tool_proxy_200_response';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['capabilityoffered'] === null) {
            $invalidProperties[] = "'capabilityoffered' can't be null";
        }
        ...
        if ($this->container['regurl'] === null) {
            $invalidProperties[] = "'regurl' can't be null";
        }
        if ($this->container['secret'] === null) {
            $invalidProperties[] = "'secret' can't be null";
        }
        if ($this->container['serviceoffered'] === null) {
            $invalidProperties[] = "'serviceoffered' can't be null";
        }
        ...
        if ($this->container['toolproxy'] === null) {
            $invalidProperties[] = "'toolproxy' can't be null";
        }
     ...
     *
     * @param string $capabilityoffered Tool proxy capabilities offered
     *
     * @return self
     */
     ...
     * Sets guid
     *
     * @param string $guid Tool proxy globally unique identifier
     *
     * @return self
     */
     ...
     * Sets secret
     *
     * @param string $secret Tool proxy shared secret
     *
     * @return self
     */
     ...
     * Sets serviceoffered
     *
     * @param string $serviceoffered Tool proxy services offered
     *
     * @return self
     */
     ...
     * Sets state
     *
     * @param int $state Tool proxy state
     *
     * @return self
     */
     ...
     * Sets timecreated
     *
     * @param int $timecreated Tool proxy time created
     *
     * @return self
     */
     ...
     * Sets timemodified
     *
     * @param int $timemodified Tool proxy modified
     *
     * @return self
     */
     ...
     * Sets toolproxy
     *
     * @param string $toolproxy Tool proxy
     *
     * @return self
     */
     ...
     * Sets vendorcode
     *
     * @param string $vendorcode Tool proxy consumer code
     *
     * @return self
     */
