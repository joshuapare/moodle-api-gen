...
/**
 * ModForumGetDiscussionPostsByUseridRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModForumGetDiscussionPostsByUseridRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_forum_get_discussion_posts_by_userid_request';
    ...
    */
     ...
     * Sets cmid
     *
     * @param int $cmid The ID of the module of which to fetch items.
     *
     * @return self
     */
     ...
     * Sets userid
     *
     * @param int $userid The ID of the user of whom to fetch posts.
     *
     * @return self
     */
