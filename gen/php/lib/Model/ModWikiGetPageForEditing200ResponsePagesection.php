...
/**
 * ModWikiGetPageForEditing200ResponsePagesection Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModWikiGetPageForEditing200ResponsePagesection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_wiki_get_page_for_editing_200_response_pagesection';
    ...
    */
     ...
     * Sets content
     *
     * @param string|null $content The contents of the page-section to be edited.
     *
     * @return self
     */
     ...
     * Sets contentformat
     *
     * @param string|null $contentformat Format of the original content of the page.
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param int $version Latest version of the page.
     *
     * @return self
     */
