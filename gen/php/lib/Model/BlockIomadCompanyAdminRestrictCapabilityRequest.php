...
/**
 * BlockIomadCompanyAdminRestrictCapabilityRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BlockIomadCompanyAdminRestrictCapabilityRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'block_iomad_company_admin_restrict_capability_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('templateid', $data ?? [], 0);
    }
    ...
    */
     ...
     * Sets allow
     *
     * @param bool $allow Set capability?
     *
     * @return self
     */
     ...
     * Sets companyid
     *
     * @param int $companyid Company ID. Ignored if templateid is non-zero
     *
     * @return self
     */
     ...
     * Sets templateid
     *
     * @param int|null $templateid Template ID. Set to 0 if company restriction
     *
     * @return self
     */
