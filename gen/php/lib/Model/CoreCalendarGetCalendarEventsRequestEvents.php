...
/**
 * CoreCalendarGetCalendarEventsRequestEvents Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreCalendarGetCalendarEventsRequestEvents implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_calendar_get_calendar_events_request_events';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('eventids', $data ?? [], null);
    ...
    */
     ...
     * Sets categoryids
     *
     * @param object[]|null $categoryids categoryids
     *
     * @return self
     */
     ...
     * Sets eventids
     *
     * @param object[]|null $eventids eventids
     *
     * @return self
     */
    ...
    {
        if (is_null($eventids)) {
            throw new \InvalidArgumentException('non-nullable eventids cannot be null');
        }
