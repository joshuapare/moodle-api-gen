...
/**
 * ModUrlGetUrlsByCourses200ResponseUrlsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModUrlGetUrlsByCourses200ResponseUrlsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_url_get_urls_by_courses_200_response_urls_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('externalurl', $data ?? [], 'null');
    ...
    */
     ...
     * Sets display
     *
     * @param int|null $display How to display the url
     *
     * @return self
     */
    ...
    public function setExternalurl($externalurl)
    {
        if (is_null($externalurl)) {
            throw new \InvalidArgumentException('non-nullable externalurl cannot be null');
        }
     ...
     * Sets parameters
     *
     * @param string|null $parameters Parameters to append to the URL
     *
     * @return self
     */
     ...
     * Sets timemodified
     *
     * @param int|null $timemodified Last time the url was modified
     *
     * @return self
     */
