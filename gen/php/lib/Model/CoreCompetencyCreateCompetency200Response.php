...
/**
 * CoreCompetencyCreateCompetency200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreCompetencyCreateCompetency200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_competency_create_competency_200_response';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['competencyframeworkid'] === null) {
            $invalidProperties[] = "'competencyframeworkid' can't be null";
        }
        ...
        if ($this->container['ruleconfig'] === null) {
            $invalidProperties[] = "'ruleconfig' can't be null";
        }
     ...
     *
     * @param int $competencyframeworkid competencyframeworkid
     *
     * @return self
     */
     ...
     * Sets ruleconfig
     *
     * @param string $ruleconfig ruleconfig
     *
     * @return self
     */
