...
/**
 * CoreUserViewUserListRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreUserViewUserListRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_user_view_user_list_request';
    ...
    */
     ...
     * Sets courseid
     *
     * @param int $courseid id of the course, 0 for site
     *
     * @return self
     */
