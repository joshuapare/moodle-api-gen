...
/**
 * CoreCourseGetEnrolledUsersByCmidRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreCourseGetEnrolledUsersByCmidRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_course_get_enrolled_users_by_cmid_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('onlyactive', $data ?? [], false);
    }
    ...
    */
     ...
     * Sets onlyactive
     *
     * @param bool|null $onlyactive whether to return only active users or all.
     *
     * @return self
     */
    public function setOnlyactive($onlyactive)
    {
        if (is_null($onlyactive)) {
            throw new \InvalidArgumentException('non-nullable onlyactive cannot be null');
        }
