...
/**
 * ModH5pactivityGetH5pactivitiesByCourses200ResponseH5pactivitiesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModH5pactivityGetH5pactivitiesByCourses200ResponseH5pactivitiesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_h5pactivity_get_h5pactivities_by_courses_200_response_h5pactivities_inner';
    ...
    protected static $openAPITypes = [
        ...
        'course' => 'int',
        'coursemodule' => 'int',
        'deployedfile' => '\OpenAPI\Client\Model\ModH5pactivityGetH5pactivitiesByCourses200ResponseH5pactivitiesInnerDeployedfile',
        'displayoptions' => 'int',
        'enabletracking' => 'int',
        'grade' => 'int',
        'grademethod' => 'int',
        ...
        'introformat' => 'int',
        'name' => 'string',
        'package' => '\OpenAPI\Client\Model\CoreBlogGetEntries200ResponseEntriesInnerSummaryfilesInner[]',
        'timecreated' => 'int',
        'timemodified' => 'int'
    ];
    ...
    protected static $setters = [
        ...
        'deployedfile' => 'setDeployedfile',
        'displayoptions' => 'setDisplayoptions',
        'enabletracking' => 'setEnabletracking',
        'grade' => 'setGrade',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('deployedfile', $data ?? [], null);
        $this->setIfExists('displayoptions', $data ?? [], 0);
        $this->setIfExists('enabletracking', $data ?? [], 1);
        $this->setIfExists('grade', $data ?? [], 0);
        $this->setIfExists('grademethod', $data ?? [], 1);
    ...
    */
     ...
     * Sets contenthash
     *
     * @param string|null $contenthash Sha1 hash of file content.
     *
     * @return self
     */
     ...
     * Sets context
     *
     * @param int|null $context context
     *
     * @return self
     */
     ...
     * Sets course
     *
     * @param int|null $course Course id this h5p activity is part of.
     *
     * @return self
     */
     ...
     * Gets deployedfile
     *
     * @return \OpenAPI\Client\Model\ModH5pactivityGetH5pactivitiesByCourses200ResponseH5pactivitiesInnerDeployedfile|null
     */
    public function getDeployedfile()
    {
        return $this->container['deployedfile'];
    }

    /**
     * Sets deployedfile
     *
     * @param \OpenAPI\Client\Model\ModH5pactivityGetH5pactivitiesByCourses200ResponseH5pactivitiesInnerDeployedfile|null $deployedfile deployedfile
     *
     * @return self
     */
    public function setDeployedfile($deployedfile)
    {
        if (is_null($deployedfile)) {
            throw new \InvalidArgumentException('non-nullable deployedfile cannot be null');
        }
        $this->container['deployedfile'] = $deployedfile;
    ...
    {
        return $this->container['displayoptions'];
    }

    /**
     * Sets displayoptions
     *
     * @param int|null $displayoptions H5P Button display options.
     *
     * @return self
     */
    public function setDisplayoptions($displayoptions)
    {
        if (is_null($displayoptions)) {
            throw new \InvalidArgumentException('non-nullable displayoptions cannot be null');
        }
        $this->container['displayoptions'] = $displayoptions;
    ...
    {
        return $this->container['enabletracking'];
    }

    /**
     * Sets enabletracking
     *
     * @param int|null $enabletracking Enable xAPI tracking.
     *
     * @return self
     */
    public function setEnabletracking($enabletracking)
    {
        if (is_null($enabletracking)) {
            throw new \InvalidArgumentException('non-nullable enabletracking cannot be null');
        }
        $this->container['enabletracking'] = $enabletracking;
     ...
     * Sets grade
     *
     * @param int|null $grade The maximum grade for submission.
     *
     * @return self
     */
     ...
     * Sets grademethod
     *
     * @param int|null $grademethod Which H5P attempt is used for grading.
     *
     * @return self
     */
     ...
     * Sets intro
     *
     * @param string|null $intro H5P activity description.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the activity module instance.
     *
     * @return self
     */
     ...
     * Sets package
     *
     * @param \OpenAPI\Client\Model\CoreBlogGetEntries200ResponseEntriesInnerSummaryfilesInner[]|null $package package
     *
     * @return self
     */
     ...
     * Sets timecreated
     *
     * @param int|null $timecreated Timestamp of when the instance was added to the course.
     *
     * @return self
     */
     ...
     * Sets timemodified
     *
     * @param int|null $timemodified Timestamp of when the instance was last modified.
     *
     * @return self
     */
