...
/**
 * CoreGroupGetActivityAllowedGroupsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreGroupGetActivityAllowedGroupsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_group_get_activity_allowed_groups_request';
    ...
    */
     ...
     * Sets userid
     *
     * @param int|null $userid id of user, empty for current user
     *
     * @return self
     */
