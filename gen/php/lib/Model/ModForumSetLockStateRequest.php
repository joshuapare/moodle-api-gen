...
/**
 * ModForumSetLockStateRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModForumSetLockStateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_forum_set_lock_state_request';
    ...
    */
     ...
     * Sets discussionid
     *
     * @param int $discussionid The discussion to lock / unlock
     *
     * @return self
     */
     ...
     * Sets targetstate
     *
     * @param int $targetstate The timestamp for the lock state
     *
     * @return self
     */
