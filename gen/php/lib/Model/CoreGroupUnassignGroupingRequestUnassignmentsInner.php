...
/**
 * CoreGroupUnassignGroupingRequestUnassignmentsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreGroupUnassignGroupingRequestUnassignmentsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_group_unassign_grouping_request_unassignments_inner';
    ...
    */
     ...
     * Sets groupid
     *
     * @param int|null $groupid group record id
     *
     * @return self
     */
     ...
     * Sets groupingid
     *
     * @param int|null $groupingid grouping record id
     *
     * @return self
     */
