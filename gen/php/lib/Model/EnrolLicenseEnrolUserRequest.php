...
/**
 * EnrolLicenseEnrolUserRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EnrolLicenseEnrolUserRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'enrol_license_enrol_user_request';
    ...
    */
     ...
     * Sets instanceid
     *
     * @param int|null $instanceid Instance id oflicenseenrolment plugin.
     *
     * @return self
     */
     ...
     * Sets password
     *
     * @param string|null $password Enrolment key
     *
     * @return self
     */
