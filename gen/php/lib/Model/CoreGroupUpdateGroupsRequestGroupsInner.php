...
/**
 * CoreGroupUpdateGroupsRequestGroupsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreGroupUpdateGroupsRequestGroupsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_group_update_groups_request_groups_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id ID of the group
     *
     * @return self
     */
     ...
     * Sets participation
     *
     * @param bool|null $participation activity participation enabled? Only for \"all\" and \"members\" visibility
     *
     * @return self
     */
     ...
     * Sets visibility
     *
     * @param string|null $visibility group visibility mode. 0 = Visible to all. 1 = Visible to members. 2 = See own membership. 3 = Membership is hidden.
     *
     * @return self
     */
