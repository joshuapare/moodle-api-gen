...
/**
 * CoreRoleAssignRolesRequestAssignmentsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreRoleAssignRolesRequestAssignmentsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_role_assign_roles_request_assignments_inner';
    ...
    */
     ...
     * Sets contextid
     *
     * @param int|null $contextid The context to assign the user role in
     *
     * @return self
     */
     ...
     * Sets contextlevel
     *
     * @param string|null $contextlevel The context level to assign the user role in                                     (block, course, coursecat, system, user, module)
     *
     * @return self
     */
     ...
     * Sets instanceid
     *
     * @param int|null $instanceid The Instance id of item where the role needs to be assigned
     *
     * @return self
     */
