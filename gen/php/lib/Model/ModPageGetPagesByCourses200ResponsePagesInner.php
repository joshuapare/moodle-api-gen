...
/**
 * ModPageGetPagesByCourses200ResponsePagesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModPageGetPagesByCourses200ResponsePagesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_page_get_pages_by_courses_200_response_pages_inner';
    ...
    */
     ...
     * Sets display
     *
     * @param int|null $display How to display the page
     *
     * @return self
     */
     ...
     * Sets timemodified
     *
     * @param int|null $timemodified Last time the page was modified
     *
     * @return self
     */
