...
/**
 * CoreBlockGetDashboardBlocks200ResponseBlocksInnerContentsFilesInner Class Doc Comment
 *
 * @category Class
 * @description File.
 * @package  OpenAPI\Client
 ...
 */
class CoreBlockGetDashboardBlocks200ResponseBlocksInnerContentsFilesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_block_get_dashboard_blocks_200_response_blocks_inner_contents_files_inner';
    ...
    protected static $setters = [
        ...
        'fileurl' => 'setFileurl',
        'isexternalfile' => 'setIsexternalfile',
    ...
    protected static $getters = [
        ...
        'fileurl' => 'getFileurl',
        'isexternalfile' => 'getIsexternalfile',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('isexternalfile', $data ?? [], null);
        $this->setIfExists('mimetype', $data ?? [], null);
        $this->setIfExists('repositorytype', $data ?? [], null);
    ...
    */
     ...
     * @return bool|null
     */
    public function getIsexternalfile()
    {
        return $this->container['isexternalfile'];
    }

    /**
     * Sets isexternalfile
     *
     * @param bool|null $isexternalfile Whether is an external file.
     *
     * @return self
     */
    public function setIsexternalfile($isexternalfile)
    {
        if (is_null($isexternalfile)) {
            throw new \InvalidArgumentException('non-nullable isexternalfile cannot be null');
        }
        $this->container['isexternalfile'] = $isexternalfile;
     ...
     * Sets repositorytype
     *
     * @param string|null $repositorytype The repository type for external files.
     *
     * @return self
     */
    public function setRepositorytype($repositorytype)
    {
        if (is_null($repositorytype)) {
            throw new \InvalidArgumentException('non-nullable repositorytype cannot be null');
        }
