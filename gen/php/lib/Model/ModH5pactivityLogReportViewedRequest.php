...
/**
 * ModH5pactivityLogReportViewedRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModH5pactivityLogReportViewedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_h5pactivity_log_report_viewed_request';
    ...
    */
     ...
     * Sets userid
     *
     * @param int|null $userid The user id to log attempt (null means only current user)
     *
     * @return self
     */
