...
/**
 * CoreTagGetTagCloud200ResponseTagsInner Class Doc Comment
 *
 * @category Class
 * @description Tags.
 * @package  OpenAPI\Client
 ...
 */
class CoreTagGetTagCloud200ResponseTagsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_tag_get_tag_cloud_200_response_tags_inner';
    ...
    */
     ...
     * Sets count
     *
     * @param int|null $count Number of tag instances.
     *
     * @return self
     */
     ...
     * Sets flag
     *
     * @param bool|null $flag Whether the tag is flagged as inappropriate.
     *
     * @return self
     */
     ...
     * Sets isstandard
     *
     * @param bool|null $isstandard Whether is a standard tag or not.
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param int|null $size Proportional size to display the tag.
     *
     * @return self
     */
     ...
     * Sets viewurl
     *
     * @param string|null $viewurl URL to view the tag index.
     *
     * @return self
     */
