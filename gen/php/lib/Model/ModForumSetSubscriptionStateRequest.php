...
/**
 * ModForumSetSubscriptionStateRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModForumSetSubscriptionStateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_forum_set_subscription_state_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('targetstate', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['targetstate'] === null) {
            $invalidProperties[] = "'targetstate' can't be null";
        }
     ...
     * Sets discussionid
     *
     * @param int $discussionid The discussion to subscribe or unsubscribe
     *
     * @return self
     */
     ...
     * Sets forumid
     *
     * @param int $forumid Forum that the discussion is in
     *
     * @return self
     */
    ...
    {
        return $this->container['targetstate'];
    }

    /**
     * Sets targetstate
     *
     * @param bool $targetstate The target state
     *
     * @return self
     */
    public function setTargetstate($targetstate)
    {
        if (is_null($targetstate)) {
            throw new \InvalidArgumentException('non-nullable targetstate cannot be null');
        }
        $this->container['targetstate'] = $targetstate;
