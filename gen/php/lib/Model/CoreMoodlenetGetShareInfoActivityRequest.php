...
/**
 * CoreMoodlenetGetShareInfoActivityRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreMoodlenetGetShareInfoActivityRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_moodlenet_get_share_info_activity_request';
    ...
    */
     ...
     * Sets cmid
     *
     * @param int $cmid The cmid of the activity
     *
     * @return self
     */
