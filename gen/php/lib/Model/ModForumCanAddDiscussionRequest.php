...
/**
 * ModForumCanAddDiscussionRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModForumCanAddDiscussionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_forum_can_add_discussion_request';
    ...
    */
     ...
     * Sets groupid
     *
     * @param int|null $groupid The group to check, default to active group.                                                 Use -1 to check if the user can post in all the groups.
     *
     * @return self
     */
