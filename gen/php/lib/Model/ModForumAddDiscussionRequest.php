...
/**
 * ModForumAddDiscussionRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModForumAddDiscussionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_forum_add_discussion_request';
    ...
    protected static $openAPITypes = [
        ...
        'groupid' => 'int',
        'message' => 'string',
        'options' => '\OpenAPI\Client\Model\ModForumAddDiscussionRequestOptionsInner[]',
        'subject' => 'string'
    ];
    ...
    */
     ...
     * Sets groupid
     *
     * @param int|null $groupid The group, default to 0
     *
     * @return self
     */
     ...
     * Gets options
     *
     * @return \OpenAPI\Client\Model\ModForumAddDiscussionRequestOptionsInner[]|null
     */
     ...
     * Sets options
     *
     * @param \OpenAPI\Client\Model\ModForumAddDiscussionRequestOptionsInner[]|null $options options
     *
     * @return self
     */
