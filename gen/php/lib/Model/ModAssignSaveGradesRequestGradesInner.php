...
/**
 * ModAssignSaveGradesRequestGradesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModAssignSaveGradesRequestGradesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mod_assign_save_grades_request_grades_inner';
    ...
    protected static $openAPITypes = [
        ...
        'attemptnumber' => 'int',
        'grade' => 'float',
        'plugindata' => '\OpenAPI\Client\Model\ModAssignSaveGradesRequestGradesInnerPlugindata',
        'userid' => 'int',
    ...
    */
     ...
     * Sets addattempt
     *
     * @param bool|null $addattempt Allow another attempt if manual attempt reopen method
     *
     * @return self
     */
     ...
     * Sets attemptnumber
     *
     * @param int|null $attemptnumber The attempt number (-1 means latest attempt)
     *
     * @return self
     */
     ...
     * Sets grade
     *
     * @param float|null $grade The new grade for this user. Ignored if advanced grading used
     *
     * @return self
     */
     ...
     * Gets plugindata
     *
     * @return \OpenAPI\Client\Model\ModAssignSaveGradesRequestGradesInnerPlugindata|null
     */
     ...
     * Sets plugindata
     *
     * @param \OpenAPI\Client\Model\ModAssignSaveGradesRequestGradesInnerPlugindata|null $plugindata plugindata
     *
     * @return self
     */
     ...
     * Sets userid
     *
     * @param int|null $userid The student id to operate on
     *
     * @return self
     */
     ...
     * Sets workflowstate
     *
     * @param string|null $workflowstate The next marking workflow state
     *
     * @return self
     */
