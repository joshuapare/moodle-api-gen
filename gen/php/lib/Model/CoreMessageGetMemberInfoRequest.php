...
/**
 * CoreMessageGetMemberInfoRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CoreMessageGetMemberInfoRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'core_message_get_member_info_request';
    ...
    */
     ...
     *
     * @param bool|null $includecontactrequests include contact requests in response
     *
     * @return self
     */
     ...
     *
     * @param bool|null $includeprivacyinfo include privacy info in response
     *
     * @return self
     */
     ...
     *
     * @param int $referenceuserid id of the user
     *
     * @return self
     */
    public function setReferenceuserid($referenceuserid)
    {
        if (is_null($referenceuserid)) {
            throw new \InvalidArgumentException('non-nullable referenceuserid cannot be null');
        }
