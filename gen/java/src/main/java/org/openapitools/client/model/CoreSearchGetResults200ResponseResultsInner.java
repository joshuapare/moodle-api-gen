...
public class CoreSearchGetResults200ResponseResultsInner {
  ...
  private String coursefullname = "null";
  ...
  private Integer multiplefiles = null;
  ...
  public CoreSearchGetResults200ResponseResultsInner() {
  }

  public CoreSearchGetResults200ResponseResultsInner areaname(String areaname) {
  ...
  **/
  ...
  public CoreSearchGetResults200ResponseResultsInner componentname(String componentname) {
  ...
  **/
  ...
  public CoreSearchGetResults200ResponseResultsInner content(String content) {
  ...
  **/
  ...
  public CoreSearchGetResults200ResponseResultsInner contextid(Integer contextid) {
  ...
  **/
  ...
  public CoreSearchGetResults200ResponseResultsInner contexturl(String contexturl) {
  ...
  **/
  ...
  public CoreSearchGetResults200ResponseResultsInner coursefullname(String coursefullname) {
  ...
  **/
  ...
  public CoreSearchGetResults200ResponseResultsInner courseurl(String courseurl) {
  ...
  **/
  ...
  public CoreSearchGetResults200ResponseResultsInner description1(String description1) {
  ...
  **/
  ...
  public CoreSearchGetResults200ResponseResultsInner description2(String description2) {
  ...
  **/
  ...
  public CoreSearchGetResults200ResponseResultsInner docurl(String docurl) {
    this.docurl = docurl;
    return this;
  }
  ...
  **/
  ...
  public CoreSearchGetResults200ResponseResultsInner filename(String filename) {
  ...
  **/
  ...
  public CoreSearchGetResults200ResponseResultsInner filenames(String filenames) {
  ...
  **/
  ...
  public CoreSearchGetResults200ResponseResultsInner iconurl(String iconurl) {
  ...
  **/
  ...
  public CoreSearchGetResults200ResponseResultsInner itemid(Integer itemid) {
    this.itemid = itemid;
    return this;
  }
  ...
  **/
  ...
  public CoreSearchGetResults200ResponseResultsInner multiplefiles(Integer multiplefiles) {
  ...
  **/
  ...
  public CoreSearchGetResults200ResponseResultsInner textformat(Integer textformat) {
  ...
  **/
  ...
  public CoreSearchGetResults200ResponseResultsInner timemodified(Integer timemodified) {
  ...
  **/
  ...
  public CoreSearchGetResults200ResponseResultsInner title(String title) {
    this.title = title;
    return this;
  }
  ...
  **/
  ...
  public CoreSearchGetResults200ResponseResultsInner userfullname(String userfullname) {
  ...
  **/
  ...
  public CoreSearchGetResults200ResponseResultsInner userid(Integer userid) {
    this.userid = userid;
    return this;
  }
  ...
  **/
  ...
  public CoreSearchGetResults200ResponseResultsInner userurl(String userurl) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CoreSearchGetResults200ResponseResultsInner coreSearchGetResults200ResponseResultsInner = (CoreSearchGetResults200ResponseResultsInner) o;
    return Objects.equals(this.areaname, coreSearchGetResults200ResponseResultsInner.areaname) &&
        Objects.equals(this.componentname, coreSearchGetResults200ResponseResultsInner.componentname) &&
        Objects.equals(this.content, coreSearchGetResults200ResponseResultsInner.content) &&
        Objects.equals(this.contextid, coreSearchGetResults200ResponseResultsInner.contextid) &&
        Objects.equals(this.contexturl, coreSearchGetResults200ResponseResultsInner.contexturl) &&
        Objects.equals(this.coursefullname, coreSearchGetResults200ResponseResultsInner.coursefullname) &&
        Objects.equals(this.courseurl, coreSearchGetResults200ResponseResultsInner.courseurl) &&
        Objects.equals(this.description1, coreSearchGetResults200ResponseResultsInner.description1) &&
        Objects.equals(this.description2, coreSearchGetResults200ResponseResultsInner.description2) &&
        Objects.equals(this.docurl, coreSearchGetResults200ResponseResultsInner.docurl) &&
        Objects.equals(this.filename, coreSearchGetResults200ResponseResultsInner.filename) &&
        Objects.equals(this.filenames, coreSearchGetResults200ResponseResultsInner.filenames) &&
        Objects.equals(this.iconurl, coreSearchGetResults200ResponseResultsInner.iconurl) &&
        Objects.equals(this.itemid, coreSearchGetResults200ResponseResultsInner.itemid) &&
        Objects.equals(this.multiplefiles, coreSearchGetResults200ResponseResultsInner.multiplefiles) &&
        Objects.equals(this.textformat, coreSearchGetResults200ResponseResultsInner.textformat) &&
        Objects.equals(this.timemodified, coreSearchGetResults200ResponseResultsInner.timemodified) &&
        Objects.equals(this.title, coreSearchGetResults200ResponseResultsInner.title) &&
        Objects.equals(this.userfullname, coreSearchGetResults200ResponseResultsInner.userfullname) &&
        Objects.equals(this.userid, coreSearchGetResults200ResponseResultsInner.userid) &&
        Objects.equals(this.userurl, coreSearchGetResults200ResponseResultsInner.userurl);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to CoreSearchGetResults200ResponseResultsInner
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CoreSearchGetResults200ResponseResultsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CoreSearchGetResults200ResponseResultsInner is not found in the empty JSON string", CoreSearchGetResults200ResponseResultsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CoreSearchGetResults200ResponseResultsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CoreSearchGetResults200ResponseResultsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CoreSearchGetResults200ResponseResultsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CoreSearchGetResults200ResponseResultsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CoreSearchGetResults200ResponseResultsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CoreSearchGetResults200ResponseResultsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CoreSearchGetResults200ResponseResultsInner>() {
           @Override
           public void write(JsonWriter out, CoreSearchGetResults200ResponseResultsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CoreSearchGetResults200ResponseResultsInner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CoreSearchGetResults200ResponseResultsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CoreSearchGetResults200ResponseResultsInner
  * @throws IOException if the JSON string is invalid with respect to CoreSearchGetResults200ResponseResultsInner
  */
  public static CoreSearchGetResults200ResponseResultsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CoreSearchGetResults200ResponseResultsInner.class);
  }

 /**
  * Convert an instance of CoreSearchGetResults200ResponseResultsInner to an JSON string
  *
  * @return JSON string
  */
