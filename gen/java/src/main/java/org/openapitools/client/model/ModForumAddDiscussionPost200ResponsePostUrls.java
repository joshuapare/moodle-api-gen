...
public class ModForumAddDiscussionPost200ResponsePostUrls {
  ...
  private String markasunread = "null";
  ...
  private String viewisolated = "null";
  ...
  public ModForumAddDiscussionPost200ResponsePostUrls() {
  }

  public ModForumAddDiscussionPost200ResponsePostUrls delete(String delete) {
    this.delete = delete;
    return this;
  }
  ...
  **/
  ...
  public ModForumAddDiscussionPost200ResponsePostUrls discuss(String discuss) {
  ...
  **/
  ...
  public ModForumAddDiscussionPost200ResponsePostUrls edit(String edit) {
    this.edit = edit;
    return this;
  }
  ...
  **/
  ...
  public ModForumAddDiscussionPost200ResponsePostUrls export(String export) {
    this.export = export;
    return this;
  }
  ...
  **/
  ...
  public ModForumAddDiscussionPost200ResponsePostUrls markasread(String markasread) {
  ...
  **/
  ...
  public ModForumAddDiscussionPost200ResponsePostUrls markasunread(String markasunread) {
  ...
  **/
  ...
  public ModForumAddDiscussionPost200ResponsePostUrls reply(String reply) {
    this.reply = reply;
    return this;
  }
  ...
  **/
  ...
  public ModForumAddDiscussionPost200ResponsePostUrls split(String split) {
    this.split = split;
    return this;
  }
  ...
  **/
  ...
  public ModForumAddDiscussionPost200ResponsePostUrls view(String view) {
    this.view = view;
    return this;
  }
  ...
  **/
  ...
  public ModForumAddDiscussionPost200ResponsePostUrls viewisolated(String viewisolated) {
  ...
  **/
  ...
  public ModForumAddDiscussionPost200ResponsePostUrls viewparent(String viewparent) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModForumAddDiscussionPost200ResponsePostUrls modForumAddDiscussionPost200ResponsePostUrls = (ModForumAddDiscussionPost200ResponsePostUrls) o;
    return Objects.equals(this.delete, modForumAddDiscussionPost200ResponsePostUrls.delete) &&
        Objects.equals(this.discuss, modForumAddDiscussionPost200ResponsePostUrls.discuss) &&
        Objects.equals(this.edit, modForumAddDiscussionPost200ResponsePostUrls.edit) &&
        Objects.equals(this.export, modForumAddDiscussionPost200ResponsePostUrls.export) &&
        Objects.equals(this.markasread, modForumAddDiscussionPost200ResponsePostUrls.markasread) &&
        Objects.equals(this.markasunread, modForumAddDiscussionPost200ResponsePostUrls.markasunread) &&
        Objects.equals(this.reply, modForumAddDiscussionPost200ResponsePostUrls.reply) &&
        Objects.equals(this.split, modForumAddDiscussionPost200ResponsePostUrls.split) &&
        Objects.equals(this.view, modForumAddDiscussionPost200ResponsePostUrls.view) &&
        Objects.equals(this.viewisolated, modForumAddDiscussionPost200ResponsePostUrls.viewisolated) &&
        Objects.equals(this.viewparent, modForumAddDiscussionPost200ResponsePostUrls.viewparent);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ModForumAddDiscussionPost200ResponsePostUrls
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModForumAddDiscussionPost200ResponsePostUrls.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModForumAddDiscussionPost200ResponsePostUrls is not found in the empty JSON string", ModForumAddDiscussionPost200ResponsePostUrls.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModForumAddDiscussionPost200ResponsePostUrls.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModForumAddDiscussionPost200ResponsePostUrls` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModForumAddDiscussionPost200ResponsePostUrls.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModForumAddDiscussionPost200ResponsePostUrls' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModForumAddDiscussionPost200ResponsePostUrls> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModForumAddDiscussionPost200ResponsePostUrls.class));

       return (TypeAdapter<T>) new TypeAdapter<ModForumAddDiscussionPost200ResponsePostUrls>() {
           @Override
           public void write(JsonWriter out, ModForumAddDiscussionPost200ResponsePostUrls value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModForumAddDiscussionPost200ResponsePostUrls read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ModForumAddDiscussionPost200ResponsePostUrls given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ModForumAddDiscussionPost200ResponsePostUrls
  * @throws IOException if the JSON string is invalid with respect to ModForumAddDiscussionPost200ResponsePostUrls
  */
  public static ModForumAddDiscussionPost200ResponsePostUrls fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModForumAddDiscussionPost200ResponsePostUrls.class);
  }

 /**
  * Convert an instance of ModForumAddDiscussionPost200ResponsePostUrls to an JSON string
  *
  * @return JSON string
  */
