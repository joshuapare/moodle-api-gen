...
public class ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner {
  ...
  public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner() {
  }

  public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner approved(Boolean approved) {
  ...
  **/
  ...
  public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner attachment(Boolean attachment) {
  ...
  **/
  ...
  public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner attachments(List<CoreBlockGetDashboardBlocks200ResponseBlocksInnerContentsFilesInner> attachments) {
    this.attachments = attachments;
    return this;
  }

  public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner addAttachmentsItem(CoreBlockGetDashboardBlocks200ResponseBlocksInnerContentsFilesInner attachmentsItem) {
  ...
  **/
  ...
  public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner casesensitive(Boolean casesensitive) {
  ...
  **/
  ...
  public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner concept(String concept) {
  ...
  **/
  ...
  public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner definition(String definition) {
  ...
  **/
  ...
  public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner definitionformat(Integer definitionformat) {
  ...
  **/
  ...
  public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner definitioninlinefiles(List<CoreBlockGetDashboardBlocks200ResponseBlocksInnerContentsFilesInner> definitioninlinefiles) {
    this.definitioninlinefiles = definitioninlinefiles;
    return this;
  }

  public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner addDefinitioninlinefilesItem(CoreBlockGetDashboardBlocks200ResponseBlocksInnerContentsFilesInner definitioninlinefilesItem) {
  ...
  **/
  ...
  public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner definitiontrust(Boolean definitiontrust) {
  ...
  **/
  ...
  public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner fullmatch(Boolean fullmatch) {
  ...
  **/
  ...
  public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner glossaryid(Integer glossaryid) {
  ...
  **/
  ...
  public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner sourceglossaryid(Integer sourceglossaryid) {
  ...
  **/
  ...
  public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner tags(List<ModDataGetEntries200ResponseEntriesInnerTagsInner> tags) {
    this.tags = tags;
    return this;
  }

  public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner addTagsItem(ModDataGetEntries200ResponseEntriesInnerTagsInner tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner teacherentry(Boolean teacherentry) {
  ...
  **/
  ...
  public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner timecreated(Integer timecreated) {
  ...
  **/
  ...
  public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner timemodified(Integer timemodified) {
  ...
  **/
  ...
  public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner usedynalink(Boolean usedynalink) {
  ...
  **/
  ...
  public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner userfullname(String userfullname) {
  ...
  **/
  ...
  public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner userid(Integer userid) {
    this.userid = userid;
    return this;
  }
  ...
  **/
  ...
  public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner userpictureurl(String userpictureurl) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner modGlossaryGetEntriesByAuthorId200ResponseEntriesInner = (ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner) o;
    return Objects.equals(this.approved, modGlossaryGetEntriesByAuthorId200ResponseEntriesInner.approved) &&
        Objects.equals(this.attachment, modGlossaryGetEntriesByAuthorId200ResponseEntriesInner.attachment) &&
        Objects.equals(this.attachments, modGlossaryGetEntriesByAuthorId200ResponseEntriesInner.attachments) &&
        Objects.equals(this.casesensitive, modGlossaryGetEntriesByAuthorId200ResponseEntriesInner.casesensitive) &&
        Objects.equals(this.concept, modGlossaryGetEntriesByAuthorId200ResponseEntriesInner.concept) &&
        Objects.equals(this.definition, modGlossaryGetEntriesByAuthorId200ResponseEntriesInner.definition) &&
        Objects.equals(this.definitionformat, modGlossaryGetEntriesByAuthorId200ResponseEntriesInner.definitionformat) &&
        Objects.equals(this.definitioninlinefiles, modGlossaryGetEntriesByAuthorId200ResponseEntriesInner.definitioninlinefiles) &&
        Objects.equals(this.definitiontrust, modGlossaryGetEntriesByAuthorId200ResponseEntriesInner.definitiontrust) &&
        Objects.equals(this.fullmatch, modGlossaryGetEntriesByAuthorId200ResponseEntriesInner.fullmatch) &&
        Objects.equals(this.glossaryid, modGlossaryGetEntriesByAuthorId200ResponseEntriesInner.glossaryid) &&
        Objects.equals(this.id, modGlossaryGetEntriesByAuthorId200ResponseEntriesInner.id) &&
        Objects.equals(this.sourceglossaryid, modGlossaryGetEntriesByAuthorId200ResponseEntriesInner.sourceglossaryid) &&
        Objects.equals(this.tags, modGlossaryGetEntriesByAuthorId200ResponseEntriesInner.tags) &&
        Objects.equals(this.teacherentry, modGlossaryGetEntriesByAuthorId200ResponseEntriesInner.teacherentry) &&
        Objects.equals(this.timecreated, modGlossaryGetEntriesByAuthorId200ResponseEntriesInner.timecreated) &&
        Objects.equals(this.timemodified, modGlossaryGetEntriesByAuthorId200ResponseEntriesInner.timemodified) &&
        Objects.equals(this.usedynalink, modGlossaryGetEntriesByAuthorId200ResponseEntriesInner.usedynalink) &&
        Objects.equals(this.userfullname, modGlossaryGetEntriesByAuthorId200ResponseEntriesInner.userfullname) &&
        Objects.equals(this.userid, modGlossaryGetEntriesByAuthorId200ResponseEntriesInner.userid) &&
        Objects.equals(this.userpictureurl, modGlossaryGetEntriesByAuthorId200ResponseEntriesInner.userpictureurl);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner is not found in the empty JSON string", ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner>() {
           @Override
           public void write(JsonWriter out, ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner
  * @throws IOException if the JSON string is invalid with respect to ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner
  */
  public static ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner.class);
  }

 /**
  * Convert an instance of ModGlossaryGetEntriesByAuthorId200ResponseEntriesInner to an JSON string
  *
  * @return JSON string
  */
