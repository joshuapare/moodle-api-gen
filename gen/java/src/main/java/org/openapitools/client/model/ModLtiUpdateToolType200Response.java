...
public class ModLtiUpdateToolType200Response {
  ...
  public ModLtiUpdateToolType200Response() {
  }

  public ModLtiUpdateToolType200Response capabilitygroups(List<Object> capabilitygroups) {
    this.capabilitygroups = capabilitygroups;
    return this;
  }

  public ModLtiUpdateToolType200Response addCapabilitygroupsItem(Object capabilitygroupsItem) {
  ...
  **/
  ...
  public ModLtiUpdateToolType200Response clientid(String clientid) {
  ...
  **/
  ...
  public ModLtiUpdateToolType200Response courseid(Integer courseid) {
  ...
  **/
  ...
  public ModLtiUpdateToolType200Response deploymentid(Integer deploymentid) {
  ...
  **/
  ...
  public ModLtiUpdateToolType200Response description(String description) {
  ...
  **/
  ...
  public ModLtiUpdateToolType200Response hascapabilitygroups(Boolean hascapabilitygroups) {
  ...
  **/
  ...
  public ModLtiUpdateToolType200Response id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public ModLtiUpdateToolType200Response instancecount(Integer instancecount) {
  ...
  **/
  ...
  public ModLtiUpdateToolType200Response instanceids(List<Object> instanceids) {
    this.instanceids = instanceids;
    return this;
  }

  public ModLtiUpdateToolType200Response addInstanceidsItem(Object instanceidsItem) {
  ...
  **/
  ...
  public ModLtiUpdateToolType200Response name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public ModLtiUpdateToolType200Response platformid(String platformid) {
  ...
  **/
  ...
  public ModLtiUpdateToolType200Response state(ModLtiGetToolTypesAndProxies200ResponseTypesInnerState state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public ModLtiUpdateToolType200Response urls(ModLtiGetToolTypesAndProxies200ResponseTypesInnerUrls urls) {
    this.urls = urls;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModLtiUpdateToolType200Response modLtiUpdateToolType200Response = (ModLtiUpdateToolType200Response) o;
    return Objects.equals(this.capabilitygroups, modLtiUpdateToolType200Response.capabilitygroups) &&
        Objects.equals(this.clientid, modLtiUpdateToolType200Response.clientid) &&
        Objects.equals(this.courseid, modLtiUpdateToolType200Response.courseid) &&
        Objects.equals(this.deploymentid, modLtiUpdateToolType200Response.deploymentid) &&
        Objects.equals(this.description, modLtiUpdateToolType200Response.description) &&
        Objects.equals(this.hascapabilitygroups, modLtiUpdateToolType200Response.hascapabilitygroups) &&
        Objects.equals(this.id, modLtiUpdateToolType200Response.id) &&
        Objects.equals(this.instancecount, modLtiUpdateToolType200Response.instancecount) &&
        Objects.equals(this.instanceids, modLtiUpdateToolType200Response.instanceids) &&
        Objects.equals(this.name, modLtiUpdateToolType200Response.name) &&
        Objects.equals(this.platformid, modLtiUpdateToolType200Response.platformid) &&
        Objects.equals(this.state, modLtiUpdateToolType200Response.state) &&
        Objects.equals(this.urls, modLtiUpdateToolType200Response.urls);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ModLtiUpdateToolType200Response
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModLtiUpdateToolType200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModLtiUpdateToolType200Response is not found in the empty JSON string", ModLtiUpdateToolType200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModLtiUpdateToolType200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModLtiUpdateToolType200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ModLtiUpdateToolType200Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModLtiUpdateToolType200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModLtiUpdateToolType200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModLtiUpdateToolType200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModLtiUpdateToolType200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ModLtiUpdateToolType200Response>() {
           @Override
           public void write(JsonWriter out, ModLtiUpdateToolType200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModLtiUpdateToolType200Response read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ModLtiUpdateToolType200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ModLtiUpdateToolType200Response
  * @throws IOException if the JSON string is invalid with respect to ModLtiUpdateToolType200Response
  */
  public static ModLtiUpdateToolType200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModLtiUpdateToolType200Response.class);
  }

 /**
  * Convert an instance of ModLtiUpdateToolType200Response to an JSON string
  *
  * @return JSON string
  */
