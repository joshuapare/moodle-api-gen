...
public class CoreCompetencyReadPlan200ResponseCommentarea {
  ...
  private Boolean canpostorhascomments;
  ...
  private String collapsediconkey;
  ...
  private Boolean displaytotalcount;
  ...
  public CoreCompetencyReadPlan200ResponseCommentarea autostart(Boolean autostart) {
  ...
  **/
  ...
  public CoreCompetencyReadPlan200ResponseCommentarea canpost(Boolean canpost) {
  ...
  **/
  ...
  public CoreCompetencyReadPlan200ResponseCommentarea canpostorhascomments(Boolean canpostorhascomments) {
  ...
  **/
  ...
  public CoreCompetencyReadPlan200ResponseCommentarea canview(Boolean canview) {
  ...
  **/
  ...
  public CoreCompetencyReadPlan200ResponseCommentarea cid(String cid) {
    this.cid = cid;
    return this;
  }
  ...
  **/
  ...
  public CoreCompetencyReadPlan200ResponseCommentarea collapsediconkey(String collapsediconkey) {
  ...
  **/
  ...
  public CoreCompetencyReadPlan200ResponseCommentarea commentarea(String commentarea) {
  ...
  **/
  ...
  public CoreCompetencyReadPlan200ResponseCommentarea component(String component) {
  ...
  **/
  ...
  public CoreCompetencyReadPlan200ResponseCommentarea contextid(Integer contextid) {
  ...
  **/
  ...
  public CoreCompetencyReadPlan200ResponseCommentarea count(Integer count) {
    this.count = count;
    return this;
  }
  ...
  **/
  ...
  public CoreCompetencyReadPlan200ResponseCommentarea courseid(Integer courseid) {
  ...
  **/
  ...
  public CoreCompetencyReadPlan200ResponseCommentarea displaycancel(Boolean displaycancel) {
  ...
  **/
  ...
  public CoreCompetencyReadPlan200ResponseCommentarea displaytotalcount(Boolean displaytotalcount) {
  ...
  **/
  ...
  public CoreCompetencyReadPlan200ResponseCommentarea fullwidth(Boolean fullwidth) {
  ...
  **/
  ...
  public CoreCompetencyReadPlan200ResponseCommentarea itemid(Integer itemid) {
    this.itemid = itemid;
    return this;
  }
  ...
  **/
  ...
  public CoreCompetencyReadPlan200ResponseCommentarea linktext(String linktext) {
  ...
  **/
  ...
  public CoreCompetencyReadPlan200ResponseCommentarea notoggle(Boolean notoggle) {
  ...
  **/
  ...
  public CoreCompetencyReadPlan200ResponseCommentarea template(String template) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CoreCompetencyReadPlan200ResponseCommentarea coreCompetencyReadPlan200ResponseCommentarea = (CoreCompetencyReadPlan200ResponseCommentarea) o;
    return Objects.equals(this.autostart, coreCompetencyReadPlan200ResponseCommentarea.autostart) &&
        Objects.equals(this.canpost, coreCompetencyReadPlan200ResponseCommentarea.canpost) &&
        Objects.equals(this.canpostorhascomments, coreCompetencyReadPlan200ResponseCommentarea.canpostorhascomments) &&
        Objects.equals(this.canview, coreCompetencyReadPlan200ResponseCommentarea.canview) &&
        Objects.equals(this.cid, coreCompetencyReadPlan200ResponseCommentarea.cid) &&
        Objects.equals(this.collapsediconkey, coreCompetencyReadPlan200ResponseCommentarea.collapsediconkey) &&
        Objects.equals(this.commentarea, coreCompetencyReadPlan200ResponseCommentarea.commentarea) &&
        Objects.equals(this.component, coreCompetencyReadPlan200ResponseCommentarea.component) &&
        Objects.equals(this.contextid, coreCompetencyReadPlan200ResponseCommentarea.contextid) &&
        Objects.equals(this.count, coreCompetencyReadPlan200ResponseCommentarea.count) &&
        Objects.equals(this.courseid, coreCompetencyReadPlan200ResponseCommentarea.courseid) &&
        Objects.equals(this.displaycancel, coreCompetencyReadPlan200ResponseCommentarea.displaycancel) &&
        Objects.equals(this.displaytotalcount, coreCompetencyReadPlan200ResponseCommentarea.displaytotalcount) &&
        Objects.equals(this.fullwidth, coreCompetencyReadPlan200ResponseCommentarea.fullwidth) &&
        Objects.equals(this.itemid, coreCompetencyReadPlan200ResponseCommentarea.itemid) &&
        Objects.equals(this.linktext, coreCompetencyReadPlan200ResponseCommentarea.linktext) &&
        Objects.equals(this.notoggle, coreCompetencyReadPlan200ResponseCommentarea.notoggle) &&
        Objects.equals(this.template, coreCompetencyReadPlan200ResponseCommentarea.template);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to CoreCompetencyReadPlan200ResponseCommentarea
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CoreCompetencyReadPlan200ResponseCommentarea.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CoreCompetencyReadPlan200ResponseCommentarea is not found in the empty JSON string", CoreCompetencyReadPlan200ResponseCommentarea.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CoreCompetencyReadPlan200ResponseCommentarea.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CoreCompetencyReadPlan200ResponseCommentarea` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CoreCompetencyReadPlan200ResponseCommentarea.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CoreCompetencyReadPlan200ResponseCommentarea.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CoreCompetencyReadPlan200ResponseCommentarea' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CoreCompetencyReadPlan200ResponseCommentarea> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CoreCompetencyReadPlan200ResponseCommentarea.class));

       return (TypeAdapter<T>) new TypeAdapter<CoreCompetencyReadPlan200ResponseCommentarea>() {
           @Override
           public void write(JsonWriter out, CoreCompetencyReadPlan200ResponseCommentarea value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CoreCompetencyReadPlan200ResponseCommentarea read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CoreCompetencyReadPlan200ResponseCommentarea given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CoreCompetencyReadPlan200ResponseCommentarea
  * @throws IOException if the JSON string is invalid with respect to CoreCompetencyReadPlan200ResponseCommentarea
  */
  public static CoreCompetencyReadPlan200ResponseCommentarea fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CoreCompetencyReadPlan200ResponseCommentarea.class);
  }

 /**
  * Convert an instance of CoreCompetencyReadPlan200ResponseCommentarea to an JSON string
  *
  * @return JSON string
  */
