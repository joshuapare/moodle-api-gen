...
public class CoreSearchGetTopResultsRequestFilters {
  ...
  public CoreSearchGetTopResultsRequestFilters() {
  }

  public CoreSearchGetTopResultsRequestFilters areaids(List<Object> areaids) {
    this.areaids = areaids;
    return this;
  }

  public CoreSearchGetTopResultsRequestFilters addAreaidsItem(Object areaidsItem) {
  ...
  **/
  ...
  public CoreSearchGetTopResultsRequestFilters cat(String cat) {
    this.cat = cat;
    return this;
  }
  ...
  **/
  ...
  public CoreSearchGetTopResultsRequestFilters contextids(List<Object> contextids) {
    this.contextids = contextids;
    return this;
  }

  public CoreSearchGetTopResultsRequestFilters addContextidsItem(Object contextidsItem) {
  ...
  **/
  ...
  public CoreSearchGetTopResultsRequestFilters courseids(List<Object> courseids) {
    this.courseids = courseids;
    return this;
  }

  public CoreSearchGetTopResultsRequestFilters addCourseidsItem(Object courseidsItem) {
  ...
  **/
  ...
  public CoreSearchGetTopResultsRequestFilters groupids(List<Object> groupids) {
    this.groupids = groupids;
    return this;
  }

  public CoreSearchGetTopResultsRequestFilters addGroupidsItem(Object groupidsItem) {
  ...
  **/
  ...
  public CoreSearchGetTopResultsRequestFilters mycoursesonly(Boolean mycoursesonly) {
  ...
  **/
  ...
  public CoreSearchGetTopResultsRequestFilters order(String order) {
    this.order = order;
    return this;
  }
  ...
  **/
  ...
  public CoreSearchGetTopResultsRequestFilters timeend(Integer timeend) {
  ...
  **/
  ...
  public CoreSearchGetTopResultsRequestFilters timestart(Integer timestart) {
  ...
  **/
  ...
  public CoreSearchGetTopResultsRequestFilters title(String title) {
    this.title = title;
    return this;
  }
  ...
  **/
  ...
  public CoreSearchGetTopResultsRequestFilters userids(List<Object> userids) {
    this.userids = userids;
    return this;
  }

  public CoreSearchGetTopResultsRequestFilters addUseridsItem(Object useridsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CoreSearchGetTopResultsRequestFilters coreSearchGetTopResultsRequestFilters = (CoreSearchGetTopResultsRequestFilters) o;
    return Objects.equals(this.areaids, coreSearchGetTopResultsRequestFilters.areaids) &&
        Objects.equals(this.cat, coreSearchGetTopResultsRequestFilters.cat) &&
        Objects.equals(this.contextids, coreSearchGetTopResultsRequestFilters.contextids) &&
        Objects.equals(this.courseids, coreSearchGetTopResultsRequestFilters.courseids) &&
        Objects.equals(this.groupids, coreSearchGetTopResultsRequestFilters.groupids) &&
        Objects.equals(this.mycoursesonly, coreSearchGetTopResultsRequestFilters.mycoursesonly) &&
        Objects.equals(this.order, coreSearchGetTopResultsRequestFilters.order) &&
        Objects.equals(this.timeend, coreSearchGetTopResultsRequestFilters.timeend) &&
        Objects.equals(this.timestart, coreSearchGetTopResultsRequestFilters.timestart) &&
        Objects.equals(this.title, coreSearchGetTopResultsRequestFilters.title) &&
        Objects.equals(this.userids, coreSearchGetTopResultsRequestFilters.userids);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to CoreSearchGetTopResultsRequestFilters
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CoreSearchGetTopResultsRequestFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CoreSearchGetTopResultsRequestFilters is not found in the empty JSON string", CoreSearchGetTopResultsRequestFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CoreSearchGetTopResultsRequestFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CoreSearchGetTopResultsRequestFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CoreSearchGetTopResultsRequestFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CoreSearchGetTopResultsRequestFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CoreSearchGetTopResultsRequestFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CoreSearchGetTopResultsRequestFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<CoreSearchGetTopResultsRequestFilters>() {
           @Override
           public void write(JsonWriter out, CoreSearchGetTopResultsRequestFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CoreSearchGetTopResultsRequestFilters read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CoreSearchGetTopResultsRequestFilters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CoreSearchGetTopResultsRequestFilters
  * @throws IOException if the JSON string is invalid with respect to CoreSearchGetTopResultsRequestFilters
  */
  public static CoreSearchGetTopResultsRequestFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CoreSearchGetTopResultsRequestFilters.class);
  }

 /**
  * Convert an instance of CoreSearchGetTopResultsRequestFilters to an JSON string
  *
  * @return JSON string
  */
