...
namespace MoodleClient.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/4.3.4/csharp");
            BasePath = "https://localhost/webservice/restful/server.php";
        ...
        public Configuration(
            ...
            string basePath = "https://localhost/webservice/restful/server.php") : this()
        {
        ...
        {
            string report = "C# SDK (MoodleClient) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 4.3.4\n";
            report += "    SDK Package Version: 4.3.4\n";
