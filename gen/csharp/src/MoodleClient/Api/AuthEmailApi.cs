...
namespace MoodleClient.Api
{
    ...
    public partial class AuthEmailApi : IAuthEmailApi
    {
        ...
        /// <returns></returns>
        public AuthEmailApi(MoodleClient.Client.Configuration configuration)
        {
        ...
        public AuthEmailApi(MoodleClient.Client.ISynchronousClient client, MoodleClient.Client.IAsynchronousClient asyncClient, MoodleClient.Client.IReadableConfiguration configuration)
        {
        ...
        {
            MoodleClient.Client.ApiResponse<AuthEmailGetSignupSettings200Response> localVarResponse = AuthEmailGetSignupSettingsWithHttpInfo();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AuthEmailGetSignupSettings200Response</returns>
        public MoodleClient.Client.ApiResponse<AuthEmailGetSignupSettings200Response> AuthEmailGetSignupSettingsWithHttpInfo(int operationIndex = 0)
        {
        ...
        {
            MoodleClient.Client.ApiResponse<AuthEmailGetSignupSettings200Response> localVarResponse = await AuthEmailGetSignupSettingsWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AuthEmailGetSignupSettings200Response)</returns>
        public async System.Threading.Tasks.Task<MoodleClient.Client.ApiResponse<AuthEmailGetSignupSettings200Response>> AuthEmailGetSignupSettingsWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            MoodleClient.Client.ApiResponse<AuthEmailSignupUser200Response> localVarResponse = AuthEmailSignupUserWithHttpInfo(authEmailSignupUserRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AuthEmailSignupUser200Response</returns>
        public MoodleClient.Client.ApiResponse<AuthEmailSignupUser200Response> AuthEmailSignupUserWithHttpInfo(AuthEmailSignupUserRequest authEmailSignupUserRequest, int operationIndex = 0)
        {
            // verify the required parameter 'authEmailSignupUserRequest' is set
            if (authEmailSignupUserRequest == null)
            {
                throw new MoodleClient.Client.ApiException(400, "Missing required parameter 'authEmailSignupUserRequest' when calling AuthEmailApi->AuthEmailSignupUser");
            }
        ...
        {
            MoodleClient.Client.ApiResponse<AuthEmailSignupUser200Response> localVarResponse = await AuthEmailSignupUserWithHttpInfoAsync(authEmailSignupUserRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AuthEmailSignupUser200Response)</returns>
        public async System.Threading.Tasks.Task<MoodleClient.Client.ApiResponse<AuthEmailSignupUser200Response>> AuthEmailSignupUserWithHttpInfoAsync(AuthEmailSignupUserRequest authEmailSignupUserRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'authEmailSignupUserRequest' is set
            if (authEmailSignupUserRequest == null)
            {
