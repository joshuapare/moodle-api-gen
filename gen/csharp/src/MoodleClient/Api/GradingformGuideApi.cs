...
namespace MoodleClient.Api
{
    ...
    public partial class GradingformGuideApi : IGradingformGuideApi
    {
        ...
        /// <returns></returns>
        public GradingformGuideApi(MoodleClient.Client.Configuration configuration)
        {
        ...
        public GradingformGuideApi(MoodleClient.Client.ISynchronousClient client, MoodleClient.Client.IAsynchronousClient asyncClient, MoodleClient.Client.IReadableConfiguration configuration)
        {
        ...
        {
            MoodleClient.Client.ApiResponse<GradingformGuideGraderGradingpanelFetch200Response> localVarResponse = GradingformGuideGraderGradingpanelFetchWithHttpInfo(coreGradesGraderGradingpanelScaleFetchRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GradingformGuideGraderGradingpanelFetch200Response</returns>
        public MoodleClient.Client.ApiResponse<GradingformGuideGraderGradingpanelFetch200Response> GradingformGuideGraderGradingpanelFetchWithHttpInfo(CoreGradesGraderGradingpanelScaleFetchRequest coreGradesGraderGradingpanelScaleFetchRequest, int operationIndex = 0)
        {
            ...
            {
                throw new MoodleClient.Client.ApiException(400, "Missing required parameter 'coreGradesGraderGradingpanelScaleFetchRequest' when calling GradingformGuideApi->GradingformGuideGraderGradingpanelFetch");
            }
        ...
        {
            MoodleClient.Client.ApiResponse<GradingformGuideGraderGradingpanelFetch200Response> localVarResponse = await GradingformGuideGraderGradingpanelFetchWithHttpInfoAsync(coreGradesGraderGradingpanelScaleFetchRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GradingformGuideGraderGradingpanelFetch200Response)</returns>
        public async System.Threading.Tasks.Task<MoodleClient.Client.ApiResponse<GradingformGuideGraderGradingpanelFetch200Response>> GradingformGuideGraderGradingpanelFetchWithHttpInfoAsync(CoreGradesGraderGradingpanelScaleFetchRequest coreGradesGraderGradingpanelScaleFetchRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'coreGradesGraderGradingpanelScaleFetchRequest' is set
            if (coreGradesGraderGradingpanelScaleFetchRequest == null)
            {
        ...
        {
            MoodleClient.Client.ApiResponse<GradingformGuideGraderGradingpanelStore200Response> localVarResponse = GradingformGuideGraderGradingpanelStoreWithHttpInfo(coreGradesGraderGradingpanelScaleStoreRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GradingformGuideGraderGradingpanelStore200Response</returns>
        public MoodleClient.Client.ApiResponse<GradingformGuideGraderGradingpanelStore200Response> GradingformGuideGraderGradingpanelStoreWithHttpInfo(CoreGradesGraderGradingpanelScaleStoreRequest coreGradesGraderGradingpanelScaleStoreRequest, int operationIndex = 0)
        {
            ...
            {
                throw new MoodleClient.Client.ApiException(400, "Missing required parameter 'coreGradesGraderGradingpanelScaleStoreRequest' when calling GradingformGuideApi->GradingformGuideGraderGradingpanelStore");
            }
        ...
        {
            MoodleClient.Client.ApiResponse<GradingformGuideGraderGradingpanelStore200Response> localVarResponse = await GradingformGuideGraderGradingpanelStoreWithHttpInfoAsync(coreGradesGraderGradingpanelScaleStoreRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GradingformGuideGraderGradingpanelStore200Response)</returns>
        public async System.Threading.Tasks.Task<MoodleClient.Client.ApiResponse<GradingformGuideGraderGradingpanelStore200Response>> GradingformGuideGraderGradingpanelStoreWithHttpInfoAsync(CoreGradesGraderGradingpanelScaleStoreRequest coreGradesGraderGradingpanelScaleStoreRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'coreGradesGraderGradingpanelScaleStoreRequest' is set
            if (coreGradesGraderGradingpanelScaleStoreRequest == null)
            {
