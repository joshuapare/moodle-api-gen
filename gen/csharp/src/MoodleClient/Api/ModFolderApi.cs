...
namespace MoodleClient.Api
{
    ...
    public partial class ModFolderApi : IModFolderApi
    {
        ...
        /// <returns></returns>
        public ModFolderApi(MoodleClient.Client.Configuration configuration)
        {
        ...
        public ModFolderApi(MoodleClient.Client.ISynchronousClient client, MoodleClient.Client.IAsynchronousClient asyncClient, MoodleClient.Client.IReadableConfiguration configuration)
        {
        ...
        {
            MoodleClient.Client.ApiResponse<ModFolderGetFoldersByCourses200Response> localVarResponse = ModFolderGetFoldersByCoursesWithHttpInfo(modBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ModFolderGetFoldersByCourses200Response</returns>
        public MoodleClient.Client.ApiResponse<ModFolderGetFoldersByCourses200Response> ModFolderGetFoldersByCoursesWithHttpInfo(ModBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest modBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest, int operationIndex = 0)
        {
            ...
            {
                throw new MoodleClient.Client.ApiException(400, "Missing required parameter 'modBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest' when calling ModFolderApi->ModFolderGetFoldersByCourses");
            }
        ...
        {
            MoodleClient.Client.ApiResponse<ModFolderGetFoldersByCourses200Response> localVarResponse = await ModFolderGetFoldersByCoursesWithHttpInfoAsync(modBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ModFolderGetFoldersByCourses200Response)</returns>
        public async System.Threading.Tasks.Task<MoodleClient.Client.ApiResponse<ModFolderGetFoldersByCourses200Response>> ModFolderGetFoldersByCoursesWithHttpInfoAsync(ModBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest modBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'modBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest' is set
            if (modBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest == null)
            {
        ...
        {
            MoodleClient.Client.ApiResponse<CoreCalendarDeleteSubscription200Response> localVarResponse = ModFolderViewFolderWithHttpInfo(modFolderViewFolderRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CoreCalendarDeleteSubscription200Response</returns>
        public MoodleClient.Client.ApiResponse<CoreCalendarDeleteSubscription200Response> ModFolderViewFolderWithHttpInfo(ModFolderViewFolderRequest modFolderViewFolderRequest, int operationIndex = 0)
        {
            // verify the required parameter 'modFolderViewFolderRequest' is set
            if (modFolderViewFolderRequest == null)
            {
                throw new MoodleClient.Client.ApiException(400, "Missing required parameter 'modFolderViewFolderRequest' when calling ModFolderApi->ModFolderViewFolder");
            }
        ...
        {
            MoodleClient.Client.ApiResponse<CoreCalendarDeleteSubscription200Response> localVarResponse = await ModFolderViewFolderWithHttpInfoAsync(modFolderViewFolderRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CoreCalendarDeleteSubscription200Response)</returns>
        public async System.Threading.Tasks.Task<MoodleClient.Client.ApiResponse<CoreCalendarDeleteSubscription200Response>> ModFolderViewFolderWithHttpInfoAsync(ModFolderViewFolderRequest modFolderViewFolderRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'modFolderViewFolderRequest' is set
            if (modFolderViewFolderRequest == null)
            {
