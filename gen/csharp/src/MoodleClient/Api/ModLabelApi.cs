...
namespace MoodleClient.Api
{
    ...
    public partial class ModLabelApi : IModLabelApi
    {
        ...
        /// <returns></returns>
        public ModLabelApi(MoodleClient.Client.Configuration configuration)
        {
        ...
        public ModLabelApi(MoodleClient.Client.ISynchronousClient client, MoodleClient.Client.IAsynchronousClient asyncClient, MoodleClient.Client.IReadableConfiguration configuration)
        {
        ...
        {
            MoodleClient.Client.ApiResponse<ModLabelGetLabelsByCourses200Response> localVarResponse = ModLabelGetLabelsByCoursesWithHttpInfo(modBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ModLabelGetLabelsByCourses200Response</returns>
        public MoodleClient.Client.ApiResponse<ModLabelGetLabelsByCourses200Response> ModLabelGetLabelsByCoursesWithHttpInfo(ModBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest modBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest, int operationIndex = 0)
        {
            ...
            {
                throw new MoodleClient.Client.ApiException(400, "Missing required parameter 'modBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest' when calling ModLabelApi->ModLabelGetLabelsByCourses");
            }
        ...
        {
            MoodleClient.Client.ApiResponse<ModLabelGetLabelsByCourses200Response> localVarResponse = await ModLabelGetLabelsByCoursesWithHttpInfoAsync(modBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ModLabelGetLabelsByCourses200Response)</returns>
        public async System.Threading.Tasks.Task<MoodleClient.Client.ApiResponse<ModLabelGetLabelsByCourses200Response>> ModLabelGetLabelsByCoursesWithHttpInfoAsync(ModBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest modBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'modBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest' is set
            if (modBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest == null)
            {
