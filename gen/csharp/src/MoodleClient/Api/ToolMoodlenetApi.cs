...
namespace MoodleClient.Api
{
    ...
    public partial class ToolMoodlenetApi : IToolMoodlenetApi
    {
        ...
        /// <returns></returns>
        public ToolMoodlenetApi(MoodleClient.Client.Configuration configuration)
        {
        ...
        public ToolMoodlenetApi(MoodleClient.Client.ISynchronousClient client, MoodleClient.Client.IAsynchronousClient asyncClient, MoodleClient.Client.IReadableConfiguration configuration)
        {
        ...
        {
            MoodleClient.Client.ApiResponse<ToolMoodlenetSearchCourses200Response> localVarResponse = ToolMoodlenetSearchCoursesWithHttpInfo(toolMoodlenetSearchCoursesRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ToolMoodlenetSearchCourses200Response</returns>
        public MoodleClient.Client.ApiResponse<ToolMoodlenetSearchCourses200Response> ToolMoodlenetSearchCoursesWithHttpInfo(ToolMoodlenetSearchCoursesRequest toolMoodlenetSearchCoursesRequest, int operationIndex = 0)
        {
            // verify the required parameter 'toolMoodlenetSearchCoursesRequest' is set
            if (toolMoodlenetSearchCoursesRequest == null)
            {
                throw new MoodleClient.Client.ApiException(400, "Missing required parameter 'toolMoodlenetSearchCoursesRequest' when calling ToolMoodlenetApi->ToolMoodlenetSearchCourses");
            }
        ...
        {
            MoodleClient.Client.ApiResponse<ToolMoodlenetSearchCourses200Response> localVarResponse = await ToolMoodlenetSearchCoursesWithHttpInfoAsync(toolMoodlenetSearchCoursesRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ToolMoodlenetSearchCourses200Response)</returns>
        public async System.Threading.Tasks.Task<MoodleClient.Client.ApiResponse<ToolMoodlenetSearchCourses200Response>> ToolMoodlenetSearchCoursesWithHttpInfoAsync(ToolMoodlenetSearchCoursesRequest toolMoodlenetSearchCoursesRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'toolMoodlenetSearchCoursesRequest' is set
            if (toolMoodlenetSearchCoursesRequest == null)
            {
        ...
        {
            MoodleClient.Client.ApiResponse<ToolMoodlenetVerifyWebfinger200Response> localVarResponse = ToolMoodlenetVerifyWebfingerWithHttpInfo(toolMoodlenetVerifyWebfingerRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ToolMoodlenetVerifyWebfinger200Response</returns>
        public MoodleClient.Client.ApiResponse<ToolMoodlenetVerifyWebfinger200Response> ToolMoodlenetVerifyWebfingerWithHttpInfo(ToolMoodlenetVerifyWebfingerRequest toolMoodlenetVerifyWebfingerRequest, int operationIndex = 0)
        {
            // verify the required parameter 'toolMoodlenetVerifyWebfingerRequest' is set
            if (toolMoodlenetVerifyWebfingerRequest == null)
            {
                throw new MoodleClient.Client.ApiException(400, "Missing required parameter 'toolMoodlenetVerifyWebfingerRequest' when calling ToolMoodlenetApi->ToolMoodlenetVerifyWebfinger");
            }
        ...
        {
            MoodleClient.Client.ApiResponse<ToolMoodlenetVerifyWebfinger200Response> localVarResponse = await ToolMoodlenetVerifyWebfingerWithHttpInfoAsync(toolMoodlenetVerifyWebfingerRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ToolMoodlenetVerifyWebfinger200Response)</returns>
        public async System.Threading.Tasks.Task<MoodleClient.Client.ApiResponse<ToolMoodlenetVerifyWebfinger200Response>> ToolMoodlenetVerifyWebfingerWithHttpInfoAsync(ToolMoodlenetVerifyWebfingerRequest toolMoodlenetVerifyWebfingerRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'toolMoodlenetVerifyWebfingerRequest' is set
            if (toolMoodlenetVerifyWebfingerRequest == null)
            {
