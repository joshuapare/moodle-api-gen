...
namespace MoodleClient.Api
{
    ...
    public partial class GradereportOverviewApi : IGradereportOverviewApi
    {
        ...
        /// <returns></returns>
        public GradereportOverviewApi(MoodleClient.Client.Configuration configuration)
        {
        ...
        public GradereportOverviewApi(MoodleClient.Client.ISynchronousClient client, MoodleClient.Client.IAsynchronousClient asyncClient, MoodleClient.Client.IReadableConfiguration configuration)
        {
        ...
        {
            MoodleClient.Client.ApiResponse<GradereportOverviewGetCourseGrades200Response> localVarResponse = GradereportOverviewGetCourseGradesWithHttpInfo(gradereportOverviewGetCourseGradesRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GradereportOverviewGetCourseGrades200Response</returns>
        public MoodleClient.Client.ApiResponse<GradereportOverviewGetCourseGrades200Response> GradereportOverviewGetCourseGradesWithHttpInfo(GradereportOverviewGetCourseGradesRequest gradereportOverviewGetCourseGradesRequest, int operationIndex = 0)
        {
            ...
            {
                throw new MoodleClient.Client.ApiException(400, "Missing required parameter 'gradereportOverviewGetCourseGradesRequest' when calling GradereportOverviewApi->GradereportOverviewGetCourseGrades");
            }
        ...
        {
            MoodleClient.Client.ApiResponse<GradereportOverviewGetCourseGrades200Response> localVarResponse = await GradereportOverviewGetCourseGradesWithHttpInfoAsync(gradereportOverviewGetCourseGradesRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GradereportOverviewGetCourseGrades200Response)</returns>
        public async System.Threading.Tasks.Task<MoodleClient.Client.ApiResponse<GradereportOverviewGetCourseGrades200Response>> GradereportOverviewGetCourseGradesWithHttpInfoAsync(GradereportOverviewGetCourseGradesRequest gradereportOverviewGetCourseGradesRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'gradereportOverviewGetCourseGradesRequest' is set
            if (gradereportOverviewGetCourseGradesRequest == null)
            {
        ...
        {
            MoodleClient.Client.ApiResponse<CoreCalendarDeleteSubscription200Response> localVarResponse = GradereportOverviewViewGradeReportWithHttpInfo(gradereportOverviewViewGradeReportRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CoreCalendarDeleteSubscription200Response</returns>
        public MoodleClient.Client.ApiResponse<CoreCalendarDeleteSubscription200Response> GradereportOverviewViewGradeReportWithHttpInfo(GradereportOverviewViewGradeReportRequest gradereportOverviewViewGradeReportRequest, int operationIndex = 0)
        {
            ...
            {
                throw new MoodleClient.Client.ApiException(400, "Missing required parameter 'gradereportOverviewViewGradeReportRequest' when calling GradereportOverviewApi->GradereportOverviewViewGradeReport");
            }
        ...
        {
            MoodleClient.Client.ApiResponse<CoreCalendarDeleteSubscription200Response> localVarResponse = await GradereportOverviewViewGradeReportWithHttpInfoAsync(gradereportOverviewViewGradeReportRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CoreCalendarDeleteSubscription200Response)</returns>
        public async System.Threading.Tasks.Task<MoodleClient.Client.ApiResponse<CoreCalendarDeleteSubscription200Response>> GradereportOverviewViewGradeReportWithHttpInfoAsync(GradereportOverviewViewGradeReportRequest gradereportOverviewViewGradeReportRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'gradereportOverviewViewGradeReportRequest' is set
            if (gradereportOverviewViewGradeReportRequest == null)
            {
