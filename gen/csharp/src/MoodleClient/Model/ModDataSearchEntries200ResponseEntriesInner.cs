...
namespace MoodleClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "mod_data_search_entries_200_response_entries_inner")]
    public partial class ModDataSearchEntries200ResponseEntriesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModDataSearchEntries200ResponseEntriesInner" /> class.
        /// </summary>
        /// <param name="approved">Whether the entry has been approved (if the database is configured in that way). (default to 0).</param>
        /// <param name="canmanageentry">Whether the current user can manage this entry.</param>
