...
namespace MoodleClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "tool_lp_search_cohorts_200_response_cohorts_inner")]
    public partial class ToolLpSearchCohorts200ResponseCohortsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolLpSearchCohorts200ResponseCohortsInner" /> class.
        /// </summary>
        ...
        /// <param name="theme">cohort theme.</param>
        /// <param name="visible">cohort visible.</param>
        public ToolLpSearchCohorts200ResponseCohortsInner(List<CoreCourseGetCoursesByField200ResponseCoursesInnerCustomfieldsInner> customfields = default(List<CoreCourseGetCoursesByField200ResponseCoursesInnerCustomfieldsInner>), string description = default(string), int descriptionformat = default(int), int id = default(int), string idnumber = default(string), string name = default(string), string theme = default(string), bool visible = default(bool))
        {
