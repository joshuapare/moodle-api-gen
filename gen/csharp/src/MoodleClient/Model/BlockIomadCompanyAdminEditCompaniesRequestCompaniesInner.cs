...
namespace MoodleClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "block_iomad_company_admin_edit_companies_request_companies_inner")]
    public partial class BlockIomadCompanyAdminEditCompaniesRequestCompaniesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BlockIomadCompanyAdminEditCompaniesRequestCompaniesInner" /> class.
        /// </summary>
        /// <param name="address">Company location address.</param>
        /// <param name="autosubscribe">User default forum auto-subscribe (default to null).</param>
        /// <param name="city">Company location city.</param>
        /// <param name="code">Compay code (default to &quot;null&quot;).</param>
        /// <param name="companyterminated">Company contract is terminated when &lt;&gt; 0 (default to null).</param>
        ...
        /// <param name="customcss">Company custom css (default to &quot;null&quot;).</param>
        /// <param name="ecommerce">Ecommerce is disabled when &#x3D; 0 (default to null).</param>
        /// <param name="headingcolor">Company heading color (default to &quot;null&quot;).</param>
        /// <param name="hostname">Company hostname (default to &quot;null&quot;).</param>
        /// <param name="htmleditor">User default text editor (default to null).</param>
        /// <param name="id">Company id number (default to null).</param>
        /// <param name="lang">User default language (default to &quot;null&quot;).</param>
        /// <param name="linkcolor">Company ink color (default to &quot;null&quot;).</param>
        /// <param name="maildigest">User default digest type (default to null).</param>
        /// <param name="maildisplay">User default email display (default to null).</param>
        /// <param name="mailformat">User default email format (default to null).</param>
        /// <param name="maincolor">Company main color (default to &quot;null&quot;).</param>
        /// <param name="maxusers">Company maximum number of users (default to null).</param>
        /// <param name="name">Company long name.</param>
        /// <param name="parentid">ID of parent company (default to null).</param>
        /// <param name="postcode">Company location postcode.</param>
        /// <param name="region">Company location region.</param>
        /// <param name="screenreader">User default screen reader (default to null).</param>
        /// <param name="shortname">Compay short name.</param>
        /// <param name="suspendafter">Number of seconds after termination date to suspend the company (default to null).</param>
        /// <param name="suspended">Company is suspended when &lt;&gt; 0 (default to null).</param>
        /// <param name="theme">Company theme (default to &quot;null&quot;).</param>
        /// <param name="timezone">User default timezone (default to &quot;null&quot;).</param>
        /// <param name="trackforums">User default forum tracking (default to null).</param>
        /// <param name="validto">Contract termination date in unix timestamp.</param>
        public BlockIomadCompanyAdminEditCompaniesRequestCompaniesInner(string address = default(string), int autosubscribe = null, string city = default(string), string code = @"null", int companyterminated = null, string country = default(string), string custom1 = default(string), string custom2 = default(string), string custom3 = default(string), string customcss = @"null", int ecommerce = null, string headingcolor = @"null", string hostname = @"null", int htmleditor = null, int id = null, string lang = @"null", string linkcolor = @"null", int maildigest = null, int maildisplay = null, int mailformat = null, string maincolor = @"null", int maxusers = null, string name = default(string), int parentid = null, string postcode = default(string), string region = default(string), int screenreader = null, string shortname = default(string), int suspendafter = null, int suspended = null, string theme = @"null", string timezone = @"null", int trackforums = null, int validto = default(int))
        {
            ...
            this.Headingcolor = headingcolor ?? @"null";
