...
namespace MoodleClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "mod_lti_get_tool_types_request")]
    public partial class ModLtiGetToolTypesRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModLtiGetToolTypesRequest" /> class.
        /// </summary>
        /// <param name="toolproxyid">Tool proxy id (default to 0).</param>
        public ModLtiGetToolTypesRequest(int toolproxyid = 0)
        {
