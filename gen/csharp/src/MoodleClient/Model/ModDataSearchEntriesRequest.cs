...
namespace MoodleClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "mod_data_search_entries_request")]
    public partial class ModDataSearchEntriesRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModDataSearchEntriesRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ModDataSearchEntriesRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ModDataSearchEntriesRequest" /> class.
        /// </summary>
        /// <param name="advsearch">advsearch.</param>
        ...
        /// <param name="order">The direction of the sorting: &#39;ASC&#39; or &#39;DESC&#39;.                                                 Empty for using the default database setting..</param>
        ...
        /// <param name="returncontents">Whether to return contents or not. (default to false).</param>
        /// <param name="search">search string (empty when using advanced) (default to &quot;&quot;).</param>
        /// <param name="sort">Sort the records by this field id, reserved ids are:                                                 0: timeadded                                                 -1: firstname                                                 -2: lastname                                                 -3: approved                                                 -4: timemodified.                                                 Empty for using the default database setting..</param>
        public ModDataSearchEntriesRequest(List<ModDataSearchEntriesRequestAdvsearchInner> advsearch = default(List<ModDataSearchEntriesRequestAdvsearchInner>), int databaseid = default(int), int groupid = 0, string order = default(string), int page = 0, int perpage = 0, bool returncontents = false, string search = @"", int sort = default(int))
        {
        ...
        /// <summary>
        /// Gets or Sets Advsearch
        /// </summary>
        [DataMember(Name = "advsearch", EmitDefaultValue = false)]
        public List<ModDataSearchEntriesRequestAdvsearchInner> Advsearch { get; set; }
        ...
        /// </summary>
        /// <value>Whether to return contents or not.</value>
        ...
        /// </summary>
        /// <value>search string (empty when using advanced)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Advsearch: ").Append(Advsearch).Append("\n");
