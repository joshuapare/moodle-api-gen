...
namespace MoodleClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "core_competency_create_template_request_template")]
    public partial class CoreCompetencyCreateTemplateRequestTemplate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreCompetencyCreateTemplateRequestTemplate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreCompetencyCreateTemplateRequestTemplate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreCompetencyCreateTemplateRequestTemplate" /> class.
        /// </summary>
        ...
        public CoreCompetencyCreateTemplateRequestTemplate(int contextid = default(int), string contextlevel = default(string), string description = @"", int descriptionformat = 1, int duedate = 0, int instanceid = default(int), string shortname = default(string), int timecreated = 0, int timemodified = 0, int usermodified = 0, bool visible = 1)
        {
            // to ensure "shortname" is required (not null)
            if (shortname == null)
            {
                throw new ArgumentNullException("shortname is a required property for CoreCompetencyCreateTemplateRequestTemplate and cannot be null");
            }
