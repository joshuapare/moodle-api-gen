...
namespace MoodleClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "mod_h5pactivity_get_results_200_response_attempts_inner")]
    public partial class ModH5pactivityGetResults200ResponseAttemptsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModH5pactivityGetResults200ResponseAttemptsInner" /> class.
        /// </summary>
        ...
        public ModH5pactivityGetResults200ResponseAttemptsInner(int attempt = default(int), int completion = default(int), int duration = default(int), int h5pactivityid = default(int), int id = default(int), int maxscore = default(int), int rawscore = default(int), List<ModH5pactivityGetResults200ResponseAttemptsInnerResultsInner> results = default(List<ModH5pactivityGetResults200ResponseAttemptsInnerResultsInner>), decimal scaled = default(decimal), int success = default(int), int timecreated = default(int), int timemodified = default(int), int userid = default(int))
        {
        ...
        public List<ModH5pactivityGetResults200ResponseAttemptsInnerResultsInner> Results { get; set; }
