...
namespace MoodleClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "core_competency_list_templates_request")]
    public partial class CoreCompetencyListTemplatesRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreCompetencyListTemplatesRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreCompetencyListTemplatesRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreCompetencyListTemplatesRequest" /> class.
        /// </summary>
        /// <param name="context">context (required).</param>
        /// <param name="includes">What other contexts to fetch the templates from. (children, parents, self) (default to &quot;children&quot;).</param>
        /// <param name="limit">Return this number of records at most. (default to 0).</param>
        /// <param name="onlyvisible">If should list only visible templates (default to false).</param>
        ...
        public CoreCompetencyListTemplatesRequest(CoreCohortSearchCohortsRequestContext context = default(CoreCohortSearchCohortsRequestContext), string includes = @"children", int limit = 0, bool onlyvisible = false, string order = @"", int skip = 0, string sort = @"")
        {
            // to ensure "context" is required (not null)
            if (context == null)
            {
                throw new ArgumentNullException("context is a required property for CoreCompetencyListTemplatesRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>What other contexts to fetch the templates from. (children, parents, self)</value>
        ...
        /// </summary>
        /// <value>If should list only visible templates</value>
