...
namespace MoodleClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "tool_lp_data_for_user_competency_summary_in_course_200_response_usercompetencysummary")]
    public partial class ToolLpDataForUserCompetencySummaryInCourse200ResponseUsercompetencysummary : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolLpDataForUserCompetencySummaryInCourse200ResponseUsercompetencysummary" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ToolLpDataForUserCompetencySummaryInCourse200ResponseUsercompetencysummary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolLpDataForUserCompetencySummaryInCourse200ResponseUsercompetencysummary" /> class.
        /// </summary>
        /// <param name="cangrade">cangrade (required).</param>
        ...
        /// <param name="showrelatedcompetencies">showrelatedcompetencies (required).</param>
        ...
        public ToolLpDataForUserCompetencySummaryInCourse200ResponseUsercompetencysummary(bool cangrade = default(bool), CoreCompetencyReadPlan200ResponseCommentarea commentarea = default(CoreCompetencyReadPlan200ResponseCommentarea), ToolLpDataForCompetencySummary200Response competency = default(ToolLpDataForCompetencySummary200Response), List<ToolLpDataForUserCompetencySummary200ResponseEvidenceInner> evidence = default(List<ToolLpDataForUserCompetencySummary200ResponseEvidenceInner>), bool showrelatedcompetencies = default(bool), CoreCompetencyGradeCompetency200ResponseActionuser user = default(CoreCompetencyGradeCompetency200ResponseActionuser), ToolLpDataForUserCompetencySummary200ResponseUsercompetency usercompetency = default(ToolLpDataForUserCompetencySummary200ResponseUsercompetency), ToolLpDataForCourseCompetenciesPage200ResponseCompetenciesInnerUsercompetencycourse usercompetencycourse = default(ToolLpDataForCourseCompetenciesPage200ResponseCompetenciesInnerUsercompetencycourse), ToolLpDataForUserCompetencySummary200ResponseUsercompetencyplan usercompetencyplan = default(ToolLpDataForUserCompetencySummary200ResponseUsercompetencyplan))
        {
            this.Cangrade = cangrade;
            // to ensure "competency" is required (not null)
            if (competency == null)
            {
                throw new ArgumentNullException("competency is a required property for ToolLpDataForUserCompetencySummaryInCourse200ResponseUsercompetencysummary and cannot be null");
            }
            this.Competency = competency;
            // to ensure "evidence" is required (not null)
            if (evidence == null)
            {
                throw new ArgumentNullException("evidence is a required property for ToolLpDataForUserCompetencySummaryInCourse200ResponseUsercompetencysummary and cannot be null");
            }
            ...
            if (user == null)
            {
                throw new ArgumentNullException("user is a required property for ToolLpDataForUserCompetencySummaryInCourse200ResponseUsercompetencysummary and cannot be null");
            }
            this.User = user;
