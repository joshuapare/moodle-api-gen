...
namespace MoodleClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "core_grades_grader_gradingpanel_point_store_request")]
    public partial class CoreGradesGraderGradingpanelPointStoreRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreGradesGraderGradingpanelPointStoreRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreGradesGraderGradingpanelPointStoreRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreGradesGraderGradingpanelPointStoreRequest" /> class.
        /// </summary>
        ...
        /// <param name="formdata">The serialised form data representing the grade (required) (default to &quot;null&quot;).</param>
        ...
        public CoreGradesGraderGradingpanelPointStoreRequest(string component = default(string), int contextid = default(int), string formdata = @"null", int gradeduserid = default(int), string itemname = default(string), bool notifyuser = false)
        {
            // to ensure "component" is required (not null)
            if (component == null)
            {
                throw new ArgumentNullException("component is a required property for CoreGradesGraderGradingpanelPointStoreRequest and cannot be null");
            }
            ...
            if (formdata == null)
            {
                throw new ArgumentNullException("formdata is a required property for CoreGradesGraderGradingpanelPointStoreRequest and cannot be null");
            }
            ...
            if (itemname == null)
            {
                throw new ArgumentNullException("itemname is a required property for CoreGradesGraderGradingpanelPointStoreRequest and cannot be null");
            }
