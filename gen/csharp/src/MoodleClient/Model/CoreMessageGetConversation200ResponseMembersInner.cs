...
namespace MoodleClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "core_message_get_conversation_200_response_members_inner")]
    public partial class CoreMessageGetConversation200ResponseMembersInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreMessageGetConversation200ResponseMembersInner" /> class.
        /// </summary>
        /// <param name="canmessage">If the user can be messaged (default to null).</param>
        /// <param name="canmessageevenifblocked">If the user can still message even if they get blocked (default to null).</param>
        ...
        /// <param name="iscontact">Is the user a contact? (default to null).</param>
        /// <param name="isdeleted">Is the user deleted? (default to null).</param>
        ...
        /// <param name="profileurl">The link to the user&#39;s profile page (default to &quot;null&quot;).</param>
        /// <param name="requirescontact">If the user requires to be contacts (default to null).</param>
        /// <param name="showonlinestatus">Show the user&#39;s online status?.</param>
        public CoreMessageGetConversation200ResponseMembersInner(bool canmessage = null, bool canmessageevenifblocked = null, List<CoreMessageGetConversation200ResponseMembersInnerContactrequestsInner> contactrequests = default(List<CoreMessageGetConversation200ResponseMembersInnerContactrequestsInner>), List<CoreMessageGetConversation200ResponseMembersInnerConversationsInner> conversations = default(List<CoreMessageGetConversation200ResponseMembersInnerConversationsInner>), string fullname = default(string), int id = default(int), bool isblocked = default(bool), bool iscontact = null, bool isdeleted = null, bool isonline = default(bool), string profileimageurl = default(string), string profileimageurlsmall = default(string), string profileurl = @"null", bool requirescontact = null, bool showonlinestatus = default(bool))
        {
        ...
        public List<CoreMessageGetConversation200ResponseMembersInnerContactrequestsInner> Contactrequests { get; set; }

        /// <summary>
        /// Gets or Sets Conversations
        /// </summary>
        [DataMember(Name = "conversations", EmitDefaultValue = false)]
        public List<CoreMessageGetConversation200ResponseMembersInnerConversationsInner> Conversations { get; set; }
