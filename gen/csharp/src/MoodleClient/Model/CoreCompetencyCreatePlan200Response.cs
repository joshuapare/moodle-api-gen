...
namespace MoodleClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "core_competency_create_plan_200_response")]
    public partial class CoreCompetencyCreatePlan200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreCompetencyCreatePlan200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreCompetencyCreatePlan200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreCompetencyCreatePlan200Response" /> class.
        /// </summary>
        /// <param name="canbeedited">canbeedited (required) (default to null).</param>
        /// <param name="canmanage">canmanage (required).</param>
        /// <param name="canrequestreview">canrequestreview (required) (default to null).</param>
        /// <param name="canreview">canreview (required) (default to null).</param>
        ...
        /// <param name="duedateformatted">duedateformatted (required) (default to &quot;null&quot;).</param>
        /// <param name="id">id (required) (default to 0).</param>
        /// <param name="isactive">isactive (required) (default to null).</param>
        /// <param name="isapproveallowed">isapproveallowed (required) (default to null).</param>
        /// <param name="isbasedontemplate">isbasedontemplate (required) (default to null).</param>
        /// <param name="iscancelreviewrequestallowed">iscancelreviewrequestallowed (required) (default to null).</param>
        /// <param name="iscompleteallowed">iscompleteallowed (required) (default to null).</param>
        /// <param name="iscompleted">iscompleted (required) (default to null).</param>
        /// <param name="isdraft">isdraft (required) (default to null).</param>
        /// <param name="isinreview">isinreview (required) (default to null).</param>
        /// <param name="isreopenallowed">isreopenallowed (required) (default to null).</param>
        /// <param name="isrequestreviewallowed">isrequestreviewallowed (required) (default to null).</param>
        /// <param name="isstartreviewallowed">isstartreviewallowed (required) (default to null).</param>
        /// <param name="isstopreviewallowed">isstopreviewallowed (required) (default to null).</param>
        /// <param name="isunapproveallowed">isunapproveallowed (required) (default to null).</param>
        /// <param name="isunlinkallowed">isunlinkallowed (required) (default to null).</param>
        /// <param name="iswaitingforreview">iswaitingforreview (required) (default to null).</param>
        ...
        /// <param name="statusname">statusname (required) (default to &quot;null&quot;).</param>
        ...
        public CoreCompetencyCreatePlan200Response(bool canbeedited = null, bool canmanage = default(bool), bool canrequestreview = null, bool canreview = null, CoreCompetencyCreatePlan200ResponseCommentarea commentarea = default(CoreCompetencyCreatePlan200ResponseCommentarea), string description = @"", int descriptionformat = 1, int duedate = 0, string duedateformatted = @"null", int id = 0, bool isactive = null, bool isapproveallowed = null, bool isbasedontemplate = null, bool iscancelreviewrequestallowed = null, bool iscompleteallowed = null, bool iscompleted = null, bool isdraft = null, bool isinreview = null, bool isreopenallowed = null, bool isrequestreviewallowed = null, bool isstartreviewallowed = null, bool isstopreviewallowed = null, bool isunapproveallowed = null, bool isunlinkallowed = null, bool iswaitingforreview = null, string name = default(string), int origtemplateid = default(int), CoreCompetencyCreatePlan200ResponseReviewer reviewer = default(CoreCompetencyCreatePlan200ResponseReviewer), int reviewerid = default(int), int status = 0, string statusname = @"null", CoreCompetencyCreatePlan200ResponseTemplate template = default(CoreCompetencyCreatePlan200ResponseTemplate), int templateid = default(int), int timecreated = 0, int timemodified = 0, string url = default(string), int userid = default(int), int usermodified = 0)
        {
            ...
            if (commentarea == null)
            {
                throw new ArgumentNullException("commentarea is a required property for CoreCompetencyCreatePlan200Response and cannot be null");
            }
            this.Commentarea = commentarea;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for CoreCompetencyCreatePlan200Response and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("duedateformatted is a required property for CoreCompetencyCreatePlan200Response and cannot be null");
            }
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CoreCompetencyCreatePlan200Response and cannot be null");
            }
            this.Name = name;
            ...
            if (statusname == null)
            {
                throw new ArgumentNullException("statusname is a required property for CoreCompetencyCreatePlan200Response and cannot be null");
            }
            ...
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for CoreCompetencyCreatePlan200Response and cannot be null");
            }
            this.Url = url;
            this.Userid = userid;
        ...
        public CoreCompetencyCreatePlan200ResponseCommentarea Commentarea { get; set; }
        ...
        public CoreCompetencyCreatePlan200ResponseReviewer Reviewer { get; set; }
        ...
        public CoreCompetencyCreatePlan200ResponseTemplate Template { get; set; }
