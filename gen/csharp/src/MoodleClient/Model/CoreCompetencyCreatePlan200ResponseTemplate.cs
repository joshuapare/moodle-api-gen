...
namespace MoodleClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "core_competency_create_plan_200_response_template")]
    public partial class CoreCompetencyCreatePlan200ResponseTemplate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreCompetencyCreatePlan200ResponseTemplate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreCompetencyCreatePlan200ResponseTemplate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreCompetencyCreatePlan200ResponseTemplate" /> class.
        /// </summary>
        /// <param name="canmanage">canmanage (required).</param>
        /// <param name="canread">canread (required) (default to null).</param>
        /// <param name="cohortscount">cohortscount (required) (default to null).</param>
        ...
        /// <param name="planscount">planscount (required) (default to null).</param>
        ...
        public CoreCompetencyCreatePlan200ResponseTemplate(bool canmanage = default(bool), bool canread = null, int cohortscount = null, int contextid = default(int), string contextname = default(string), string contextnamenoprefix = default(string), string description = @"", int descriptionformat = 1, int duedate = 0, string duedateformatted = default(string), int id = 0, int planscount = null, string shortname = default(string), int timecreated = 0, int timemodified = 0, int usermodified = 0, bool visible = 1)
        {
            ...
            if (contextname == null)
            {
                throw new ArgumentNullException("contextname is a required property for CoreCompetencyCreatePlan200ResponseTemplate and cannot be null");
            }
            this.Contextname = contextname;
            // to ensure "contextnamenoprefix" is required (not null)
            if (contextnamenoprefix == null)
            {
                throw new ArgumentNullException("contextnamenoprefix is a required property for CoreCompetencyCreatePlan200ResponseTemplate and cannot be null");
            }
            this.Contextnamenoprefix = contextnamenoprefix;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for CoreCompetencyCreatePlan200ResponseTemplate and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("duedateformatted is a required property for CoreCompetencyCreatePlan200ResponseTemplate and cannot be null");
            }
            ...
            if (shortname == null)
            {
                throw new ArgumentNullException("shortname is a required property for CoreCompetencyCreatePlan200ResponseTemplate and cannot be null");
            }
