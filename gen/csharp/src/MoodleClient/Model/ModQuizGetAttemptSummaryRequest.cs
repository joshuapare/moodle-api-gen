...
namespace MoodleClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "mod_quiz_get_attempt_summary_request")]
    public partial class ModQuizGetAttemptSummaryRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModQuizGetAttemptSummaryRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ModQuizGetAttemptSummaryRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ModQuizGetAttemptSummaryRequest" /> class.
        /// </summary>
        /// <param name="attemptid">attempt id (required).</param>
        /// <param name="preflightdata">preflightdata.</param>
        public ModQuizGetAttemptSummaryRequest(int attemptid = default(int), List<ModQuizGetAttemptDataRequestPreflightdataInner> preflightdata = default(List<ModQuizGetAttemptDataRequestPreflightdataInner>))
        {
