...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "tool_lp_search_cohorts_request")]
    public partial class ToolLpSearchCohortsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolLpSearchCohortsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ToolLpSearchCohortsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolLpSearchCohortsRequest" /> class.
        /// </summary>
        ...
        public ToolLpSearchCohortsRequest(CoreCohortSearchCohortsRequestContext context = default(CoreCohortSearchCohortsRequestContext), string includes = @"parents", int limitfrom = 0, int limitnum = 25, string query = default(string))
        {
            // to ensure "context" is required (not null)
            if (context == null)
            {
                throw new ArgumentNullException("context is a required property for ToolLpSearchCohortsRequest and cannot be null");
            }
            this.Context = context;
            // to ensure "query" is required (not null)
            if (query == null)
            {
                throw new ArgumentNullException("query is a required property for ToolLpSearchCohortsRequest and cannot be null");
            }
            this.Query = query;
