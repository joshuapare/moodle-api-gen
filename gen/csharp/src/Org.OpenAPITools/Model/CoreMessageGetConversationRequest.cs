...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "core_message_get_conversation_request")]
    public partial class CoreMessageGetConversationRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreMessageGetConversationRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreMessageGetConversationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreMessageGetConversationRequest" /> class.
        /// </summary>
        /// <param name="conversationid">The id of the conversation to fetch (required) (default to null).</param>
        /// <param name="includecontactrequests">Include contact requests in the members (required) (default to null).</param>
        /// <param name="includeprivacyinfo">Include privacy info in the members (required) (default to null).</param>
        ...
        /// <param name="userid">The id of the user who we are viewing conversations for (required) (default to null).</param>
        public CoreMessageGetConversationRequest(int conversationid = null, bool includecontactrequests = null, bool includeprivacyinfo = null, int memberlimit = 0, int memberoffset = 0, int messagelimit = 100, int messageoffset = 0, bool newestmessagesfirst = true, int userid = null)
        {
        ...
        /// </summary>
        /// <value>The id of the conversation to fetch</value>
