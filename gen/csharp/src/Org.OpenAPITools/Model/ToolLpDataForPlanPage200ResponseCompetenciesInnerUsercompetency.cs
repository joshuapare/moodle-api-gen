...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "tool_lp_data_for_plan_page_200_response_competencies_inner_usercompetency")]
    public partial class ToolLpDataForPlanPage200ResponseCompetenciesInnerUsercompetency : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolLpDataForPlanPage200ResponseCompetenciesInnerUsercompetency" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ToolLpDataForPlanPage200ResponseCompetenciesInnerUsercompetency() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolLpDataForPlanPage200ResponseCompetenciesInnerUsercompetency" /> class.
        /// </summary>
        ...
        /// <param name="isstatusidle">isstatusidle (required) (default to null).</param>
        /// <param name="isstatusinreview">isstatusinreview (required) (default to null).</param>
        /// <param name="isstatuswaitingforreview">isstatuswaitingforreview (required) (default to null).</param>
        ...
        public ToolLpDataForPlanPage200ResponseCompetenciesInnerUsercompetency(bool canrequestreview = default(bool), bool canreview = default(bool), int competencyid = default(int), int grade = default(int), string gradename = default(string), int id = 0, bool iscancelreviewrequestallowed = default(bool), bool isrequestreviewallowed = default(bool), bool isstartreviewallowed = default(bool), bool isstatusidle = null, bool isstatusinreview = null, bool isstatuswaitingforreview = null, bool isstopreviewallowed = default(bool), bool proficiency = default(bool), string proficiencyname = default(string), CoreCompetencyGradeCompetency200ResponseActionuser reviewer = default(CoreCompetencyGradeCompetency200ResponseActionuser), int reviewerid = default(int), int status = 0, string statusname = default(string), int timecreated = 0, int timemodified = 0, string url = default(string), int userid = default(int), int usermodified = 0)
        {
            ...
            if (gradename == null)
            {
                throw new ArgumentNullException("gradename is a required property for ToolLpDataForPlanPage200ResponseCompetenciesInnerUsercompetency and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("proficiencyname is a required property for ToolLpDataForPlanPage200ResponseCompetenciesInnerUsercompetency and cannot be null");
            }
            ...
            if (statusname == null)
            {
                throw new ArgumentNullException("statusname is a required property for ToolLpDataForPlanPage200ResponseCompetenciesInnerUsercompetency and cannot be null");
            }
            ...
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for ToolLpDataForPlanPage200ResponseCompetenciesInnerUsercompetency and cannot be null");
            }
            this.Url = url;
            this.Userid = userid;
