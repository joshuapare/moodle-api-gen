...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "core_search_get_results_request_filters")]
    public partial class CoreSearchGetResultsRequestFilters : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreSearchGetResultsRequestFilters" /> class.
        /// </summary>
        ...
        public CoreSearchGetResultsRequestFilters(List<Object> areaids = default(List<Object>), string cat = @"", List<Object> contextids = default(List<Object>), List<Object> courseids = default(List<Object>), List<Object> groupids = default(List<Object>), bool mycoursesonly = false, string order = @"", int timeend = 0, int timestart = 0, string title = @"null", List<Object> userids = default(List<Object>))
        {
