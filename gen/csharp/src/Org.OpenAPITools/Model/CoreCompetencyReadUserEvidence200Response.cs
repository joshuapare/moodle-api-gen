...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "core_competency_read_user_evidence_200_response")]
    public partial class CoreCompetencyReadUserEvidence200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreCompetencyReadUserEvidence200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreCompetencyReadUserEvidence200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreCompetencyReadUserEvidence200Response" /> class.
        /// </summary>
        /// <param name="canmanage">canmanage (required).</param>
        /// <param name="competencies">competencies (required).</param>
        /// <param name="competencycount">competencycount (required) (default to null).</param>
        ...
        /// <param name="filecount">filecount (required) (default to null).</param>
        /// <param name="files">files (required).</param>
        /// <param name="hasurlorfiles">hasurlorfiles (required) (default to null).</param>
        ...
        /// <param name="urlshort">urlshort (required) (default to &quot;null&quot;).</param>
        /// <param name="userid">userid (required).</param>
        /// <param name="usermodified">usermodified (required) (default to 0).</param>
        public CoreCompetencyReadUserEvidence200Response(bool canmanage = default(bool), List<CoreCompetencyReadUserEvidence200ResponseCompetenciesInner> competencies = default(List<CoreCompetencyReadUserEvidence200ResponseCompetenciesInner>), int competencycount = null, string description = @"", int descriptionformat = 1, int filecount = null, List<CoreCompetencyReadUserEvidence200ResponseFilesInner> files = default(List<CoreCompetencyReadUserEvidence200ResponseFilesInner>), bool hasurlorfiles = null, int id = 0, string name = default(string), int timecreated = 0, int timemodified = 0, string url = @"", string urlshort = @"null", int userid = default(int), int usermodified = 0)
        {
            this.Canmanage = canmanage;
            // to ensure "competencies" is required (not null)
            if (competencies == null)
            {
                throw new ArgumentNullException("competencies is a required property for CoreCompetencyReadUserEvidence200Response and cannot be null");
            }
            ...
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for CoreCompetencyReadUserEvidence200Response and cannot be null");
            }
            ...
            if (files == null)
            {
                throw new ArgumentNullException("files is a required property for CoreCompetencyReadUserEvidence200Response and cannot be null");
            }
            this.Files = files;
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CoreCompetencyReadUserEvidence200Response and cannot be null");
            }
            this.Name = name;
            ...
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for CoreCompetencyReadUserEvidence200Response and cannot be null");
            }
            this.Url = url;
            // to ensure "urlshort" is required (not null)
            if (urlshort == null)
            {
                throw new ArgumentNullException("urlshort is a required property for CoreCompetencyReadUserEvidence200Response and cannot be null");
            }
        ...
        public List<CoreCompetencyReadUserEvidence200ResponseCompetenciesInner> Competencies { get; set; }
        ...
        public List<CoreCompetencyReadUserEvidence200ResponseFilesInner> Files { get; set; }
