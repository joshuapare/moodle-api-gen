...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "core_competency_duplicate_competency_framework_200_response")]
    public partial class CoreCompetencyDuplicateCompetencyFramework200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreCompetencyDuplicateCompetencyFramework200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreCompetencyDuplicateCompetencyFramework200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreCompetencyDuplicateCompetencyFramework200Response" /> class.
        /// </summary>
        /// <param name="canmanage">canmanage (required).</param>
        /// <param name="competenciescount">competenciescount (required).</param>
        ...
        public CoreCompetencyDuplicateCompetencyFramework200Response(bool canmanage = default(bool), int competenciescount = default(int), int contextid = default(int), string contextname = default(string), string contextnamenoprefix = default(string), string description = @"", int descriptionformat = 1, int id = 0, string idnumber = default(string), string scaleconfiguration = default(string), int scaleid = default(int), string shortname = default(string), string taxonomies = @"", int timecreated = 0, int timemodified = 0, int usermodified = 0, bool visible = 1)
        {
            ...
            if (contextname == null)
            {
                throw new ArgumentNullException("contextname is a required property for CoreCompetencyDuplicateCompetencyFramework200Response and cannot be null");
            }
            this.Contextname = contextname;
            // to ensure "contextnamenoprefix" is required (not null)
            if (contextnamenoprefix == null)
            {
                throw new ArgumentNullException("contextnamenoprefix is a required property for CoreCompetencyDuplicateCompetencyFramework200Response and cannot be null");
            }
            this.Contextnamenoprefix = contextnamenoprefix;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for CoreCompetencyDuplicateCompetencyFramework200Response and cannot be null");
            }
            ...
            if (idnumber == null)
            {
                throw new ArgumentNullException("idnumber is a required property for CoreCompetencyDuplicateCompetencyFramework200Response and cannot be null");
            }
            this.Idnumber = idnumber;
            // to ensure "scaleconfiguration" is required (not null)
            if (scaleconfiguration == null)
            {
                throw new ArgumentNullException("scaleconfiguration is a required property for CoreCompetencyDuplicateCompetencyFramework200Response and cannot be null");
            }
            ...
            if (shortname == null)
            {
                throw new ArgumentNullException("shortname is a required property for CoreCompetencyDuplicateCompetencyFramework200Response and cannot be null");
            }
            this.Shortname = shortname;
            // to ensure "taxonomies" is required (not null)
            if (taxonomies == null)
            {
                throw new ArgumentNullException("taxonomies is a required property for CoreCompetencyDuplicateCompetencyFramework200Response and cannot be null");
            }
