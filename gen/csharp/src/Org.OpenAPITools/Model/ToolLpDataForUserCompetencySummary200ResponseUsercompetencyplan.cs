...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "tool_lp_data_for_user_competency_summary_200_response_usercompetencyplan")]
    public partial class ToolLpDataForUserCompetencySummary200ResponseUsercompetencyplan : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolLpDataForUserCompetencySummary200ResponseUsercompetencyplan" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ToolLpDataForUserCompetencySummary200ResponseUsercompetencyplan() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolLpDataForUserCompetencySummary200ResponseUsercompetencyplan" /> class.
        /// </summary>
        ...
        public ToolLpDataForUserCompetencySummary200ResponseUsercompetencyplan(int competencyid = default(int), int grade = default(int), string gradename = default(string), int id = 0, int planid = default(int), bool proficiency = default(bool), string proficiencyname = default(string), int sortorder = 0, int timecreated = 0, int timemodified = 0, int userid = default(int), int usermodified = 0)
        {
            ...
            if (gradename == null)
            {
                throw new ArgumentNullException("gradename is a required property for ToolLpDataForUserCompetencySummary200ResponseUsercompetencyplan and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("proficiencyname is a required property for ToolLpDataForUserCompetencySummary200ResponseUsercompetencyplan and cannot be null");
            }
