...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "core_xapi_delete_states_request")]
    public partial class CoreXapiDeleteStatesRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreXapiDeleteStatesRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CoreXapiDeleteStatesRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreXapiDeleteStatesRequest" /> class.
        /// </summary>
        ...
        public CoreXapiDeleteStatesRequest(string activityId = default(string), string agent = default(string), string component = default(string), string registration = default(string))
        {
            // to ensure "activityId" is required (not null)
            if (activityId == null)
            {
                throw new ArgumentNullException("activityId is a required property for CoreXapiDeleteStatesRequest and cannot be null");
            }
            this.ActivityId = activityId;
            // to ensure "agent" is required (not null)
            if (agent == null)
            {
                throw new ArgumentNullException("agent is a required property for CoreXapiDeleteStatesRequest and cannot be null");
            }
            this.Agent = agent;
            // to ensure "component" is required (not null)
            if (component == null)
            {
                throw new ArgumentNullException("component is a required property for CoreXapiDeleteStatesRequest and cannot be null");
            }
