...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "core_grading_get_gradingform_instances_200_response_instances_inner_rubric_criteria_inner")]
    public partial class CoreGradingGetGradingformInstances200ResponseInstancesInnerRubricCriteriaInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreGradingGetGradingformInstances200ResponseInstancesInnerRubricCriteriaInner" /> class.
        /// </summary>
        /// <param name="criterionid">criterion id.</param>
        /// <param name="id">filling id.</param>
        /// <param name="levelid">level id.</param>
        /// <param name="remark">remark.</param>
        /// <param name="remarkformat">remark format (1 &#x3D; HTML, 0 &#x3D; MOODLE, 2 &#x3D; PLAIN, or 4 &#x3D; MARKDOWN).</param>
        public CoreGradingGetGradingformInstances200ResponseInstancesInnerRubricCriteriaInner(int criterionid = default(int), int id = default(int), int levelid = default(int), string remark = default(string), int remarkformat = default(int))
        {
