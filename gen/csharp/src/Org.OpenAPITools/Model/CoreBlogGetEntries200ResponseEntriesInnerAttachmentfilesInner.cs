...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "core_blog_get_entries_200_response_entries_inner_attachmentfiles_inner")]
    public partial class CoreBlogGetEntries200ResponseEntriesInnerAttachmentfilesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreBlogGetEntries200ResponseEntriesInnerAttachmentfilesInner" /> class.
        /// </summary>
        ...
        /// <param name="repositorytype">The repository type for the external files. (default to &quot;null&quot;).</param>
        /// <param name="timemodified">Time modified. (default to null).</param>
        public CoreBlogGetEntries200ResponseEntriesInnerAttachmentfilesInner(string filename = @"null", string filepath = @"null", int filesize = null, string fileurl = @"null", bool isexternalfile = null, string mimetype = @"null", string repositorytype = @"null", int timemodified = null)
        {
