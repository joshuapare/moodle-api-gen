...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "mod_forum_add_discussion_post_200_response_post_attachments_inner")]
    public partial class ModForumAddDiscussionPost200ResponsePostAttachmentsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModForumAddDiscussionPost200ResponsePostAttachmentsInner" /> class.
        /// </summary>
        ...
        public ModForumAddDiscussionPost200ResponsePostAttachmentsInner(string author = default(string), string component = default(string), int contextid = default(int), string filearea = default(string), string filename = default(string), string filenameshort = default(string), string filepath = default(string), int filesize = default(int), string filesizeformatted = default(string), ModForumAddDiscussionPost200ResponsePostAttachmentsInnerHtml html = default(ModForumAddDiscussionPost200ResponsePostAttachmentsInnerHtml), string icon = default(string), bool isdir = default(bool), bool isimage = default(bool), int itemid = default(int), string license = default(string), int timecreated = default(int), string timecreatedformatted = default(string), int timemodified = default(int), string timemodifiedformatted = default(string), string url = default(string), ModForumAddDiscussionPost200ResponsePostAttachmentsInnerUrls urls = default(ModForumAddDiscussionPost200ResponsePostAttachmentsInnerUrls))
        {
            this.Author = author;
        ...
        public ModForumAddDiscussionPost200ResponsePostAttachmentsInnerHtml Html { get; set; }
        ...
        public ModForumAddDiscussionPost200ResponsePostAttachmentsInnerUrls Urls { get; set; }
