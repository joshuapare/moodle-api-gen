...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "mod_assign_get_submission_status_200_response_lastattempt_submission")]
    public partial class ModAssignGetSubmissionStatus200ResponseLastattemptSubmission : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModAssignGetSubmissionStatus200ResponseLastattemptSubmission" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ModAssignGetSubmissionStatus200ResponseLastattemptSubmission() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ModAssignGetSubmissionStatus200ResponseLastattemptSubmission" /> class.
        /// </summary>
        ...
        /// <param name="id">submission id (required) (default to null).</param>
        /// <param name="latest">latest attempt (default to null).</param>
        /// <param name="plugins">plugins.</param>
        /// <param name="status">submission status (required) (default to &quot;null&quot;).</param>
        /// <param name="timecreated">submission creation time (required) (default to null).</param>
        /// <param name="timemodified">submission last modified time (required) (default to null).</param>
        /// <param name="timestarted">submission start time (default to null).</param>
        /// <param name="userid">student id (required).</param>
        public ModAssignGetSubmissionStatus200ResponseLastattemptSubmission(int assignment = default(int), int attemptnumber = default(int), string gradingstatus = default(string), int groupid = default(int), int id = null, int latest = null, List<ModAssignGetSubmissionStatus200ResponseLastattemptSubmissionPluginsInner> plugins = default(List<ModAssignGetSubmissionStatus200ResponseLastattemptSubmissionPluginsInner>), string status = @"null", int timecreated = null, int timemodified = null, int timestarted = null, int userid = default(int))
        {
            ...
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for ModAssignGetSubmissionStatus200ResponseLastattemptSubmission and cannot be null");
            }
            this.Status = status;
