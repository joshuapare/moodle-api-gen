...
namespace Org.OpenAPITools.Model
{
    ...
    /// Books
    /// </summary>
    [DataContract(Name = "mod_book_get_books_by_courses_200_response_books_inner")]
    public partial class ModBookGetBooksByCourses200ResponseBooksInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModBookGetBooksByCourses200ResponseBooksInner" /> class.
        /// </summary>
        /// <param name="course">Course id.</param>
        /// <param name="coursemodule">Course module id.</param>
        /// <param name="customtitles">Book custom titles type (default to null).</param>
        ...
        /// <param name="navstyle">Book navigation style configuration (default to null).</param>
        /// <param name="numbering">Book numbering configuration (default to null).</param>
        /// <param name="revision">Book revision (default to null).</param>
        ...
        public ModBookGetBooksByCourses200ResponseBooksInner(int course = default(int), int coursemodule = default(int), int customtitles = null, int groupingid = default(int), int groupmode = default(int), int id = default(int), string intro = default(string), List<CoreBlockGetDashboardBlocks200ResponseBlocksInnerContentsFilesInner> introfiles = default(List<CoreBlockGetDashboardBlocks200ResponseBlocksInnerContentsFilesInner>), int introformat = default(int), string lang = default(string), string name = default(string), int navstyle = null, int numbering = null, int revision = null, int section = default(int), int timecreated = null, int timemodified = null, bool visible = default(bool))
        {
            this.Course = course;
        ...
        /// </summary>
        /// <value>Book custom titles type</value>
        [DataMember(Name = "customtitles", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Book navigation style configuration</value>
        [DataMember(Name = "navstyle", EmitDefaultValue = false)]
        public int Navstyle { get; set; }

        /// <summary>
        /// Book numbering configuration
        /// </summary>
        /// <value>Book numbering configuration</value>
        [DataMember(Name = "numbering", EmitDefaultValue = false)]
        public int Numbering { get; set; }

        /// <summary>
        /// Book revision
        /// </summary>
        /// <value>Book revision</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Customtitles: ").Append(Customtitles).Append("\n");
            ...
            sb.Append("  Navstyle: ").Append(Navstyle).Append("\n");
