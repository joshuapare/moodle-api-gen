...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "mod_quiz_view_attempt_request")]
    public partial class ModQuizViewAttemptRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModQuizViewAttemptRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ModQuizViewAttemptRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ModQuizViewAttemptRequest" /> class.
        /// </summary>
        ...
        public ModQuizViewAttemptRequest(int attemptid = default(int), int page = default(int), List<ModQuizGetAttemptDataRequestPreflightdataInner> preflightdata = default(List<ModQuizGetAttemptDataRequestPreflightdataInner>))
        {
