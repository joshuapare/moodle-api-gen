...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "mod_feedback_get_analysis_200_response_itemsdata_inner_item_itemfiles_inner")]
    public partial class ModFeedbackGetAnalysis200ResponseItemsdataInnerItemItemfilesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModFeedbackGetAnalysis200ResponseItemsdataInnerItemItemfilesInner" /> class.
        /// </summary>
        ...
        public ModFeedbackGetAnalysis200ResponseItemsdataInnerItemItemfilesInner(string author = default(string), string component = default(string), int contextid = default(int), string filearea = default(string), string filename = default(string), string filenameshort = default(string), string filepath = default(string), int filesize = default(int), string filesizeformatted = default(string), string icon = default(string), bool isdir = default(bool), bool isimage = default(bool), int itemid = default(int), string license = default(string), int timecreated = default(int), string timecreatedformatted = default(string), int timemodified = default(int), string timemodifiedformatted = default(string), string url = default(string))
        {
            this.Author = author;
