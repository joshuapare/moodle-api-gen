...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "report_competency_data_for_report_200_response_usercompetencies_inner_usercompetencycourse")]
    public partial class ReportCompetencyDataForReport200ResponseUsercompetenciesInnerUsercompetencycourse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportCompetencyDataForReport200ResponseUsercompetenciesInnerUsercompetencycourse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ReportCompetencyDataForReport200ResponseUsercompetenciesInnerUsercompetencycourse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportCompetencyDataForReport200ResponseUsercompetenciesInnerUsercompetencycourse" /> class.
        /// </summary>
        ...
        /// <param name="proficiency">proficiency (required) (default to null).</param>
        /// <param name="proficiencyname">proficiencyname (required) (default to &quot;null&quot;).</param>
        ...
        public ReportCompetencyDataForReport200ResponseUsercompetenciesInnerUsercompetencycourse(int competencyid = default(int), int courseid = default(int), int grade = default(int), string gradename = default(string), int id = 0, bool proficiency = null, string proficiencyname = @"null", int timecreated = 0, int timemodified = 0, int userid = default(int), int usermodified = 0)
        {
            ...
            if (gradename == null)
            {
                throw new ArgumentNullException("gradename is a required property for ReportCompetencyDataForReport200ResponseUsercompetenciesInnerUsercompetencycourse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("proficiencyname is a required property for ReportCompetencyDataForReport200ResponseUsercompetenciesInnerUsercompetencycourse and cannot be null");
            }
