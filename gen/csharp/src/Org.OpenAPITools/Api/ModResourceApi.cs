...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class ModResourceApi : IModResourceApi
    {
        ...
        /// <returns></returns>
        public ModResourceApi(Org.OpenAPITools.Client.Configuration configuration)
        {
        ...
        public ModResourceApi(Org.OpenAPITools.Client.ISynchronousClient client, Org.OpenAPITools.Client.IAsynchronousClient asyncClient, Org.OpenAPITools.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<ModResourceGetResourcesByCourses200Response> localVarResponse = ModResourceGetResourcesByCoursesWithHttpInfo(modBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ModResourceGetResourcesByCourses200Response</returns>
        public Org.OpenAPITools.Client.ApiResponse<ModResourceGetResourcesByCourses200Response> ModResourceGetResourcesByCoursesWithHttpInfo(ModBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest modBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest, int operationIndex = 0)
        {
            ...
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'modBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest' when calling ModResourceApi->ModResourceGetResourcesByCourses");
            }
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<ModResourceGetResourcesByCourses200Response> localVarResponse = await ModResourceGetResourcesByCoursesWithHttpInfoAsync(modBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ModResourceGetResourcesByCourses200Response)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<ModResourceGetResourcesByCourses200Response>> ModResourceGetResourcesByCoursesWithHttpInfoAsync(ModBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest modBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'modBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest' is set
            if (modBigbluebuttonbnGetBigbluebuttonbnsByCoursesRequest == null)
            {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<CoreCalendarDeleteSubscription200Response> localVarResponse = ModResourceViewResourceWithHttpInfo(modResourceViewResourceRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CoreCalendarDeleteSubscription200Response</returns>
        public Org.OpenAPITools.Client.ApiResponse<CoreCalendarDeleteSubscription200Response> ModResourceViewResourceWithHttpInfo(ModResourceViewResourceRequest modResourceViewResourceRequest, int operationIndex = 0)
        {
            // verify the required parameter 'modResourceViewResourceRequest' is set
            if (modResourceViewResourceRequest == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'modResourceViewResourceRequest' when calling ModResourceApi->ModResourceViewResource");
            }
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<CoreCalendarDeleteSubscription200Response> localVarResponse = await ModResourceViewResourceWithHttpInfoAsync(modResourceViewResourceRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CoreCalendarDeleteSubscription200Response)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<CoreCalendarDeleteSubscription200Response>> ModResourceViewResourceWithHttpInfoAsync(ModResourceViewResourceRequest modResourceViewResourceRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'modResourceViewResourceRequest' is set
            if (modResourceViewResourceRequest == null)
            {
