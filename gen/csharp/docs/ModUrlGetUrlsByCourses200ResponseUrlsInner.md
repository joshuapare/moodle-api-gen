# Org.OpenAPITools.Model.ModUrlGetUrlsByCourses200ResponseUrlsInner
...
**Externalurl** | **string** | External URL | [optional] [default to "null"]
...
**Parameters** | **string** | Parameters to append to the URL | [optional] [default to "null"]
