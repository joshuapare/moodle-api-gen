...
<p align="center">
  <img src="https://moodle.com/wp-content/uploads/2024/02/Moodlelogo.svg" alt="Moodle" width="200">
</p>
...
| Client                  | Link                                                                                        | Version              |
|-------------------------|---------------------------------------------------------------------------------------------|----------------------|
| Go                      | [Go](https://pkg.go.dev/github.com/joshuapare/moodle-client-go)                             | 0.1.0 (Unreleased)   |
| PHP                     | [PHP](https://packagist.org/packages/joshuapare/moodle-client-php)                          | 0.1.0 (Unreleased)   |
...
| Python                  | [Python](https://pypi.org/project/moodle-client-python)                                     | 0.1.0 (Unreleased)   |
| Java                    | [Java](https://search.maven.org/artifact/com.joshuapare/moodle-client-java)                 | 0.1.0 (Unreleased)   |
| Rust                    | [Rust](https://crates.io/crates/moodle-client-rust)                                         | 0.1.0 (Unreleased)   |
| C#                      | [C#](https://www.nuget.org/packages/MoodleClientCsharp)                                     | 0.1.0 (Unreleased)   |
